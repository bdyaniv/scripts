...
INSERT INTO BN_HITS_SP_20110606
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110606;

SELECT count(*) as BN_HITS_SP_20110606 FROM BN_HITS_SP_20110606;

TRUNCATE BN_HITS_CLIENT_20110606;
INSERT INTO BN_HITS_CLIENT_20110606
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110606;

SELECT count(*) as BN_HITS_CLIENT_20110606 FROM BN_HITS_CLIENT_20110606;
