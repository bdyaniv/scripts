...
INSERT INTO BN_HITS_SP_20110821
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110821;

SELECT count(*) as BN_HITS_SP_20110821 FROM BN_HITS_SP_20110821;

TRUNCATE BN_HITS_CLIENT_20110821;
INSERT INTO BN_HITS_CLIENT_20110821
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110821;

SELECT count(*) as BN_HITS_CLIENT_20110821 FROM BN_HITS_CLIENT_20110821;
