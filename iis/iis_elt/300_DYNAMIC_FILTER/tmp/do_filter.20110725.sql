...
INSERT INTO BN_HITS_SP_20110725
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110725;

SELECT count(*) as BN_HITS_SP_20110725 FROM BN_HITS_SP_20110725;

TRUNCATE BN_HITS_CLIENT_20110725;
INSERT INTO BN_HITS_CLIENT_20110725
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110725;

SELECT count(*) as BN_HITS_CLIENT_20110725 FROM BN_HITS_CLIENT_20110725;
