...
INSERT INTO BN_HITS_SP_20111124
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111124;

SELECT count(*) as BN_HITS_SP_20111124 FROM BN_HITS_SP_20111124;

TRUNCATE BN_HITS_CLIENT_20111124;
INSERT INTO BN_HITS_CLIENT_20111124
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111124;

SELECT count(*) as BN_HITS_CLIENT_20111124 FROM BN_HITS_CLIENT_20111124;
