...
INSERT INTO BN_HITS_SP_20110713
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110713;

SELECT count(*) as BN_HITS_SP_20110713 FROM BN_HITS_SP_20110713;

TRUNCATE BN_HITS_CLIENT_20110713;
INSERT INTO BN_HITS_CLIENT_20110713
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110713;

SELECT count(*) as BN_HITS_CLIENT_20110713 FROM BN_HITS_CLIENT_20110713;
