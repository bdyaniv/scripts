...
INSERT INTO BN_HITS_SP_20111118
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111118;

SELECT count(*) as BN_HITS_SP_20111118 FROM BN_HITS_SP_20111118;

TRUNCATE BN_HITS_CLIENT_20111118;
INSERT INTO BN_HITS_CLIENT_20111118
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111118;

SELECT count(*) as BN_HITS_CLIENT_20111118 FROM BN_HITS_CLIENT_20111118;
