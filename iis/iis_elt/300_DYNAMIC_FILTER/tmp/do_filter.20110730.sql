...
INSERT INTO BN_HITS_SP_20110730
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110730;

SELECT count(*) as BN_HITS_SP_20110730 FROM BN_HITS_SP_20110730;

TRUNCATE BN_HITS_CLIENT_20110730;
INSERT INTO BN_HITS_CLIENT_20110730
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110730;

SELECT count(*) as BN_HITS_CLIENT_20110730 FROM BN_HITS_CLIENT_20110730;
