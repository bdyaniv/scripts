...
INSERT INTO BN_HITS_SP_20110811
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110811;

SELECT count(*) as BN_HITS_SP_20110811 FROM BN_HITS_SP_20110811;

TRUNCATE BN_HITS_CLIENT_20110811;
INSERT INTO BN_HITS_CLIENT_20110811
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110811;

SELECT count(*) as BN_HITS_CLIENT_20110811 FROM BN_HITS_CLIENT_20110811;
