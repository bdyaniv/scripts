...
INSERT INTO BN_HITS_SP_20111122
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111122;

SELECT count(*) as BN_HITS_SP_20111122 FROM BN_HITS_SP_20111122;

TRUNCATE BN_HITS_CLIENT_20111122;
INSERT INTO BN_HITS_CLIENT_20111122
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111122;

SELECT count(*) as BN_HITS_CLIENT_20111122 FROM BN_HITS_CLIENT_20111122;
