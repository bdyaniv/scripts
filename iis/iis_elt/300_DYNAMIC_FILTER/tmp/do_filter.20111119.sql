...
INSERT INTO BN_HITS_SP_20111119
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111119;

SELECT count(*) as BN_HITS_SP_20111119 FROM BN_HITS_SP_20111119;

TRUNCATE BN_HITS_CLIENT_20111119;
INSERT INTO BN_HITS_CLIENT_20111119
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111119;

SELECT count(*) as BN_HITS_CLIENT_20111119 FROM BN_HITS_CLIENT_20111119;
