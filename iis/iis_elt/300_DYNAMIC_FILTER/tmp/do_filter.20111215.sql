...
INSERT INTO BN_HITS_SP_20111215
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111215;

SELECT count(*) as BN_HITS_SP_20111215 FROM BN_HITS_SP_20111215;

TRUNCATE BN_HITS_CLIENT_20111215;
INSERT INTO BN_HITS_CLIENT_20111215
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111215;

SELECT count(*) as BN_HITS_CLIENT_20111215 FROM BN_HITS_CLIENT_20111215;
