...
INSERT INTO BN_HITS_SP_20110409
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110409;

SELECT count(*) as BN_HITS_SP_20110409 FROM BN_HITS_SP_20110409;

TRUNCATE BN_HITS_CLIENT_20110409;
INSERT INTO BN_HITS_CLIENT_20110409
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110409;

SELECT count(*) as BN_HITS_CLIENT_20110409 FROM BN_HITS_CLIENT_20110409;
