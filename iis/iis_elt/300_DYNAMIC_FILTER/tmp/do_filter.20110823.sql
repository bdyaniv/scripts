...
INSERT INTO BN_HITS_SP_20110823
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110823;

SELECT count(*) as BN_HITS_SP_20110823 FROM BN_HITS_SP_20110823;

TRUNCATE BN_HITS_CLIENT_20110823;
INSERT INTO BN_HITS_CLIENT_20110823
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110823;

SELECT count(*) as BN_HITS_CLIENT_20110823 FROM BN_HITS_CLIENT_20110823;
