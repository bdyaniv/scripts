...
INSERT INTO BN_HITS_SP_20110715
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110715;

SELECT count(*) as BN_HITS_SP_20110715 FROM BN_HITS_SP_20110715;

TRUNCATE BN_HITS_CLIENT_20110715;
INSERT INTO BN_HITS_CLIENT_20110715
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110715;

SELECT count(*) as BN_HITS_CLIENT_20110715 FROM BN_HITS_CLIENT_20110715;
