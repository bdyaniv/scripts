...
INSERT INTO BN_HITS_SP_20111002
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111002;

SELECT count(*) as BN_HITS_SP_20111002 FROM BN_HITS_SP_20111002;

TRUNCATE BN_HITS_CLIENT_20111002;
INSERT INTO BN_HITS_CLIENT_20111002
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111002;

SELECT count(*) as BN_HITS_CLIENT_20111002 FROM BN_HITS_CLIENT_20111002;
