...
INSERT INTO BN_HITS_SP_20110415
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110415;

SELECT count(*) as BN_HITS_SP_20110415 FROM BN_HITS_SP_20110415;

TRUNCATE BN_HITS_CLIENT_20110415;
INSERT INTO BN_HITS_CLIENT_20110415
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110415;

SELECT count(*) as BN_HITS_CLIENT_20110415 FROM BN_HITS_CLIENT_20110415;
