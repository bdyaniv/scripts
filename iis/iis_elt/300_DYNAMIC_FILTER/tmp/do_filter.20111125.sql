...
INSERT INTO BN_HITS_SP_20111125
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111125;

SELECT count(*) as BN_HITS_SP_20111125 FROM BN_HITS_SP_20111125;

TRUNCATE BN_HITS_CLIENT_20111125;
INSERT INTO BN_HITS_CLIENT_20111125
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111125;

SELECT count(*) as BN_HITS_CLIENT_20111125 FROM BN_HITS_CLIENT_20111125;
