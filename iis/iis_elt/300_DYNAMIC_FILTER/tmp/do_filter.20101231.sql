...
INSERT INTO BN_HITS_SP_20101231
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101231;

SELECT count(*) as BN_HITS_SP_20101231 FROM BN_HITS_SP_20101231;

TRUNCATE BN_HITS_CLIENT_20101231;
INSERT INTO BN_HITS_CLIENT_20101231
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101231;

SELECT count(*) as BN_HITS_CLIENT_20101231 FROM BN_HITS_CLIENT_20101231;
