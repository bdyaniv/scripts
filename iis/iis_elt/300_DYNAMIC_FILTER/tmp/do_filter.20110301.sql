...
INSERT INTO BN_HITS_SP_20110301
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110301;

SELECT count(*) as BN_HITS_SP_20110301 FROM BN_HITS_SP_20110301;

TRUNCATE BN_HITS_CLIENT_20110301;
INSERT INTO BN_HITS_CLIENT_20110301
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110301;

SELECT count(*) as BN_HITS_CLIENT_20110301 FROM BN_HITS_CLIENT_20110301;
