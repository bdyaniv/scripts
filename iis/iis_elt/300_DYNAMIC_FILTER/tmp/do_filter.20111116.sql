...
INSERT INTO BN_HITS_SP_20111116
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111116;

SELECT count(*) as BN_HITS_SP_20111116 FROM BN_HITS_SP_20111116;

TRUNCATE BN_HITS_CLIENT_20111116;
INSERT INTO BN_HITS_CLIENT_20111116
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111116;

SELECT count(*) as BN_HITS_CLIENT_20111116 FROM BN_HITS_CLIENT_20111116;
