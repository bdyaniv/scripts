...
INSERT INTO BN_HITS_SP_20110906
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110906;

SELECT count(*) as BN_HITS_SP_20110906 FROM BN_HITS_SP_20110906;

TRUNCATE BN_HITS_CLIENT_20110906;
INSERT INTO BN_HITS_CLIENT_20110906
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110906;

SELECT count(*) as BN_HITS_CLIENT_20110906 FROM BN_HITS_CLIENT_20110906;
