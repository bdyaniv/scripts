...
INSERT INTO BN_HITS_SP_20111026
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111026;

SELECT count(*) as BN_HITS_SP_20111026 FROM BN_HITS_SP_20111026;

TRUNCATE BN_HITS_CLIENT_20111026;
INSERT INTO BN_HITS_CLIENT_20111026
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111026;

SELECT count(*) as BN_HITS_CLIENT_20111026 FROM BN_HITS_CLIENT_20111026;
