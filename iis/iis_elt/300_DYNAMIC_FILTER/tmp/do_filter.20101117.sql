...
INSERT INTO BN_HITS_SP_20101117
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101117;

SELECT count(*) as BN_HITS_SP_20101117 FROM BN_HITS_SP_20101117;

TRUNCATE BN_HITS_CLIENT_20101117;
INSERT INTO BN_HITS_CLIENT_20101117
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101117;

SELECT count(*) as BN_HITS_CLIENT_20101117 FROM BN_HITS_CLIENT_20101117;
