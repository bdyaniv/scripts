...
INSERT INTO BN_HITS_SP_20101227
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101227;

SELECT count(*) as BN_HITS_SP_20101227 FROM BN_HITS_SP_20101227;

TRUNCATE BN_HITS_CLIENT_20101227;
INSERT INTO BN_HITS_CLIENT_20101227
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101227;

SELECT count(*) as BN_HITS_CLIENT_20101227 FROM BN_HITS_CLIENT_20101227;
