...
INSERT INTO BN_HITS_SP_20110728
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110728;

SELECT count(*) as BN_HITS_SP_20110728 FROM BN_HITS_SP_20110728;

TRUNCATE BN_HITS_CLIENT_20110728;
INSERT INTO BN_HITS_CLIENT_20110728
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110728;

SELECT count(*) as BN_HITS_CLIENT_20110728 FROM BN_HITS_CLIENT_20110728;
