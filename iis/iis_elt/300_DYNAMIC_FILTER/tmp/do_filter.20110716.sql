...
INSERT INTO BN_HITS_SP_20110716
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110716;

SELECT count(*) as BN_HITS_SP_20110716 FROM BN_HITS_SP_20110716;

TRUNCATE BN_HITS_CLIENT_20110716;
INSERT INTO BN_HITS_CLIENT_20110716
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110716;

SELECT count(*) as BN_HITS_CLIENT_20110716 FROM BN_HITS_CLIENT_20110716;
