...
INSERT INTO BN_HITS_SP_20101120
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101120;

SELECT count(*) as BN_HITS_SP_20101120 FROM BN_HITS_SP_20101120;

TRUNCATE BN_HITS_CLIENT_20101120;
INSERT INTO BN_HITS_CLIENT_20101120
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101120;

SELECT count(*) as BN_HITS_CLIENT_20101120 FROM BN_HITS_CLIENT_20101120;
