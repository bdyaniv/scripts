...
INSERT INTO BN_HITS_SP_20110326
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110326;

SELECT count(*) as BN_HITS_SP_20110326 FROM BN_HITS_SP_20110326;

TRUNCATE BN_HITS_CLIENT_20110326;
INSERT INTO BN_HITS_CLIENT_20110326
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110326;

SELECT count(*) as BN_HITS_CLIENT_20110326 FROM BN_HITS_CLIENT_20110326;
