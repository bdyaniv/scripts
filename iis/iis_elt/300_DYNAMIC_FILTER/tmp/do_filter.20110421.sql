...
INSERT INTO BN_HITS_SP_20110421
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110421;

SELECT count(*) as BN_HITS_SP_20110421 FROM BN_HITS_SP_20110421;

TRUNCATE BN_HITS_CLIENT_20110421;
INSERT INTO BN_HITS_CLIENT_20110421
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110421;

SELECT count(*) as BN_HITS_CLIENT_20110421 FROM BN_HITS_CLIENT_20110421;
