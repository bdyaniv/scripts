...
INSERT INTO BN_HITS_SP_20101121
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101121;

SELECT count(*) as BN_HITS_SP_20101121 FROM BN_HITS_SP_20101121;

TRUNCATE BN_HITS_CLIENT_20101121;
INSERT INTO BN_HITS_CLIENT_20101121
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101121;

SELECT count(*) as BN_HITS_CLIENT_20101121 FROM BN_HITS_CLIENT_20101121;
