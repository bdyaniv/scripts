...
INSERT INTO BN_HITS_SP_20110417
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110417;

SELECT count(*) as BN_HITS_SP_20110417 FROM BN_HITS_SP_20110417;

TRUNCATE BN_HITS_CLIENT_20110417;
INSERT INTO BN_HITS_CLIENT_20110417
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110417;

SELECT count(*) as BN_HITS_CLIENT_20110417 FROM BN_HITS_CLIENT_20110417;
