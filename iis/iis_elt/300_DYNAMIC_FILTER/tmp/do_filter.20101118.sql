...
INSERT INTO BN_HITS_SP_20101118
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101118;

SELECT count(*) as BN_HITS_SP_20101118 FROM BN_HITS_SP_20101118;

TRUNCATE BN_HITS_CLIENT_20101118;
INSERT INTO BN_HITS_CLIENT_20101118
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101118;

SELECT count(*) as BN_HITS_CLIENT_20101118 FROM BN_HITS_CLIENT_20101118;
