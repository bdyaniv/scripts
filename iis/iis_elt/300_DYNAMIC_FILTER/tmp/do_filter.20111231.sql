...
INSERT INTO BN_HITS_SP_20111231
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111231;

SELECT count(*) as BN_HITS_SP_20111231 FROM BN_HITS_SP_20111231;

TRUNCATE BN_HITS_CLIENT_20111231;
INSERT INTO BN_HITS_CLIENT_20111231
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111231;

SELECT count(*) as BN_HITS_CLIENT_20111231 FROM BN_HITS_CLIENT_20111231;
