...
INSERT INTO BN_HITS_SP_20110902
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110902;

SELECT count(*) as BN_HITS_SP_20110902 FROM BN_HITS_SP_20110902;

TRUNCATE BN_HITS_CLIENT_20110902;
INSERT INTO BN_HITS_CLIENT_20110902
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110902;

SELECT count(*) as BN_HITS_CLIENT_20110902 FROM BN_HITS_CLIENT_20110902;
