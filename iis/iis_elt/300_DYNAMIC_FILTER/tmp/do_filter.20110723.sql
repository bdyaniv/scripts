...
INSERT INTO BN_HITS_SP_20110723
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110723;

SELECT count(*) as BN_HITS_SP_20110723 FROM BN_HITS_SP_20110723;

TRUNCATE BN_HITS_CLIENT_20110723;
INSERT INTO BN_HITS_CLIENT_20110723
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110723;

SELECT count(*) as BN_HITS_CLIENT_20110723 FROM BN_HITS_CLIENT_20110723;
