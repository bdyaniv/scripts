...
INSERT INTO BN_HITS_SP_20110803
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110803;

SELECT count(*) as BN_HITS_SP_20110803 FROM BN_HITS_SP_20110803;

TRUNCATE BN_HITS_CLIENT_20110803;
INSERT INTO BN_HITS_CLIENT_20110803
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110803;

SELECT count(*) as BN_HITS_CLIENT_20110803 FROM BN_HITS_CLIENT_20110803;
