...
INSERT INTO BN_HITS_SP_20110116
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110116;

SELECT count(*) as BN_HITS_SP_20110116 FROM BN_HITS_SP_20110116;

TRUNCATE BN_HITS_CLIENT_20110116;
INSERT INTO BN_HITS_CLIENT_20110116
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110116;

SELECT count(*) as BN_HITS_CLIENT_20110116 FROM BN_HITS_CLIENT_20110116;
