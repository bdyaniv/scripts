...
INSERT INTO BN_HITS_SP_20110113
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110113;

SELECT count(*) as BN_HITS_SP_20110113 FROM BN_HITS_SP_20110113;

TRUNCATE BN_HITS_CLIENT_20110113;
INSERT INTO BN_HITS_CLIENT_20110113
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110113;

SELECT count(*) as BN_HITS_CLIENT_20110113 FROM BN_HITS_CLIENT_20110113;
