...
INSERT INTO BN_HITS_SP_20120101
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20120101;

SELECT count(*) as BN_HITS_SP_20120101 FROM BN_HITS_SP_20120101;

TRUNCATE BN_HITS_CLIENT_20120101;
INSERT INTO BN_HITS_CLIENT_20120101
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20120101;

SELECT count(*) as BN_HITS_CLIENT_20120101 FROM BN_HITS_CLIENT_20120101;
