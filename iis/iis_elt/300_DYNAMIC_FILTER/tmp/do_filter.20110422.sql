...
INSERT INTO BN_HITS_SP_20110422
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110422;

SELECT count(*) as BN_HITS_SP_20110422 FROM BN_HITS_SP_20110422;

TRUNCATE BN_HITS_CLIENT_20110422;
INSERT INTO BN_HITS_CLIENT_20110422
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110422;

SELECT count(*) as BN_HITS_CLIENT_20110422 FROM BN_HITS_CLIENT_20110422;
