...
INSERT INTO BN_HITS_SP_20111030
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111030;

SELECT count(*) as BN_HITS_SP_20111030 FROM BN_HITS_SP_20111030;

TRUNCATE BN_HITS_CLIENT_20111030;
INSERT INTO BN_HITS_CLIENT_20111030
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111030;

SELECT count(*) as BN_HITS_CLIENT_20111030 FROM BN_HITS_CLIENT_20111030;
