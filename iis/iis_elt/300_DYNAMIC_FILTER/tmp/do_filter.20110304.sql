...
INSERT INTO BN_HITS_SP_20110304
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110304;

SELECT count(*) as BN_HITS_SP_20110304 FROM BN_HITS_SP_20110304;

TRUNCATE BN_HITS_CLIENT_20110304;
INSERT INTO BN_HITS_CLIENT_20110304
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110304;

SELECT count(*) as BN_HITS_CLIENT_20110304 FROM BN_HITS_CLIENT_20110304;
