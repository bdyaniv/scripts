...
INSERT INTO BN_HITS_SP_20110711
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110711;

SELECT count(*) as BN_HITS_SP_20110711 FROM BN_HITS_SP_20110711;

TRUNCATE BN_HITS_CLIENT_20110711;
INSERT INTO BN_HITS_CLIENT_20110711
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110711;

SELECT count(*) as BN_HITS_CLIENT_20110711 FROM BN_HITS_CLIENT_20110711;
