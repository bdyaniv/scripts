...
INSERT INTO BN_HITS_SP_20110807
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110807;

SELECT count(*) as BN_HITS_SP_20110807 FROM BN_HITS_SP_20110807;

TRUNCATE BN_HITS_CLIENT_20110807;
INSERT INTO BN_HITS_CLIENT_20110807
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110807;

SELECT count(*) as BN_HITS_CLIENT_20110807 FROM BN_HITS_CLIENT_20110807;
