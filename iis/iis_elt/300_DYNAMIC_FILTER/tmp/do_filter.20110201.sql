...
INSERT INTO BN_HITS_SP_20110201
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110201;

SELECT count(*) as BN_HITS_SP_20110201 FROM BN_HITS_SP_20110201;

TRUNCATE BN_HITS_CLIENT_20110201;
INSERT INTO BN_HITS_CLIENT_20110201
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110201;

SELECT count(*) as BN_HITS_CLIENT_20110201 FROM BN_HITS_CLIENT_20110201;
