...
INSERT INTO BN_HITS_SP_20110228
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110228;

SELECT count(*) as BN_HITS_SP_20110228 FROM BN_HITS_SP_20110228;

TRUNCATE BN_HITS_CLIENT_20110228;
INSERT INTO BN_HITS_CLIENT_20110228
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110228;

SELECT count(*) as BN_HITS_CLIENT_20110228 FROM BN_HITS_CLIENT_20110228;
