...
INSERT INTO BN_HITS_SP_20111128
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111128;

SELECT count(*) as BN_HITS_SP_20111128 FROM BN_HITS_SP_20111128;

TRUNCATE BN_HITS_CLIENT_20111128;
INSERT INTO BN_HITS_CLIENT_20111128
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111128;

SELECT count(*) as BN_HITS_CLIENT_20111128 FROM BN_HITS_CLIENT_20111128;
