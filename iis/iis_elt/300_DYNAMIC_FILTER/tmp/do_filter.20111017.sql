...
INSERT INTO BN_HITS_SP_20111017
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111017;

SELECT count(*) as BN_HITS_SP_20111017 FROM BN_HITS_SP_20111017;

TRUNCATE BN_HITS_CLIENT_20111017;
INSERT INTO BN_HITS_CLIENT_20111017
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111017;

SELECT count(*) as BN_HITS_CLIENT_20111017 FROM BN_HITS_CLIENT_20111017;
