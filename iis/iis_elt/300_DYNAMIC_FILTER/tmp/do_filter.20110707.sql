...
INSERT INTO BN_HITS_SP_20110707
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110707;

SELECT count(*) as BN_HITS_SP_20110707 FROM BN_HITS_SP_20110707;

TRUNCATE BN_HITS_CLIENT_20110707;
INSERT INTO BN_HITS_CLIENT_20110707
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110707;

SELECT count(*) as BN_HITS_CLIENT_20110707 FROM BN_HITS_CLIENT_20110707;
