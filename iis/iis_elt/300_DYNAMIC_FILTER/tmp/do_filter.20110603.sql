...
INSERT INTO BN_HITS_SP_20110603
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110603;

SELECT count(*) as BN_HITS_SP_20110603 FROM BN_HITS_SP_20110603;

TRUNCATE BN_HITS_CLIENT_20110603;
INSERT INTO BN_HITS_CLIENT_20110603
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110603;

SELECT count(*) as BN_HITS_CLIENT_20110603 FROM BN_HITS_CLIENT_20110603;
