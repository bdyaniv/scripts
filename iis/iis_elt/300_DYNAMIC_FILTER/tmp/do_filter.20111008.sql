...
INSERT INTO BN_HITS_SP_20111008
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111008;

SELECT count(*) as BN_HITS_SP_20111008 FROM BN_HITS_SP_20111008;

TRUNCATE BN_HITS_CLIENT_20111008;
INSERT INTO BN_HITS_CLIENT_20111008
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111008;

SELECT count(*) as BN_HITS_CLIENT_20111008 FROM BN_HITS_CLIENT_20111008;
