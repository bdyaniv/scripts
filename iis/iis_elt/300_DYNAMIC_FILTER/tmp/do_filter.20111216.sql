...
INSERT INTO BN_HITS_SP_20111216
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111216;

SELECT count(*) as BN_HITS_SP_20111216 FROM BN_HITS_SP_20111216;

TRUNCATE BN_HITS_CLIENT_20111216;
INSERT INTO BN_HITS_CLIENT_20111216
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111216;

SELECT count(*) as BN_HITS_CLIENT_20111216 FROM BN_HITS_CLIENT_20111216;
