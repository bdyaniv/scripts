...
INSERT INTO BN_HITS_SP_20110830
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110830;

SELECT count(*) as BN_HITS_SP_20110830 FROM BN_HITS_SP_20110830;

TRUNCATE BN_HITS_CLIENT_20110830;
INSERT INTO BN_HITS_CLIENT_20110830
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110830;

SELECT count(*) as BN_HITS_CLIENT_20110830 FROM BN_HITS_CLIENT_20110830;
