...
INSERT INTO BN_HITS_SP_20110804
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110804;

SELECT count(*) as BN_HITS_SP_20110804 FROM BN_HITS_SP_20110804;

TRUNCATE BN_HITS_CLIENT_20110804;
INSERT INTO BN_HITS_CLIENT_20110804
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110804;

SELECT count(*) as BN_HITS_CLIENT_20110804 FROM BN_HITS_CLIENT_20110804;
