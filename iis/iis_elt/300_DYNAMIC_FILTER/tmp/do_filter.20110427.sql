...
INSERT INTO BN_HITS_SP_20110427
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110427;

SELECT count(*) as BN_HITS_SP_20110427 FROM BN_HITS_SP_20110427;

TRUNCATE BN_HITS_CLIENT_20110427;
INSERT INTO BN_HITS_CLIENT_20110427
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110427;

SELECT count(*) as BN_HITS_CLIENT_20110427 FROM BN_HITS_CLIENT_20110427;
