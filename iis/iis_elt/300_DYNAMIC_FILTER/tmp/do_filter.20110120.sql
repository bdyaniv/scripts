...
INSERT INTO BN_HITS_SP_20110120
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110120;

SELECT count(*) as BN_HITS_SP_20110120 FROM BN_HITS_SP_20110120;

TRUNCATE BN_HITS_CLIENT_20110120;
INSERT INTO BN_HITS_CLIENT_20110120
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110120;

SELECT count(*) as BN_HITS_CLIENT_20110120 FROM BN_HITS_CLIENT_20110120;
