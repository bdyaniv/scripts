...
INSERT INTO BN_HITS_SP_20101114
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101114;

SELECT count(*) as BN_HITS_SP_20101114 FROM BN_HITS_SP_20101114;

TRUNCATE BN_HITS_CLIENT_20101114;
INSERT INTO BN_HITS_CLIENT_20101114
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101114;

SELECT count(*) as BN_HITS_CLIENT_20101114 FROM BN_HITS_CLIENT_20101114;
