...
INSERT INTO BN_HITS_SP_20110623
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110623;

SELECT count(*) as BN_HITS_SP_20110623 FROM BN_HITS_SP_20110623;

TRUNCATE BN_HITS_CLIENT_20110623;
INSERT INTO BN_HITS_CLIENT_20110623
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110623;

SELECT count(*) as BN_HITS_CLIENT_20110623 FROM BN_HITS_CLIENT_20110623;
