...
INSERT INTO BN_HITS_SP_20110818
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110818;

SELECT count(*) as BN_HITS_SP_20110818 FROM BN_HITS_SP_20110818;

TRUNCATE BN_HITS_CLIENT_20110818;
INSERT INTO BN_HITS_CLIENT_20110818
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110818;

SELECT count(*) as BN_HITS_CLIENT_20110818 FROM BN_HITS_CLIENT_20110818;
