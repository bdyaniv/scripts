...
/* S.SEQ_HIT_ID, */
 ...
 -- iis_mapping_cols trxm for RESOURCE_NAME
  ...
  UI_ACTION
FROM 
  web_resource_hits_2010_05_20
WHERE
  user_id is not null and
  hit_ts >= ('2010_05_20 0:0:0'::timestamp + interval '5 hours')
;
...
/* S.SEQ_HIT_ID, */
 ...
 -- iis_mapping_cols trxm for RESOURCE_NAME
  ...
  UI_ACTION
FROM 
  web_resource_hits_2010_05_21
WHERE
  user_id is not null and
  hit_ts < ('2010_05_21 00:00:00'::timestamp + interval '5 hours')
;
