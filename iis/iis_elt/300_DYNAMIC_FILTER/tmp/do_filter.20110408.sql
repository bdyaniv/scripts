...
INSERT INTO BN_HITS_SP_20110408
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110408;

SELECT count(*) as BN_HITS_SP_20110408 FROM BN_HITS_SP_20110408;

TRUNCATE BN_HITS_CLIENT_20110408;
INSERT INTO BN_HITS_CLIENT_20110408
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110408;

SELECT count(*) as BN_HITS_CLIENT_20110408 FROM BN_HITS_CLIENT_20110408;
