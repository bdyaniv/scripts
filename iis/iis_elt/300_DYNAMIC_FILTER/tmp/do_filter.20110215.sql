...
INSERT INTO BN_HITS_SP_20110215
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110215;

SELECT count(*) as BN_HITS_SP_20110215 FROM BN_HITS_SP_20110215;

TRUNCATE BN_HITS_CLIENT_20110215;
INSERT INTO BN_HITS_CLIENT_20110215
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110215;

SELECT count(*) as BN_HITS_CLIENT_20110215 FROM BN_HITS_CLIENT_20110215;
