...
INSERT INTO BN_HITS_SP_20121101
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20121101;

SELECT count(*) as BN_HITS_SP_20121101 FROM BN_HITS_SP_20121101;

TRUNCATE BN_HITS_CLIENT_20121101;
INSERT INTO BN_HITS_CLIENT_20121101
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20121101;

SELECT count(*) as BN_HITS_CLIENT_20121101 FROM BN_HITS_CLIENT_20121101;
