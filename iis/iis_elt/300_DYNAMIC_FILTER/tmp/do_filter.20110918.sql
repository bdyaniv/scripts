...
INSERT INTO BN_HITS_SP_20110918
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110918;

SELECT count(*) as BN_HITS_SP_20110918 FROM BN_HITS_SP_20110918;

TRUNCATE BN_HITS_CLIENT_20110918;
INSERT INTO BN_HITS_CLIENT_20110918
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110918;

SELECT count(*) as BN_HITS_CLIENT_20110918 FROM BN_HITS_CLIENT_20110918;
