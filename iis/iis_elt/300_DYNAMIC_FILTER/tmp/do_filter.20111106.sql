...
INSERT INTO BN_HITS_SP_20111106
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111106;

SELECT count(*) as BN_HITS_SP_20111106 FROM BN_HITS_SP_20111106;

TRUNCATE BN_HITS_CLIENT_20111106;
INSERT INTO BN_HITS_CLIENT_20111106
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111106;

SELECT count(*) as BN_HITS_CLIENT_20111106 FROM BN_HITS_CLIENT_20111106;
