...
INSERT INTO BN_HITS_SP_20110810
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110810;

SELECT count(*) as BN_HITS_SP_20110810 FROM BN_HITS_SP_20110810;

TRUNCATE BN_HITS_CLIENT_20110810;
INSERT INTO BN_HITS_CLIENT_20110810
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110810;

SELECT count(*) as BN_HITS_CLIENT_20110810 FROM BN_HITS_CLIENT_20110810;
