...
INSERT INTO BN_HITS_SP_20111027
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111027;

SELECT count(*) as BN_HITS_SP_20111027 FROM BN_HITS_SP_20111027;

TRUNCATE BN_HITS_CLIENT_20111027;
INSERT INTO BN_HITS_CLIENT_20111027
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111027;

SELECT count(*) as BN_HITS_CLIENT_20111027 FROM BN_HITS_CLIENT_20111027;
