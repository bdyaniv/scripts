...
INSERT INTO BN_HITS_SP_20110420
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110420;

SELECT count(*) as BN_HITS_SP_20110420 FROM BN_HITS_SP_20110420;

TRUNCATE BN_HITS_CLIENT_20110420;
INSERT INTO BN_HITS_CLIENT_20110420
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110420;

SELECT count(*) as BN_HITS_CLIENT_20110420 FROM BN_HITS_CLIENT_20110420;
