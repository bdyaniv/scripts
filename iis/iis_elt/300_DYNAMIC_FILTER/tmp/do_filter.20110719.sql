...
SELECT count(*) as BN_HITS_SP_20110719 FROM BN_HITS_SP_20110719;

TRUNCATE BN_HITS_CLIENT_20110719;
INSERT INTO BN_HITS_CLIENT_20110719
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110719;

SELECT count(*) as BN_HITS_CLIENT_20110719 FROM BN_HITS_CLIENT_20110719;
