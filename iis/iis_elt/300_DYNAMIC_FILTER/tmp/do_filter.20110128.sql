...
INSERT INTO BN_HITS_SP_20110128
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110128;

SELECT count(*) as BN_HITS_SP_20110128 FROM BN_HITS_SP_20110128;

TRUNCATE BN_HITS_CLIENT_20110128;
INSERT INTO BN_HITS_CLIENT_20110128
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110128;

SELECT count(*) as BN_HITS_CLIENT_20110128 FROM BN_HITS_CLIENT_20110128;
