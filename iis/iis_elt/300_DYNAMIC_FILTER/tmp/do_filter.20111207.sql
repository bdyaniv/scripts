...
INSERT INTO BN_HITS_SP_20111207
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111207;

SELECT count(*) as BN_HITS_SP_20111207 FROM BN_HITS_SP_20111207;

TRUNCATE BN_HITS_CLIENT_20111207;
INSERT INTO BN_HITS_CLIENT_20111207
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111207;

SELECT count(*) as BN_HITS_CLIENT_20111207 FROM BN_HITS_CLIENT_20111207;
