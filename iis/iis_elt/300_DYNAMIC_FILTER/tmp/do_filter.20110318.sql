...
INSERT INTO BN_HITS_SP_20110318
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110318;

SELECT count(*) as BN_HITS_SP_20110318 FROM BN_HITS_SP_20110318;

TRUNCATE BN_HITS_CLIENT_20110318;
INSERT INTO BN_HITS_CLIENT_20110318
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110318;

SELECT count(*) as BN_HITS_CLIENT_20110318 FROM BN_HITS_CLIENT_20110318;
