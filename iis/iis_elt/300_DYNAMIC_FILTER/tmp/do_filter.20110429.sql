...
INSERT INTO BN_HITS_SP_20110429
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110429;

SELECT count(*) as BN_HITS_SP_20110429 FROM BN_HITS_SP_20110429;

TRUNCATE BN_HITS_CLIENT_20110429;
INSERT INTO BN_HITS_CLIENT_20110429
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110429;

SELECT count(*) as BN_HITS_CLIENT_20110429 FROM BN_HITS_CLIENT_20110429;
