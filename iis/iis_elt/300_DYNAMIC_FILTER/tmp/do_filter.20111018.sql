...
INSERT INTO BN_HITS_SP_20111018
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111018;

SELECT count(*) as BN_HITS_SP_20111018 FROM BN_HITS_SP_20111018;

TRUNCATE BN_HITS_CLIENT_20111018;
INSERT INTO BN_HITS_CLIENT_20111018
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111018;

SELECT count(*) as BN_HITS_CLIENT_20111018 FROM BN_HITS_CLIENT_20111018;
