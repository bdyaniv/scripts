...
INSERT INTO BN_HITS_SP_20110329
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110329;

SELECT count(*) as BN_HITS_SP_20110329 FROM BN_HITS_SP_20110329;

TRUNCATE BN_HITS_CLIENT_20110329;
INSERT INTO BN_HITS_CLIENT_20110329
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110329;

SELECT count(*) as BN_HITS_CLIENT_20110329 FROM BN_HITS_CLIENT_20110329;
