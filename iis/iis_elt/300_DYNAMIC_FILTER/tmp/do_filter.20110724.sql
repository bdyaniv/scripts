...
INSERT INTO BN_HITS_SP_20110724
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110724;

SELECT count(*) as BN_HITS_SP_20110724 FROM BN_HITS_SP_20110724;

TRUNCATE BN_HITS_CLIENT_20110724;
INSERT INTO BN_HITS_CLIENT_20110724
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110724;

SELECT count(*) as BN_HITS_CLIENT_20110724 FROM BN_HITS_CLIENT_20110724;
