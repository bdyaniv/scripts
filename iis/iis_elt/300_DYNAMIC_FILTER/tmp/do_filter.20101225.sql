...
INSERT INTO BN_HITS_SP_20101225
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101225;

SELECT count(*) as BN_HITS_SP_20101225 FROM BN_HITS_SP_20101225;

TRUNCATE BN_HITS_CLIENT_20101225;
INSERT INTO BN_HITS_CLIENT_20101225
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101225;

SELECT count(*) as BN_HITS_CLIENT_20101225 FROM BN_HITS_CLIENT_20101225;
