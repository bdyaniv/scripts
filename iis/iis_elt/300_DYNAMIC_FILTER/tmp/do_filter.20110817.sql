...
INSERT INTO BN_HITS_SP_20110817
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110817;

SELECT count(*) as BN_HITS_SP_20110817 FROM BN_HITS_SP_20110817;

TRUNCATE BN_HITS_CLIENT_20110817;
INSERT INTO BN_HITS_CLIENT_20110817
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110817;

SELECT count(*) as BN_HITS_CLIENT_20110817 FROM BN_HITS_CLIENT_20110817;
