...
INSERT INTO BN_HITS_SP_20110801
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110801;

SELECT count(*) as BN_HITS_SP_20110801 FROM BN_HITS_SP_20110801;

TRUNCATE BN_HITS_CLIENT_20110801;
INSERT INTO BN_HITS_CLIENT_20110801
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110801;

SELECT count(*) as BN_HITS_CLIENT_20110801 FROM BN_HITS_CLIENT_20110801;
