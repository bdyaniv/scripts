...
INSERT INTO BN_HITS_SP_20111115
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111115;

SELECT count(*) as BN_HITS_SP_20111115 FROM BN_HITS_SP_20111115;

TRUNCATE BN_HITS_CLIENT_20111115;
INSERT INTO BN_HITS_CLIENT_20111115
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111115;

SELECT count(*) as BN_HITS_CLIENT_20111115 FROM BN_HITS_CLIENT_20111115;
