...
INSERT INTO BN_HITS_SP_20110916
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110916;

SELECT count(*) as BN_HITS_SP_20110916 FROM BN_HITS_SP_20110916;

TRUNCATE BN_HITS_CLIENT_20110916;
INSERT INTO BN_HITS_CLIENT_20110916
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110916;

SELECT count(*) as BN_HITS_CLIENT_20110916 FROM BN_HITS_CLIENT_20110916;
