...
INSERT INTO BN_HITS_SP_20111104
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111104;

SELECT count(*) as BN_HITS_SP_20111104 FROM BN_HITS_SP_20111104;

TRUNCATE BN_HITS_CLIENT_20111104;
INSERT INTO BN_HITS_CLIENT_20111104
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111104;

SELECT count(*) as BN_HITS_CLIENT_20111104 FROM BN_HITS_CLIENT_20111104;
