...
INSERT INTO BN_HITS_SP_20110729
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110729;

SELECT count(*) as BN_HITS_SP_20110729 FROM BN_HITS_SP_20110729;

TRUNCATE BN_HITS_CLIENT_20110729;
INSERT INTO BN_HITS_CLIENT_20110729
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110729;

SELECT count(*) as BN_HITS_CLIENT_20110729 FROM BN_HITS_CLIENT_20110729;
