...
INSERT INTO BN_HITS_SP_20110219
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110219;

SELECT count(*) as BN_HITS_SP_20110219 FROM BN_HITS_SP_20110219;

TRUNCATE BN_HITS_CLIENT_20110219;
INSERT INTO BN_HITS_CLIENT_20110219
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110219;

SELECT count(*) as BN_HITS_CLIENT_20110219 FROM BN_HITS_CLIENT_20110219;
