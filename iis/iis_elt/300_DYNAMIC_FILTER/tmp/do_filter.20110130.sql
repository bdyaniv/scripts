...
INSERT INTO BN_HITS_SP_20110130
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110130;

SELECT count(*) as BN_HITS_SP_20110130 FROM BN_HITS_SP_20110130;

TRUNCATE BN_HITS_CLIENT_20110130;
INSERT INTO BN_HITS_CLIENT_20110130
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110130;

SELECT count(*) as BN_HITS_CLIENT_20110130 FROM BN_HITS_CLIENT_20110130;
