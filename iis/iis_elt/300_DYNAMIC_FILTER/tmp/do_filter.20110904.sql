...
INSERT INTO BN_HITS_SP_20110904
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110904;

SELECT count(*) as BN_HITS_SP_20110904 FROM BN_HITS_SP_20110904;

TRUNCATE BN_HITS_CLIENT_20110904;
INSERT INTO BN_HITS_CLIENT_20110904
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110904;

SELECT count(*) as BN_HITS_CLIENT_20110904 FROM BN_HITS_CLIENT_20110904;
