...
INSERT INTO BN_HITS_SP_20110216
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110216;

SELECT count(*) as BN_HITS_SP_20110216 FROM BN_HITS_SP_20110216;

TRUNCATE BN_HITS_CLIENT_20110216;
INSERT INTO BN_HITS_CLIENT_20110216
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110216;

SELECT count(*) as BN_HITS_CLIENT_20110216 FROM BN_HITS_CLIENT_20110216;
