...
INSERT INTO BN_HITS_SP_20110926
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110926;

SELECT count(*) as BN_HITS_SP_20110926 FROM BN_HITS_SP_20110926;

TRUNCATE BN_HITS_CLIENT_20110926;
INSERT INTO BN_HITS_CLIENT_20110926
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110926;

SELECT count(*) as BN_HITS_CLIENT_20110926 FROM BN_HITS_CLIENT_20110926;
