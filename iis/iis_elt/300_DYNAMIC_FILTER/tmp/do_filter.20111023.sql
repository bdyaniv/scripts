...
INSERT INTO BN_HITS_SP_20111023
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111023;

SELECT count(*) as BN_HITS_SP_20111023 FROM BN_HITS_SP_20111023;

TRUNCATE BN_HITS_CLIENT_20111023;
INSERT INTO BN_HITS_CLIENT_20111023
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111023;

SELECT count(*) as BN_HITS_CLIENT_20111023 FROM BN_HITS_CLIENT_20111023;
