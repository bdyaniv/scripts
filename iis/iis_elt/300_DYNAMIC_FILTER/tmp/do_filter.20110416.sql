...
INSERT INTO BN_HITS_SP_20110416
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110416;

SELECT count(*) as BN_HITS_SP_20110416 FROM BN_HITS_SP_20110416;

TRUNCATE BN_HITS_CLIENT_20110416;
INSERT INTO BN_HITS_CLIENT_20110416
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110416;

SELECT count(*) as BN_HITS_CLIENT_20110416 FROM BN_HITS_CLIENT_20110416;
