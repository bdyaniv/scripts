...
INSERT INTO BN_HITS_SP_20101213
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101213;

SELECT count(*) as BN_HITS_SP_20101213 FROM BN_HITS_SP_20101213;

TRUNCATE BN_HITS_CLIENT_20101213;
INSERT INTO BN_HITS_CLIENT_20101213
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101213;

SELECT count(*) as BN_HITS_CLIENT_20101213 FROM BN_HITS_CLIENT_20101213;
