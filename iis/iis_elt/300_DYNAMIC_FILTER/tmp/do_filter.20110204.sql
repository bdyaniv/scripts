...
INSERT INTO BN_HITS_SP_20110204
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110204;

SELECT count(*) as BN_HITS_SP_20110204 FROM BN_HITS_SP_20110204;

TRUNCATE BN_HITS_CLIENT_20110204;
INSERT INTO BN_HITS_CLIENT_20110204
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110204;

SELECT count(*) as BN_HITS_CLIENT_20110204 FROM BN_HITS_CLIENT_20110204;
