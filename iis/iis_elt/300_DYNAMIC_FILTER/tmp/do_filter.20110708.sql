...
INSERT INTO BN_HITS_SP_20110708
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110708;

SELECT count(*) as BN_HITS_SP_20110708 FROM BN_HITS_SP_20110708;

TRUNCATE BN_HITS_CLIENT_20110708;
INSERT INTO BN_HITS_CLIENT_20110708
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110708;

SELECT count(*) as BN_HITS_CLIENT_20110708 FROM BN_HITS_CLIENT_20110708;
