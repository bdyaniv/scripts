...
INSERT INTO BN_HITS_SP_20111101
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111101;

SELECT count(*) as BN_HITS_SP_20111101 FROM BN_HITS_SP_20111101;

TRUNCATE BN_HITS_CLIENT_20111101;
INSERT INTO BN_HITS_CLIENT_20111101
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111101;

SELECT count(*) as BN_HITS_CLIENT_20111101 FROM BN_HITS_CLIENT_20111101;
