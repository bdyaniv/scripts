...
INSERT INTO BN_HITS_SP_20101129
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101129;

SELECT count(*) as BN_HITS_SP_20101129 FROM BN_HITS_SP_20101129;

TRUNCATE BN_HITS_CLIENT_20101129;
INSERT INTO BN_HITS_CLIENT_20101129
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101129;

SELECT count(*) as BN_HITS_CLIENT_20101129 FROM BN_HITS_CLIENT_20101129;
