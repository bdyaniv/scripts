...
INSERT INTO BN_HITS_SP_20120106
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20120106;

SELECT count(*) as BN_HITS_SP_20120106 FROM BN_HITS_SP_20120106;

TRUNCATE BN_HITS_CLIENT_20120106;
INSERT INTO BN_HITS_CLIENT_20120106
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20120106;

SELECT count(*) as BN_HITS_CLIENT_20120106 FROM BN_HITS_CLIENT_20120106;
