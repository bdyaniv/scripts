...
INSERT INTO BN_HITS_SP_20110928
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110928;

SELECT count(*) as BN_HITS_SP_20110928 FROM BN_HITS_SP_20110928;

TRUNCATE BN_HITS_CLIENT_20110928;
INSERT INTO BN_HITS_CLIENT_20110928
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110928;

SELECT count(*) as BN_HITS_CLIENT_20110928 FROM BN_HITS_CLIENT_20110928;
