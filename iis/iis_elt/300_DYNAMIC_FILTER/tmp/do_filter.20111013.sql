...
INSERT INTO BN_HITS_SP_20111013
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111013;

SELECT count(*) as BN_HITS_SP_20111013 FROM BN_HITS_SP_20111013;

TRUNCATE BN_HITS_CLIENT_20111013;
INSERT INTO BN_HITS_CLIENT_20111013
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111013;

SELECT count(*) as BN_HITS_CLIENT_20111013 FROM BN_HITS_CLIENT_20111013;
