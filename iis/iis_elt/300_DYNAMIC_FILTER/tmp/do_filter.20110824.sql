...
INSERT INTO BN_HITS_SP_20110824
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110824;

SELECT count(*) as BN_HITS_SP_20110824 FROM BN_HITS_SP_20110824;

TRUNCATE BN_HITS_CLIENT_20110824;
INSERT INTO BN_HITS_CLIENT_20110824
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110824;

SELECT count(*) as BN_HITS_CLIENT_20110824 FROM BN_HITS_CLIENT_20110824;
