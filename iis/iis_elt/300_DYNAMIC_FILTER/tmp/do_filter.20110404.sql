...
INSERT INTO BN_HITS_SP_20110404
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110404;

SELECT count(*) as BN_HITS_SP_20110404 FROM BN_HITS_SP_20110404;

TRUNCATE BN_HITS_CLIENT_20110404;
INSERT INTO BN_HITS_CLIENT_20110404
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110404;

SELECT count(*) as BN_HITS_CLIENT_20110404 FROM BN_HITS_CLIENT_20110404;
