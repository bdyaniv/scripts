...
INSERT INTO BN_HITS_SP_20110908
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110908;

SELECT count(*) as BN_HITS_SP_20110908 FROM BN_HITS_SP_20110908;

TRUNCATE BN_HITS_CLIENT_20110908;
INSERT INTO BN_HITS_CLIENT_20110908
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110908;

SELECT count(*) as BN_HITS_CLIENT_20110908 FROM BN_HITS_CLIENT_20110908;
