...
INSERT INTO BN_HITS_SP_20111019
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111019;

SELECT count(*) as BN_HITS_SP_20111019 FROM BN_HITS_SP_20111019;

TRUNCATE BN_HITS_CLIENT_20111019;
INSERT INTO BN_HITS_CLIENT_20111019
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111019;

SELECT count(*) as BN_HITS_CLIENT_20111019 FROM BN_HITS_CLIENT_20111019;
