...
INSERT INTO BN_HITS_SP_20110619
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110619;

SELECT count(*) as BN_HITS_SP_20110619 FROM BN_HITS_SP_20110619;

TRUNCATE BN_HITS_CLIENT_20110619;
INSERT INTO BN_HITS_CLIENT_20110619
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110619;

SELECT count(*) as BN_HITS_CLIENT_20110619 FROM BN_HITS_CLIENT_20110619;
