...
INSERT INTO BN_HITS_SP_20110225
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110225;

SELECT count(*) as BN_HITS_SP_20110225 FROM BN_HITS_SP_20110225;

TRUNCATE BN_HITS_CLIENT_20110225;
INSERT INTO BN_HITS_CLIENT_20110225
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110225;

SELECT count(*) as BN_HITS_CLIENT_20110225 FROM BN_HITS_CLIENT_20110225;
