...
INSERT INTO BN_HITS_SP_20110710
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110710;

SELECT count(*) as BN_HITS_SP_20110710 FROM BN_HITS_SP_20110710;

TRUNCATE BN_HITS_CLIENT_20110710;
INSERT INTO BN_HITS_CLIENT_20110710
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110710;

SELECT count(*) as BN_HITS_CLIENT_20110710 FROM BN_HITS_CLIENT_20110710;
