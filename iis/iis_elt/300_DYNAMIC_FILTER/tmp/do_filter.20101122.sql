...
INSERT INTO BN_HITS_SP_20101122
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101122;

SELECT count(*) as BN_HITS_SP_20101122 FROM BN_HITS_SP_20101122;

TRUNCATE BN_HITS_CLIENT_20101122;
INSERT INTO BN_HITS_CLIENT_20101122
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101122;

SELECT count(*) as BN_HITS_CLIENT_20101122 FROM BN_HITS_CLIENT_20101122;
