...
INSERT INTO BN_HITS_SP_20101209
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101209;

SELECT count(*) as BN_HITS_SP_20101209 FROM BN_HITS_SP_20101209;

TRUNCATE BN_HITS_CLIENT_20101209;
INSERT INTO BN_HITS_CLIENT_20101209
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101209;

SELECT count(*) as BN_HITS_CLIENT_20101209 FROM BN_HITS_CLIENT_20101209;
