...
INSERT INTO BN_HITS_SP_20110806
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110806;

SELECT count(*) as BN_HITS_SP_20110806 FROM BN_HITS_SP_20110806;

TRUNCATE BN_HITS_CLIENT_20110806;
INSERT INTO BN_HITS_CLIENT_20110806
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110806;

SELECT count(*) as BN_HITS_CLIENT_20110806 FROM BN_HITS_CLIENT_20110806;
