...
INSERT INTO BN_HITS_SP_20110920
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110920;

SELECT count(*) as BN_HITS_SP_20110920 FROM BN_HITS_SP_20110920;

TRUNCATE BN_HITS_CLIENT_20110920;
INSERT INTO BN_HITS_CLIENT_20110920
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110920;

SELECT count(*) as BN_HITS_CLIENT_20110920 FROM BN_HITS_CLIENT_20110920;
