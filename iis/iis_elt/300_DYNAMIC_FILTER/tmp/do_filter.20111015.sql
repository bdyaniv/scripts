...
INSERT INTO BN_HITS_SP_20111015
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111015;

SELECT count(*) as BN_HITS_SP_20111015 FROM BN_HITS_SP_20111015;

TRUNCATE BN_HITS_CLIENT_20111015;
INSERT INTO BN_HITS_CLIENT_20111015
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111015;

SELECT count(*) as BN_HITS_CLIENT_20111015 FROM BN_HITS_CLIENT_20111015;
