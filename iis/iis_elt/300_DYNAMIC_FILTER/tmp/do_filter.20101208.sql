...
INSERT INTO BN_HITS_SP_20101208
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101208;

SELECT count(*) as BN_HITS_SP_20101208 FROM BN_HITS_SP_20101208;

TRUNCATE BN_HITS_CLIENT_20101208;
INSERT INTO BN_HITS_CLIENT_20101208
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101208;

SELECT count(*) as BN_HITS_CLIENT_20101208 FROM BN_HITS_CLIENT_20101208;
