...
INSERT INTO BN_HITS_SP_20110706
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110706;

SELECT count(*) as BN_HITS_SP_20110706 FROM BN_HITS_SP_20110706;

TRUNCATE BN_HITS_CLIENT_20110706;
INSERT INTO BN_HITS_CLIENT_20110706
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110706;

SELECT count(*) as BN_HITS_CLIENT_20110706 FROM BN_HITS_CLIENT_20110706;
