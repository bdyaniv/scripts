...
INSERT INTO BN_HITS_SP_20110820
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110820;

SELECT count(*) as BN_HITS_SP_20110820 FROM BN_HITS_SP_20110820;

TRUNCATE BN_HITS_CLIENT_20110820;
INSERT INTO BN_HITS_CLIENT_20110820
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110820;

SELECT count(*) as BN_HITS_CLIENT_20110820 FROM BN_HITS_CLIENT_20110820;
