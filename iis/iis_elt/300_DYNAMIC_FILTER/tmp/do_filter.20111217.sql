...
INSERT INTO BN_HITS_SP_20111217
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111217;

SELECT count(*) as BN_HITS_SP_20111217 FROM BN_HITS_SP_20111217;

TRUNCATE BN_HITS_CLIENT_20111217;
INSERT INTO BN_HITS_CLIENT_20111217
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111217;

SELECT count(*) as BN_HITS_CLIENT_20111217 FROM BN_HITS_CLIENT_20111217;
