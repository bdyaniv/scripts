...
INSERT INTO BN_HITS_SP_20110618
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110618;

SELECT count(*) as BN_HITS_SP_20110618 FROM BN_HITS_SP_20110618;

TRUNCATE BN_HITS_CLIENT_20110618;
INSERT INTO BN_HITS_CLIENT_20110618
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110618;

SELECT count(*) as BN_HITS_CLIENT_20110618 FROM BN_HITS_CLIENT_20110618;
