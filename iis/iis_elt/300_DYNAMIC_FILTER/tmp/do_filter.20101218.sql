...
INSERT INTO BN_HITS_SP_20101218
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101218;

SELECT count(*) as BN_HITS_SP_20101218 FROM BN_HITS_SP_20101218;

TRUNCATE BN_HITS_CLIENT_20101218;
INSERT INTO BN_HITS_CLIENT_20101218
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101218;

SELECT count(*) as BN_HITS_CLIENT_20101218 FROM BN_HITS_CLIENT_20101218;
