...
INSERT INTO BN_HITS_SP_20110111
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110111;

SELECT count(*) as BN_HITS_SP_20110111 FROM BN_HITS_SP_20110111;

TRUNCATE BN_HITS_CLIENT_20110111;
INSERT INTO BN_HITS_CLIENT_20110111
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110111;

SELECT count(*) as BN_HITS_CLIENT_20110111 FROM BN_HITS_CLIENT_20110111;
