...
INSERT INTO BN_HITS_SP_20110324
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110324;

SELECT count(*) as BN_HITS_SP_20110324 FROM BN_HITS_SP_20110324;

TRUNCATE BN_HITS_CLIENT_20110324;
INSERT INTO BN_HITS_CLIENT_20110324
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110324;

SELECT count(*) as BN_HITS_CLIENT_20110324 FROM BN_HITS_CLIENT_20110324;
