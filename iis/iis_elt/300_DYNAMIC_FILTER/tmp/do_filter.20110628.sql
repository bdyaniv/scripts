...
INSERT INTO BN_HITS_SP_20110628
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110628;

SELECT count(*) as BN_HITS_SP_20110628 FROM BN_HITS_SP_20110628;

TRUNCATE BN_HITS_CLIENT_20110628;
INSERT INTO BN_HITS_CLIENT_20110628
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110628;

SELECT count(*) as BN_HITS_CLIENT_20110628 FROM BN_HITS_CLIENT_20110628;
