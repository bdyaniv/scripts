...
INSERT INTO BN_HITS_SP_20111110
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111110;

SELECT count(*) as BN_HITS_SP_20111110 FROM BN_HITS_SP_20111110;

TRUNCATE BN_HITS_CLIENT_20111110;
INSERT INTO BN_HITS_CLIENT_20111110
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111110;

SELECT count(*) as BN_HITS_CLIENT_20111110 FROM BN_HITS_CLIENT_20111110;
