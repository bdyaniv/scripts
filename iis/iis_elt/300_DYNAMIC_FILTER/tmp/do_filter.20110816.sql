...
INSERT INTO BN_HITS_SP_20110816
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110816;

SELECT count(*) as BN_HITS_SP_20110816 FROM BN_HITS_SP_20110816;

TRUNCATE BN_HITS_CLIENT_20110816;
INSERT INTO BN_HITS_CLIENT_20110816
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110816;

SELECT count(*) as BN_HITS_CLIENT_20110816 FROM BN_HITS_CLIENT_20110816;
