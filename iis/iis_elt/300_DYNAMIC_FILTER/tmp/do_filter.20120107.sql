...
INSERT INTO BN_HITS_SP_20120107
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20120107;

SELECT count(*) as BN_HITS_SP_20120107 FROM BN_HITS_SP_20120107;

TRUNCATE BN_HITS_CLIENT_20120107;
INSERT INTO BN_HITS_CLIENT_20120107
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20120107;

SELECT count(*) as BN_HITS_CLIENT_20120107 FROM BN_HITS_CLIENT_20120107;
