...
INSERT INTO BN_HITS_SP_20111212
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111212;

SELECT count(*) as BN_HITS_SP_20111212 FROM BN_HITS_SP_20111212;

TRUNCATE BN_HITS_CLIENT_20111212;
INSERT INTO BN_HITS_CLIENT_20111212
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111212;

SELECT count(*) as BN_HITS_CLIENT_20111212 FROM BN_HITS_CLIENT_20111212;
