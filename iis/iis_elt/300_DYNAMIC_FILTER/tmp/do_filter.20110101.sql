...
INSERT INTO BN_HITS_SP_20110101
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110101;

SELECT count(*) as BN_HITS_SP_20110101 FROM BN_HITS_SP_20110101;

TRUNCATE BN_HITS_CLIENT_20110101;
INSERT INTO BN_HITS_CLIENT_20110101
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110101;

SELECT count(*) as BN_HITS_CLIENT_20110101 FROM BN_HITS_CLIENT_20110101;
