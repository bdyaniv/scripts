...
INSERT INTO BN_HITS_SP_20110319
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110319;

SELECT count(*) as BN_HITS_SP_20110319 FROM BN_HITS_SP_20110319;

TRUNCATE BN_HITS_CLIENT_20110319;
INSERT INTO BN_HITS_CLIENT_20110319
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110319;

SELECT count(*) as BN_HITS_CLIENT_20110319 FROM BN_HITS_CLIENT_20110319;
