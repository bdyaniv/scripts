...
INSERT INTO BN_HITS_SP_20110712
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110712;

SELECT count(*) as BN_HITS_SP_20110712 FROM BN_HITS_SP_20110712;

TRUNCATE BN_HITS_CLIENT_20110712;
INSERT INTO BN_HITS_CLIENT_20110712
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110712;

SELECT count(*) as BN_HITS_CLIENT_20110712 FROM BN_HITS_CLIENT_20110712;
