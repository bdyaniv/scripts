...
INSERT INTO BN_HITS_SP_20111025
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111025;

SELECT count(*) as BN_HITS_SP_20111025 FROM BN_HITS_SP_20111025;

TRUNCATE BN_HITS_CLIENT_20111025;
INSERT INTO BN_HITS_CLIENT_20111025
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111025;

SELECT count(*) as BN_HITS_CLIENT_20111025 FROM BN_HITS_CLIENT_20111025;
