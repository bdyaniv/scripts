...
INSERT INTO BN_HITS_SP_20110202
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110202;

SELECT count(*) as BN_HITS_SP_20110202 FROM BN_HITS_SP_20110202;

TRUNCATE BN_HITS_CLIENT_20110202;
INSERT INTO BN_HITS_CLIENT_20110202
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110202;

SELECT count(*) as BN_HITS_CLIENT_20110202 FROM BN_HITS_CLIENT_20110202;
