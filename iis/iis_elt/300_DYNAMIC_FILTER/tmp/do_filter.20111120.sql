...
INSERT INTO BN_HITS_SP_20111120
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111120;

SELECT count(*) as BN_HITS_SP_20111120 FROM BN_HITS_SP_20111120;

TRUNCATE BN_HITS_CLIENT_20111120;
INSERT INTO BN_HITS_CLIENT_20111120
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111120;

SELECT count(*) as BN_HITS_CLIENT_20111120 FROM BN_HITS_CLIENT_20111120;
