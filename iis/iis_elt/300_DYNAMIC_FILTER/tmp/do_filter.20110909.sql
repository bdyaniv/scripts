...
INSERT INTO BN_HITS_SP_20110909
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110909;

SELECT count(*) as BN_HITS_SP_20110909 FROM BN_HITS_SP_20110909;

TRUNCATE BN_HITS_CLIENT_20110909;
INSERT INTO BN_HITS_CLIENT_20110909
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110909;

SELECT count(*) as BN_HITS_CLIENT_20110909 FROM BN_HITS_CLIENT_20110909;
