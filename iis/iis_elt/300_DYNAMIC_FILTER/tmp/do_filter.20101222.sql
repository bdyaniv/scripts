...
INSERT INTO BN_HITS_SP_20101222
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101222;

SELECT count(*) as BN_HITS_SP_20101222 FROM BN_HITS_SP_20101222;

TRUNCATE BN_HITS_CLIENT_20101222;
INSERT INTO BN_HITS_CLIENT_20101222
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101222;

SELECT count(*) as BN_HITS_CLIENT_20101222 FROM BN_HITS_CLIENT_20101222;
