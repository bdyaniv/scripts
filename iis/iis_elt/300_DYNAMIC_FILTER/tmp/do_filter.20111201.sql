...
INSERT INTO BN_HITS_SP_20111201
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111201;

SELECT count(*) as BN_HITS_SP_20111201 FROM BN_HITS_SP_20111201;

TRUNCATE BN_HITS_CLIENT_20111201;
INSERT INTO BN_HITS_CLIENT_20111201
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111201;

SELECT count(*) as BN_HITS_CLIENT_20111201 FROM BN_HITS_CLIENT_20111201;
