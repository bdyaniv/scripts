...
INSERT INTO BN_HITS_SP_20111221
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111221;

SELECT count(*) as BN_HITS_SP_20111221 FROM BN_HITS_SP_20111221;

TRUNCATE BN_HITS_CLIENT_20111221;
INSERT INTO BN_HITS_CLIENT_20111221
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111221;

SELECT count(*) as BN_HITS_CLIENT_20111221 FROM BN_HITS_CLIENT_20111221;
