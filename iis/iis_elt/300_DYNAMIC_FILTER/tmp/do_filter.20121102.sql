...
INSERT INTO BN_HITS_SP_20121102
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20121102;

SELECT count(*) as BN_HITS_SP_20121102 FROM BN_HITS_SP_20121102;

TRUNCATE BN_HITS_CLIENT_20121102;
INSERT INTO BN_HITS_CLIENT_20121102
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20121102;

SELECT count(*) as BN_HITS_CLIENT_20121102 FROM BN_HITS_CLIENT_20121102;
