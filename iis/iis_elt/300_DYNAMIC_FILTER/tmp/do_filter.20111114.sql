...
INSERT INTO BN_HITS_SP_20111114
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111114;

SELECT count(*) as BN_HITS_SP_20111114 FROM BN_HITS_SP_20111114;

TRUNCATE BN_HITS_CLIENT_20111114;
INSERT INTO BN_HITS_CLIENT_20111114
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111114;

SELECT count(*) as BN_HITS_CLIENT_20111114 FROM BN_HITS_CLIENT_20111114;
