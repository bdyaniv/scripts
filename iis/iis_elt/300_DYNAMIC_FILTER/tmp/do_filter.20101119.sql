...
INSERT INTO BN_HITS_SP_20101119
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101119;

SELECT count(*) as BN_HITS_SP_20101119 FROM BN_HITS_SP_20101119;

TRUNCATE BN_HITS_CLIENT_20101119;
INSERT INTO BN_HITS_CLIENT_20101119
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101119;

SELECT count(*) as BN_HITS_CLIENT_20101119 FROM BN_HITS_CLIENT_20101119;
