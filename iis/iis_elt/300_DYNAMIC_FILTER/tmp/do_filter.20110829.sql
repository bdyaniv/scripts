...
INSERT INTO BN_HITS_SP_20110829
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110829;

SELECT count(*) as BN_HITS_SP_20110829 FROM BN_HITS_SP_20110829;

TRUNCATE BN_HITS_CLIENT_20110829;
INSERT INTO BN_HITS_CLIENT_20110829
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110829;

SELECT count(*) as BN_HITS_CLIENT_20110829 FROM BN_HITS_CLIENT_20110829;
