...
INSERT INTO BN_HITS_SP_20110226
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110226;

SELECT count(*) as BN_HITS_SP_20110226 FROM BN_HITS_SP_20110226;

TRUNCATE BN_HITS_CLIENT_20110226;
INSERT INTO BN_HITS_CLIENT_20110226
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110226;

SELECT count(*) as BN_HITS_CLIENT_20110226 FROM BN_HITS_CLIENT_20110226;
