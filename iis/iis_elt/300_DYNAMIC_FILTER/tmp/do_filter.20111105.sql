...
INSERT INTO BN_HITS_SP_20111105
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111105;

SELECT count(*) as BN_HITS_SP_20111105 FROM BN_HITS_SP_20111105;

TRUNCATE BN_HITS_CLIENT_20111105;
INSERT INTO BN_HITS_CLIENT_20111105
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111105;

SELECT count(*) as BN_HITS_CLIENT_20111105 FROM BN_HITS_CLIENT_20111105;
