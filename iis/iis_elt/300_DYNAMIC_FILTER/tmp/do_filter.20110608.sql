...
INSERT INTO BN_HITS_SP_20110608
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110608;

SELECT count(*) as BN_HITS_SP_20110608 FROM BN_HITS_SP_20110608;

TRUNCATE BN_HITS_CLIENT_20110608;
INSERT INTO BN_HITS_CLIENT_20110608
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110608;

SELECT count(*) as BN_HITS_CLIENT_20110608 FROM BN_HITS_CLIENT_20110608;
