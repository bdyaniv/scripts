...
INSERT INTO BN_HITS_SP_20101223
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101223;

SELECT count(*) as BN_HITS_SP_20101223 FROM BN_HITS_SP_20101223;

TRUNCATE BN_HITS_CLIENT_20101223;
INSERT INTO BN_HITS_CLIENT_20101223
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101223;

SELECT count(*) as BN_HITS_CLIENT_20101223 FROM BN_HITS_CLIENT_20101223;
