...
INSERT INTO BN_HITS_SP_20110208
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110208;

SELECT count(*) as BN_HITS_SP_20110208 FROM BN_HITS_SP_20110208;

TRUNCATE BN_HITS_CLIENT_20110208;
INSERT INTO BN_HITS_CLIENT_20110208
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110208;

SELECT count(*) as BN_HITS_CLIENT_20110208 FROM BN_HITS_CLIENT_20110208;
