...
INSERT INTO BN_HITS_SP_20111021
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111021;

SELECT count(*) as BN_HITS_SP_20111021 FROM BN_HITS_SP_20111021;

TRUNCATE BN_HITS_CLIENT_20111021;
INSERT INTO BN_HITS_CLIENT_20111021
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111021;

SELECT count(*) as BN_HITS_CLIENT_20111021 FROM BN_HITS_CLIENT_20111021;
