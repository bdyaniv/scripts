...
INSERT INTO BN_HITS_SP_20111213
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111213;

SELECT count(*) as BN_HITS_SP_20111213 FROM BN_HITS_SP_20111213;

TRUNCATE BN_HITS_CLIENT_20111213;
INSERT INTO BN_HITS_CLIENT_20111213
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111213;

SELECT count(*) as BN_HITS_CLIENT_20111213 FROM BN_HITS_CLIENT_20111213;
