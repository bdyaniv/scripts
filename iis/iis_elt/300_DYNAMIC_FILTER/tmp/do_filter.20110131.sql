...
INSERT INTO BN_HITS_SP_20110131
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110131;

SELECT count(*) as BN_HITS_SP_20110131 FROM BN_HITS_SP_20110131;

TRUNCATE BN_HITS_CLIENT_20110131;
INSERT INTO BN_HITS_CLIENT_20110131
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110131;

SELECT count(*) as BN_HITS_CLIENT_20110131 FROM BN_HITS_CLIENT_20110131;
