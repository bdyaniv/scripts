...
INSERT INTO BN_HITS_SP_20111109
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111109;

SELECT count(*) as BN_HITS_SP_20111109 FROM BN_HITS_SP_20111109;

TRUNCATE BN_HITS_CLIENT_20111109;
INSERT INTO BN_HITS_CLIENT_20111109
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111109;

SELECT count(*) as BN_HITS_CLIENT_20111109 FROM BN_HITS_CLIENT_20111109;
