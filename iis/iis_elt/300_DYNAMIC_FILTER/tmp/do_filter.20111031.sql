...
INSERT INTO BN_HITS_SP_20111031
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111031;

SELECT count(*) as BN_HITS_SP_20111031 FROM BN_HITS_SP_20111031;

TRUNCATE BN_HITS_CLIENT_20111031;
INSERT INTO BN_HITS_CLIENT_20111031
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111031;

SELECT count(*) as BN_HITS_CLIENT_20111031 FROM BN_HITS_CLIENT_20111031;
