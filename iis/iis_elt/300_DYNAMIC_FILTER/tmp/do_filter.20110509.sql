...
INSERT INTO BN_HITS_SP_20110509
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110509;

SELECT count(*) as BN_HITS_SP_20110509 FROM BN_HITS_SP_20110509;

TRUNCATE BN_HITS_CLIENT_20110509;
INSERT INTO BN_HITS_CLIENT_20110509
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110509;

SELECT count(*) as BN_HITS_CLIENT_20110509 FROM BN_HITS_CLIENT_20110509;
