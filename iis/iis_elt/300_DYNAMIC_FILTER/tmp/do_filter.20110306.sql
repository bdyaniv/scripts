...
INSERT INTO BN_HITS_SP_20110306
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110306;

SELECT count(*) as BN_HITS_SP_20110306 FROM BN_HITS_SP_20110306;

TRUNCATE BN_HITS_CLIENT_20110306;
INSERT INTO BN_HITS_CLIENT_20110306
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110306;

SELECT count(*) as BN_HITS_CLIENT_20110306 FROM BN_HITS_CLIENT_20110306;
