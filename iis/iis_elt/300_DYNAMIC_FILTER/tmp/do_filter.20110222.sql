...
INSERT INTO BN_HITS_SP_20110222
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110222;

SELECT count(*) as BN_HITS_SP_20110222 FROM BN_HITS_SP_20110222;

TRUNCATE BN_HITS_CLIENT_20110222;
INSERT INTO BN_HITS_CLIENT_20110222
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110222;

SELECT count(*) as BN_HITS_CLIENT_20110222 FROM BN_HITS_CLIENT_20110222;
