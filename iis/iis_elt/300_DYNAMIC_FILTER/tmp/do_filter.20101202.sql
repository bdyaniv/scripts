...
INSERT INTO BN_HITS_SP_20101202
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101202;

SELECT count(*) as BN_HITS_SP_20101202 FROM BN_HITS_SP_20101202;

TRUNCATE BN_HITS_CLIENT_20101202;
INSERT INTO BN_HITS_CLIENT_20101202
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101202;

SELECT count(*) as BN_HITS_CLIENT_20101202 FROM BN_HITS_CLIENT_20101202;
