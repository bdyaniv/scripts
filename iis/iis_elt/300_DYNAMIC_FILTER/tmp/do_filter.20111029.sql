...
INSERT INTO BN_HITS_SP_20111029
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111029;

SELECT count(*) as BN_HITS_SP_20111029 FROM BN_HITS_SP_20111029;

TRUNCATE BN_HITS_CLIENT_20111029;
INSERT INTO BN_HITS_CLIENT_20111029
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111029;

SELECT count(*) as BN_HITS_CLIENT_20111029 FROM BN_HITS_CLIENT_20111029;
