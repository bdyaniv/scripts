...
INSERT INTO BN_HITS_SP_20110424
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110424;

SELECT count(*) as BN_HITS_SP_20110424 FROM BN_HITS_SP_20110424;

TRUNCATE BN_HITS_CLIENT_20110424;
INSERT INTO BN_HITS_CLIENT_20110424
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110424;

SELECT count(*) as BN_HITS_CLIENT_20110424 FROM BN_HITS_CLIENT_20110424;
