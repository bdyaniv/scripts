...
INSERT INTO BN_HITS_SP_20110921
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110921;

SELECT count(*) as BN_HITS_SP_20110921 FROM BN_HITS_SP_20110921;

TRUNCATE BN_HITS_CLIENT_20110921;
INSERT INTO BN_HITS_CLIENT_20110921
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110921;

SELECT count(*) as BN_HITS_CLIENT_20110921 FROM BN_HITS_CLIENT_20110921;
