...
INSERT INTO BN_HITS_SP_20110701
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110701;

SELECT count(*) as BN_HITS_SP_20110701 FROM BN_HITS_SP_20110701;

TRUNCATE BN_HITS_CLIENT_20110701;
INSERT INTO BN_HITS_CLIENT_20110701
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110701;

SELECT count(*) as BN_HITS_CLIENT_20110701 FROM BN_HITS_CLIENT_20110701;
