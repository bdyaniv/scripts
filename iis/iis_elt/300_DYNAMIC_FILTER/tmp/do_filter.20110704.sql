...
INSERT INTO BN_HITS_SP_20110704
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110704;

SELECT count(*) as BN_HITS_SP_20110704 FROM BN_HITS_SP_20110704;

TRUNCATE BN_HITS_CLIENT_20110704;
INSERT INTO BN_HITS_CLIENT_20110704
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110704;

SELECT count(*) as BN_HITS_CLIENT_20110704 FROM BN_HITS_CLIENT_20110704;
