...
INSERT INTO BN_HITS_SP_20110107
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110107;

SELECT count(*) as BN_HITS_SP_20110107 FROM BN_HITS_SP_20110107;

TRUNCATE BN_HITS_CLIENT_20110107;
INSERT INTO BN_HITS_CLIENT_20110107
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110107;

SELECT count(*) as BN_HITS_CLIENT_20110107 FROM BN_HITS_CLIENT_20110107;
