...
INSERT INTO BN_HITS_SP_20110630
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110630;

SELECT count(*) as BN_HITS_SP_20110630 FROM BN_HITS_SP_20110630;

TRUNCATE BN_HITS_CLIENT_20110630;
INSERT INTO BN_HITS_CLIENT_20110630
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110630;

SELECT count(*) as BN_HITS_CLIENT_20110630 FROM BN_HITS_CLIENT_20110630;
