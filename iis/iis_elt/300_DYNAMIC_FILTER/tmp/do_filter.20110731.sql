...
INSERT INTO BN_HITS_SP_20110731
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110731;

SELECT count(*) as BN_HITS_SP_20110731 FROM BN_HITS_SP_20110731;

TRUNCATE BN_HITS_CLIENT_20110731;
INSERT INTO BN_HITS_CLIENT_20110731
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110731;

SELECT count(*) as BN_HITS_CLIENT_20110731 FROM BN_HITS_CLIENT_20110731;
