...
INSERT INTO BN_HITS_SP_20110510
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110510;

SELECT count(*) as BN_HITS_SP_20110510 FROM BN_HITS_SP_20110510;

TRUNCATE BN_HITS_CLIENT_20110510;
INSERT INTO BN_HITS_CLIENT_20110510
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110510;

SELECT count(*) as BN_HITS_CLIENT_20110510 FROM BN_HITS_CLIENT_20110510;
