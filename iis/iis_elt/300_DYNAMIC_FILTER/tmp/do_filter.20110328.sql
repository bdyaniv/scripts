...
INSERT INTO BN_HITS_SP_20110328
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110328;

SELECT count(*) as BN_HITS_SP_20110328 FROM BN_HITS_SP_20110328;

TRUNCATE BN_HITS_CLIENT_20110328;
INSERT INTO BN_HITS_CLIENT_20110328
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110328;

SELECT count(*) as BN_HITS_CLIENT_20110328 FROM BN_HITS_CLIENT_20110328;
