...
INSERT INTO BN_HITS_SP_20110205
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110205;

SELECT count(*) as BN_HITS_SP_20110205 FROM BN_HITS_SP_20110205;

TRUNCATE BN_HITS_CLIENT_20110205;
INSERT INTO BN_HITS_CLIENT_20110205
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110205;

SELECT count(*) as BN_HITS_CLIENT_20110205 FROM BN_HITS_CLIENT_20110205;
