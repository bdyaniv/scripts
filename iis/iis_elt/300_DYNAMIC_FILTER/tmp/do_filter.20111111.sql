...
INSERT INTO BN_HITS_SP_20111111
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111111;

SELECT count(*) as BN_HITS_SP_20111111 FROM BN_HITS_SP_20111111;

TRUNCATE BN_HITS_CLIENT_20111111;
INSERT INTO BN_HITS_CLIENT_20111111
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111111;

SELECT count(*) as BN_HITS_CLIENT_20111111 FROM BN_HITS_CLIENT_20111111;
