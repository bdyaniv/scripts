...
INSERT INTO BN_HITS_SP_20110802
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110802;

SELECT count(*) as BN_HITS_SP_20110802 FROM BN_HITS_SP_20110802;

TRUNCATE BN_HITS_CLIENT_20110802;
INSERT INTO BN_HITS_CLIENT_20110802
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110802;

SELECT count(*) as BN_HITS_CLIENT_20110802 FROM BN_HITS_CLIENT_20110802;
