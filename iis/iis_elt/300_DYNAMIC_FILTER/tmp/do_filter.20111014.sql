...
INSERT INTO BN_HITS_SP_20111014
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111014;

SELECT count(*) as BN_HITS_SP_20111014 FROM BN_HITS_SP_20111014;

TRUNCATE BN_HITS_CLIENT_20111014;
INSERT INTO BN_HITS_CLIENT_20111014
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111014;

SELECT count(*) as BN_HITS_CLIENT_20111014 FROM BN_HITS_CLIENT_20111014;
