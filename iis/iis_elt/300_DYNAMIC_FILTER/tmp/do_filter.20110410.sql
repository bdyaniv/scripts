...
INSERT INTO BN_HITS_SP_20110410
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110410;

SELECT count(*) as BN_HITS_SP_20110410 FROM BN_HITS_SP_20110410;

TRUNCATE BN_HITS_CLIENT_20110410;
INSERT INTO BN_HITS_CLIENT_20110410
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110410;

SELECT count(*) as BN_HITS_CLIENT_20110410 FROM BN_HITS_CLIENT_20110410;
