...
INSERT INTO BN_HITS_SP_20110502
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110502;

SELECT count(*) as BN_HITS_SP_20110502 FROM BN_HITS_SP_20110502;

TRUNCATE BN_HITS_CLIENT_20110502;
INSERT INTO BN_HITS_CLIENT_20110502
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110502;

SELECT count(*) as BN_HITS_CLIENT_20110502 FROM BN_HITS_CLIENT_20110502;
