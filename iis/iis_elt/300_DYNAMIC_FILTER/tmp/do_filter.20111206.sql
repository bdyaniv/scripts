...
INSERT INTO BN_HITS_SP_20111206
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111206;

SELECT count(*) as BN_HITS_SP_20111206 FROM BN_HITS_SP_20111206;

TRUNCATE BN_HITS_CLIENT_20111206;
INSERT INTO BN_HITS_CLIENT_20111206
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111206;

SELECT count(*) as BN_HITS_CLIENT_20111206 FROM BN_HITS_CLIENT_20111206;
