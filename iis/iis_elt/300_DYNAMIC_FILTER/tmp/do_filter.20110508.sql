...
INSERT INTO BN_HITS_SP_20110508
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110508;

SELECT count(*) as BN_HITS_SP_20110508 FROM BN_HITS_SP_20110508;

TRUNCATE BN_HITS_CLIENT_20110508;
INSERT INTO BN_HITS_CLIENT_20110508
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110508;

SELECT count(*) as BN_HITS_CLIENT_20110508 FROM BN_HITS_CLIENT_20110508;
