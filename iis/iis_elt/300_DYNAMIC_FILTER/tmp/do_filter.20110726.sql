...
INSERT INTO BN_HITS_SP_20110726
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110726;

SELECT count(*) as BN_HITS_SP_20110726 FROM BN_HITS_SP_20110726;

TRUNCATE BN_HITS_CLIENT_20110726;
INSERT INTO BN_HITS_CLIENT_20110726
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110726;

SELECT count(*) as BN_HITS_CLIENT_20110726 FROM BN_HITS_CLIENT_20110726;
