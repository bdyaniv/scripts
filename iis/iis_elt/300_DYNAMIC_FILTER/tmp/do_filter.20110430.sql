...
INSERT INTO BN_HITS_SP_20110430
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110430;

SELECT count(*) as BN_HITS_SP_20110430 FROM BN_HITS_SP_20110430;

TRUNCATE BN_HITS_CLIENT_20110430;
INSERT INTO BN_HITS_CLIENT_20110430
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110430;

SELECT count(*) as BN_HITS_CLIENT_20110430 FROM BN_HITS_CLIENT_20110430;
