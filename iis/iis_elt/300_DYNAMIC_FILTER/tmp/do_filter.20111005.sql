...
INSERT INTO BN_HITS_SP_20111005
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111005;

SELECT count(*) as BN_HITS_SP_20111005 FROM BN_HITS_SP_20111005;

TRUNCATE BN_HITS_CLIENT_20111005;
INSERT INTO BN_HITS_CLIENT_20111005
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111005;

SELECT count(*) as BN_HITS_CLIENT_20111005 FROM BN_HITS_CLIENT_20111005;
