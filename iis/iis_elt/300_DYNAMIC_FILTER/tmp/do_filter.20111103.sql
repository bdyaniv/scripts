...
INSERT INTO BN_HITS_SP_20111103
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111103;

SELECT count(*) as BN_HITS_SP_20111103 FROM BN_HITS_SP_20111103;

TRUNCATE BN_HITS_CLIENT_20111103;
INSERT INTO BN_HITS_CLIENT_20111103
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111103;

SELECT count(*) as BN_HITS_CLIENT_20111103 FROM BN_HITS_CLIENT_20111103;
