...
INSERT INTO BN_HITS_SP_20111020
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111020;

SELECT count(*) as BN_HITS_SP_20111020 FROM BN_HITS_SP_20111020;

TRUNCATE BN_HITS_CLIENT_20111020;
INSERT INTO BN_HITS_CLIENT_20111020
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111020;

SELECT count(*) as BN_HITS_CLIENT_20111020 FROM BN_HITS_CLIENT_20111020;
