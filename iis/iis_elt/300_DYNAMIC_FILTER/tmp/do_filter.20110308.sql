...
INSERT INTO BN_HITS_SP_20110308
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110308;

SELECT count(*) as BN_HITS_SP_20110308 FROM BN_HITS_SP_20110308;

TRUNCATE BN_HITS_CLIENT_20110308;
INSERT INTO BN_HITS_CLIENT_20110308
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110308;

SELECT count(*) as BN_HITS_CLIENT_20110308 FROM BN_HITS_CLIENT_20110308;
