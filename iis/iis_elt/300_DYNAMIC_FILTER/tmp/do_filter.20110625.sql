...
INSERT INTO BN_HITS_SP_20110625
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110625;

SELECT count(*) as BN_HITS_SP_20110625 FROM BN_HITS_SP_20110625;

TRUNCATE BN_HITS_CLIENT_20110625;
INSERT INTO BN_HITS_CLIENT_20110625
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110625;

SELECT count(*) as BN_HITS_CLIENT_20110625 FROM BN_HITS_CLIENT_20110625;
