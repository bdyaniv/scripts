...
INSERT INTO BN_HITS_SP_20110827
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110827;

SELECT count(*) as BN_HITS_SP_20110827 FROM BN_HITS_SP_20110827;

TRUNCATE BN_HITS_CLIENT_20110827;
INSERT INTO BN_HITS_CLIENT_20110827
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110827;

SELECT count(*) as BN_HITS_CLIENT_20110827 FROM BN_HITS_CLIENT_20110827;
