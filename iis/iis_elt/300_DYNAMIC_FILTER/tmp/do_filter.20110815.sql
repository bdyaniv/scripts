...
INSERT INTO BN_HITS_SP_20110815
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110815;

SELECT count(*) as BN_HITS_SP_20110815 FROM BN_HITS_SP_20110815;

TRUNCATE BN_HITS_CLIENT_20110815;
INSERT INTO BN_HITS_CLIENT_20110815
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110815;

SELECT count(*) as BN_HITS_CLIENT_20110815 FROM BN_HITS_CLIENT_20110815;
