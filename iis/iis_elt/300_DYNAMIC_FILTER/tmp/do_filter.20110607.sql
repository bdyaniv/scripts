...
INSERT INTO BN_HITS_SP_20110607
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110607;

SELECT count(*) as BN_HITS_SP_20110607 FROM BN_HITS_SP_20110607;

TRUNCATE BN_HITS_CLIENT_20110607;
INSERT INTO BN_HITS_CLIENT_20110607
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110607;

SELECT count(*) as BN_HITS_CLIENT_20110607 FROM BN_HITS_CLIENT_20110607;
