...
INSERT INTO BN_HITS_SP_20110913
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110913;

SELECT count(*) as BN_HITS_SP_20110913 FROM BN_HITS_SP_20110913;

TRUNCATE BN_HITS_CLIENT_20110913;
INSERT INTO BN_HITS_CLIENT_20110913
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110913;

SELECT count(*) as BN_HITS_CLIENT_20110913 FROM BN_HITS_CLIENT_20110913;
