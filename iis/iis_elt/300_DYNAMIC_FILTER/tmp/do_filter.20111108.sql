...
INSERT INTO BN_HITS_SP_20111108
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111108;

SELECT count(*) as BN_HITS_SP_20111108 FROM BN_HITS_SP_20111108;

TRUNCATE BN_HITS_CLIENT_20111108;
INSERT INTO BN_HITS_CLIENT_20111108
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111108;

SELECT count(*) as BN_HITS_CLIENT_20111108 FROM BN_HITS_CLIENT_20111108;
