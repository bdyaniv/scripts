...
INSERT INTO BN_HITS_SP_20110330
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110330;

SELECT count(*) as BN_HITS_SP_20110330 FROM BN_HITS_SP_20110330;

TRUNCATE BN_HITS_CLIENT_20110330;
INSERT INTO BN_HITS_CLIENT_20110330
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110330;

SELECT count(*) as BN_HITS_CLIENT_20110330 FROM BN_HITS_CLIENT_20110330;
