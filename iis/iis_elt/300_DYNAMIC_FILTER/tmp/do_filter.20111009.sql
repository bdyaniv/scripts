...
INSERT INTO BN_HITS_SP_20111009
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111009;

SELECT count(*) as BN_HITS_SP_20111009 FROM BN_HITS_SP_20111009;

TRUNCATE BN_HITS_CLIENT_20111009;
INSERT INTO BN_HITS_CLIENT_20111009
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111009;

SELECT count(*) as BN_HITS_CLIENT_20111009 FROM BN_HITS_CLIENT_20111009;
