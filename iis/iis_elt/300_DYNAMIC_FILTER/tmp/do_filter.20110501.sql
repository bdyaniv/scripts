...
INSERT INTO BN_HITS_SP_20110501
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110501;

SELECT count(*) as BN_HITS_SP_20110501 FROM BN_HITS_SP_20110501;

TRUNCATE BN_HITS_CLIENT_20110501;
INSERT INTO BN_HITS_CLIENT_20110501
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110501;

SELECT count(*) as BN_HITS_CLIENT_20110501 FROM BN_HITS_CLIENT_20110501;
