...
INSERT INTO BN_HITS_SP_20110122
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110122;

SELECT count(*) as BN_HITS_SP_20110122 FROM BN_HITS_SP_20110122;

TRUNCATE BN_HITS_CLIENT_20110122;
INSERT INTO BN_HITS_CLIENT_20110122
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110122;

SELECT count(*) as BN_HITS_CLIENT_20110122 FROM BN_HITS_CLIENT_20110122;
