...
INSERT INTO BN_HITS_SP_20110705
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110705;

SELECT count(*) as BN_HITS_SP_20110705 FROM BN_HITS_SP_20110705;

TRUNCATE BN_HITS_CLIENT_20110705;
INSERT INTO BN_HITS_CLIENT_20110705
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110705;

SELECT count(*) as BN_HITS_CLIENT_20110705 FROM BN_HITS_CLIENT_20110705;
