...
INSERT INTO BN_HITS_SP_20110617
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110617;

SELECT count(*) as BN_HITS_SP_20110617 FROM BN_HITS_SP_20110617;

TRUNCATE BN_HITS_CLIENT_20110617;
INSERT INTO BN_HITS_CLIENT_20110617
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110617;

SELECT count(*) as BN_HITS_CLIENT_20110617 FROM BN_HITS_CLIENT_20110617;
