...
INSERT INTO BN_HITS_SP_20110809
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110809;

SELECT count(*) as BN_HITS_SP_20110809 FROM BN_HITS_SP_20110809;

TRUNCATE BN_HITS_CLIENT_20110809;
INSERT INTO BN_HITS_CLIENT_20110809
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110809;

SELECT count(*) as BN_HITS_CLIENT_20110809 FROM BN_HITS_CLIENT_20110809;
