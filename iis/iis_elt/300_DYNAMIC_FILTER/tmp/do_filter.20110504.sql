...
INSERT INTO BN_HITS_SP_20110504
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110504;

SELECT count(*) as BN_HITS_SP_20110504 FROM BN_HITS_SP_20110504;

TRUNCATE BN_HITS_CLIENT_20110504;
INSERT INTO BN_HITS_CLIENT_20110504
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110504;

SELECT count(*) as BN_HITS_CLIENT_20110504 FROM BN_HITS_CLIENT_20110504;
