...
INSERT INTO BN_HITS_SP_20110315
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110315;

SELECT count(*) as BN_HITS_SP_20110315 FROM BN_HITS_SP_20110315;

TRUNCATE BN_HITS_CLIENT_20110315;
INSERT INTO BN_HITS_CLIENT_20110315
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110315;

SELECT count(*) as BN_HITS_CLIENT_20110315 FROM BN_HITS_CLIENT_20110315;
