...
INSERT INTO BN_HITS_SP_20110428
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110428;

SELECT count(*) as BN_HITS_SP_20110428 FROM BN_HITS_SP_20110428;

TRUNCATE BN_HITS_CLIENT_20110428;
INSERT INTO BN_HITS_CLIENT_20110428
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110428;

SELECT count(*) as BN_HITS_CLIENT_20110428 FROM BN_HITS_CLIENT_20110428;
