...
INSERT INTO BN_HITS_SP_20110413
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110413;

SELECT count(*) as BN_HITS_SP_20110413 FROM BN_HITS_SP_20110413;

TRUNCATE BN_HITS_CLIENT_20110413;
INSERT INTO BN_HITS_CLIENT_20110413
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110413;

SELECT count(*) as BN_HITS_CLIENT_20110413 FROM BN_HITS_CLIENT_20110413;
