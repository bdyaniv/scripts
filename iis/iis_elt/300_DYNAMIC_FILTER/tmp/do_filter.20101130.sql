...
INSERT INTO BN_HITS_SP_20101130
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101130;

SELECT count(*) as BN_HITS_SP_20101130 FROM BN_HITS_SP_20101130;

TRUNCATE BN_HITS_CLIENT_20101130;
INSERT INTO BN_HITS_CLIENT_20101130
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101130;

SELECT count(*) as BN_HITS_CLIENT_20101130 FROM BN_HITS_CLIENT_20101130;
