...
INSERT INTO BN_HITS_SP_20110805
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110805;

SELECT count(*) as BN_HITS_SP_20110805 FROM BN_HITS_SP_20110805;

TRUNCATE BN_HITS_CLIENT_20110805;
INSERT INTO BN_HITS_CLIENT_20110805
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110805;

SELECT count(*) as BN_HITS_CLIENT_20110805 FROM BN_HITS_CLIENT_20110805;
