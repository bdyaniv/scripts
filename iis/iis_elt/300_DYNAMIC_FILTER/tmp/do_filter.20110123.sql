...
INSERT INTO BN_HITS_SP_20110123
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110123;

SELECT count(*) as BN_HITS_SP_20110123 FROM BN_HITS_SP_20110123;

TRUNCATE BN_HITS_CLIENT_20110123;
INSERT INTO BN_HITS_CLIENT_20110123
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110123;

SELECT count(*) as BN_HITS_CLIENT_20110123 FROM BN_HITS_CLIENT_20110123;
