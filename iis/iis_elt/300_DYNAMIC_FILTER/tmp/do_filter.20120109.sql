...
INSERT INTO BN_HITS_SP_20120109
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20120109;

SELECT count(*) as BN_HITS_SP_20120109 FROM BN_HITS_SP_20120109;

TRUNCATE BN_HITS_CLIENT_20120109;
INSERT INTO BN_HITS_CLIENT_20120109
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20120109;

SELECT count(*) as BN_HITS_CLIENT_20120109 FROM BN_HITS_CLIENT_20120109;
