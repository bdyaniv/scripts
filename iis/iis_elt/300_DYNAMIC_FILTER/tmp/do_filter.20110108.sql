...
INSERT INTO BN_HITS_SP_20110108
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110108;

SELECT count(*) as BN_HITS_SP_20110108 FROM BN_HITS_SP_20110108;

TRUNCATE BN_HITS_CLIENT_20110108;
INSERT INTO BN_HITS_CLIENT_20110108
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110108;

SELECT count(*) as BN_HITS_CLIENT_20110108 FROM BN_HITS_CLIENT_20110108;
