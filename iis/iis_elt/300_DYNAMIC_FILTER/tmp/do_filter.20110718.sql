...
INSERT INTO BN_HITS_SP_20110718
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110718;

SELECT count(*) as BN_HITS_SP_20110718 FROM BN_HITS_SP_20110718;

TRUNCATE BN_HITS_CLIENT_20110718;
INSERT INTO BN_HITS_CLIENT_20110718
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110718;

SELECT count(*) as BN_HITS_CLIENT_20110718 FROM BN_HITS_CLIENT_20110718;
