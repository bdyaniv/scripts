...
INSERT INTO BN_HITS_SP_20110727
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110727;

SELECT count(*) as BN_HITS_SP_20110727 FROM BN_HITS_SP_20110727;

TRUNCATE BN_HITS_CLIENT_20110727;
INSERT INTO BN_HITS_CLIENT_20110727
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110727;

SELECT count(*) as BN_HITS_CLIENT_20110727 FROM BN_HITS_CLIENT_20110727;
