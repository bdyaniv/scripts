...
INSERT INTO BN_HITS_SP_20101205
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101205;

SELECT count(*) as BN_HITS_SP_20101205 FROM BN_HITS_SP_20101205;

TRUNCATE BN_HITS_CLIENT_20101205;
INSERT INTO BN_HITS_CLIENT_20101205
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101205;

SELECT count(*) as BN_HITS_CLIENT_20101205 FROM BN_HITS_CLIENT_20101205;
