...
INSERT INTO BN_HITS_SP_20101116
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101116;

SELECT count(*) as BN_HITS_SP_20101116 FROM BN_HITS_SP_20101116;

TRUNCATE BN_HITS_CLIENT_20101116;
INSERT INTO BN_HITS_CLIENT_20101116
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101116;

SELECT count(*) as BN_HITS_CLIENT_20101116 FROM BN_HITS_CLIENT_20101116;
