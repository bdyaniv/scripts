...
INSERT INTO BN_HITS_SP_20110612
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110612;

SELECT count(*) as BN_HITS_SP_20110612 FROM BN_HITS_SP_20110612;

TRUNCATE BN_HITS_CLIENT_20110612;
INSERT INTO BN_HITS_CLIENT_20110612
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110612;

SELECT count(*) as BN_HITS_CLIENT_20110612 FROM BN_HITS_CLIENT_20110612;
