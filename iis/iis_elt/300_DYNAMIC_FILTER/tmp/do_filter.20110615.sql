...
INSERT INTO BN_HITS_SP_20110615
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110615;

SELECT count(*) as BN_HITS_SP_20110615 FROM BN_HITS_SP_20110615;

TRUNCATE BN_HITS_CLIENT_20110615;
INSERT INTO BN_HITS_CLIENT_20110615
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110615;

SELECT count(*) as BN_HITS_CLIENT_20110615 FROM BN_HITS_CLIENT_20110615;
