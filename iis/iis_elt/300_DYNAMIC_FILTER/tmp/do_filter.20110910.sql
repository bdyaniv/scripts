...
INSERT INTO BN_HITS_SP_20110910
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110910;

SELECT count(*) as BN_HITS_SP_20110910 FROM BN_HITS_SP_20110910;

TRUNCATE BN_HITS_CLIENT_20110910;
INSERT INTO BN_HITS_CLIENT_20110910
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110910;

SELECT count(*) as BN_HITS_CLIENT_20110910 FROM BN_HITS_CLIENT_20110910;
