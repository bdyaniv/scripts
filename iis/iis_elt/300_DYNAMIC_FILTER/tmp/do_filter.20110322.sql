...
INSERT INTO BN_HITS_SP_20110322
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110322;

SELECT count(*) as BN_HITS_SP_20110322 FROM BN_HITS_SP_20110322;

TRUNCATE BN_HITS_CLIENT_20110322;
INSERT INTO BN_HITS_CLIENT_20110322
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110322;

SELECT count(*) as BN_HITS_CLIENT_20110322 FROM BN_HITS_CLIENT_20110322;
