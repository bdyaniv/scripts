...
INSERT INTO BN_HITS_SP_20111224
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111224;

SELECT count(*) as BN_HITS_SP_20111224 FROM BN_HITS_SP_20111224;

TRUNCATE BN_HITS_CLIENT_20111224;
INSERT INTO BN_HITS_CLIENT_20111224
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111224;

SELECT count(*) as BN_HITS_CLIENT_20111224 FROM BN_HITS_CLIENT_20111224;
