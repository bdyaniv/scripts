...
INSERT INTO BN_HITS_SP_20110927
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110927;

SELECT count(*) as BN_HITS_SP_20110927 FROM BN_HITS_SP_20110927;

TRUNCATE BN_HITS_CLIENT_20110927;
INSERT INTO BN_HITS_CLIENT_20110927
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110927;

SELECT count(*) as BN_HITS_CLIENT_20110927 FROM BN_HITS_CLIENT_20110927;
