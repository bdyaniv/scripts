...
INSERT INTO BN_HITS_SP_20110112
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110112;

SELECT count(*) as BN_HITS_SP_20110112 FROM BN_HITS_SP_20110112;

TRUNCATE BN_HITS_CLIENT_20110112;
INSERT INTO BN_HITS_CLIENT_20110112
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110112;

SELECT count(*) as BN_HITS_CLIENT_20110112 FROM BN_HITS_CLIENT_20110112;
