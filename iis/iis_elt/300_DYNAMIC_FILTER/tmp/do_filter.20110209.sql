...
INSERT INTO BN_HITS_SP_20110209
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110209;

SELECT count(*) as BN_HITS_SP_20110209 FROM BN_HITS_SP_20110209;

TRUNCATE BN_HITS_CLIENT_20110209;
INSERT INTO BN_HITS_CLIENT_20110209
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110209;

SELECT count(*) as BN_HITS_CLIENT_20110209 FROM BN_HITS_CLIENT_20110209;
