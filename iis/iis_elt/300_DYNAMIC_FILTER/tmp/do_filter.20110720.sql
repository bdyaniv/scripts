...
INSERT INTO BN_HITS_SP_20110720
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110720;

SELECT count(*) as BN_HITS_SP_20110720 FROM BN_HITS_SP_20110720;

TRUNCATE BN_HITS_CLIENT_20110720;
INSERT INTO BN_HITS_CLIENT_20110720
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110720;

SELECT count(*) as BN_HITS_CLIENT_20110720 FROM BN_HITS_CLIENT_20110720;
