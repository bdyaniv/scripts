...
INSERT INTO BN_HITS_SP_20110320
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110320;

SELECT count(*) as BN_HITS_SP_20110320 FROM BN_HITS_SP_20110320;

TRUNCATE BN_HITS_CLIENT_20110320;
INSERT INTO BN_HITS_CLIENT_20110320
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110320;

SELECT count(*) as BN_HITS_CLIENT_20110320 FROM BN_HITS_CLIENT_20110320;
