...
INSERT INTO BN_HITS_SP_20110914
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110914;

SELECT count(*) as BN_HITS_SP_20110914 FROM BN_HITS_SP_20110914;

TRUNCATE BN_HITS_CLIENT_20110914;
INSERT INTO BN_HITS_CLIENT_20110914
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110914;

SELECT count(*) as BN_HITS_CLIENT_20110914 FROM BN_HITS_CLIENT_20110914;
