...
INSERT INTO BN_HITS_SP_20110703
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110703;

SELECT count(*) as BN_HITS_SP_20110703 FROM BN_HITS_SP_20110703;

TRUNCATE BN_HITS_CLIENT_20110703;
INSERT INTO BN_HITS_CLIENT_20110703
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110703;

SELECT count(*) as BN_HITS_CLIENT_20110703 FROM BN_HITS_CLIENT_20110703;
