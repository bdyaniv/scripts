...
INSERT INTO BN_HITS_SP_20110922
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110922;

SELECT count(*) as BN_HITS_SP_20110922 FROM BN_HITS_SP_20110922;

TRUNCATE BN_HITS_CLIENT_20110922;
INSERT INTO BN_HITS_CLIENT_20110922
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110922;

SELECT count(*) as BN_HITS_CLIENT_20110922 FROM BN_HITS_CLIENT_20110922;
