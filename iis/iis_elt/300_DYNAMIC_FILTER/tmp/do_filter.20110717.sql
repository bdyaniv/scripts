...
INSERT INTO BN_HITS_SP_20110717
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110717;

SELECT count(*) as BN_HITS_SP_20110717 FROM BN_HITS_SP_20110717;

TRUNCATE BN_HITS_CLIENT_20110717;
INSERT INTO BN_HITS_CLIENT_20110717
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110717;

SELECT count(*) as BN_HITS_CLIENT_20110717 FROM BN_HITS_CLIENT_20110717;
