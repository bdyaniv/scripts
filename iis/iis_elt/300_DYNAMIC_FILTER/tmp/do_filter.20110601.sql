...
INSERT INTO BN_HITS_SP_20110601
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110601;

SELECT count(*) as BN_HITS_SP_20110601 FROM BN_HITS_SP_20110601;

TRUNCATE BN_HITS_CLIENT_20110601;
INSERT INTO BN_HITS_CLIENT_20110601
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110601;

SELECT count(*) as BN_HITS_CLIENT_20110601 FROM BN_HITS_CLIENT_20110601;
