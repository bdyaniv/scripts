...
INSERT INTO BN_HITS_SP_20110828
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110828;

SELECT count(*) as BN_HITS_SP_20110828 FROM BN_HITS_SP_20110828;

TRUNCATE BN_HITS_CLIENT_20110828;
INSERT INTO BN_HITS_CLIENT_20110828
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110828;

SELECT count(*) as BN_HITS_CLIENT_20110828 FROM BN_HITS_CLIENT_20110828;
