...
INSERT INTO BN_HITS_SP_20110819
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110819;

SELECT count(*) as BN_HITS_SP_20110819 FROM BN_HITS_SP_20110819;

TRUNCATE BN_HITS_CLIENT_20110819;
INSERT INTO BN_HITS_CLIENT_20110819
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110819;

SELECT count(*) as BN_HITS_CLIENT_20110819 FROM BN_HITS_CLIENT_20110819;
