...
INSERT INTO BN_HITS_SP_20110923
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110923;

SELECT count(*) as BN_HITS_SP_20110923 FROM BN_HITS_SP_20110923;

TRUNCATE BN_HITS_CLIENT_20110923;
INSERT INTO BN_HITS_CLIENT_20110923
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110923;

SELECT count(*) as BN_HITS_CLIENT_20110923 FROM BN_HITS_CLIENT_20110923;
