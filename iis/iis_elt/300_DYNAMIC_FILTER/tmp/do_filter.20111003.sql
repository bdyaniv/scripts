...
INSERT INTO BN_HITS_SP_20111003
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111003;

SELECT count(*) as BN_HITS_SP_20111003 FROM BN_HITS_SP_20111003;

TRUNCATE BN_HITS_CLIENT_20111003;
INSERT INTO BN_HITS_CLIENT_20111003
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111003;

SELECT count(*) as BN_HITS_CLIENT_20111003 FROM BN_HITS_CLIENT_20111003;
