...
INSERT INTO BN_HITS_SP_20110316
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110316;

SELECT count(*) as BN_HITS_SP_20110316 FROM BN_HITS_SP_20110316;

TRUNCATE BN_HITS_CLIENT_20110316;
INSERT INTO BN_HITS_CLIENT_20110316
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110316;

SELECT count(*) as BN_HITS_CLIENT_20110316 FROM BN_HITS_CLIENT_20110316;
