...
INSERT INTO BN_HITS_SP_20110808
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110808;

SELECT count(*) as BN_HITS_SP_20110808 FROM BN_HITS_SP_20110808;

TRUNCATE BN_HITS_CLIENT_20110808;
INSERT INTO BN_HITS_CLIENT_20110808
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110808;

SELECT count(*) as BN_HITS_CLIENT_20110808 FROM BN_HITS_CLIENT_20110808;
