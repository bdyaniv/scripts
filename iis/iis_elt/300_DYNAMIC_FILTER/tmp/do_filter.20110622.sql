...
INSERT INTO BN_HITS_SP_20110622
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110622;

SELECT count(*) as BN_HITS_SP_20110622 FROM BN_HITS_SP_20110622;

TRUNCATE BN_HITS_CLIENT_20110622;
INSERT INTO BN_HITS_CLIENT_20110622
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110622;

SELECT count(*) as BN_HITS_CLIENT_20110622 FROM BN_HITS_CLIENT_20110622;
