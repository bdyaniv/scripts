...
INSERT INTO BN_HITS_SP_20101207
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101207;

SELECT count(*) as BN_HITS_SP_20101207 FROM BN_HITS_SP_20101207;

TRUNCATE BN_HITS_CLIENT_20101207;
INSERT INTO BN_HITS_CLIENT_20101207
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101207;

SELECT count(*) as BN_HITS_CLIENT_20101207 FROM BN_HITS_CLIENT_20101207;
