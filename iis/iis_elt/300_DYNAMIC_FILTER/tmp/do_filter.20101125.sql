...
INSERT INTO BN_HITS_SP_20101125
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101125;

SELECT count(*) as BN_HITS_SP_20101125 FROM BN_HITS_SP_20101125;

TRUNCATE BN_HITS_CLIENT_20101125;
INSERT INTO BN_HITS_CLIENT_20101125
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101125;

SELECT count(*) as BN_HITS_CLIENT_20101125 FROM BN_HITS_CLIENT_20101125;
