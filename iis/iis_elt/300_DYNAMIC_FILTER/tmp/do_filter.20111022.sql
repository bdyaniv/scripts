...
INSERT INTO BN_HITS_SP_20111022
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111022;

SELECT count(*) as BN_HITS_SP_20111022 FROM BN_HITS_SP_20111022;

TRUNCATE BN_HITS_CLIENT_20111022;
INSERT INTO BN_HITS_CLIENT_20111022
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111022;

SELECT count(*) as BN_HITS_CLIENT_20111022 FROM BN_HITS_CLIENT_20111022;
