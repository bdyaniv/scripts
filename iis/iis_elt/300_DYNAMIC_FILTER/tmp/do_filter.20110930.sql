...
INSERT INTO BN_HITS_SP_20110930
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110930;

SELECT count(*) as BN_HITS_SP_20110930 FROM BN_HITS_SP_20110930;

TRUNCATE BN_HITS_CLIENT_20110930;
INSERT INTO BN_HITS_CLIENT_20110930
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110930;

SELECT count(*) as BN_HITS_CLIENT_20110930 FROM BN_HITS_CLIENT_20110930;
