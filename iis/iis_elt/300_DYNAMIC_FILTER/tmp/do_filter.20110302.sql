...
INSERT INTO BN_HITS_SP_20110302
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110302;

SELECT count(*) as BN_HITS_SP_20110302 FROM BN_HITS_SP_20110302;

TRUNCATE BN_HITS_CLIENT_20110302;
INSERT INTO BN_HITS_CLIENT_20110302
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110302;

SELECT count(*) as BN_HITS_CLIENT_20110302 FROM BN_HITS_CLIENT_20110302;
