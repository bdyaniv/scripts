...
INSERT INTO BN_HITS_SP_20110915
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110915;

SELECT count(*) as BN_HITS_SP_20110915 FROM BN_HITS_SP_20110915;

TRUNCATE BN_HITS_CLIENT_20110915;
INSERT INTO BN_HITS_CLIENT_20110915
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110915;

SELECT count(*) as BN_HITS_CLIENT_20110915 FROM BN_HITS_CLIENT_20110915;
