...
INSERT INTO BN_HITS_SP_20111001
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111001;

SELECT count(*) as BN_HITS_SP_20111001 FROM BN_HITS_SP_20111001;

TRUNCATE BN_HITS_CLIENT_20111001;
INSERT INTO BN_HITS_CLIENT_20111001
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111001;

SELECT count(*) as BN_HITS_CLIENT_20111001 FROM BN_HITS_CLIENT_20111001;
