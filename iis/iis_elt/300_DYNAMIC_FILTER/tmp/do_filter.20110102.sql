...
INSERT INTO BN_HITS_SP_20110102
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110102;

SELECT count(*) as BN_HITS_SP_20110102 FROM BN_HITS_SP_20110102;

TRUNCATE BN_HITS_CLIENT_20110102;
INSERT INTO BN_HITS_CLIENT_20110102
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110102;

SELECT count(*) as BN_HITS_CLIENT_20110102 FROM BN_HITS_CLIENT_20110102;
