...
INSERT INTO BN_HITS_SP_20110327
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110327;

SELECT count(*) as BN_HITS_SP_20110327 FROM BN_HITS_SP_20110327;

TRUNCATE BN_HITS_CLIENT_20110327;
INSERT INTO BN_HITS_CLIENT_20110327
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110327;

SELECT count(*) as BN_HITS_CLIENT_20110327 FROM BN_HITS_CLIENT_20110327;
