...
INSERT INTO BN_HITS_SP_20110511
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110511;

SELECT count(*) as BN_HITS_SP_20110511 FROM BN_HITS_SP_20110511;

TRUNCATE BN_HITS_CLIENT_20110511;
INSERT INTO BN_HITS_CLIENT_20110511
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110511;

SELECT count(*) as BN_HITS_CLIENT_20110511 FROM BN_HITS_CLIENT_20110511;
