...
INSERT INTO BN_HITS_SP_20111011
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111011;

SELECT count(*) as BN_HITS_SP_20111011 FROM BN_HITS_SP_20111011;

TRUNCATE BN_HITS_CLIENT_20111011;
INSERT INTO BN_HITS_CLIENT_20111011
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111011;

SELECT count(*) as BN_HITS_CLIENT_20111011 FROM BN_HITS_CLIENT_20111011;
