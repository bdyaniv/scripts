...
INSERT INTO BN_HITS_SP_20121104
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20121104;

SELECT count(*) as BN_HITS_SP_20121104 FROM BN_HITS_SP_20121104;

TRUNCATE BN_HITS_CLIENT_20121104;
INSERT INTO BN_HITS_CLIENT_20121104
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20121104;

SELECT count(*) as BN_HITS_CLIENT_20121104 FROM BN_HITS_CLIENT_20121104;
