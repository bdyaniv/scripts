...
INSERT INTO BN_HITS_SP_20101203
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101203;

SELECT count(*) as BN_HITS_SP_20101203 FROM BN_HITS_SP_20101203;

TRUNCATE BN_HITS_CLIENT_20101203;
INSERT INTO BN_HITS_CLIENT_20101203
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101203;

SELECT count(*) as BN_HITS_CLIENT_20101203 FROM BN_HITS_CLIENT_20101203;
