...
INSERT INTO BN_HITS_SP_20110825
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110825;

SELECT count(*) as BN_HITS_SP_20110825 FROM BN_HITS_SP_20110825;

TRUNCATE BN_HITS_CLIENT_20110825;
INSERT INTO BN_HITS_CLIENT_20110825
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110825;

SELECT count(*) as BN_HITS_CLIENT_20110825 FROM BN_HITS_CLIENT_20110825;
