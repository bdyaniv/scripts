...
INSERT INTO BN_HITS_SP_20110919
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110919;

SELECT count(*) as BN_HITS_SP_20110919 FROM BN_HITS_SP_20110919;

TRUNCATE BN_HITS_CLIENT_20110919;
INSERT INTO BN_HITS_CLIENT_20110919
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110919;

SELECT count(*) as BN_HITS_CLIENT_20110919 FROM BN_HITS_CLIENT_20110919;
