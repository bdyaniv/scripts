...
INSERT INTO BN_HITS_SP_20110616
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110616;

SELECT count(*) as BN_HITS_SP_20110616 FROM BN_HITS_SP_20110616;

TRUNCATE BN_HITS_CLIENT_20110616;
INSERT INTO BN_HITS_CLIENT_20110616
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110616;

SELECT count(*) as BN_HITS_CLIENT_20110616 FROM BN_HITS_CLIENT_20110616;
