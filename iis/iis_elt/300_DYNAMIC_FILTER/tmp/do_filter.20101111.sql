...
INSERT INTO BN_HITS_SP_20101111
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101111;

SELECT count(*) as BN_HITS_SP_20101111 FROM BN_HITS_SP_20101111;

TRUNCATE BN_HITS_CLIENT_20101111;
INSERT INTO BN_HITS_CLIENT_20101111
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101111;

SELECT count(*) as BN_HITS_CLIENT_20101111 FROM BN_HITS_CLIENT_20101111;
