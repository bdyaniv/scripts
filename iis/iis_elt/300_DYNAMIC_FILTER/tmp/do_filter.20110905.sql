...
INSERT INTO BN_HITS_SP_20110905
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110905;

SELECT count(*) as BN_HITS_SP_20110905 FROM BN_HITS_SP_20110905;

TRUNCATE BN_HITS_CLIENT_20110905;
INSERT INTO BN_HITS_CLIENT_20110905
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110905;

SELECT count(*) as BN_HITS_CLIENT_20110905 FROM BN_HITS_CLIENT_20110905;
