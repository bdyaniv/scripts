...
INSERT INTO BN_HITS_SP_20111230
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111230;

SELECT count(*) as BN_HITS_SP_20111230 FROM BN_HITS_SP_20111230;

TRUNCATE BN_HITS_CLIENT_20111230;
INSERT INTO BN_HITS_CLIENT_20111230
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111230;

SELECT count(*) as BN_HITS_CLIENT_20111230 FROM BN_HITS_CLIENT_20111230;
