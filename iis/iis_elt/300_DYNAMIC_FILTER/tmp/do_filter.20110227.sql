...
INSERT INTO BN_HITS_SP_20110227
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110227;

SELECT count(*) as BN_HITS_SP_20110227 FROM BN_HITS_SP_20110227;

TRUNCATE BN_HITS_CLIENT_20110227;
INSERT INTO BN_HITS_CLIENT_20110227
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110227;

SELECT count(*) as BN_HITS_CLIENT_20110227 FROM BN_HITS_CLIENT_20110227;
