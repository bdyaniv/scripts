...
INSERT INTO BN_HITS_SP_20120108
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20120108;

SELECT count(*) as BN_HITS_SP_20120108 FROM BN_HITS_SP_20120108;

TRUNCATE BN_HITS_CLIENT_20120108;
INSERT INTO BN_HITS_CLIENT_20120108
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20120108;

SELECT count(*) as BN_HITS_CLIENT_20120108 FROM BN_HITS_CLIENT_20120108;
