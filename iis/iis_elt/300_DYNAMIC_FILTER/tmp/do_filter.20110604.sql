...
INSERT INTO BN_HITS_SP_20110604
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110604;

SELECT count(*) as BN_HITS_SP_20110604 FROM BN_HITS_SP_20110604;

TRUNCATE BN_HITS_CLIENT_20110604;
INSERT INTO BN_HITS_CLIENT_20110604
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110604;

SELECT count(*) as BN_HITS_CLIENT_20110604 FROM BN_HITS_CLIENT_20110604;
