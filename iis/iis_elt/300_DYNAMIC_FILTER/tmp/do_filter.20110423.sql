...
INSERT INTO BN_HITS_SP_20110423
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110423;

SELECT count(*) as BN_HITS_SP_20110423 FROM BN_HITS_SP_20110423;

TRUNCATE BN_HITS_CLIENT_20110423;
INSERT INTO BN_HITS_CLIENT_20110423
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110423;

SELECT count(*) as BN_HITS_CLIENT_20110423 FROM BN_HITS_CLIENT_20110423;
