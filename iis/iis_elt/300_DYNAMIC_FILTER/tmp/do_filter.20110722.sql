...
INSERT INTO BN_HITS_SP_20110722
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110722;

SELECT count(*) as BN_HITS_SP_20110722 FROM BN_HITS_SP_20110722;

TRUNCATE BN_HITS_CLIENT_20110722;
INSERT INTO BN_HITS_CLIENT_20110722
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110722;

SELECT count(*) as BN_HITS_CLIENT_20110722 FROM BN_HITS_CLIENT_20110722;
