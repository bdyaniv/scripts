...
INSERT INTO BN_HITS_SP_20110411
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110411;

SELECT count(*) as BN_HITS_SP_20110411 FROM BN_HITS_SP_20110411;

TRUNCATE BN_HITS_CLIENT_20110411;
INSERT INTO BN_HITS_CLIENT_20110411
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110411;

SELECT count(*) as BN_HITS_CLIENT_20110411 FROM BN_HITS_CLIENT_20110411;
