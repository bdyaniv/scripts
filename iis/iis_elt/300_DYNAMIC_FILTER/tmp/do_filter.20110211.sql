...
INSERT INTO BN_HITS_SP_20110211
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110211;

SELECT count(*) as BN_HITS_SP_20110211 FROM BN_HITS_SP_20110211;

TRUNCATE BN_HITS_CLIENT_20110211;
INSERT INTO BN_HITS_CLIENT_20110211
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110211;

SELECT count(*) as BN_HITS_CLIENT_20110211 FROM BN_HITS_CLIENT_20110211;
