...
INSERT INTO BN_HITS_SP_20110321
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110321;

SELECT count(*) as BN_HITS_SP_20110321 FROM BN_HITS_SP_20110321;

TRUNCATE BN_HITS_CLIENT_20110321;
INSERT INTO BN_HITS_CLIENT_20110321
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110321;

SELECT count(*) as BN_HITS_CLIENT_20110321 FROM BN_HITS_CLIENT_20110321;
