...
INSERT INTO BN_HITS_SP_20111123
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111123;

SELECT count(*) as BN_HITS_SP_20111123 FROM BN_HITS_SP_20111123;

TRUNCATE BN_HITS_CLIENT_20111123;
INSERT INTO BN_HITS_CLIENT_20111123
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111123;

SELECT count(*) as BN_HITS_CLIENT_20111123 FROM BN_HITS_CLIENT_20111123;
