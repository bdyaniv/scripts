...
INSERT INTO BN_HITS_SP_20101115
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101115;

SELECT count(*) as BN_HITS_SP_20101115 FROM BN_HITS_SP_20101115;

TRUNCATE BN_HITS_CLIENT_20101115;
INSERT INTO BN_HITS_CLIENT_20101115
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101115;

SELECT count(*) as BN_HITS_CLIENT_20101115 FROM BN_HITS_CLIENT_20101115;
