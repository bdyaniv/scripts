...
INSERT INTO BN_HITS_SP_20110917
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110917;

SELECT count(*) as BN_HITS_SP_20110917 FROM BN_HITS_SP_20110917;

TRUNCATE BN_HITS_CLIENT_20110917;
INSERT INTO BN_HITS_CLIENT_20110917
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110917;

SELECT count(*) as BN_HITS_CLIENT_20110917 FROM BN_HITS_CLIENT_20110917;
