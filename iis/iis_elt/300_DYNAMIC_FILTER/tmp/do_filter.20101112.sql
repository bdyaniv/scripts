...
INSERT INTO BN_HITS_SP_20101112
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101112;

SELECT count(*) as BN_HITS_SP_20101112 FROM BN_HITS_SP_20101112;

TRUNCATE BN_HITS_CLIENT_20101112;
INSERT INTO BN_HITS_CLIENT_20101112
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101112;

SELECT count(*) as BN_HITS_CLIENT_20101112 FROM BN_HITS_CLIENT_20101112;
