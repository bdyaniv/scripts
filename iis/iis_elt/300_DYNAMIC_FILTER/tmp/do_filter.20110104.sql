...
INSERT INTO BN_HITS_SP_20110104
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110104;

SELECT count(*) as BN_HITS_SP_20110104 FROM BN_HITS_SP_20110104;

TRUNCATE BN_HITS_CLIENT_20110104;
INSERT INTO BN_HITS_CLIENT_20110104
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110104;

SELECT count(*) as BN_HITS_CLIENT_20110104 FROM BN_HITS_CLIENT_20110104;
