...
INSERT INTO BN_HITS_SP_20111004
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111004;

SELECT count(*) as BN_HITS_SP_20111004 FROM BN_HITS_SP_20111004;

TRUNCATE BN_HITS_CLIENT_20111004;
INSERT INTO BN_HITS_CLIENT_20111004
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111004;

SELECT count(*) as BN_HITS_CLIENT_20111004 FROM BN_HITS_CLIENT_20111004;
