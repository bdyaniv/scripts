...
INSERT INTO BN_HITS_SP_20110414
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110414;

SELECT count(*) as BN_HITS_SP_20110414 FROM BN_HITS_SP_20110414;

TRUNCATE BN_HITS_CLIENT_20110414;
INSERT INTO BN_HITS_CLIENT_20110414
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110414;

SELECT count(*) as BN_HITS_CLIENT_20110414 FROM BN_HITS_CLIENT_20110414;
