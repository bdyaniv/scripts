...
INSERT INTO BN_HITS_SP_20110826
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110826;

SELECT count(*) as BN_HITS_SP_20110826 FROM BN_HITS_SP_20110826;

TRUNCATE BN_HITS_CLIENT_20110826;
INSERT INTO BN_HITS_CLIENT_20110826
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110826;

SELECT count(*) as BN_HITS_CLIENT_20110826 FROM BN_HITS_CLIENT_20110826;
