...
INSERT INTO BN_HITS_SP_20110629
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110629;

SELECT count(*) as BN_HITS_SP_20110629 FROM BN_HITS_SP_20110629;

TRUNCATE BN_HITS_CLIENT_20110629;
INSERT INTO BN_HITS_CLIENT_20110629
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110629;

SELECT count(*) as BN_HITS_CLIENT_20110629 FROM BN_HITS_CLIENT_20110629;
