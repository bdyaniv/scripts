...
INSERT INTO BN_HITS_SP_20110124
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110124;

SELECT count(*) as BN_HITS_SP_20110124 FROM BN_HITS_SP_20110124;

TRUNCATE BN_HITS_CLIENT_20110124;
INSERT INTO BN_HITS_CLIENT_20110124
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110124;

SELECT count(*) as BN_HITS_CLIENT_20110124 FROM BN_HITS_CLIENT_20110124;
