...
INSERT INTO BN_HITS_SP_20110218
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110218;

SELECT count(*) as BN_HITS_SP_20110218 FROM BN_HITS_SP_20110218;

TRUNCATE BN_HITS_CLIENT_20110218;
INSERT INTO BN_HITS_CLIENT_20110218
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110218;

SELECT count(*) as BN_HITS_CLIENT_20110218 FROM BN_HITS_CLIENT_20110218;
