...
INSERT INTO BN_HITS_SP_20101206
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101206;

SELECT count(*) as BN_HITS_SP_20101206 FROM BN_HITS_SP_20101206;

TRUNCATE BN_HITS_CLIENT_20101206;
INSERT INTO BN_HITS_CLIENT_20101206
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101206;

SELECT count(*) as BN_HITS_CLIENT_20101206 FROM BN_HITS_CLIENT_20101206;
