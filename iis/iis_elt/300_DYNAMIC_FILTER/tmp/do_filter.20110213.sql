...
INSERT INTO BN_HITS_SP_20110213
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110213;

SELECT count(*) as BN_HITS_SP_20110213 FROM BN_HITS_SP_20110213;

TRUNCATE BN_HITS_CLIENT_20110213;
INSERT INTO BN_HITS_CLIENT_20110213
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110213;

SELECT count(*) as BN_HITS_CLIENT_20110213 FROM BN_HITS_CLIENT_20110213;
