...
INSERT INTO BN_HITS_SP_20101108
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101108;

SELECT count(*) as BN_HITS_SP_20101108 FROM BN_HITS_SP_20101108;

TRUNCATE BN_HITS_CLIENT_20101108;
INSERT INTO BN_HITS_CLIENT_20101108
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101108;

SELECT count(*) as BN_HITS_CLIENT_20101108 FROM BN_HITS_CLIENT_20101108;
