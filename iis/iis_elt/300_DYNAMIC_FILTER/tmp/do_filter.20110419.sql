...
INSERT INTO BN_HITS_SP_20110419
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110419;

SELECT count(*) as BN_HITS_SP_20110419 FROM BN_HITS_SP_20110419;

TRUNCATE BN_HITS_CLIENT_20110419;
INSERT INTO BN_HITS_CLIENT_20110419
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110419;

SELECT count(*) as BN_HITS_CLIENT_20110419 FROM BN_HITS_CLIENT_20110419;
