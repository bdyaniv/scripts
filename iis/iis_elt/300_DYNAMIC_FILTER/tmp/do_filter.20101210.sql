...
INSERT INTO BN_HITS_SP_20101210
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101210;

SELECT count(*) as BN_HITS_SP_20101210 FROM BN_HITS_SP_20101210;

TRUNCATE BN_HITS_CLIENT_20101210;
INSERT INTO BN_HITS_CLIENT_20101210
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101210;

SELECT count(*) as BN_HITS_CLIENT_20101210 FROM BN_HITS_CLIENT_20101210;
