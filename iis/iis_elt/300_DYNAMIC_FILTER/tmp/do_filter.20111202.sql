...
INSERT INTO BN_HITS_SP_20111202
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111202;

SELECT count(*) as BN_HITS_SP_20111202 FROM BN_HITS_SP_20111202;

TRUNCATE BN_HITS_CLIENT_20111202;
INSERT INTO BN_HITS_CLIENT_20111202
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111202;

SELECT count(*) as BN_HITS_CLIENT_20111202 FROM BN_HITS_CLIENT_20111202;
