...
INSERT INTO BN_HITS_SP_20111016
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111016;

SELECT count(*) as BN_HITS_SP_20111016 FROM BN_HITS_SP_20111016;

TRUNCATE BN_HITS_CLIENT_20111016;
INSERT INTO BN_HITS_CLIENT_20111016
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111016;

SELECT count(*) as BN_HITS_CLIENT_20111016 FROM BN_HITS_CLIENT_20111016;
