...
INSERT INTO BN_HITS_SP_20111219
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111219;

SELECT count(*) as BN_HITS_SP_20111219 FROM BN_HITS_SP_20111219;

TRUNCATE BN_HITS_CLIENT_20111219;
INSERT INTO BN_HITS_CLIENT_20111219
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111219;

SELECT count(*) as BN_HITS_CLIENT_20111219 FROM BN_HITS_CLIENT_20111219;
