...
/* S.SEQ_HIT_ID, */
 ...
 -- iis_mapping_cols trxm for RESOURCE_NAME
  ...
  UI_ACTION
FROM 
  web_resource_hits_2010_05_13
WHERE
  user_id is not null and
  hit_ts >= ('2010_05_13 0:0:0'::timestamp + interval '5 hours')
;
...
/* S.SEQ_HIT_ID, */
 ...
 -- iis_mapping_cols trxm for RESOURCE_NAME
  ...
  UI_ACTION
FROM 
  web_resource_hits_2010_05_14
WHERE
  user_id is not null and
  hit_ts < ('2010_05_14 00:00:00'::timestamp + interval '5 hours')
;
