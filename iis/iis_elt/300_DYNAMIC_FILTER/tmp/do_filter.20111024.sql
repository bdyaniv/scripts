...
INSERT INTO BN_HITS_SP_20111024
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111024;

SELECT count(*) as BN_HITS_SP_20111024 FROM BN_HITS_SP_20111024;

TRUNCATE BN_HITS_CLIENT_20111024;
INSERT INTO BN_HITS_CLIENT_20111024
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111024;

SELECT count(*) as BN_HITS_CLIENT_20111024 FROM BN_HITS_CLIENT_20111024;
