...
INSERT INTO BN_HITS_SP_20110831
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110831;

SELECT count(*) as BN_HITS_SP_20110831 FROM BN_HITS_SP_20110831;

TRUNCATE BN_HITS_CLIENT_20110831;
INSERT INTO BN_HITS_CLIENT_20110831
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110831;

SELECT count(*) as BN_HITS_CLIENT_20110831 FROM BN_HITS_CLIENT_20110831;
