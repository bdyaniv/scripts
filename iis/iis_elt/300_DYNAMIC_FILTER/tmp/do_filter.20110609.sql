...
INSERT INTO BN_HITS_SP_20110609
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110609;

SELECT count(*) as BN_HITS_SP_20110609 FROM BN_HITS_SP_20110609;

TRUNCATE BN_HITS_CLIENT_20110609;
INSERT INTO BN_HITS_CLIENT_20110609
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110609;

SELECT count(*) as BN_HITS_CLIENT_20110609 FROM BN_HITS_CLIENT_20110609;
