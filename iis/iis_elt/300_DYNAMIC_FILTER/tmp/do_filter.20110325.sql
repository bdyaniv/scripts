...
INSERT INTO BN_HITS_SP_20110325
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110325;

SELECT count(*) as BN_HITS_SP_20110325 FROM BN_HITS_SP_20110325;

TRUNCATE BN_HITS_CLIENT_20110325;
INSERT INTO BN_HITS_CLIENT_20110325
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110325;

SELECT count(*) as BN_HITS_CLIENT_20110325 FROM BN_HITS_CLIENT_20110325;
