...
INSERT INTO BN_HITS_SP_20110224
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110224;

SELECT count(*) as BN_HITS_SP_20110224 FROM BN_HITS_SP_20110224;

TRUNCATE BN_HITS_CLIENT_20110224;
INSERT INTO BN_HITS_CLIENT_20110224
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110224;

SELECT count(*) as BN_HITS_CLIENT_20110224 FROM BN_HITS_CLIENT_20110224;
