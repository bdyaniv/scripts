...
INSERT INTO BN_HITS_SP_20110506
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110506;

SELECT count(*) as BN_HITS_SP_20110506 FROM BN_HITS_SP_20110506;

TRUNCATE BN_HITS_CLIENT_20110506;
INSERT INTO BN_HITS_CLIENT_20110506
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110506;

SELECT count(*) as BN_HITS_CLIENT_20110506 FROM BN_HITS_CLIENT_20110506;
