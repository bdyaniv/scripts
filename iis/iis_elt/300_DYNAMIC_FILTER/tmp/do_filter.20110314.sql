...
INSERT INTO BN_HITS_SP_20110314
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110314;

SELECT count(*) as BN_HITS_SP_20110314 FROM BN_HITS_SP_20110314;

TRUNCATE BN_HITS_CLIENT_20110314;
INSERT INTO BN_HITS_CLIENT_20110314
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110314;

SELECT count(*) as BN_HITS_CLIENT_20110314 FROM BN_HITS_CLIENT_20110314;
