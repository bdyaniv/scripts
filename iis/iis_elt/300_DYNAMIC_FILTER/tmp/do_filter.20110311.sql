...
INSERT INTO BN_HITS_SP_20110311
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110311;

SELECT count(*) as BN_HITS_SP_20110311 FROM BN_HITS_SP_20110311;

TRUNCATE BN_HITS_CLIENT_20110311;
INSERT INTO BN_HITS_CLIENT_20110311
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110311;

SELECT count(*) as BN_HITS_CLIENT_20110311 FROM BN_HITS_CLIENT_20110311;
