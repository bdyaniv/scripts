...
INSERT INTO BN_HITS_SP_20111129
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111129;

SELECT count(*) as BN_HITS_SP_20111129 FROM BN_HITS_SP_20111129;

TRUNCATE BN_HITS_CLIENT_20111129;
INSERT INTO BN_HITS_CLIENT_20111129
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111129;

SELECT count(*) as BN_HITS_CLIENT_20111129 FROM BN_HITS_CLIENT_20111129;
