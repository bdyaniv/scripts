...
INSERT INTO BN_HITS_SP_20110407
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110407;

SELECT count(*) as BN_HITS_SP_20110407 FROM BN_HITS_SP_20110407;

TRUNCATE BN_HITS_CLIENT_20110407;
INSERT INTO BN_HITS_CLIENT_20110407
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110407;

SELECT count(*) as BN_HITS_CLIENT_20110407 FROM BN_HITS_CLIENT_20110407;
