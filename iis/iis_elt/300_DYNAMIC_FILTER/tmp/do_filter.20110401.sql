...
INSERT INTO BN_HITS_SP_20110401
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110401;

SELECT count(*) as BN_HITS_SP_20110401 FROM BN_HITS_SP_20110401;

TRUNCATE BN_HITS_CLIENT_20110401;
INSERT INTO BN_HITS_CLIENT_20110401
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110401;

SELECT count(*) as BN_HITS_CLIENT_20110401 FROM BN_HITS_CLIENT_20110401;
