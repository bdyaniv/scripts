...
INSERT INTO BN_HITS_SP_20110924
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110924;

SELECT count(*) as BN_HITS_SP_20110924 FROM BN_HITS_SP_20110924;

TRUNCATE BN_HITS_CLIENT_20110924;
INSERT INTO BN_HITS_CLIENT_20110924
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110924;

SELECT count(*) as BN_HITS_CLIENT_20110924 FROM BN_HITS_CLIENT_20110924;
