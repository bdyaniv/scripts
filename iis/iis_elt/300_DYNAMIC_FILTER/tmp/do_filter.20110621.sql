...
INSERT INTO BN_HITS_SP_20110621
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110621;

SELECT count(*) as BN_HITS_SP_20110621 FROM BN_HITS_SP_20110621;

TRUNCATE BN_HITS_CLIENT_20110621;
INSERT INTO BN_HITS_CLIENT_20110621
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110621;

SELECT count(*) as BN_HITS_CLIENT_20110621 FROM BN_HITS_CLIENT_20110621;
