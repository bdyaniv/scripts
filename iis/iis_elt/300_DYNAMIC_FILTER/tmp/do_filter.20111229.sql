...
INSERT INTO BN_HITS_SP_20111229
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111229;

SELECT count(*) as BN_HITS_SP_20111229 FROM BN_HITS_SP_20111229;

TRUNCATE BN_HITS_CLIENT_20111229;
INSERT INTO BN_HITS_CLIENT_20111229
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111229;

SELECT count(*) as BN_HITS_CLIENT_20111229 FROM BN_HITS_CLIENT_20111229;
