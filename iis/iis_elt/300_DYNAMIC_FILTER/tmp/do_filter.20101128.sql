...
INSERT INTO BN_HITS_SP_20101128
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101128;

SELECT count(*) as BN_HITS_SP_20101128 FROM BN_HITS_SP_20101128;

TRUNCATE BN_HITS_CLIENT_20101128;
INSERT INTO BN_HITS_CLIENT_20101128
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101128;

SELECT count(*) as BN_HITS_CLIENT_20101128 FROM BN_HITS_CLIENT_20101128;
