...
INSERT INTO BN_HITS_SP_20110106
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110106;

SELECT count(*) as BN_HITS_SP_20110106 FROM BN_HITS_SP_20110106;

TRUNCATE BN_HITS_CLIENT_20110106;
INSERT INTO BN_HITS_CLIENT_20110106
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110106;

SELECT count(*) as BN_HITS_CLIENT_20110106 FROM BN_HITS_CLIENT_20110106;
