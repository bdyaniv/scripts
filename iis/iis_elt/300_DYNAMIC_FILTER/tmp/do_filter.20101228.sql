...
INSERT INTO BN_HITS_SP_20101228
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101228;

SELECT count(*) as BN_HITS_SP_20101228 FROM BN_HITS_SP_20101228;

TRUNCATE BN_HITS_CLIENT_20101228;
INSERT INTO BN_HITS_CLIENT_20101228
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101228;

SELECT count(*) as BN_HITS_CLIENT_20101228 FROM BN_HITS_CLIENT_20101228;
