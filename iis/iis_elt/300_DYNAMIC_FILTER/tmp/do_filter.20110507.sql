...
INSERT INTO BN_HITS_SP_20110507
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110507;

SELECT count(*) as BN_HITS_SP_20110507 FROM BN_HITS_SP_20110507;

TRUNCATE BN_HITS_CLIENT_20110507;
INSERT INTO BN_HITS_CLIENT_20110507
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110507;

SELECT count(*) as BN_HITS_CLIENT_20110507 FROM BN_HITS_CLIENT_20110507;
