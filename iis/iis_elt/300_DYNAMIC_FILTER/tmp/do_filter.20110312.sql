...
INSERT INTO BN_HITS_SP_20110312
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110312;

SELECT count(*) as BN_HITS_SP_20110312 FROM BN_HITS_SP_20110312;

TRUNCATE BN_HITS_CLIENT_20110312;
INSERT INTO BN_HITS_CLIENT_20110312
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110312;

SELECT count(*) as BN_HITS_CLIENT_20110312 FROM BN_HITS_CLIENT_20110312;
