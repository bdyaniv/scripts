...
INSERT INTO BN_HITS_SP_20111209
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111209;

SELECT count(*) as BN_HITS_SP_20111209 FROM BN_HITS_SP_20111209;

TRUNCATE BN_HITS_CLIENT_20111209;
INSERT INTO BN_HITS_CLIENT_20111209
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111209;

SELECT count(*) as BN_HITS_CLIENT_20111209 FROM BN_HITS_CLIENT_20111209;
