...
INSERT INTO BN_HITS_SP_20110317
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110317;

SELECT count(*) as BN_HITS_SP_20110317 FROM BN_HITS_SP_20110317;

TRUNCATE BN_HITS_CLIENT_20110317;
INSERT INTO BN_HITS_CLIENT_20110317
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110317;

SELECT count(*) as BN_HITS_CLIENT_20110317 FROM BN_HITS_CLIENT_20110317;
