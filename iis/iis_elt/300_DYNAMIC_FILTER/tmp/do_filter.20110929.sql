...
INSERT INTO BN_HITS_SP_20110929
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110929;

SELECT count(*) as BN_HITS_SP_20110929 FROM BN_HITS_SP_20110929;

TRUNCATE BN_HITS_CLIENT_20110929;
INSERT INTO BN_HITS_CLIENT_20110929
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110929;

SELECT count(*) as BN_HITS_CLIENT_20110929 FROM BN_HITS_CLIENT_20110929;
