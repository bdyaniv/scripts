...
INSERT INTO BN_HITS_SP_20110109
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110109;

SELECT count(*) as BN_HITS_SP_20110109 FROM BN_HITS_SP_20110109;

TRUNCATE BN_HITS_CLIENT_20110109;
INSERT INTO BN_HITS_CLIENT_20110109
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110109;

SELECT count(*) as BN_HITS_CLIENT_20110109 FROM BN_HITS_CLIENT_20110109;
