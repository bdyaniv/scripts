...
INSERT INTO BN_HITS_SP_20110822
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110822;

SELECT count(*) as BN_HITS_SP_20110822 FROM BN_HITS_SP_20110822;

TRUNCATE BN_HITS_CLIENT_20110822;
INSERT INTO BN_HITS_CLIENT_20110822
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110822;

SELECT count(*) as BN_HITS_CLIENT_20110822 FROM BN_HITS_CLIENT_20110822;
