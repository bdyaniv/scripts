...
INSERT INTO BN_HITS_SP_20111130
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111130;

SELECT count(*) as BN_HITS_SP_20111130 FROM BN_HITS_SP_20111130;

TRUNCATE BN_HITS_CLIENT_20111130;
INSERT INTO BN_HITS_CLIENT_20111130
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111130;

SELECT count(*) as BN_HITS_CLIENT_20111130 FROM BN_HITS_CLIENT_20111130;
