...
INSERT INTO BN_HITS_SP_20110210
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110210;

SELECT count(*) as BN_HITS_SP_20110210 FROM BN_HITS_SP_20110210;

TRUNCATE BN_HITS_CLIENT_20110210;
INSERT INTO BN_HITS_CLIENT_20110210
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110210;

SELECT count(*) as BN_HITS_CLIENT_20110210 FROM BN_HITS_CLIENT_20110210;
