...
INSERT INTO BN_HITS_SP_20111010
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111010;

SELECT count(*) as BN_HITS_SP_20111010 FROM BN_HITS_SP_20111010;

TRUNCATE BN_HITS_CLIENT_20111010;
INSERT INTO BN_HITS_CLIENT_20111010
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111010;

SELECT count(*) as BN_HITS_CLIENT_20111010 FROM BN_HITS_CLIENT_20111010;
