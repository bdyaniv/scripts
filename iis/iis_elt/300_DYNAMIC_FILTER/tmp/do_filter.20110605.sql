...
INSERT INTO BN_HITS_SP_20110605
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110605;

SELECT count(*) as BN_HITS_SP_20110605 FROM BN_HITS_SP_20110605;

TRUNCATE BN_HITS_CLIENT_20110605;
INSERT INTO BN_HITS_CLIENT_20110605
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110605;

SELECT count(*) as BN_HITS_CLIENT_20110605 FROM BN_HITS_CLIENT_20110605;
