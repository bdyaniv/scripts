...
INSERT INTO BN_HITS_SP_20110115
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110115;

SELECT count(*) as BN_HITS_SP_20110115 FROM BN_HITS_SP_20110115;

TRUNCATE BN_HITS_CLIENT_20110115;
INSERT INTO BN_HITS_CLIENT_20110115
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110115;

SELECT count(*) as BN_HITS_CLIENT_20110115 FROM BN_HITS_CLIENT_20110115;
