...
INSERT INTO BN_HITS_SP_20111006
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111006;

SELECT count(*) as BN_HITS_SP_20111006 FROM BN_HITS_SP_20111006;

TRUNCATE BN_HITS_CLIENT_20111006;
INSERT INTO BN_HITS_CLIENT_20111006
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111006;

SELECT count(*) as BN_HITS_CLIENT_20111006 FROM BN_HITS_CLIENT_20111006;
