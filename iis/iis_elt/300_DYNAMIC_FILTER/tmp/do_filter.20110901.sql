...
INSERT INTO BN_HITS_SP_20110901
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110901;

SELECT count(*) as BN_HITS_SP_20110901 FROM BN_HITS_SP_20110901;

TRUNCATE BN_HITS_CLIENT_20110901;
INSERT INTO BN_HITS_CLIENT_20110901
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110901;

SELECT count(*) as BN_HITS_CLIENT_20110901 FROM BN_HITS_CLIENT_20110901;
