...
INSERT INTO BN_HITS_SP_20110303
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110303;

SELECT count(*) as BN_HITS_SP_20110303 FROM BN_HITS_SP_20110303;

TRUNCATE BN_HITS_CLIENT_20110303;
INSERT INTO BN_HITS_CLIENT_20110303
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110303;

SELECT count(*) as BN_HITS_CLIENT_20110303 FROM BN_HITS_CLIENT_20110303;
