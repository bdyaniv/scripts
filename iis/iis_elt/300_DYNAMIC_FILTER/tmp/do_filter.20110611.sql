...
INSERT INTO BN_HITS_SP_20110611
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110611;

SELECT count(*) as BN_HITS_SP_20110611 FROM BN_HITS_SP_20110611;

TRUNCATE BN_HITS_CLIENT_20110611;
INSERT INTO BN_HITS_CLIENT_20110611
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110611;

SELECT count(*) as BN_HITS_CLIENT_20110611 FROM BN_HITS_CLIENT_20110611;
