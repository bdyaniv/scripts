...
INSERT INTO BN_HITS_SP_20110402
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110402;

SELECT count(*) as BN_HITS_SP_20110402 FROM BN_HITS_SP_20110402;

TRUNCATE BN_HITS_CLIENT_20110402;
INSERT INTO BN_HITS_CLIENT_20110402
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110402;

SELECT count(*) as BN_HITS_CLIENT_20110402 FROM BN_HITS_CLIENT_20110402;
