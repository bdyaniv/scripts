...
INSERT INTO BN_HITS_SP_20110323
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110323;

SELECT count(*) as BN_HITS_SP_20110323 FROM BN_HITS_SP_20110323;

TRUNCATE BN_HITS_CLIENT_20110323;
INSERT INTO BN_HITS_CLIENT_20110323
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110323;

SELECT count(*) as BN_HITS_CLIENT_20110323 FROM BN_HITS_CLIENT_20110323;
