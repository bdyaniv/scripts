...
INSERT INTO BN_HITS_SP_20110911
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110911;

SELECT count(*) as BN_HITS_SP_20110911 FROM BN_HITS_SP_20110911;

TRUNCATE BN_HITS_CLIENT_20110911;
INSERT INTO BN_HITS_CLIENT_20110911
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110911;

SELECT count(*) as BN_HITS_CLIENT_20110911 FROM BN_HITS_CLIENT_20110911;
