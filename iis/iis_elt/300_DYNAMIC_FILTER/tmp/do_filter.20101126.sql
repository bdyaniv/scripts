...
INSERT INTO BN_HITS_SP_20101126
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101126;

SELECT count(*) as BN_HITS_SP_20101126 FROM BN_HITS_SP_20101126;

TRUNCATE BN_HITS_CLIENT_20101126;
INSERT INTO BN_HITS_CLIENT_20101126
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101126;

SELECT count(*) as BN_HITS_CLIENT_20101126 FROM BN_HITS_CLIENT_20101126;
