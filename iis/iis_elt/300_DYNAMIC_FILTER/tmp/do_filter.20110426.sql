...
INSERT INTO BN_HITS_SP_20110426
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110426;

SELECT count(*) as BN_HITS_SP_20110426 FROM BN_HITS_SP_20110426;

TRUNCATE BN_HITS_CLIENT_20110426;
INSERT INTO BN_HITS_CLIENT_20110426
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110426;

SELECT count(*) as BN_HITS_CLIENT_20110426 FROM BN_HITS_CLIENT_20110426;
