...
INSERT INTO BN_HITS_SP_20111012
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111012;

SELECT count(*) as BN_HITS_SP_20111012 FROM BN_HITS_SP_20111012;

TRUNCATE BN_HITS_CLIENT_20111012;
INSERT INTO BN_HITS_CLIENT_20111012
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111012;

SELECT count(*) as BN_HITS_CLIENT_20111012 FROM BN_HITS_CLIENT_20111012;
