...
INSERT INTO BN_HITS_SP_20110331
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110331;

SELECT count(*) as BN_HITS_SP_20110331 FROM BN_HITS_SP_20110331;

TRUNCATE BN_HITS_CLIENT_20110331;
INSERT INTO BN_HITS_CLIENT_20110331
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110331;

SELECT count(*) as BN_HITS_CLIENT_20110331 FROM BN_HITS_CLIENT_20110331;
