...
INSERT INTO BN_HITS_SP_20110127
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110127;

SELECT count(*) as BN_HITS_SP_20110127 FROM BN_HITS_SP_20110127;

TRUNCATE BN_HITS_CLIENT_20110127;
INSERT INTO BN_HITS_CLIENT_20110127
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110127;

SELECT count(*) as BN_HITS_CLIENT_20110127 FROM BN_HITS_CLIENT_20110127;
