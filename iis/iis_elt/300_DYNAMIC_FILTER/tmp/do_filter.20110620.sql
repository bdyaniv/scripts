...
INSERT INTO BN_HITS_SP_20110620
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110620;

SELECT count(*) as BN_HITS_SP_20110620 FROM BN_HITS_SP_20110620;

TRUNCATE BN_HITS_CLIENT_20110620;
INSERT INTO BN_HITS_CLIENT_20110620
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110620;

SELECT count(*) as BN_HITS_CLIENT_20110620 FROM BN_HITS_CLIENT_20110620;
