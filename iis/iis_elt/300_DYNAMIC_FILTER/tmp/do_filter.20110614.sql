...
INSERT INTO BN_HITS_SP_20110614
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110614;

SELECT count(*) as BN_HITS_SP_20110614 FROM BN_HITS_SP_20110614;

TRUNCATE BN_HITS_CLIENT_20110614;
INSERT INTO BN_HITS_CLIENT_20110614
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110614;

SELECT count(*) as BN_HITS_CLIENT_20110614 FROM BN_HITS_CLIENT_20110614;
