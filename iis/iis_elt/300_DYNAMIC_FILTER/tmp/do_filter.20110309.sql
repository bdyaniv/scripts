...
INSERT INTO BN_HITS_SP_20110309
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110309;

SELECT count(*) as BN_HITS_SP_20110309 FROM BN_HITS_SP_20110309;

TRUNCATE BN_HITS_CLIENT_20110309;
INSERT INTO BN_HITS_CLIENT_20110309
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110309;

SELECT count(*) as BN_HITS_CLIENT_20110309 FROM BN_HITS_CLIENT_20110309;
