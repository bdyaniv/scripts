...
INSERT INTO BN_HITS_SP_20120102
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20120102;

SELECT count(*) as BN_HITS_SP_20120102 FROM BN_HITS_SP_20120102;

TRUNCATE BN_HITS_CLIENT_20120102;
INSERT INTO BN_HITS_CLIENT_20120102
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20120102;

SELECT count(*) as BN_HITS_CLIENT_20120102 FROM BN_HITS_CLIENT_20120102;
