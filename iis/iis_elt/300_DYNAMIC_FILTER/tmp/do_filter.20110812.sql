...
INSERT INTO BN_HITS_SP_20110812
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110812;

SELECT count(*) as BN_HITS_SP_20110812 FROM BN_HITS_SP_20110812;

TRUNCATE BN_HITS_CLIENT_20110812;
INSERT INTO BN_HITS_CLIENT_20110812
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110812;

SELECT count(*) as BN_HITS_CLIENT_20110812 FROM BN_HITS_CLIENT_20110812;
