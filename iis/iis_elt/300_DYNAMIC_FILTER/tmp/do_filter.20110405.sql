...
INSERT INTO BN_HITS_SP_20110405
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110405;

SELECT count(*) as BN_HITS_SP_20110405 FROM BN_HITS_SP_20110405;

TRUNCATE BN_HITS_CLIENT_20110405;
INSERT INTO BN_HITS_CLIENT_20110405
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110405;

SELECT count(*) as BN_HITS_CLIENT_20110405 FROM BN_HITS_CLIENT_20110405;
