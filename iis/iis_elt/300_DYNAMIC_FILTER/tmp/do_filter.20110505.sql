...
INSERT INTO BN_HITS_SP_20110505
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110505;

SELECT count(*) as BN_HITS_SP_20110505 FROM BN_HITS_SP_20110505;

TRUNCATE BN_HITS_CLIENT_20110505;
INSERT INTO BN_HITS_CLIENT_20110505
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110505;

SELECT count(*) as BN_HITS_CLIENT_20110505 FROM BN_HITS_CLIENT_20110505;
