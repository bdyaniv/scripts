...
INSERT INTO BN_HITS_SP_20110221
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110221;

SELECT count(*) as BN_HITS_SP_20110221 FROM BN_HITS_SP_20110221;

TRUNCATE BN_HITS_CLIENT_20110221;
INSERT INTO BN_HITS_CLIENT_20110221
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110221;

SELECT count(*) as BN_HITS_CLIENT_20110221 FROM BN_HITS_CLIENT_20110221;
