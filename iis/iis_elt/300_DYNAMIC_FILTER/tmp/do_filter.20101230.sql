...
INSERT INTO BN_HITS_SP_20101230
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101230;

SELECT count(*) as BN_HITS_SP_20101230 FROM BN_HITS_SP_20101230;

TRUNCATE BN_HITS_CLIENT_20101230;
INSERT INTO BN_HITS_CLIENT_20101230
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101230;

SELECT count(*) as BN_HITS_CLIENT_20101230 FROM BN_HITS_CLIENT_20101230;
