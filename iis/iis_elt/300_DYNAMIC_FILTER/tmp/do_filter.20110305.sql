...
INSERT INTO BN_HITS_SP_20110305
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110305;

SELECT count(*) as BN_HITS_SP_20110305 FROM BN_HITS_SP_20110305;

TRUNCATE BN_HITS_CLIENT_20110305;
INSERT INTO BN_HITS_CLIENT_20110305
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110305;

SELECT count(*) as BN_HITS_CLIENT_20110305 FROM BN_HITS_CLIENT_20110305;
