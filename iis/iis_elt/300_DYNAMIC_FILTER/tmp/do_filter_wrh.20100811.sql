...
/* S.SEQ_HIT_ID, */
 ...
 -- iis_mapping_cols trxm for RESOURCE_NAME
  ...
  UI_ACTION
FROM 
  web_resource_hits_2010_08_11
WHERE
  user_id is not null and
  hit_ts >= ('2010_08_11 0:0:0'::timestamp + interval '5 hours')
;
...
/* S.SEQ_HIT_ID, */
 ...
 -- iis_mapping_cols trxm for RESOURCE_NAME
  ...
  UI_ACTION
FROM 
  web_resource_hits_2010_08_12
WHERE
  user_id is not null and
  hit_ts < ('2010_08_12 00:00:00'::timestamp + interval '5 hours')
;
