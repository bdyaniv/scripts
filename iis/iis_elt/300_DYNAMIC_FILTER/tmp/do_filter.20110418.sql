...
INSERT INTO BN_HITS_SP_20110418
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110418;

SELECT count(*) as BN_HITS_SP_20110418 FROM BN_HITS_SP_20110418;

TRUNCATE BN_HITS_CLIENT_20110418;
INSERT INTO BN_HITS_CLIENT_20110418
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110418;

SELECT count(*) as BN_HITS_CLIENT_20110418 FROM BN_HITS_CLIENT_20110418;
