...
INSERT INTO BN_HITS_SP_20110813
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110813;

SELECT count(*) as BN_HITS_SP_20110813 FROM BN_HITS_SP_20110813;

TRUNCATE BN_HITS_CLIENT_20110813;
INSERT INTO BN_HITS_CLIENT_20110813
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110813;

SELECT count(*) as BN_HITS_CLIENT_20110813 FROM BN_HITS_CLIENT_20110813;
