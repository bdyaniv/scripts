...
INSERT INTO BN_HITS_SP_20110627
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110627;

SELECT count(*) as BN_HITS_SP_20110627 FROM BN_HITS_SP_20110627;

TRUNCATE BN_HITS_CLIENT_20110627;
INSERT INTO BN_HITS_CLIENT_20110627
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110627;

SELECT count(*) as BN_HITS_CLIENT_20110627 FROM BN_HITS_CLIENT_20110627;
