...
INSERT INTO BN_HITS_SP_20110610
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110610;

SELECT count(*) as BN_HITS_SP_20110610 FROM BN_HITS_SP_20110610;

TRUNCATE BN_HITS_CLIENT_20110610;
INSERT INTO BN_HITS_CLIENT_20110610
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110610;

SELECT count(*) as BN_HITS_CLIENT_20110610 FROM BN_HITS_CLIENT_20110610;
