...
INSERT INTO BN_HITS_SP_20110912
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110912;

SELECT count(*) as BN_HITS_SP_20110912 FROM BN_HITS_SP_20110912;

TRUNCATE BN_HITS_CLIENT_20110912;
INSERT INTO BN_HITS_CLIENT_20110912
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110912;

SELECT count(*) as BN_HITS_CLIENT_20110912 FROM BN_HITS_CLIENT_20110912;
