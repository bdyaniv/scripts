...
INSERT INTO BN_HITS_SP_20110310
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110310;

SELECT count(*) as BN_HITS_SP_20110310 FROM BN_HITS_SP_20110310;

TRUNCATE BN_HITS_CLIENT_20110310;
INSERT INTO BN_HITS_CLIENT_20110310
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110310;

SELECT count(*) as BN_HITS_CLIENT_20110310 FROM BN_HITS_CLIENT_20110310;
