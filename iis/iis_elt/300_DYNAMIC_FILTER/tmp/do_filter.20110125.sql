...
INSERT INTO BN_HITS_SP_20110125
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110125;

SELECT count(*) as BN_HITS_SP_20110125 FROM BN_HITS_SP_20110125;

TRUNCATE BN_HITS_CLIENT_20110125;
INSERT INTO BN_HITS_CLIENT_20110125
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110125;

SELECT count(*) as BN_HITS_CLIENT_20110125 FROM BN_HITS_CLIENT_20110125;
