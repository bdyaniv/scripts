...
INSERT INTO BN_HITS_SP_20120103
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20120103;

SELECT count(*) as BN_HITS_SP_20120103 FROM BN_HITS_SP_20120103;

TRUNCATE BN_HITS_CLIENT_20120103;
INSERT INTO BN_HITS_CLIENT_20120103
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20120103;

SELECT count(*) as BN_HITS_CLIENT_20120103 FROM BN_HITS_CLIENT_20120103;
