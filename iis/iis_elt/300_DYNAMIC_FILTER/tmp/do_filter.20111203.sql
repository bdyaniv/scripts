...
INSERT INTO BN_HITS_SP_20111203
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111203;

SELECT count(*) as BN_HITS_SP_20111203 FROM BN_HITS_SP_20111203;

TRUNCATE BN_HITS_CLIENT_20111203;
INSERT INTO BN_HITS_CLIENT_20111203
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111203;

SELECT count(*) as BN_HITS_CLIENT_20111203 FROM BN_HITS_CLIENT_20111203;
