...
INSERT INTO BN_HITS_SP_20110105
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110105;

SELECT count(*) as BN_HITS_SP_20110105 FROM BN_HITS_SP_20110105;

TRUNCATE BN_HITS_CLIENT_20110105;
INSERT INTO BN_HITS_CLIENT_20110105
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110105;

SELECT count(*) as BN_HITS_CLIENT_20110105 FROM BN_HITS_CLIENT_20110105;
