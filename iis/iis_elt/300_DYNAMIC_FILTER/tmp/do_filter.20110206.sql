...
INSERT INTO BN_HITS_SP_20110206
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110206;

SELECT count(*) as BN_HITS_SP_20110206 FROM BN_HITS_SP_20110206;

TRUNCATE BN_HITS_CLIENT_20110206;
INSERT INTO BN_HITS_CLIENT_20110206
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110206;

SELECT count(*) as BN_HITS_CLIENT_20110206 FROM BN_HITS_CLIENT_20110206;
