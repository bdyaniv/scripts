...
INSERT INTO BN_HITS_SP_20101226
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101226;

SELECT count(*) as BN_HITS_SP_20101226 FROM BN_HITS_SP_20101226;

TRUNCATE BN_HITS_CLIENT_20101226;
INSERT INTO BN_HITS_CLIENT_20101226
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101226;

SELECT count(*) as BN_HITS_CLIENT_20101226 FROM BN_HITS_CLIENT_20101226;
