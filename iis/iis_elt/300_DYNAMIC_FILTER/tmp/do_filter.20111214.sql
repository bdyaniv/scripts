...
INSERT INTO BN_HITS_SP_20111214
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111214;

SELECT count(*) as BN_HITS_SP_20111214 FROM BN_HITS_SP_20111214;

TRUNCATE BN_HITS_CLIENT_20111214;
INSERT INTO BN_HITS_CLIENT_20111214
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111214;

SELECT count(*) as BN_HITS_CLIENT_20111214 FROM BN_HITS_CLIENT_20111214;
