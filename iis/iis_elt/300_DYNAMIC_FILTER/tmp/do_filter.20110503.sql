...
INSERT INTO BN_HITS_SP_20110503
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110503;

SELECT count(*) as BN_HITS_SP_20110503 FROM BN_HITS_SP_20110503;

TRUNCATE BN_HITS_CLIENT_20110503;
INSERT INTO BN_HITS_CLIENT_20110503
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110503;

SELECT count(*) as BN_HITS_CLIENT_20110503 FROM BN_HITS_CLIENT_20110503;
