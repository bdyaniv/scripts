...
INSERT INTO BN_HITS_SP_20110223
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110223;

SELECT count(*) as BN_HITS_SP_20110223 FROM BN_HITS_SP_20110223;

TRUNCATE BN_HITS_CLIENT_20110223;
INSERT INTO BN_HITS_CLIENT_20110223
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110223;

SELECT count(*) as BN_HITS_CLIENT_20110223 FROM BN_HITS_CLIENT_20110223;
