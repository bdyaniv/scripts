...
INSERT INTO BN_HITS_SP_20110702
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110702;

SELECT count(*) as BN_HITS_SP_20110702 FROM BN_HITS_SP_20110702;

TRUNCATE BN_HITS_CLIENT_20110702;
INSERT INTO BN_HITS_CLIENT_20110702
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110702;

SELECT count(*) as BN_HITS_CLIENT_20110702 FROM BN_HITS_CLIENT_20110702;
