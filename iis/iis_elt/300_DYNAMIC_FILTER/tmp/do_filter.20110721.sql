...
INSERT INTO BN_HITS_SP_20110721
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110721;

SELECT count(*) as BN_HITS_SP_20110721 FROM BN_HITS_SP_20110721;

TRUNCATE BN_HITS_CLIENT_20110721;
INSERT INTO BN_HITS_CLIENT_20110721
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110721;

SELECT count(*) as BN_HITS_CLIENT_20110721 FROM BN_HITS_CLIENT_20110721;
