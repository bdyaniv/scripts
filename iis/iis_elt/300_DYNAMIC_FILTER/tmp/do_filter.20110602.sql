...
INSERT INTO BN_HITS_SP_20110602
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110602;

SELECT count(*) as BN_HITS_SP_20110602 FROM BN_HITS_SP_20110602;

TRUNCATE BN_HITS_CLIENT_20110602;
INSERT INTO BN_HITS_CLIENT_20110602
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110602;

SELECT count(*) as BN_HITS_CLIENT_20110602 FROM BN_HITS_CLIENT_20110602;
