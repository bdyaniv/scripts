...
INSERT INTO BN_HITS_SP_20110425
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110425;

SELECT count(*) as BN_HITS_SP_20110425 FROM BN_HITS_SP_20110425;

TRUNCATE BN_HITS_CLIENT_20110425;
INSERT INTO BN_HITS_CLIENT_20110425
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110425;

SELECT count(*) as BN_HITS_CLIENT_20110425 FROM BN_HITS_CLIENT_20110425;
