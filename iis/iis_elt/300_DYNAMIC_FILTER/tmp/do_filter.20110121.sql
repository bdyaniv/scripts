...
INSERT INTO BN_HITS_SP_20110121
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110121;

SELECT count(*) as BN_HITS_SP_20110121 FROM BN_HITS_SP_20110121;

TRUNCATE BN_HITS_CLIENT_20110121;
INSERT INTO BN_HITS_CLIENT_20110121
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110121;

SELECT count(*) as BN_HITS_CLIENT_20110121 FROM BN_HITS_CLIENT_20110121;
