...
INSERT INTO BN_HITS_SP_20110613
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110613;

SELECT count(*) as BN_HITS_SP_20110613 FROM BN_HITS_SP_20110613;

TRUNCATE BN_HITS_CLIENT_20110613;
INSERT INTO BN_HITS_CLIENT_20110613
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110613;

SELECT count(*) as BN_HITS_CLIENT_20110613 FROM BN_HITS_CLIENT_20110613;
