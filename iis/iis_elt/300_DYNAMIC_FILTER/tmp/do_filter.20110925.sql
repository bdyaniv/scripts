...
INSERT INTO BN_HITS_SP_20110925
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110925;

SELECT count(*) as BN_HITS_SP_20110925 FROM BN_HITS_SP_20110925;

TRUNCATE BN_HITS_CLIENT_20110925;
INSERT INTO BN_HITS_CLIENT_20110925
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110925;

SELECT count(*) as BN_HITS_CLIENT_20110925 FROM BN_HITS_CLIENT_20110925;
