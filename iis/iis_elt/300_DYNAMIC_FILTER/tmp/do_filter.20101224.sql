...
INSERT INTO BN_HITS_SP_20101224
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101224;

SELECT count(*) as BN_HITS_SP_20101224 FROM BN_HITS_SP_20101224;

TRUNCATE BN_HITS_CLIENT_20101224;
INSERT INTO BN_HITS_CLIENT_20101224
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101224;

SELECT count(*) as BN_HITS_CLIENT_20101224 FROM BN_HITS_CLIENT_20101224;
