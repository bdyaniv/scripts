...
INSERT INTO BN_HITS_SP_20111204
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111204;

SELECT count(*) as BN_HITS_SP_20111204 FROM BN_HITS_SP_20111204;

TRUNCATE BN_HITS_CLIENT_20111204;
INSERT INTO BN_HITS_CLIENT_20111204
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111204;

SELECT count(*) as BN_HITS_CLIENT_20111204 FROM BN_HITS_CLIENT_20111204;
