...
INSERT INTO BN_HITS_SP_20111220
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111220;

SELECT count(*) as BN_HITS_SP_20111220 FROM BN_HITS_SP_20111220;

TRUNCATE BN_HITS_CLIENT_20111220;
INSERT INTO BN_HITS_CLIENT_20111220
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111220;

SELECT count(*) as BN_HITS_CLIENT_20111220 FROM BN_HITS_CLIENT_20111220;
