...
INSERT INTO BN_HITS_SP_20110110
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110110;

SELECT count(*) as BN_HITS_SP_20110110 FROM BN_HITS_SP_20110110;

TRUNCATE BN_HITS_CLIENT_20110110;
INSERT INTO BN_HITS_CLIENT_20110110
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110110;

SELECT count(*) as BN_HITS_CLIENT_20110110 FROM BN_HITS_CLIENT_20110110;
