...
INSERT INTO BN_HITS_SP_20101123
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101123;

SELECT count(*) as BN_HITS_SP_20101123 FROM BN_HITS_SP_20101123;

TRUNCATE BN_HITS_CLIENT_20101123;
INSERT INTO BN_HITS_CLIENT_20101123
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101123;

SELECT count(*) as BN_HITS_CLIENT_20101123 FROM BN_HITS_CLIENT_20101123;
