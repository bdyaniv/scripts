...
INSERT INTO BN_HITS_SP_20110624
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110624;

SELECT count(*) as BN_HITS_SP_20110624 FROM BN_HITS_SP_20110624;

TRUNCATE BN_HITS_CLIENT_20110624;
INSERT INTO BN_HITS_CLIENT_20110624
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110624;

SELECT count(*) as BN_HITS_CLIENT_20110624 FROM BN_HITS_CLIENT_20110624;
