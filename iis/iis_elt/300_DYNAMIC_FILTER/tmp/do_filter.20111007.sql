...
INSERT INTO BN_HITS_SP_20111007
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111007;

SELECT count(*) as BN_HITS_SP_20111007 FROM BN_HITS_SP_20111007;

TRUNCATE BN_HITS_CLIENT_20111007;
INSERT INTO BN_HITS_CLIENT_20111007
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111007;

SELECT count(*) as BN_HITS_CLIENT_20111007 FROM BN_HITS_CLIENT_20111007;
