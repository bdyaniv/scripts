...
INSERT INTO BN_HITS_SP_20121103
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20121103;

SELECT count(*) as BN_HITS_SP_20121103 FROM BN_HITS_SP_20121103;

TRUNCATE BN_HITS_CLIENT_20121103;
INSERT INTO BN_HITS_CLIENT_20121103
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20121103;

SELECT count(*) as BN_HITS_CLIENT_20121103 FROM BN_HITS_CLIENT_20121103;
