...
INSERT INTO BN_HITS_SP_20110907
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110907;

SELECT count(*) as BN_HITS_SP_20110907 FROM BN_HITS_SP_20110907;

TRUNCATE BN_HITS_CLIENT_20110907;
INSERT INTO BN_HITS_CLIENT_20110907
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110907;

SELECT count(*) as BN_HITS_CLIENT_20110907 FROM BN_HITS_CLIENT_20110907;
