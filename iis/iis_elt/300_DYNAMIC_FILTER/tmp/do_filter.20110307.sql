...
INSERT INTO BN_HITS_SP_20110307
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110307;

SELECT count(*) as BN_HITS_SP_20110307 FROM BN_HITS_SP_20110307;

TRUNCATE BN_HITS_CLIENT_20110307;
INSERT INTO BN_HITS_CLIENT_20110307
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110307;

SELECT count(*) as BN_HITS_CLIENT_20110307 FROM BN_HITS_CLIENT_20110307;
