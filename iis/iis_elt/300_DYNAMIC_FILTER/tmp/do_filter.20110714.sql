...
INSERT INTO BN_HITS_SP_20110714
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110714;

SELECT count(*) as BN_HITS_SP_20110714 FROM BN_HITS_SP_20110714;

TRUNCATE BN_HITS_CLIENT_20110714;
INSERT INTO BN_HITS_CLIENT_20110714
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110714;

SELECT count(*) as BN_HITS_CLIENT_20110714 FROM BN_HITS_CLIENT_20110714;
