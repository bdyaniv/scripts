...
INSERT INTO BN_HITS_SP_20110403
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110403;

SELECT count(*) as BN_HITS_SP_20110403 FROM BN_HITS_SP_20110403;

TRUNCATE BN_HITS_CLIENT_20110403;
INSERT INTO BN_HITS_CLIENT_20110403
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110403;

SELECT count(*) as BN_HITS_CLIENT_20110403 FROM BN_HITS_CLIENT_20110403;
