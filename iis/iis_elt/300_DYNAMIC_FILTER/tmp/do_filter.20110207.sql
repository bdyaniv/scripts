...
INSERT INTO BN_HITS_SP_20110207
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110207;

SELECT count(*) as BN_HITS_SP_20110207 FROM BN_HITS_SP_20110207;

TRUNCATE BN_HITS_CLIENT_20110207;
INSERT INTO BN_HITS_CLIENT_20110207
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110207;

SELECT count(*) as BN_HITS_CLIENT_20110207 FROM BN_HITS_CLIENT_20110207;
