...
INSERT INTO BN_HITS_SP_20101216
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20101216;

SELECT count(*) as BN_HITS_SP_20101216 FROM BN_HITS_SP_20101216;

TRUNCATE BN_HITS_CLIENT_20101216;
INSERT INTO BN_HITS_CLIENT_20101216
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20101216;

SELECT count(*) as BN_HITS_CLIENT_20101216 FROM BN_HITS_CLIENT_20101216;
