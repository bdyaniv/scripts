...
INSERT INTO BN_HITS_SP_20110412
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110412;

SELECT count(*) as BN_HITS_SP_20110412 FROM BN_HITS_SP_20110412;

TRUNCATE BN_HITS_CLIENT_20110412;
INSERT INTO BN_HITS_CLIENT_20110412
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110412;

SELECT count(*) as BN_HITS_CLIENT_20110412 FROM BN_HITS_CLIENT_20110412;
