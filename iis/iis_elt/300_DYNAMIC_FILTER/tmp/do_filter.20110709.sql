...
INSERT INTO BN_HITS_SP_20110709
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110709;

SELECT count(*) as BN_HITS_SP_20110709 FROM BN_HITS_SP_20110709;

TRUNCATE BN_HITS_CLIENT_20110709;
INSERT INTO BN_HITS_CLIENT_20110709
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110709;

SELECT count(*) as BN_HITS_CLIENT_20110709 FROM BN_HITS_CLIENT_20110709;
