...
INSERT INTO BN_HITS_SP_20110313
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110313;

SELECT count(*) as BN_HITS_SP_20110313 FROM BN_HITS_SP_20110313;

TRUNCATE BN_HITS_CLIENT_20110313;
INSERT INTO BN_HITS_CLIENT_20110313
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110313;

SELECT count(*) as BN_HITS_CLIENT_20110313 FROM BN_HITS_CLIENT_20110313;
