...
INSERT INTO BN_HITS_SP_20110814
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110814;

SELECT count(*) as BN_HITS_SP_20110814 FROM BN_HITS_SP_20110814;

TRUNCATE BN_HITS_CLIENT_20110814;
INSERT INTO BN_HITS_CLIENT_20110814
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110814;

SELECT count(*) as BN_HITS_CLIENT_20110814 FROM BN_HITS_CLIENT_20110814;
