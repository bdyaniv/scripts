...
INSERT INTO BN_HITS_SP_20111028
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111028;

SELECT count(*) as BN_HITS_SP_20111028 FROM BN_HITS_SP_20111028;

TRUNCATE BN_HITS_CLIENT_20111028;
INSERT INTO BN_HITS_CLIENT_20111028
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111028;

SELECT count(*) as BN_HITS_CLIENT_20111028 FROM BN_HITS_CLIENT_20111028;
