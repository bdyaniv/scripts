...
INSERT INTO BN_HITS_SP_20110406
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110406;

SELECT count(*) as BN_HITS_SP_20110406 FROM BN_HITS_SP_20110406;

TRUNCATE BN_HITS_CLIENT_20110406;
INSERT INTO BN_HITS_CLIENT_20110406
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110406;

SELECT count(*) as BN_HITS_CLIENT_20110406 FROM BN_HITS_CLIENT_20110406;
