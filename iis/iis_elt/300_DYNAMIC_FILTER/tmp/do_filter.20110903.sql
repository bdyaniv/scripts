...
INSERT INTO BN_HITS_SP_20110903
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110903;

SELECT count(*) as BN_HITS_SP_20110903 FROM BN_HITS_SP_20110903;

TRUNCATE BN_HITS_CLIENT_20110903;
INSERT INTO BN_HITS_CLIENT_20110903
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110903;

SELECT count(*) as BN_HITS_CLIENT_20110903 FROM BN_HITS_CLIENT_20110903;
