...
INSERT INTO BN_HITS_SP_20111121
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20111121;

SELECT count(*) as BN_HITS_SP_20111121 FROM BN_HITS_SP_20111121;

TRUNCATE BN_HITS_CLIENT_20111121;
INSERT INTO BN_HITS_CLIENT_20111121
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20111121;

SELECT count(*) as BN_HITS_CLIENT_20111121 FROM BN_HITS_CLIENT_20111121;
