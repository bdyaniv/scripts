...
INSERT INTO BN_HITS_SP_20120211
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20120211;

SELECT count(*) as BN_HITS_SP_20120211 FROM BN_HITS_SP_20120211;

TRUNCATE BN_HITS_CLIENT_20120211;
INSERT INTO BN_HITS_CLIENT_20120211
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20120211;

SELECT count(*) as BN_HITS_CLIENT_20120211 FROM BN_HITS_CLIENT_20120211;
