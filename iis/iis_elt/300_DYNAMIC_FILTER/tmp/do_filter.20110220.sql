...
INSERT INTO BN_HITS_SP_20110220
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110220;

SELECT count(*) as BN_HITS_SP_20110220 FROM BN_HITS_SP_20110220;

TRUNCATE BN_HITS_CLIENT_20110220;
INSERT INTO BN_HITS_CLIENT_20110220
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110220;

SELECT count(*) as BN_HITS_CLIENT_20110220 FROM BN_HITS_CLIENT_20110220;
