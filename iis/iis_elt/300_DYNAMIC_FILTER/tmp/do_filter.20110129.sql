...
INSERT INTO BN_HITS_SP_20110129
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110129;

SELECT count(*) as BN_HITS_SP_20110129 FROM BN_HITS_SP_20110129;

TRUNCATE BN_HITS_CLIENT_20110129;
INSERT INTO BN_HITS_CLIENT_20110129
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110129;

SELECT count(*) as BN_HITS_CLIENT_20110129 FROM BN_HITS_CLIENT_20110129;
