...
INSERT INTO BN_HITS_SP_20110626
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_SP_20110626;

SELECT count(*) as BN_HITS_SP_20110626 FROM BN_HITS_SP_20110626;

TRUNCATE BN_HITS_CLIENT_20110626;
INSERT INTO BN_HITS_CLIENT_20110626
(
  HIT_TIMESTAMP,
  USER_ID      ,
  IP_ADDRESS   ,
...
ANALYZE BN_HITS_CLIENT_20110626;

SELECT count(*) as BN_HITS_CLIENT_20110626 FROM BN_HITS_CLIENT_20110626;
