...
/* S.SEQ_HIT_ID, */
 ...
 -- iis_mapping_cols trxm for RESOURCE_NAME
  ...
  UI_ACTION
FROM 
  web_resource_hits_%CUR_YYYY-MM-DD%
WHERE
  user_id is not null and
  hit_ts >= ('%CUR_YYYY-MM-DD% 0:0:0'::timestamp + interval '5 hours')
;
...
/* S.SEQ_HIT_ID, */
 ...
 -- iis_mapping_cols trxm for RESOURCE_NAME
  ...
  UI_ACTION
FROM 
  web_resource_hits_%NEXT_YYYY-MM-DD%
WHERE
  user_id is not null and
  hit_ts < ('%NEXT_YYYY-MM-DD% 00:00:00'::timestamp + interval '5 hours')
;
