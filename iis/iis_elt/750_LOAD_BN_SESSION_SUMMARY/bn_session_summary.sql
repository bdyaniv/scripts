...
WHERE 
   ...
   a.visit_date = '%CUR_YYYYMMDD%'::date
;

TRUNCATE SESSION_SUMMARY_%CUR_YYYYMMDD%;
INSERT INTO SESSION_SUMMARY_%CUR_YYYYMMDD%
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_%CUR_YYYYMMDD%;
SELECT count(*) from SESSION_SUMMARY_%CUR_YYYYMMDD%;
END;
