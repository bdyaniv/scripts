...
WHERE 
   ...
   a.visit_date = '20100817'::date
;

TRUNCATE SESSION_SUMMARY_20100817;
INSERT INTO SESSION_SUMMARY_20100817
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100817;
SELECT count(*) from SESSION_SUMMARY_20100817;
END;
