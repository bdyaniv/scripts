...
WHERE 
   ...
   a.visit_date = '20111220'::date
;

TRUNCATE SESSION_SUMMARY_20111220;
INSERT INTO SESSION_SUMMARY_20111220
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111220;
SELECT count(*) from SESSION_SUMMARY_20111220;
END;
