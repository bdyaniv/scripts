...
WHERE 
   ...
   a.visit_date = '20110921'::date
;

TRUNCATE SESSION_SUMMARY_20110921;
INSERT INTO SESSION_SUMMARY_20110921
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110921;
SELECT count(*) from SESSION_SUMMARY_20110921;
END;
