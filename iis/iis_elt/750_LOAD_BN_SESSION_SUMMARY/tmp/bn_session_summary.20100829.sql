...
WHERE 
   ...
   a.visit_date = '20100829'::date
;

TRUNCATE SESSION_SUMMARY_20100829;
INSERT INTO SESSION_SUMMARY_20100829
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100829;
SELECT count(*) from SESSION_SUMMARY_20100829;
END;
