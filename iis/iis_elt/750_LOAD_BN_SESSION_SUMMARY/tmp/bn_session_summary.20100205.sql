...
WHERE 
   ...
   a.visit_date = '20100205'::date
;

TRUNCATE SESSION_SUMMARY_20100205;
INSERT INTO SESSION_SUMMARY_20100205
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100205;
SELECT count(*) from SESSION_SUMMARY_20100205;
END;
