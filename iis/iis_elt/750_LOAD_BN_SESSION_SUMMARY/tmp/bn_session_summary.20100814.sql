...
WHERE 
   ...
   a.visit_date = '20100814'::date
;

TRUNCATE SESSION_SUMMARY_20100814;
INSERT INTO SESSION_SUMMARY_20100814
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100814;
SELECT count(*) from SESSION_SUMMARY_20100814;
END;
