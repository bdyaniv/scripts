...
WHERE 
   ...
   a.visit_date = '20100228'::date
;

TRUNCATE SESSION_SUMMARY_20100228;
INSERT INTO SESSION_SUMMARY_20100228
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100228;
SELECT count(*) from SESSION_SUMMARY_20100228;
END;
