...
WHERE 
   ...
   a.visit_date = '20100611'::date
;

TRUNCATE SESSION_SUMMARY_20100611;
INSERT INTO SESSION_SUMMARY_20100611
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100611;
SELECT count(*) from SESSION_SUMMARY_20100611;
END;
