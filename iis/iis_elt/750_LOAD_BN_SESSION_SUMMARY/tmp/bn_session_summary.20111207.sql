...
WHERE 
   ...
   a.visit_date = '20111207'::date
;

TRUNCATE SESSION_SUMMARY_20111207;
INSERT INTO SESSION_SUMMARY_20111207
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111207;
SELECT count(*) from SESSION_SUMMARY_20111207;
END;
