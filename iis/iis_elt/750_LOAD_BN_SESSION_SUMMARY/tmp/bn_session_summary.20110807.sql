...
WHERE 
   ...
   a.visit_date = '20110807'::date
;

TRUNCATE SESSION_SUMMARY_20110807;
INSERT INTO SESSION_SUMMARY_20110807
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110807;
SELECT count(*) from SESSION_SUMMARY_20110807;
END;
