...
WHERE 
   ...
   a.visit_date = '20110622'::date
;

TRUNCATE SESSION_SUMMARY_20110622;
INSERT INTO SESSION_SUMMARY_20110622
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110622;
SELECT count(*) from SESSION_SUMMARY_20110622;
END;
