...
WHERE 
   ...
   a.visit_date = '20101102'::date
;

TRUNCATE SESSION_SUMMARY_20101102;
INSERT INTO SESSION_SUMMARY_20101102
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101102;
SELECT count(*) from SESSION_SUMMARY_20101102;
END;
