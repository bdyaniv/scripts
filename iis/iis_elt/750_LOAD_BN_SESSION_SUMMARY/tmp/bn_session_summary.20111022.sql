...
WHERE 
   ...
   a.visit_date = '20111022'::date
;

TRUNCATE SESSION_SUMMARY_20111022;
INSERT INTO SESSION_SUMMARY_20111022
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111022;
SELECT count(*) from SESSION_SUMMARY_20111022;
END;
