...
WHERE 
   ...
   a.visit_date = '20110418'::date
;

TRUNCATE SESSION_SUMMARY_20110418;
INSERT INTO SESSION_SUMMARY_20110418
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110418;
SELECT count(*) from SESSION_SUMMARY_20110418;
END;
