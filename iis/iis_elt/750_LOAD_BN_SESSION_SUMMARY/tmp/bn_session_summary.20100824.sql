...
WHERE 
   ...
   a.visit_date = '20100824'::date
;

TRUNCATE SESSION_SUMMARY_20100824;
INSERT INTO SESSION_SUMMARY_20100824
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100824;
SELECT count(*) from SESSION_SUMMARY_20100824;
END;
