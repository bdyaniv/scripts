...
WHERE 
   ...
   a.visit_date = '20100605'::date
;

TRUNCATE SESSION_SUMMARY_20100605;
INSERT INTO SESSION_SUMMARY_20100605
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100605;
SELECT count(*) from SESSION_SUMMARY_20100605;
END;
