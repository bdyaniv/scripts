...
WHERE 
   ...
   a.visit_date = '20100403'::date
;

TRUNCATE SESSION_SUMMARY_20100403;
INSERT INTO SESSION_SUMMARY_20100403
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100403;
SELECT count(*) from SESSION_SUMMARY_20100403;
END;
