...
WHERE 
   ...
   a.visit_date = '20101105'::date
;

TRUNCATE SESSION_SUMMARY_20101105;
INSERT INTO SESSION_SUMMARY_20101105
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101105;
SELECT count(*) from SESSION_SUMMARY_20101105;
END;
