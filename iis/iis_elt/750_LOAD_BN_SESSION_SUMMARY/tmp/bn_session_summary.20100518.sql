...
WHERE 
   ...
   a.visit_date = '20100518'::date
;

TRUNCATE SESSION_SUMMARY_20100518;
INSERT INTO SESSION_SUMMARY_20100518
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100518;
SELECT count(*) from SESSION_SUMMARY_20100518;
END;
