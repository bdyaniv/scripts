...
WHERE 
   ...
   a.visit_date = '20100430'::date
;

TRUNCATE SESSION_SUMMARY_20100430;
INSERT INTO SESSION_SUMMARY_20100430
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100430;
SELECT count(*) from SESSION_SUMMARY_20100430;
END;
