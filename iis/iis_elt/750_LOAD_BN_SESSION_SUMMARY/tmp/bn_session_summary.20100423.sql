...
WHERE 
   ...
   a.visit_date = '20100423'::date
;

TRUNCATE SESSION_SUMMARY_20100423;
INSERT INTO SESSION_SUMMARY_20100423
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100423;
SELECT count(*) from SESSION_SUMMARY_20100423;
END;
