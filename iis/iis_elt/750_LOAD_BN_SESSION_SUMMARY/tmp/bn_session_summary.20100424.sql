...
WHERE 
   ...
   a.visit_date = '20100424'::date
;

TRUNCATE SESSION_SUMMARY_20100424;
INSERT INTO SESSION_SUMMARY_20100424
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100424;
SELECT count(*) from SESSION_SUMMARY_20100424;
END;
