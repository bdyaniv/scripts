...
WHERE 
   ...
   a.visit_date = '20100927'::date
;

TRUNCATE SESSION_SUMMARY_20100927;
INSERT INTO SESSION_SUMMARY_20100927
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100927;
SELECT count(*) from SESSION_SUMMARY_20100927;
END;
