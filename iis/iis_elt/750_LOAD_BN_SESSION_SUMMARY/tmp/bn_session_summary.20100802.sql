...
WHERE 
   ...
   a.visit_date = '20100802'::date
;

TRUNCATE SESSION_SUMMARY_20100802;
INSERT INTO SESSION_SUMMARY_20100802
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100802;
SELECT count(*) from SESSION_SUMMARY_20100802;
END;
