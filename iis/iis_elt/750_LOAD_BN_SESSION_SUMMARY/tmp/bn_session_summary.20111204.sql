...
WHERE 
   ...
   a.visit_date = '20111204'::date
;

TRUNCATE SESSION_SUMMARY_20111204;
INSERT INTO SESSION_SUMMARY_20111204
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111204;
SELECT count(*) from SESSION_SUMMARY_20111204;
END;
