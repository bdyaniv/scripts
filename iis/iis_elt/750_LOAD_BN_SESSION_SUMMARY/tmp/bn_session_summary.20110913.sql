...
WHERE 
   ...
   a.visit_date = '20110913'::date
;

TRUNCATE SESSION_SUMMARY_20110913;
INSERT INTO SESSION_SUMMARY_20110913
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110913;
SELECT count(*) from SESSION_SUMMARY_20110913;
END;
