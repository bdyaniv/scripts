...
WHERE 
   ...
   a.visit_date = '20110428'::date
;

TRUNCATE SESSION_SUMMARY_20110428;
INSERT INTO SESSION_SUMMARY_20110428
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110428;
SELECT count(*) from SESSION_SUMMARY_20110428;
END;
