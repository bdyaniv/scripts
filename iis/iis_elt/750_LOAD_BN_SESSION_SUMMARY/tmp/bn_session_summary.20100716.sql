...
WHERE 
   ...
   a.visit_date = '20100716'::date
;

TRUNCATE SESSION_SUMMARY_20100716;
INSERT INTO SESSION_SUMMARY_20100716
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100716;
SELECT count(*) from SESSION_SUMMARY_20100716;
END;
