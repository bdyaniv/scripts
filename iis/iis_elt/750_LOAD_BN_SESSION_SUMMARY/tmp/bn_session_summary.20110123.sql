...
WHERE 
   ...
   a.visit_date = '20110123'::date
;

TRUNCATE SESSION_SUMMARY_20110123;
INSERT INTO SESSION_SUMMARY_20110123
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110123;
SELECT count(*) from SESSION_SUMMARY_20110123;
END;
