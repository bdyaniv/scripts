...
WHERE 
   ...
   a.visit_date = '20110305'::date
;

TRUNCATE SESSION_SUMMARY_20110305;
INSERT INTO SESSION_SUMMARY_20110305
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110305;
SELECT count(*) from SESSION_SUMMARY_20110305;
END;
