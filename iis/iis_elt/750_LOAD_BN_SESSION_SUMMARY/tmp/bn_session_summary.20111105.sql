...
WHERE 
   ...
   a.visit_date = '20111105'::date
;

TRUNCATE SESSION_SUMMARY_20111105;
INSERT INTO SESSION_SUMMARY_20111105
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111105;
SELECT count(*) from SESSION_SUMMARY_20111105;
END;
