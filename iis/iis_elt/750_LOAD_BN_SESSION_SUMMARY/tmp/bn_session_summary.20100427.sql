...
WHERE 
   ...
   a.visit_date = '20100427'::date
;

TRUNCATE SESSION_SUMMARY_20100427;
INSERT INTO SESSION_SUMMARY_20100427
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100427;
SELECT count(*) from SESSION_SUMMARY_20100427;
END;
