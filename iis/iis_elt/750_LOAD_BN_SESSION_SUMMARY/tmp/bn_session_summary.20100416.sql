...
WHERE 
   ...
   a.visit_date = '20100416'::date
;

TRUNCATE SESSION_SUMMARY_20100416;
INSERT INTO SESSION_SUMMARY_20100416
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100416;
SELECT count(*) from SESSION_SUMMARY_20100416;
END;
