...
WHERE 
   ...
   a.visit_date = '20101212'::date
;

TRUNCATE SESSION_SUMMARY_20101212;
INSERT INTO SESSION_SUMMARY_20101212
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101212;
SELECT count(*) from SESSION_SUMMARY_20101212;
END;
