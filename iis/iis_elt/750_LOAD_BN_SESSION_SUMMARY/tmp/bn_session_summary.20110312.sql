...
WHERE 
   ...
   a.visit_date = '20110312'::date
;

TRUNCATE SESSION_SUMMARY_20110312;
INSERT INTO SESSION_SUMMARY_20110312
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110312;
SELECT count(*) from SESSION_SUMMARY_20110312;
END;
