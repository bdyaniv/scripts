...
WHERE 
   ...
   a.visit_date = '20111020'::date
;

TRUNCATE SESSION_SUMMARY_20111020;
INSERT INTO SESSION_SUMMARY_20111020
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111020;
SELECT count(*) from SESSION_SUMMARY_20111020;
END;
