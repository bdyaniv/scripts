...
WHERE 
   ...
   a.visit_date = '20110620'::date
;

TRUNCATE SESSION_SUMMARY_20110620;
INSERT INTO SESSION_SUMMARY_20110620
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110620;
SELECT count(*) from SESSION_SUMMARY_20110620;
END;
