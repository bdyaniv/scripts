...
WHERE 
   ...
   a.visit_date = '20111025'::date
;

TRUNCATE SESSION_SUMMARY_20111025;
INSERT INTO SESSION_SUMMARY_20111025
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111025;
SELECT count(*) from SESSION_SUMMARY_20111025;
END;
