...
WHERE 
   ...
   a.visit_date = '20110601'::date
;

TRUNCATE SESSION_SUMMARY_20110601;
INSERT INTO SESSION_SUMMARY_20110601
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110601;
SELECT count(*) from SESSION_SUMMARY_20110601;
END;
