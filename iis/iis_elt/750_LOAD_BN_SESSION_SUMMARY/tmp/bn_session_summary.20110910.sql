...
WHERE 
   ...
   a.visit_date = '20110910'::date
;

TRUNCATE SESSION_SUMMARY_20110910;
INSERT INTO SESSION_SUMMARY_20110910
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110910;
SELECT count(*) from SESSION_SUMMARY_20110910;
END;
