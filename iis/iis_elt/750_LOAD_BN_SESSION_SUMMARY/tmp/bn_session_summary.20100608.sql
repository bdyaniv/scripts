...
WHERE 
   ...
   a.visit_date = '20100608'::date
;

TRUNCATE SESSION_SUMMARY_20100608;
INSERT INTO SESSION_SUMMARY_20100608
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100608;
SELECT count(*) from SESSION_SUMMARY_20100608;
END;
