...
WHERE 
   ...
   a.visit_date = '20100730'::date
;

TRUNCATE SESSION_SUMMARY_20100730;
INSERT INTO SESSION_SUMMARY_20100730
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100730;
SELECT count(*) from SESSION_SUMMARY_20100730;
END;
