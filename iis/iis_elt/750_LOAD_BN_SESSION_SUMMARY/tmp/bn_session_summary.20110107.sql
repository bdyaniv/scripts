...
WHERE 
   ...
   a.visit_date = '20110107'::date
;

TRUNCATE SESSION_SUMMARY_20110107;
INSERT INTO SESSION_SUMMARY_20110107
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110107;
SELECT count(*) from SESSION_SUMMARY_20110107;
END;
