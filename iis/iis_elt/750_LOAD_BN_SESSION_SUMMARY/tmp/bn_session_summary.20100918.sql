...
WHERE 
   ...
   a.visit_date = '20100918'::date
;

TRUNCATE SESSION_SUMMARY_20100918;
INSERT INTO SESSION_SUMMARY_20100918
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100918;
SELECT count(*) from SESSION_SUMMARY_20100918;
END;
