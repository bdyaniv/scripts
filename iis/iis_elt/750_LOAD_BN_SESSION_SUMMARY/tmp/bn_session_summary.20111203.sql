...
WHERE 
   ...
   a.visit_date = '20111203'::date
;

TRUNCATE SESSION_SUMMARY_20111203;
INSERT INTO SESSION_SUMMARY_20111203
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111203;
SELECT count(*) from SESSION_SUMMARY_20111203;
END;
