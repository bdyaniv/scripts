...
WHERE 
   ...
   a.visit_date = '20100326'::date
;

TRUNCATE SESSION_SUMMARY_20100326;
INSERT INTO SESSION_SUMMARY_20100326
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100326;
SELECT count(*) from SESSION_SUMMARY_20100326;
END;
