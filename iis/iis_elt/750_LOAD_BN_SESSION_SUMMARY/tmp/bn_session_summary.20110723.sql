...
WHERE 
   ...
   a.visit_date = '20110723'::date
;

TRUNCATE SESSION_SUMMARY_20110723;
INSERT INTO SESSION_SUMMARY_20110723
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110723;
SELECT count(*) from SESSION_SUMMARY_20110723;
END;
