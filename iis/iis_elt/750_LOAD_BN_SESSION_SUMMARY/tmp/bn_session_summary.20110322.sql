...
WHERE 
   ...
   a.visit_date = '20110322'::date
;

TRUNCATE SESSION_SUMMARY_20110322;
INSERT INTO SESSION_SUMMARY_20110322
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110322;
SELECT count(*) from SESSION_SUMMARY_20110322;
END;
