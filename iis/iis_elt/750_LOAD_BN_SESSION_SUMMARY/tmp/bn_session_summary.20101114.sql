...
WHERE 
   ...
   a.visit_date = '20101114'::date
;

TRUNCATE SESSION_SUMMARY_20101114;
INSERT INTO SESSION_SUMMARY_20101114
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101114;
SELECT count(*) from SESSION_SUMMARY_20101114;
END;
