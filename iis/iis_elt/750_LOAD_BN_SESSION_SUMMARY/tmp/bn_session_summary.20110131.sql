...
WHERE 
   ...
   a.visit_date = '20110131'::date
;

TRUNCATE SESSION_SUMMARY_20110131;
INSERT INTO SESSION_SUMMARY_20110131
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110131;
SELECT count(*) from SESSION_SUMMARY_20110131;
END;
