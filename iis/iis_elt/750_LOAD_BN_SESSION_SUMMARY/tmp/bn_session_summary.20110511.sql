...
WHERE 
   ...
   a.visit_date = '20110511'::date
;

TRUNCATE SESSION_SUMMARY_20110511;
INSERT INTO SESSION_SUMMARY_20110511
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110511;
SELECT count(*) from SESSION_SUMMARY_20110511;
END;
