...
WHERE 
   ...
   a.visit_date = '20100507'::date
;

TRUNCATE SESSION_SUMMARY_20100507;
INSERT INTO SESSION_SUMMARY_20100507
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100507;
SELECT count(*) from SESSION_SUMMARY_20100507;
END;
