...
WHERE 
   ...
   a.visit_date = '20110510'::date
;

TRUNCATE SESSION_SUMMARY_20110510;
INSERT INTO SESSION_SUMMARY_20110510
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110510;
SELECT count(*) from SESSION_SUMMARY_20110510;
END;
