...
WHERE 
   ...
   a.visit_date = '20111225'::date
;

TRUNCATE SESSION_SUMMARY_20111225;
INSERT INTO SESSION_SUMMARY_20111225
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111225;
SELECT count(*) from SESSION_SUMMARY_20111225;
END;
