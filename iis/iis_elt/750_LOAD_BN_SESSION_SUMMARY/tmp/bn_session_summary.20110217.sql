...
WHERE 
   ...
   a.visit_date = '20110217'::date
;

TRUNCATE SESSION_SUMMARY_20110217;
INSERT INTO SESSION_SUMMARY_20110217
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110217;
SELECT count(*) from SESSION_SUMMARY_20110217;
END;
