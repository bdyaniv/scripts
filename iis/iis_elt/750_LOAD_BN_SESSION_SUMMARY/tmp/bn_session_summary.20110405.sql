...
WHERE 
   ...
   a.visit_date = '20110405'::date
;

TRUNCATE SESSION_SUMMARY_20110405;
INSERT INTO SESSION_SUMMARY_20110405
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110405;
SELECT count(*) from SESSION_SUMMARY_20110405;
END;
