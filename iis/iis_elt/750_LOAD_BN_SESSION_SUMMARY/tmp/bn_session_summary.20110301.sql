...
WHERE 
   ...
   a.visit_date = '20110301'::date
;

TRUNCATE SESSION_SUMMARY_20110301;
INSERT INTO SESSION_SUMMARY_20110301
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110301;
SELECT count(*) from SESSION_SUMMARY_20110301;
END;
