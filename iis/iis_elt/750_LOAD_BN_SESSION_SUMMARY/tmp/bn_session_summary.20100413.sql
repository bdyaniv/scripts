...
WHERE 
   ...
   a.visit_date = '20100413'::date
;

TRUNCATE SESSION_SUMMARY_20100413;
INSERT INTO SESSION_SUMMARY_20100413
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100413;
SELECT count(*) from SESSION_SUMMARY_20100413;
END;
