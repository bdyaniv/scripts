...
WHERE 
   ...
   a.visit_date = '20100305'::date
;

TRUNCATE SESSION_SUMMARY_20100305;
INSERT INTO SESSION_SUMMARY_20100305
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100305;
SELECT count(*) from SESSION_SUMMARY_20100305;
END;
