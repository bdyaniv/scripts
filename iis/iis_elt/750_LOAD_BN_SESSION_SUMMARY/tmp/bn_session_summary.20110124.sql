...
WHERE 
   ...
   a.visit_date = '20110124'::date
;

TRUNCATE SESSION_SUMMARY_20110124;
INSERT INTO SESSION_SUMMARY_20110124
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110124;
SELECT count(*) from SESSION_SUMMARY_20110124;
END;
