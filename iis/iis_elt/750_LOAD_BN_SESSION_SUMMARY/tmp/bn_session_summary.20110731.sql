...
WHERE 
   ...
   a.visit_date = '20110731'::date
;

TRUNCATE SESSION_SUMMARY_20110731;
INSERT INTO SESSION_SUMMARY_20110731
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110731;
SELECT count(*) from SESSION_SUMMARY_20110731;
END;
