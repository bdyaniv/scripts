...
WHERE 
   ...
   a.visit_date = '20110831'::date
;

TRUNCATE SESSION_SUMMARY_20110831;
INSERT INTO SESSION_SUMMARY_20110831
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110831;
SELECT count(*) from SESSION_SUMMARY_20110831;
END;
