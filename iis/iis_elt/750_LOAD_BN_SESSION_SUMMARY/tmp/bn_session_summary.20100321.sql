...
WHERE 
   ...
   a.visit_date = '20100321'::date
;

TRUNCATE SESSION_SUMMARY_20100321;
INSERT INTO SESSION_SUMMARY_20100321
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100321;
SELECT count(*) from SESSION_SUMMARY_20100321;
END;
