...
WHERE 
   ...
   a.visit_date = '20100703'::date
;

TRUNCATE SESSION_SUMMARY_20100703;
INSERT INTO SESSION_SUMMARY_20100703
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100703;
SELECT count(*) from SESSION_SUMMARY_20100703;
END;
