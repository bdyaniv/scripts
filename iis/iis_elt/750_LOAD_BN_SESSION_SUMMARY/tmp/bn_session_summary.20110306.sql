...
WHERE 
   ...
   a.visit_date = '20110306'::date
;

TRUNCATE SESSION_SUMMARY_20110306;
INSERT INTO SESSION_SUMMARY_20110306
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110306;
SELECT count(*) from SESSION_SUMMARY_20110306;
END;
