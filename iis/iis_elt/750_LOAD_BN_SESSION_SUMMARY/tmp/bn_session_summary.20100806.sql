...
WHERE 
   ...
   a.visit_date = '20100806'::date
;

TRUNCATE SESSION_SUMMARY_20100806;
INSERT INTO SESSION_SUMMARY_20100806
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100806;
SELECT count(*) from SESSION_SUMMARY_20100806;
END;
