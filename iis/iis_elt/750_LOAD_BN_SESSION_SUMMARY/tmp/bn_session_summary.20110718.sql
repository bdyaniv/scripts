...
WHERE 
   ...
   a.visit_date = '20110718'::date
;

TRUNCATE SESSION_SUMMARY_20110718;
INSERT INTO SESSION_SUMMARY_20110718
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110718;
SELECT count(*) from SESSION_SUMMARY_20110718;
END;
