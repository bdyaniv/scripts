...
WHERE 
   ...
   a.visit_date = '20110816'::date
;

TRUNCATE SESSION_SUMMARY_20110816;
INSERT INTO SESSION_SUMMARY_20110816
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110816;
SELECT count(*) from SESSION_SUMMARY_20110816;
END;
