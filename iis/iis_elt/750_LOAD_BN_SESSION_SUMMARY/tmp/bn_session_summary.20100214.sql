...
WHERE 
   ...
   a.visit_date = '20100214'::date
;

TRUNCATE SESSION_SUMMARY_20100214;
INSERT INTO SESSION_SUMMARY_20100214
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100214;
SELECT count(*) from SESSION_SUMMARY_20100214;
END;
