...
WHERE 
   ...
   a.visit_date = '20110326'::date
;

TRUNCATE SESSION_SUMMARY_20110326;
INSERT INTO SESSION_SUMMARY_20110326
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110326;
SELECT count(*) from SESSION_SUMMARY_20110326;
END;
