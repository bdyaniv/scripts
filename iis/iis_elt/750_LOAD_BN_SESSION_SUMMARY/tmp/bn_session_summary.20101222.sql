...
WHERE 
   ...
   a.visit_date = '20101222'::date
;

TRUNCATE SESSION_SUMMARY_20101222;
INSERT INTO SESSION_SUMMARY_20101222
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101222;
SELECT count(*) from SESSION_SUMMARY_20101222;
END;
