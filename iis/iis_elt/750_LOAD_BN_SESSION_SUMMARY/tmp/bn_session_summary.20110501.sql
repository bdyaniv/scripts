...
WHERE 
   ...
   a.visit_date = '20110501'::date
;

TRUNCATE SESSION_SUMMARY_20110501;
INSERT INTO SESSION_SUMMARY_20110501
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110501;
SELECT count(*) from SESSION_SUMMARY_20110501;
END;
