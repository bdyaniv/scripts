...
WHERE 
   ...
   a.visit_date = '20100303'::date
;

TRUNCATE SESSION_SUMMARY_20100303;
INSERT INTO SESSION_SUMMARY_20100303
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100303;
SELECT count(*) from SESSION_SUMMARY_20100303;
END;
