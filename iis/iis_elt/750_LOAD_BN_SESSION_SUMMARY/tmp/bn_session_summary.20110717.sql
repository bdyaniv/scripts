...
WHERE 
   ...
   a.visit_date = '20110717'::date
;

TRUNCATE SESSION_SUMMARY_20110717;
INSERT INTO SESSION_SUMMARY_20110717
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110717;
SELECT count(*) from SESSION_SUMMARY_20110717;
END;
