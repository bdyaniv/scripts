...
WHERE 
   ...
   a.visit_date = '20110112'::date
;

TRUNCATE SESSION_SUMMARY_20110112;
INSERT INTO SESSION_SUMMARY_20110112
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110112;
SELECT count(*) from SESSION_SUMMARY_20110112;
END;
