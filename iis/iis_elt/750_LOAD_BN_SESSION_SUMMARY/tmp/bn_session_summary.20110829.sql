...
WHERE 
   ...
   a.visit_date = '20110829'::date
;

TRUNCATE SESSION_SUMMARY_20110829;
INSERT INTO SESSION_SUMMARY_20110829
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110829;
SELECT count(*) from SESSION_SUMMARY_20110829;
END;
