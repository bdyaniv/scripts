...
WHERE 
   ...
   a.visit_date = '20110106'::date
;

TRUNCATE SESSION_SUMMARY_20110106;
INSERT INTO SESSION_SUMMARY_20110106
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110106;
SELECT count(*) from SESSION_SUMMARY_20110106;
END;
