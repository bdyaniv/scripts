...
WHERE 
   ...
   a.visit_date = '20100330'::date
;

TRUNCATE SESSION_SUMMARY_20100330;
INSERT INTO SESSION_SUMMARY_20100330
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100330;
SELECT count(*) from SESSION_SUMMARY_20100330;
END;
