...
WHERE 
   ...
   a.visit_date = '20100901'::date
;

TRUNCATE SESSION_SUMMARY_20100901;
INSERT INTO SESSION_SUMMARY_20100901
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100901;
SELECT count(*) from SESSION_SUMMARY_20100901;
END;
