...
WHERE 
   ...
   a.visit_date = '20100707'::date
;

TRUNCATE SESSION_SUMMARY_20100707;
INSERT INTO SESSION_SUMMARY_20100707
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100707;
SELECT count(*) from SESSION_SUMMARY_20100707;
END;
