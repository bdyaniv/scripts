...
WHERE 
   ...
   a.visit_date = '20100928'::date
;

TRUNCATE SESSION_SUMMARY_20100928;
INSERT INTO SESSION_SUMMARY_20100928
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100928;
SELECT count(*) from SESSION_SUMMARY_20100928;
END;
