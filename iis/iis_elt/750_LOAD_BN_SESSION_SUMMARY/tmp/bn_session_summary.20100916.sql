...
WHERE 
   ...
   a.visit_date = '20100916'::date
;

TRUNCATE SESSION_SUMMARY_20100916;
INSERT INTO SESSION_SUMMARY_20100916
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100916;
SELECT count(*) from SESSION_SUMMARY_20100916;
END;
