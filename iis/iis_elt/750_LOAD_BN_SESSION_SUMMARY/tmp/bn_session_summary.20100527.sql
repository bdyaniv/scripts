...
WHERE 
   ...
   a.visit_date = '20100527'::date
;

TRUNCATE SESSION_SUMMARY_20100527;
INSERT INTO SESSION_SUMMARY_20100527
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100527;
SELECT count(*) from SESSION_SUMMARY_20100527;
END;
