...
WHERE 
   ...
   a.visit_date = '20110323'::date
;

TRUNCATE SESSION_SUMMARY_20110323;
INSERT INTO SESSION_SUMMARY_20110323
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110323;
SELECT count(*) from SESSION_SUMMARY_20110323;
END;
