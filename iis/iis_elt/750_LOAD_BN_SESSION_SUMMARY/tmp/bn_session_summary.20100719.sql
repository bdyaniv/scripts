...
WHERE 
   ...
   a.visit_date = '20100719'::date
;

TRUNCATE SESSION_SUMMARY_20100719;
INSERT INTO SESSION_SUMMARY_20100719
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100719;
SELECT count(*) from SESSION_SUMMARY_20100719;
END;
