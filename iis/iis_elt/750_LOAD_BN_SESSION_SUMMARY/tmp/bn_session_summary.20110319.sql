...
WHERE 
   ...
   a.visit_date = '20110319'::date
;

TRUNCATE SESSION_SUMMARY_20110319;
INSERT INTO SESSION_SUMMARY_20110319
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110319;
SELECT count(*) from SESSION_SUMMARY_20110319;
END;
