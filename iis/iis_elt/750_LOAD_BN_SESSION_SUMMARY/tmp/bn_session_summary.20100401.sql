...
WHERE 
   ...
   a.visit_date = '20100401'::date
;

TRUNCATE SESSION_SUMMARY_20100401;
INSERT INTO SESSION_SUMMARY_20100401
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100401;
SELECT count(*) from SESSION_SUMMARY_20100401;
END;
