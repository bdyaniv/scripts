...
WHERE 
   ...
   a.visit_date = '20101204'::date
;

TRUNCATE SESSION_SUMMARY_20101204;
INSERT INTO SESSION_SUMMARY_20101204
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101204;
SELECT count(*) from SESSION_SUMMARY_20101204;
END;
