...
WHERE 
   ...
   a.visit_date = '20110822'::date
;

TRUNCATE SESSION_SUMMARY_20110822;
INSERT INTO SESSION_SUMMARY_20110822
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110822;
SELECT count(*) from SESSION_SUMMARY_20110822;
END;
