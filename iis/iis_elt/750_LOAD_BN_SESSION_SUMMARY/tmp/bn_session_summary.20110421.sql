...
WHERE 
   ...
   a.visit_date = '20110421'::date
;

TRUNCATE SESSION_SUMMARY_20110421;
INSERT INTO SESSION_SUMMARY_20110421
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110421;
SELECT count(*) from SESSION_SUMMARY_20110421;
END;
