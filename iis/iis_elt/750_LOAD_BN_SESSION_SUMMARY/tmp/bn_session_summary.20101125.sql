...
WHERE 
   ...
   a.visit_date = '20101125'::date
;

TRUNCATE SESSION_SUMMARY_20101125;
INSERT INTO SESSION_SUMMARY_20101125
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101125;
SELECT count(*) from SESSION_SUMMARY_20101125;
END;
