...
WHERE 
   ...
   a.visit_date = '20100428'::date
;

TRUNCATE SESSION_SUMMARY_20100428;
INSERT INTO SESSION_SUMMARY_20100428
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100428;
SELECT count(*) from SESSION_SUMMARY_20100428;
END;
