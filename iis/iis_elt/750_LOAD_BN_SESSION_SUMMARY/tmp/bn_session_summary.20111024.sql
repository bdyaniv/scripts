...
WHERE 
   ...
   a.visit_date = '20111024'::date
;

TRUNCATE SESSION_SUMMARY_20111024;
INSERT INTO SESSION_SUMMARY_20111024
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111024;
SELECT count(*) from SESSION_SUMMARY_20111024;
END;
