...
WHERE 
   ...
   a.visit_date = '20111212'::date
;

TRUNCATE SESSION_SUMMARY_20111212;
INSERT INTO SESSION_SUMMARY_20111212
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111212;
SELECT count(*) from SESSION_SUMMARY_20111212;
END;
