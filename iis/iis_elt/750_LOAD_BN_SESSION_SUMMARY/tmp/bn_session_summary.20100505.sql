...
WHERE 
   ...
   a.visit_date = '20100505'::date
;

TRUNCATE SESSION_SUMMARY_20100505;
INSERT INTO SESSION_SUMMARY_20100505
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100505;
SELECT count(*) from SESSION_SUMMARY_20100505;
END;
