...
WHERE 
   ...
   a.visit_date = '20110801'::date
;

TRUNCATE SESSION_SUMMARY_20110801;
INSERT INTO SESSION_SUMMARY_20110801
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110801;
SELECT count(*) from SESSION_SUMMARY_20110801;
END;
