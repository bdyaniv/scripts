...
WHERE 
   ...
   a.visit_date = '20110509'::date
;

TRUNCATE SESSION_SUMMARY_20110509;
INSERT INTO SESSION_SUMMARY_20110509
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110509;
SELECT count(*) from SESSION_SUMMARY_20110509;
END;
