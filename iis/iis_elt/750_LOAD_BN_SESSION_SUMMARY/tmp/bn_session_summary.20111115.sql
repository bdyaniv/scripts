...
WHERE 
   ...
   a.visit_date = '20111115'::date
;

TRUNCATE SESSION_SUMMARY_20111115;
INSERT INTO SESSION_SUMMARY_20111115
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111115;
SELECT count(*) from SESSION_SUMMARY_20111115;
END;
