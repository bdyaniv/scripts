...
WHERE 
   ...
   a.visit_date = '20101004'::date
;

TRUNCATE SESSION_SUMMARY_20101004;
INSERT INTO SESSION_SUMMARY_20101004
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101004;
SELECT count(*) from SESSION_SUMMARY_20101004;
END;
