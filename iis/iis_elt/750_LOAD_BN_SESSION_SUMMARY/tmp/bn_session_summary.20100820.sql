...
WHERE 
   ...
   a.visit_date = '20100820'::date
;

TRUNCATE SESSION_SUMMARY_20100820;
INSERT INTO SESSION_SUMMARY_20100820
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100820;
SELECT count(*) from SESSION_SUMMARY_20100820;
END;
