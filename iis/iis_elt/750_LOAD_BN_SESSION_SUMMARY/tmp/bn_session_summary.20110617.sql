...
WHERE 
   ...
   a.visit_date = '20110617'::date
;

TRUNCATE SESSION_SUMMARY_20110617;
INSERT INTO SESSION_SUMMARY_20110617
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110617;
SELECT count(*) from SESSION_SUMMARY_20110617;
END;
