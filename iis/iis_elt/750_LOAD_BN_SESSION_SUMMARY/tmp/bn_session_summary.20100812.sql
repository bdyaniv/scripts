...
WHERE 
   ...
   a.visit_date = '20100812'::date
;

TRUNCATE SESSION_SUMMARY_20100812;
INSERT INTO SESSION_SUMMARY_20100812
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100812;
SELECT count(*) from SESSION_SUMMARY_20100812;
END;
