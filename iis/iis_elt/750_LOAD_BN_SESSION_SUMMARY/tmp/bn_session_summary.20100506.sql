...
WHERE 
   ...
   a.visit_date = '20100506'::date
;

TRUNCATE SESSION_SUMMARY_20100506;
INSERT INTO SESSION_SUMMARY_20100506
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100506;
SELECT count(*) from SESSION_SUMMARY_20100506;
END;
