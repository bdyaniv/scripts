...
WHERE 
   ...
   a.visit_date = '20111019'::date
;

TRUNCATE SESSION_SUMMARY_20111019;
INSERT INTO SESSION_SUMMARY_20111019
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111019;
SELECT count(*) from SESSION_SUMMARY_20111019;
END;
