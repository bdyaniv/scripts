...
WHERE 
   ...
   a.visit_date = '20110602'::date
;

TRUNCATE SESSION_SUMMARY_20110602;
INSERT INTO SESSION_SUMMARY_20110602
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110602;
SELECT count(*) from SESSION_SUMMARY_20110602;
END;
