...
WHERE 
   ...
   a.visit_date = '20100922'::date
;

TRUNCATE SESSION_SUMMARY_20100922;
INSERT INTO SESSION_SUMMARY_20100922
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100922;
SELECT count(*) from SESSION_SUMMARY_20100922;
END;
