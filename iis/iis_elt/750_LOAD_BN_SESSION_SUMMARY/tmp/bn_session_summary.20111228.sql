...
WHERE 
   ...
   a.visit_date = '20111228'::date
;

TRUNCATE SESSION_SUMMARY_20111228;
INSERT INTO SESSION_SUMMARY_20111228
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111228;
SELECT count(*) from SESSION_SUMMARY_20111228;
END;
