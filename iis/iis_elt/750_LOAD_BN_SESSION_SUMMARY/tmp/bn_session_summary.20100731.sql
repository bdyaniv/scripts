...
WHERE 
   ...
   a.visit_date = '20100731'::date
;

TRUNCATE SESSION_SUMMARY_20100731;
INSERT INTO SESSION_SUMMARY_20100731
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100731;
SELECT count(*) from SESSION_SUMMARY_20100731;
END;
