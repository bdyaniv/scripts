...
WHERE 
   ...
   a.visit_date = '20100726'::date
;

TRUNCATE SESSION_SUMMARY_20100726;
INSERT INTO SESSION_SUMMARY_20100726
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100726;
SELECT count(*) from SESSION_SUMMARY_20100726;
END;
