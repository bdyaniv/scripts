...
WHERE 
   ...
   a.visit_date = '20100909'::date
;

TRUNCATE SESSION_SUMMARY_20100909;
INSERT INTO SESSION_SUMMARY_20100909
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100909;
SELECT count(*) from SESSION_SUMMARY_20100909;
END;
