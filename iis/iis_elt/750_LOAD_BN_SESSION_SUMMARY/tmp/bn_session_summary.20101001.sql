...
WHERE 
   ...
   a.visit_date = '20101001'::date
;

TRUNCATE SESSION_SUMMARY_20101001;
INSERT INTO SESSION_SUMMARY_20101001
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101001;
SELECT count(*) from SESSION_SUMMARY_20101001;
END;
