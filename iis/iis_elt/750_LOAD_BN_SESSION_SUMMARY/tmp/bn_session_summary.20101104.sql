...
WHERE 
   ...
   a.visit_date = '20101104'::date
;

TRUNCATE SESSION_SUMMARY_20101104;
INSERT INTO SESSION_SUMMARY_20101104
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101104;
SELECT count(*) from SESSION_SUMMARY_20101104;
END;
