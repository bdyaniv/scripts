...
WHERE 
   ...
   a.visit_date = '20110824'::date
;

TRUNCATE SESSION_SUMMARY_20110824;
INSERT INTO SESSION_SUMMARY_20110824
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110824;
SELECT count(*) from SESSION_SUMMARY_20110824;
END;
