...
WHERE 
   ...
   a.visit_date = '20110412'::date
;

TRUNCATE SESSION_SUMMARY_20110412;
INSERT INTO SESSION_SUMMARY_20110412
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110412;
SELECT count(*) from SESSION_SUMMARY_20110412;
END;
