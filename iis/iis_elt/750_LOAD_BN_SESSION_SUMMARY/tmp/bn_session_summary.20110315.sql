...
WHERE 
   ...
   a.visit_date = '20110315'::date
;

TRUNCATE SESSION_SUMMARY_20110315;
INSERT INTO SESSION_SUMMARY_20110315
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110315;
SELECT count(*) from SESSION_SUMMARY_20110315;
END;
