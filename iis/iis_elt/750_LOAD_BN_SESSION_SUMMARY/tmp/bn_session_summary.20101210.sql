...
WHERE 
   ...
   a.visit_date = '20101210'::date
;

TRUNCATE SESSION_SUMMARY_20101210;
INSERT INTO SESSION_SUMMARY_20101210
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101210;
SELECT count(*) from SESSION_SUMMARY_20101210;
END;
