...
WHERE 
   ...
   a.visit_date = '20110605'::date
;

TRUNCATE SESSION_SUMMARY_20110605;
INSERT INTO SESSION_SUMMARY_20110605
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110605;
SELECT count(*) from SESSION_SUMMARY_20110605;
END;
