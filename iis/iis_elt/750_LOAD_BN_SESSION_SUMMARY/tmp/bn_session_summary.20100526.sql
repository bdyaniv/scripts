...
WHERE 
   ...
   a.visit_date = '20100526'::date
;

TRUNCATE SESSION_SUMMARY_20100526;
INSERT INTO SESSION_SUMMARY_20100526
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100526;
SELECT count(*) from SESSION_SUMMARY_20100526;
END;
