...
WHERE 
   ...
   a.visit_date = '20100617'::date
;

TRUNCATE SESSION_SUMMARY_20100617;
INSERT INTO SESSION_SUMMARY_20100617
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100617;
SELECT count(*) from SESSION_SUMMARY_20100617;
END;
