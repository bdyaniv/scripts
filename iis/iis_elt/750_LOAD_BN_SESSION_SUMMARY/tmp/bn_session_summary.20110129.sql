...
WHERE 
   ...
   a.visit_date = '20110129'::date
;

TRUNCATE SESSION_SUMMARY_20110129;
INSERT INTO SESSION_SUMMARY_20110129
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110129;
SELECT count(*) from SESSION_SUMMARY_20110129;
END;
