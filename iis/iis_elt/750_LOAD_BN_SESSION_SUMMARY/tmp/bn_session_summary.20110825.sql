...
WHERE 
   ...
   a.visit_date = '20110825'::date
;

TRUNCATE SESSION_SUMMARY_20110825;
INSERT INTO SESSION_SUMMARY_20110825
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110825;
SELECT count(*) from SESSION_SUMMARY_20110825;
END;
