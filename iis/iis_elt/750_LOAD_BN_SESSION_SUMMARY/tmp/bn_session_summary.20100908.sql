...
WHERE 
   ...
   a.visit_date = '20100908'::date
;

TRUNCATE SESSION_SUMMARY_20100908;
INSERT INTO SESSION_SUMMARY_20100908
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100908;
SELECT count(*) from SESSION_SUMMARY_20100908;
END;
