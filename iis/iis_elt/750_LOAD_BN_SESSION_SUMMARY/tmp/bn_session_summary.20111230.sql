...
WHERE 
   ...
   a.visit_date = '20111230'::date
;

TRUNCATE SESSION_SUMMARY_20111230;
INSERT INTO SESSION_SUMMARY_20111230
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111230;
SELECT count(*) from SESSION_SUMMARY_20111230;
END;
