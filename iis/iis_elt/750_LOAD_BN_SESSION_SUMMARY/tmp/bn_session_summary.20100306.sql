...
WHERE 
   ...
   a.visit_date = '20100306'::date
;

TRUNCATE SESSION_SUMMARY_20100306;
INSERT INTO SESSION_SUMMARY_20100306
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100306;
SELECT count(*) from SESSION_SUMMARY_20100306;
END;
