...
WHERE 
   ...
   a.visit_date = '20100621'::date
;

TRUNCATE SESSION_SUMMARY_20100621;
INSERT INTO SESSION_SUMMARY_20100621
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100621;
SELECT count(*) from SESSION_SUMMARY_20100621;
END;
