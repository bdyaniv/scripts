...
WHERE 
   ...
   a.visit_date = '20110316'::date
;

TRUNCATE SESSION_SUMMARY_20110316;
INSERT INTO SESSION_SUMMARY_20110316
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110316;
SELECT count(*) from SESSION_SUMMARY_20110316;
END;
