...
WHERE 
   ...
   a.visit_date = '20111111'::date
;

TRUNCATE SESSION_SUMMARY_20111111;
INSERT INTO SESSION_SUMMARY_20111111
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111111;
SELECT count(*) from SESSION_SUMMARY_20111111;
END;
