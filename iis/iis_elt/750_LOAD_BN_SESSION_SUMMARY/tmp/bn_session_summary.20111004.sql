...
WHERE 
   ...
   a.visit_date = '20111004'::date
;

TRUNCATE SESSION_SUMMARY_20111004;
INSERT INTO SESSION_SUMMARY_20111004
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111004;
SELECT count(*) from SESSION_SUMMARY_20111004;
END;
