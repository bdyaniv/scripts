...
WHERE 
   ...
   a.visit_date = '20101006'::date
;

TRUNCATE SESSION_SUMMARY_20101006;
INSERT INTO SESSION_SUMMARY_20101006
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101006;
SELECT count(*) from SESSION_SUMMARY_20101006;
END;
