...
WHERE 
   ...
   a.visit_date = '20100630'::date
;

TRUNCATE SESSION_SUMMARY_20100630;
INSERT INTO SESSION_SUMMARY_20100630
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100630;
SELECT count(*) from SESSION_SUMMARY_20100630;
END;
