...
WHERE 
   ...
   a.visit_date = '20110819'::date
;

TRUNCATE SESSION_SUMMARY_20110819;
INSERT INTO SESSION_SUMMARY_20110819
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110819;
SELECT count(*) from SESSION_SUMMARY_20110819;
END;
