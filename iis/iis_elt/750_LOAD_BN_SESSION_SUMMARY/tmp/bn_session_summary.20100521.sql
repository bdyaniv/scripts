...
WHERE 
   ...
   a.visit_date = '20100521'::date
;

TRUNCATE SESSION_SUMMARY_20100521;
INSERT INTO SESSION_SUMMARY_20100521
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100521;
SELECT count(*) from SESSION_SUMMARY_20100521;
END;
