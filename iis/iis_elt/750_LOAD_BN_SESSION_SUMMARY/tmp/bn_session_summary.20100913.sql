...
WHERE 
   ...
   a.visit_date = '20100913'::date
;

TRUNCATE SESSION_SUMMARY_20100913;
INSERT INTO SESSION_SUMMARY_20100913
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100913;
SELECT count(*) from SESSION_SUMMARY_20100913;
END;
