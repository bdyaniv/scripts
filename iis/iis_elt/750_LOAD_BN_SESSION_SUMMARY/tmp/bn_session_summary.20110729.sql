...
WHERE 
   ...
   a.visit_date = '20110729'::date
;

TRUNCATE SESSION_SUMMARY_20110729;
INSERT INTO SESSION_SUMMARY_20110729
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110729;
SELECT count(*) from SESSION_SUMMARY_20110729;
END;
