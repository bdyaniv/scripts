...
WHERE 
   ...
   a.visit_date = '20100224'::date
;

TRUNCATE SESSION_SUMMARY_20100224;
INSERT INTO SESSION_SUMMARY_20100224
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100224;
SELECT count(*) from SESSION_SUMMARY_20100224;
END;
