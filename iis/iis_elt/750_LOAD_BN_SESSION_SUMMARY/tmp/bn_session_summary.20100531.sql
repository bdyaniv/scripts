...
WHERE 
   ...
   a.visit_date = '20100531'::date
;

TRUNCATE SESSION_SUMMARY_20100531;
INSERT INTO SESSION_SUMMARY_20100531
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100531;
SELECT count(*) from SESSION_SUMMARY_20100531;
END;
