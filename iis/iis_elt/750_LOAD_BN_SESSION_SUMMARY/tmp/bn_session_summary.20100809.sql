...
WHERE 
   ...
   a.visit_date = '20100809'::date
;

TRUNCATE SESSION_SUMMARY_20100809;
INSERT INTO SESSION_SUMMARY_20100809
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100809;
SELECT count(*) from SESSION_SUMMARY_20100809;
END;
