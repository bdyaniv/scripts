...
WHERE 
   ...
   a.visit_date = '20100728'::date
;

TRUNCATE SESSION_SUMMARY_20100728;
INSERT INTO SESSION_SUMMARY_20100728
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100728;
SELECT count(*) from SESSION_SUMMARY_20100728;
END;
