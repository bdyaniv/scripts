...
WHERE 
   ...
   a.visit_date = '20111214'::date
;

TRUNCATE SESSION_SUMMARY_20111214;
INSERT INTO SESSION_SUMMARY_20111214
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111214;
SELECT count(*) from SESSION_SUMMARY_20111214;
END;
