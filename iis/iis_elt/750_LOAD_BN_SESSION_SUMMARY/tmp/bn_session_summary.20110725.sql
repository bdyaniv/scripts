...
WHERE 
   ...
   a.visit_date = '20110725'::date
;

TRUNCATE SESSION_SUMMARY_20110725;
INSERT INTO SESSION_SUMMARY_20110725
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110725;
SELECT count(*) from SESSION_SUMMARY_20110725;
END;
