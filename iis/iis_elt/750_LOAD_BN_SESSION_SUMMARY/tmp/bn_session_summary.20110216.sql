...
WHERE 
   ...
   a.visit_date = '20110216'::date
;

TRUNCATE SESSION_SUMMARY_20110216;
INSERT INTO SESSION_SUMMARY_20110216
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110216;
SELECT count(*) from SESSION_SUMMARY_20110216;
END;
