...
WHERE 
   ...
   a.visit_date = '20110317'::date
;

TRUNCATE SESSION_SUMMARY_20110317;
INSERT INTO SESSION_SUMMARY_20110317
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110317;
SELECT count(*) from SESSION_SUMMARY_20110317;
END;
