...
WHERE 
   ...
   a.visit_date = '20110911'::date
;

TRUNCATE SESSION_SUMMARY_20110911;
INSERT INTO SESSION_SUMMARY_20110911
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110911;
SELECT count(*) from SESSION_SUMMARY_20110911;
END;
