...
WHERE 
   ...
   a.visit_date = '20100602'::date
;

TRUNCATE SESSION_SUMMARY_20100602;
INSERT INTO SESSION_SUMMARY_20100602
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100602;
SELECT count(*) from SESSION_SUMMARY_20100602;
END;
