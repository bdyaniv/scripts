...
WHERE 
   ...
   a.visit_date = '20110802'::date
;

TRUNCATE SESSION_SUMMARY_20110802;
INSERT INTO SESSION_SUMMARY_20110802
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110802;
SELECT count(*) from SESSION_SUMMARY_20110802;
END;
