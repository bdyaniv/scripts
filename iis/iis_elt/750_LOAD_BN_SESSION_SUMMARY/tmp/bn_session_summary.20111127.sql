...
WHERE 
   ...
   a.visit_date = '20111127'::date
;

TRUNCATE SESSION_SUMMARY_20111127;
INSERT INTO SESSION_SUMMARY_20111127
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111127;
SELECT count(*) from SESSION_SUMMARY_20111127;
END;
