...
WHERE 
   ...
   a.visit_date = '20111008'::date
;

TRUNCATE SESSION_SUMMARY_20111008;
INSERT INTO SESSION_SUMMARY_20111008
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111008;
SELECT count(*) from SESSION_SUMMARY_20111008;
END;
