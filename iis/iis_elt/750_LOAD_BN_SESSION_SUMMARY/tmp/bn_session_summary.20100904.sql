...
WHERE 
   ...
   a.visit_date = '20100904'::date
;

TRUNCATE SESSION_SUMMARY_20100904;
INSERT INTO SESSION_SUMMARY_20100904
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100904;
SELECT count(*) from SESSION_SUMMARY_20100904;
END;
