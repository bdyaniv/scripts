...
WHERE 
   ...
   a.visit_date = '20120106'::date
;

TRUNCATE SESSION_SUMMARY_20120106;
INSERT INTO SESSION_SUMMARY_20120106
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20120106;
SELECT count(*) from SESSION_SUMMARY_20120106;
END;
