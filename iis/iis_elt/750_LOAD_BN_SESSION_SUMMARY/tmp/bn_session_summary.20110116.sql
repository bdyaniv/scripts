...
WHERE 
   ...
   a.visit_date = '20110116'::date
;

TRUNCATE SESSION_SUMMARY_20110116;
INSERT INTO SESSION_SUMMARY_20110116
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110116;
SELECT count(*) from SESSION_SUMMARY_20110116;
END;
