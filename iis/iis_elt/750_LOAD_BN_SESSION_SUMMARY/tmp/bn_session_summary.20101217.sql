...
WHERE 
   ...
   a.visit_date = '20101217'::date
;

TRUNCATE SESSION_SUMMARY_20101217;
INSERT INTO SESSION_SUMMARY_20101217
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101217;
SELECT count(*) from SESSION_SUMMARY_20101217;
END;
