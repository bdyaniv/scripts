...
WHERE 
   ...
   a.visit_date = '20100324'::date
;

TRUNCATE SESSION_SUMMARY_20100324;
INSERT INTO SESSION_SUMMARY_20100324
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100324;
SELECT count(*) from SESSION_SUMMARY_20100324;
END;
