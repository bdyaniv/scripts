...
WHERE 
   ...
   a.visit_date = '20100312'::date
;

TRUNCATE SESSION_SUMMARY_20100312;
INSERT INTO SESSION_SUMMARY_20100312
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100312;
SELECT count(*) from SESSION_SUMMARY_20100312;
END;
