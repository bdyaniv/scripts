...
WHERE 
   ...
   a.visit_date = '20110815'::date
;

TRUNCATE SESSION_SUMMARY_20110815;
INSERT INTO SESSION_SUMMARY_20110815
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110815;
SELECT count(*) from SESSION_SUMMARY_20110815;
END;
