...
WHERE 
   ...
   a.visit_date = '20101218'::date
;

TRUNCATE SESSION_SUMMARY_20101218;
INSERT INTO SESSION_SUMMARY_20101218
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101218;
SELECT count(*) from SESSION_SUMMARY_20101218;
END;
