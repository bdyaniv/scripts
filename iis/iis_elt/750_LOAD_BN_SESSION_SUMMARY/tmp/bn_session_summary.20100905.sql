...
WHERE 
   ...
   a.visit_date = '20100905'::date
;

TRUNCATE SESSION_SUMMARY_20100905;
INSERT INTO SESSION_SUMMARY_20100905
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100905;
SELECT count(*) from SESSION_SUMMARY_20100905;
END;
