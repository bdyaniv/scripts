...
WHERE 
   ...
   a.visit_date = '20110331'::date
;

TRUNCATE SESSION_SUMMARY_20110331;
INSERT INTO SESSION_SUMMARY_20110331
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110331;
SELECT count(*) from SESSION_SUMMARY_20110331;
END;
