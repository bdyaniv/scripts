...
WHERE 
   ...
   a.visit_date = '20100206'::date
;

TRUNCATE SESSION_SUMMARY_20100206;
INSERT INTO SESSION_SUMMARY_20100206
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100206;
SELECT count(*) from SESSION_SUMMARY_20100206;
END;
