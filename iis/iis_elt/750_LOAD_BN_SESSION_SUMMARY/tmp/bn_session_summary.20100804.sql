...
WHERE 
   ...
   a.visit_date = '20100804'::date
;

TRUNCATE SESSION_SUMMARY_20100804;
INSERT INTO SESSION_SUMMARY_20100804
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100804;
SELECT count(*) from SESSION_SUMMARY_20100804;
END;
