...
WHERE 
   ...
   a.visit_date = '20110724'::date
;

TRUNCATE SESSION_SUMMARY_20110724;
INSERT INTO SESSION_SUMMARY_20110724
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110724;
SELECT count(*) from SESSION_SUMMARY_20110724;
END;
