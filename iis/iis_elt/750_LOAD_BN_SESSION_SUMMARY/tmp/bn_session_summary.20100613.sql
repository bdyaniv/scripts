...
WHERE 
   ...
   a.visit_date = '20100613'::date
;

TRUNCATE SESSION_SUMMARY_20100613;
INSERT INTO SESSION_SUMMARY_20100613
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100613;
SELECT count(*) from SESSION_SUMMARY_20100613;
END;
