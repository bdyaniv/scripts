...
WHERE 
   ...
   a.visit_date = '20101119'::date
;

TRUNCATE SESSION_SUMMARY_20101119;
INSERT INTO SESSION_SUMMARY_20101119
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101119;
SELECT count(*) from SESSION_SUMMARY_20101119;
END;
