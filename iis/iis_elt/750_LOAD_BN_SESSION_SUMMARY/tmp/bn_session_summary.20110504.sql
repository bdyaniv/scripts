...
WHERE 
   ...
   a.visit_date = '20110504'::date
;

TRUNCATE SESSION_SUMMARY_20110504;
INSERT INTO SESSION_SUMMARY_20110504
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110504;
SELECT count(*) from SESSION_SUMMARY_20110504;
END;
