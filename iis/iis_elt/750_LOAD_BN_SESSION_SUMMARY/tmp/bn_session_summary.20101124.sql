...
WHERE 
   ...
   a.visit_date = '20101124'::date
;

TRUNCATE SESSION_SUMMARY_20101124;
INSERT INTO SESSION_SUMMARY_20101124
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101124;
SELECT count(*) from SESSION_SUMMARY_20101124;
END;
