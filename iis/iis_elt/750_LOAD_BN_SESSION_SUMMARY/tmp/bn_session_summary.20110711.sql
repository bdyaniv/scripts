...
WHERE 
   ...
   a.visit_date = '20110711'::date
;

TRUNCATE SESSION_SUMMARY_20110711;
INSERT INTO SESSION_SUMMARY_20110711
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110711;
SELECT count(*) from SESSION_SUMMARY_20110711;
END;
