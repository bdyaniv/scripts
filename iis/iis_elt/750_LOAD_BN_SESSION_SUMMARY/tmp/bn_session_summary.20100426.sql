...
WHERE 
   ...
   a.visit_date = '20100426'::date
;

TRUNCATE SESSION_SUMMARY_20100426;
INSERT INTO SESSION_SUMMARY_20100426
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100426;
SELECT count(*) from SESSION_SUMMARY_20100426;
END;
