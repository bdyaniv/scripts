...
WHERE 
   ...
   a.visit_date = '20100302'::date
;

TRUNCATE SESSION_SUMMARY_20100302;
INSERT INTO SESSION_SUMMARY_20100302
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100302;
SELECT count(*) from SESSION_SUMMARY_20100302;
END;
