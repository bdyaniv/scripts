...
WHERE 
   ...
   a.visit_date = '20121101'::date
;

TRUNCATE SESSION_SUMMARY_20121101;
INSERT INTO SESSION_SUMMARY_20121101
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20121101;
SELECT count(*) from SESSION_SUMMARY_20121101;
END;
