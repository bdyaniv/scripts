...
WHERE 
   ...
   a.visit_date = '20110422'::date
;

TRUNCATE SESSION_SUMMARY_20110422;
INSERT INTO SESSION_SUMMARY_20110422
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110422;
SELECT count(*) from SESSION_SUMMARY_20110422;
END;
