...
WHERE 
   ...
   a.visit_date = '20100414'::date
;

TRUNCATE SESSION_SUMMARY_20100414;
INSERT INTO SESSION_SUMMARY_20100414
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100414;
SELECT count(*) from SESSION_SUMMARY_20100414;
END;
