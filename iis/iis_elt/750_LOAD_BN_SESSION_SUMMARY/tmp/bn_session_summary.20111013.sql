...
WHERE 
   ...
   a.visit_date = '20111013'::date
;

TRUNCATE SESSION_SUMMARY_20111013;
INSERT INTO SESSION_SUMMARY_20111013
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111013;
SELECT count(*) from SESSION_SUMMARY_20111013;
END;
