...
WHERE 
   ...
   a.visit_date = '20110404'::date
;

TRUNCATE SESSION_SUMMARY_20110404;
INSERT INTO SESSION_SUMMARY_20110404
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110404;
SELECT count(*) from SESSION_SUMMARY_20110404;
END;
