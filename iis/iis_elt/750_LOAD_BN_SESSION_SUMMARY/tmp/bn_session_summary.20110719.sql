...
WHERE 
   ...
   a.visit_date = '20110719'::date
;

TRUNCATE SESSION_SUMMARY_20110719;
INSERT INTO SESSION_SUMMARY_20110719
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110719;
SELECT count(*) from SESSION_SUMMARY_20110719;
END;
