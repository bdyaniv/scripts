...
WHERE 
   ...
   a.visit_date = '20111126'::date
;

TRUNCATE SESSION_SUMMARY_20111126;
INSERT INTO SESSION_SUMMARY_20111126
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111126;
SELECT count(*) from SESSION_SUMMARY_20111126;
END;
