...
WHERE 
   ...
   a.visit_date = '20100417'::date
;

TRUNCATE SESSION_SUMMARY_20100417;
INSERT INTO SESSION_SUMMARY_20100417
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100417;
SELECT count(*) from SESSION_SUMMARY_20100417;
END;
