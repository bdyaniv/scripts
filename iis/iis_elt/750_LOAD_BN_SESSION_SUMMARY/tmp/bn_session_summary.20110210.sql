...
WHERE 
   ...
   a.visit_date = '20110210'::date
;

TRUNCATE SESSION_SUMMARY_20110210;
INSERT INTO SESSION_SUMMARY_20110210
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110210;
SELECT count(*) from SESSION_SUMMARY_20110210;
END;
