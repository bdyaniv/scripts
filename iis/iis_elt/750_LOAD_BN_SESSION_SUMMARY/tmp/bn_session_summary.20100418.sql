...
WHERE 
   ...
   a.visit_date = '20100418'::date
;

TRUNCATE SESSION_SUMMARY_20100418;
INSERT INTO SESSION_SUMMARY_20100418
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100418;
SELECT count(*) from SESSION_SUMMARY_20100418;
END;
