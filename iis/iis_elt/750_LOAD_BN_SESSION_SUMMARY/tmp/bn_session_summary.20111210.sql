...
WHERE 
   ...
   a.visit_date = '20111210'::date
;

TRUNCATE SESSION_SUMMARY_20111210;
INSERT INTO SESSION_SUMMARY_20111210
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111210;
SELECT count(*) from SESSION_SUMMARY_20111210;
END;
