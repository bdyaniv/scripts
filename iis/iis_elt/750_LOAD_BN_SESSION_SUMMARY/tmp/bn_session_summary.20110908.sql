...
WHERE 
   ...
   a.visit_date = '20110908'::date
;

TRUNCATE SESSION_SUMMARY_20110908;
INSERT INTO SESSION_SUMMARY_20110908
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110908;
SELECT count(*) from SESSION_SUMMARY_20110908;
END;
