...
WHERE 
   ...
   a.visit_date = '20100524'::date
;

TRUNCATE SESSION_SUMMARY_20100524;
INSERT INTO SESSION_SUMMARY_20100524
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100524;
SELECT count(*) from SESSION_SUMMARY_20100524;
END;
