...
WHERE 
   ...
   a.visit_date = '20101027'::date
;

TRUNCATE SESSION_SUMMARY_20101027;
INSERT INTO SESSION_SUMMARY_20101027
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101027;
SELECT count(*) from SESSION_SUMMARY_20101027;
END;
