...
WHERE 
   ...
   a.visit_date = '20110714'::date
;

TRUNCATE SESSION_SUMMARY_20110714;
INSERT INTO SESSION_SUMMARY_20110714
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110714;
SELECT count(*) from SESSION_SUMMARY_20110714;
END;
