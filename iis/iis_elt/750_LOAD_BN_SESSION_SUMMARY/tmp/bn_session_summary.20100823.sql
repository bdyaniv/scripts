...
WHERE 
   ...
   a.visit_date = '20100823'::date
;

TRUNCATE SESSION_SUMMARY_20100823;
INSERT INTO SESSION_SUMMARY_20100823
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100823;
SELECT count(*) from SESSION_SUMMARY_20100823;
END;
