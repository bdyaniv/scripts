...
WHERE 
   ...
   a.visit_date = '20110314'::date
;

TRUNCATE SESSION_SUMMARY_20110314;
INSERT INTO SESSION_SUMMARY_20110314
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110314;
SELECT count(*) from SESSION_SUMMARY_20110314;
END;
