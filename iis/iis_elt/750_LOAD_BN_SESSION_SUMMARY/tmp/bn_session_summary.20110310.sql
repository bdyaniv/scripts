...
WHERE 
   ...
   a.visit_date = '20110310'::date
;

TRUNCATE SESSION_SUMMARY_20110310;
INSERT INTO SESSION_SUMMARY_20110310
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110310;
SELECT count(*) from SESSION_SUMMARY_20110310;
END;
