...
WHERE 
   ...
   a.visit_date = '20100724'::date
;

TRUNCATE SESSION_SUMMARY_20100724;
INSERT INTO SESSION_SUMMARY_20100724
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100724;
SELECT count(*) from SESSION_SUMMARY_20100724;
END;
