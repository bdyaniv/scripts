...
WHERE 
   ...
   a.visit_date = '20100917'::date
;

TRUNCATE SESSION_SUMMARY_20100917;
INSERT INTO SESSION_SUMMARY_20100917
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100917;
SELECT count(*) from SESSION_SUMMARY_20100917;
END;
