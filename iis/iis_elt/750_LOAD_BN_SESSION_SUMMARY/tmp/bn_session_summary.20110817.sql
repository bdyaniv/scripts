...
WHERE 
   ...
   a.visit_date = '20110817'::date
;

TRUNCATE SESSION_SUMMARY_20110817;
INSERT INTO SESSION_SUMMARY_20110817
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110817;
SELECT count(*) from SESSION_SUMMARY_20110817;
END;
