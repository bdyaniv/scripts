...
WHERE 
   ...
   a.visit_date = '20101023'::date
;

TRUNCATE SESSION_SUMMARY_20101023;
INSERT INTO SESSION_SUMMARY_20101023
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101023;
SELECT count(*) from SESSION_SUMMARY_20101023;
END;
