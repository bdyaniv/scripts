...
WHERE 
   ...
   a.visit_date = '20101014'::date
;

TRUNCATE SESSION_SUMMARY_20101014;
INSERT INTO SESSION_SUMMARY_20101014
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101014;
SELECT count(*) from SESSION_SUMMARY_20101014;
END;
