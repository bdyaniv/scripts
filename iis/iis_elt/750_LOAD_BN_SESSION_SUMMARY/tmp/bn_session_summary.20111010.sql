...
WHERE 
   ...
   a.visit_date = '20111010'::date
;

TRUNCATE SESSION_SUMMARY_20111010;
INSERT INTO SESSION_SUMMARY_20111010
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111010;
SELECT count(*) from SESSION_SUMMARY_20111010;
END;
