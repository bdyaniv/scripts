...
WHERE 
   ...
   a.visit_date = '20120211'::date
;

TRUNCATE SESSION_SUMMARY_20120211;
INSERT INTO SESSION_SUMMARY_20120211
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20120211;
SELECT count(*) from SESSION_SUMMARY_20120211;
END;
