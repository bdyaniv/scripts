...
WHERE 
   ...
   a.visit_date = '20110708'::date
;

TRUNCATE SESSION_SUMMARY_20110708;
INSERT INTO SESSION_SUMMARY_20110708
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110708;
SELECT count(*) from SESSION_SUMMARY_20110708;
END;
