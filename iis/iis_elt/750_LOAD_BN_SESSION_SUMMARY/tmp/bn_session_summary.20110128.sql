...
WHERE 
   ...
   a.visit_date = '20110128'::date
;

TRUNCATE SESSION_SUMMARY_20110128;
INSERT INTO SESSION_SUMMARY_20110128
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110128;
SELECT count(*) from SESSION_SUMMARY_20110128;
END;
