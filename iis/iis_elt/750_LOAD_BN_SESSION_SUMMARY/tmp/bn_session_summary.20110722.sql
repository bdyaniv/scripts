...
WHERE 
   ...
   a.visit_date = '20110722'::date
;

TRUNCATE SESSION_SUMMARY_20110722;
INSERT INTO SESSION_SUMMARY_20110722
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110722;
SELECT count(*) from SESSION_SUMMARY_20110722;
END;
