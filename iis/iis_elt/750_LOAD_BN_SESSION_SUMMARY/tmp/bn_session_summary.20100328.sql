...
WHERE 
   ...
   a.visit_date = '20100328'::date
;

TRUNCATE SESSION_SUMMARY_20100328;
INSERT INTO SESSION_SUMMARY_20100328
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100328;
SELECT count(*) from SESSION_SUMMARY_20100328;
END;
