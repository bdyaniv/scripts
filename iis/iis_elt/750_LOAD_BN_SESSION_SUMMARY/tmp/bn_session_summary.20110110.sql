...
WHERE 
   ...
   a.visit_date = '20110110'::date
;

TRUNCATE SESSION_SUMMARY_20110110;
INSERT INTO SESSION_SUMMARY_20110110
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110110;
SELECT count(*) from SESSION_SUMMARY_20110110;
END;
