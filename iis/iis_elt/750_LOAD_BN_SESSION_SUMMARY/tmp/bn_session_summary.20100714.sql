...
WHERE 
   ...
   a.visit_date = '20100714'::date
;

TRUNCATE SESSION_SUMMARY_20100714;
INSERT INTO SESSION_SUMMARY_20100714
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100714;
SELECT count(*) from SESSION_SUMMARY_20100714;
END;
