...
WHERE 
   ...
   a.visit_date = '20100523'::date
;

TRUNCATE SESSION_SUMMARY_20100523;
INSERT INTO SESSION_SUMMARY_20100523
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100523;
SELECT count(*) from SESSION_SUMMARY_20100523;
END;
