...
WHERE 
   ...
   a.visit_date = '20111109'::date
;

TRUNCATE SESSION_SUMMARY_20111109;
INSERT INTO SESSION_SUMMARY_20111109
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111109;
SELECT count(*) from SESSION_SUMMARY_20111109;
END;
