...
WHERE 
   ...
   a.visit_date = '20101231'::date
;

TRUNCATE SESSION_SUMMARY_20101231;
INSERT INTO SESSION_SUMMARY_20101231
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101231;
SELECT count(*) from SESSION_SUMMARY_20101231;
END;
