...
WHERE 
   ...
   a.visit_date = '20101128'::date
;

TRUNCATE SESSION_SUMMARY_20101128;
INSERT INTO SESSION_SUMMARY_20101128
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101128;
SELECT count(*) from SESSION_SUMMARY_20101128;
END;
