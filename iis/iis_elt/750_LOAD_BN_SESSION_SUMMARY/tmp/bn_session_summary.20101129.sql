...
WHERE 
   ...
   a.visit_date = '20101129'::date
;

TRUNCATE SESSION_SUMMARY_20101129;
INSERT INTO SESSION_SUMMARY_20101129
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101129;
SELECT count(*) from SESSION_SUMMARY_20101129;
END;
