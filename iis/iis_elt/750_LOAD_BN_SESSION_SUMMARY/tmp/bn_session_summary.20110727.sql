...
WHERE 
   ...
   a.visit_date = '20110727'::date
;

TRUNCATE SESSION_SUMMARY_20110727;
INSERT INTO SESSION_SUMMARY_20110727
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110727;
SELECT count(*) from SESSION_SUMMARY_20110727;
END;
