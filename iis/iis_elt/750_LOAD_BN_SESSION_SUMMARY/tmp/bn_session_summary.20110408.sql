...
WHERE 
   ...
   a.visit_date = '20110408'::date
;

TRUNCATE SESSION_SUMMARY_20110408;
INSERT INTO SESSION_SUMMARY_20110408
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110408;
SELECT count(*) from SESSION_SUMMARY_20110408;
END;
