...
WHERE 
   ...
   a.visit_date = '20110507'::date
;

TRUNCATE SESSION_SUMMARY_20110507;
INSERT INTO SESSION_SUMMARY_20110507
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110507;
SELECT count(*) from SESSION_SUMMARY_20110507;
END;
