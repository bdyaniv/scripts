...
WHERE 
   ...
   a.visit_date = '20111215'::date
;

TRUNCATE SESSION_SUMMARY_20111215;
INSERT INTO SESSION_SUMMARY_20111215
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111215;
SELECT count(*) from SESSION_SUMMARY_20111215;
END;
