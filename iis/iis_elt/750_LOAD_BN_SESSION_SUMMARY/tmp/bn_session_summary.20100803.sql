...
WHERE 
   ...
   a.visit_date = '20100803'::date
;

TRUNCATE SESSION_SUMMARY_20100803;
INSERT INTO SESSION_SUMMARY_20100803
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100803;
SELECT count(*) from SESSION_SUMMARY_20100803;
END;
