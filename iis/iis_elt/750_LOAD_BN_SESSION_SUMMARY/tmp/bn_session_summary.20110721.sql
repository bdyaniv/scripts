...
WHERE 
   ...
   a.visit_date = '20110721'::date
;

TRUNCATE SESSION_SUMMARY_20110721;
INSERT INTO SESSION_SUMMARY_20110721
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110721;
SELECT count(*) from SESSION_SUMMARY_20110721;
END;
