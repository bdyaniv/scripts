...
WHERE 
   ...
   a.visit_date = '20100828'::date
;

TRUNCATE SESSION_SUMMARY_20100828;
INSERT INTO SESSION_SUMMARY_20100828
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100828;
SELECT count(*) from SESSION_SUMMARY_20100828;
END;
