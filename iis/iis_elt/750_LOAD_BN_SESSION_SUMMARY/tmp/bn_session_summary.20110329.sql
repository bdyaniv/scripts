...
WHERE 
   ...
   a.visit_date = '20110329'::date
;

TRUNCATE SESSION_SUMMARY_20110329;
INSERT INTO SESSION_SUMMARY_20110329
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110329;
SELECT count(*) from SESSION_SUMMARY_20110329;
END;
