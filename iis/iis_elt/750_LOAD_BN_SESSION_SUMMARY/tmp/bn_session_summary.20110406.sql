...
WHERE 
   ...
   a.visit_date = '20110406'::date
;

TRUNCATE SESSION_SUMMARY_20110406;
INSERT INTO SESSION_SUMMARY_20110406
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110406;
SELECT count(*) from SESSION_SUMMARY_20110406;
END;
