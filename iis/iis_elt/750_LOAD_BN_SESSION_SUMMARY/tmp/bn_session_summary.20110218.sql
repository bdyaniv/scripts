...
WHERE 
   ...
   a.visit_date = '20110218'::date
;

TRUNCATE SESSION_SUMMARY_20110218;
INSERT INTO SESSION_SUMMARY_20110218
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110218;
SELECT count(*) from SESSION_SUMMARY_20110218;
END;
