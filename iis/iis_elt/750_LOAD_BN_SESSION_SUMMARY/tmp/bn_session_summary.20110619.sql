...
WHERE 
   ...
   a.visit_date = '20110619'::date
;

TRUNCATE SESSION_SUMMARY_20110619;
INSERT INTO SESSION_SUMMARY_20110619
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110619;
SELECT count(*) from SESSION_SUMMARY_20110619;
END;
