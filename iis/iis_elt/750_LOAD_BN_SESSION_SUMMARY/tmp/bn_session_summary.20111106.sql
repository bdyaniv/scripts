...
WHERE 
   ...
   a.visit_date = '20111106'::date
;

TRUNCATE SESSION_SUMMARY_20111106;
INSERT INTO SESSION_SUMMARY_20111106
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111106;
SELECT count(*) from SESSION_SUMMARY_20111106;
END;
