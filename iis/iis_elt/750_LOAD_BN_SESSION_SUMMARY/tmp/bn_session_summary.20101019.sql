...
WHERE 
   ...
   a.visit_date = '20101019'::date
;

TRUNCATE SESSION_SUMMARY_20101019;
INSERT INTO SESSION_SUMMARY_20101019
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101019;
SELECT count(*) from SESSION_SUMMARY_20101019;
END;
