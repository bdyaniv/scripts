...
WHERE 
   ...
   a.visit_date = '20101103'::date
;

TRUNCATE SESSION_SUMMARY_20101103;
INSERT INTO SESSION_SUMMARY_20101103
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101103;
SELECT count(*) from SESSION_SUMMARY_20101103;
END;
