...
WHERE 
   ...
   a.visit_date = '20111217'::date
;

TRUNCATE SESSION_SUMMARY_20111217;
INSERT INTO SESSION_SUMMARY_20111217
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111217;
SELECT count(*) from SESSION_SUMMARY_20111217;
END;
