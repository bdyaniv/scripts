...
WHERE 
   ...
   a.visit_date = '20100614'::date
;

TRUNCATE SESSION_SUMMARY_20100614;
INSERT INTO SESSION_SUMMARY_20100614
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100614;
SELECT count(*) from SESSION_SUMMARY_20100614;
END;
