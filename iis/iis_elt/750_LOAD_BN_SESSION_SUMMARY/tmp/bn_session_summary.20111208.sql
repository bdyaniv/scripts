...
WHERE 
   ...
   a.visit_date = '20111208'::date
;

TRUNCATE SESSION_SUMMARY_20111208;
INSERT INTO SESSION_SUMMARY_20111208
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111208;
SELECT count(*) from SESSION_SUMMARY_20111208;
END;
