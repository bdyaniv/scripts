...
WHERE 
   ...
   a.visit_date = '20110606'::date
;

TRUNCATE SESSION_SUMMARY_20110606;
INSERT INTO SESSION_SUMMARY_20110606
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110606;
SELECT count(*) from SESSION_SUMMARY_20110606;
END;
