...
WHERE 
   ...
   a.visit_date = '20100408'::date
;

TRUNCATE SESSION_SUMMARY_20100408;
INSERT INTO SESSION_SUMMARY_20100408
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100408;
SELECT count(*) from SESSION_SUMMARY_20100408;
END;
