...
WHERE 
   ...
   a.visit_date = '20100325'::date
;

TRUNCATE SESSION_SUMMARY_20100325;
INSERT INTO SESSION_SUMMARY_20100325
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100325;
SELECT count(*) from SESSION_SUMMARY_20100325;
END;
