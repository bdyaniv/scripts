...
WHERE 
   ...
   a.visit_date = '20101109'::date
;

TRUNCATE SESSION_SUMMARY_20101109;
INSERT INTO SESSION_SUMMARY_20101109
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101109;
SELECT count(*) from SESSION_SUMMARY_20101109;
END;
