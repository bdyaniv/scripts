...
WHERE 
   ...
   a.visit_date = '20101121'::date
;

TRUNCATE SESSION_SUMMARY_20101121;
INSERT INTO SESSION_SUMMARY_20101121
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101121;
SELECT count(*) from SESSION_SUMMARY_20101121;
END;
