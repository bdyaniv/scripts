...
WHERE 
   ...
   a.visit_date = '20110928'::date
;

TRUNCATE SESSION_SUMMARY_20110928;
INSERT INTO SESSION_SUMMARY_20110928
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110928;
SELECT count(*) from SESSION_SUMMARY_20110928;
END;
