...
WHERE 
   ...
   a.visit_date = '20111014'::date
;

TRUNCATE SESSION_SUMMARY_20111014;
INSERT INTO SESSION_SUMMARY_20111014
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111014;
SELECT count(*) from SESSION_SUMMARY_20111014;
END;
