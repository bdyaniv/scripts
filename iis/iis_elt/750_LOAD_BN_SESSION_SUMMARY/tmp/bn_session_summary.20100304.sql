...
WHERE 
   ...
   a.visit_date = '20100304'::date
;

TRUNCATE SESSION_SUMMARY_20100304;
INSERT INTO SESSION_SUMMARY_20100304
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100304;
SELECT count(*) from SESSION_SUMMARY_20100304;
END;
