...
WHERE 
   ...
   a.visit_date = '20110324'::date
;

TRUNCATE SESSION_SUMMARY_20110324;
INSERT INTO SESSION_SUMMARY_20110324
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110324;
SELECT count(*) from SESSION_SUMMARY_20110324;
END;
