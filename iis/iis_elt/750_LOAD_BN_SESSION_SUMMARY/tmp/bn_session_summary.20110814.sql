...
WHERE 
   ...
   a.visit_date = '20110814'::date
;

TRUNCATE SESSION_SUMMARY_20110814;
INSERT INTO SESSION_SUMMARY_20110814
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110814;
SELECT count(*) from SESSION_SUMMARY_20110814;
END;
