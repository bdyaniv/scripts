...
WHERE 
   ...
   a.visit_date = '20111026'::date
;

TRUNCATE SESSION_SUMMARY_20111026;
INSERT INTO SESSION_SUMMARY_20111026
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111026;
SELECT count(*) from SESSION_SUMMARY_20111026;
END;
