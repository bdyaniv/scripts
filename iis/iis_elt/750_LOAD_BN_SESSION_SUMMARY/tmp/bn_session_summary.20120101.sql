...
WHERE 
   ...
   a.visit_date = '20120101'::date
;

TRUNCATE SESSION_SUMMARY_20120101;
INSERT INTO SESSION_SUMMARY_20120101
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20120101;
SELECT count(*) from SESSION_SUMMARY_20120101;
END;
