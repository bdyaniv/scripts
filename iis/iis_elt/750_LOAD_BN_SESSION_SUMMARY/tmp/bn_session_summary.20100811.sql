...
WHERE 
   ...
   a.visit_date = '20100811'::date
;

TRUNCATE SESSION_SUMMARY_20100811;
INSERT INTO SESSION_SUMMARY_20100811
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100811;
SELECT count(*) from SESSION_SUMMARY_20100811;
END;
