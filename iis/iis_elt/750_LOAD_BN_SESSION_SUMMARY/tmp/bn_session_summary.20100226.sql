...
WHERE 
   ...
   a.visit_date = '20100226'::date
;

TRUNCATE SESSION_SUMMARY_20100226;
INSERT INTO SESSION_SUMMARY_20100226
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100226;
SELECT count(*) from SESSION_SUMMARY_20100226;
END;
