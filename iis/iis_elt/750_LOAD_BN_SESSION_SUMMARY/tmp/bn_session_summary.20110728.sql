...
WHERE 
   ...
   a.visit_date = '20110728'::date
;

TRUNCATE SESSION_SUMMARY_20110728;
INSERT INTO SESSION_SUMMARY_20110728
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110728;
SELECT count(*) from SESSION_SUMMARY_20110728;
END;
