...
WHERE 
   ...
   a.visit_date = '20101011'::date
;

TRUNCATE SESSION_SUMMARY_20101011;
INSERT INTO SESSION_SUMMARY_20101011
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101011;
SELECT count(*) from SESSION_SUMMARY_20101011;
END;
