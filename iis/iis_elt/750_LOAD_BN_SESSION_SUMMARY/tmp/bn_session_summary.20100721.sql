...
WHERE 
   ...
   a.visit_date = '20100721'::date
;

TRUNCATE SESSION_SUMMARY_20100721;
INSERT INTO SESSION_SUMMARY_20100721
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100721;
SELECT count(*) from SESSION_SUMMARY_20100721;
END;
