...
WHERE 
   ...
   a.visit_date = '20110912'::date
;

TRUNCATE SESSION_SUMMARY_20110912;
INSERT INTO SESSION_SUMMARY_20110912
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110912;
SELECT count(*) from SESSION_SUMMARY_20110912;
END;
