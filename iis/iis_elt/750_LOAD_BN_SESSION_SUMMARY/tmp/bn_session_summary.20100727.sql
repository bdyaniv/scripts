...
WHERE 
   ...
   a.visit_date = '20100727'::date
;

TRUNCATE SESSION_SUMMARY_20100727;
INSERT INTO SESSION_SUMMARY_20100727
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100727;
SELECT count(*) from SESSION_SUMMARY_20100727;
END;
