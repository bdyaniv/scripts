...
WHERE 
   ...
   a.visit_date = '20111006'::date
;

TRUNCATE SESSION_SUMMARY_20111006;
INSERT INTO SESSION_SUMMARY_20111006
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111006;
SELECT count(*) from SESSION_SUMMARY_20111006;
END;
