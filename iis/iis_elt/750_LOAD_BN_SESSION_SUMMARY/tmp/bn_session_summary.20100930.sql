...
WHERE 
   ...
   a.visit_date = '20100930'::date
;

TRUNCATE SESSION_SUMMARY_20100930;
INSERT INTO SESSION_SUMMARY_20100930
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100930;
SELECT count(*) from SESSION_SUMMARY_20100930;
END;
