...
WHERE 
   ...
   a.visit_date = '20100520'::date
;

TRUNCATE SESSION_SUMMARY_20100520;
INSERT INTO SESSION_SUMMARY_20100520
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100520;
SELECT count(*) from SESSION_SUMMARY_20100520;
END;
