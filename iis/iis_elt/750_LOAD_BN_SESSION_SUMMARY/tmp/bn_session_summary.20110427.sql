...
WHERE 
   ...
   a.visit_date = '20110427'::date
;

TRUNCATE SESSION_SUMMARY_20110427;
INSERT INTO SESSION_SUMMARY_20110427
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110427;
SELECT count(*) from SESSION_SUMMARY_20110427;
END;
