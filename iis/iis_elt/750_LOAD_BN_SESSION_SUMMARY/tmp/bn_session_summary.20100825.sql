...
WHERE 
   ...
   a.visit_date = '20100825'::date
;

TRUNCATE SESSION_SUMMARY_20100825;
INSERT INTO SESSION_SUMMARY_20100825
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100825;
SELECT count(*) from SESSION_SUMMARY_20100825;
END;
