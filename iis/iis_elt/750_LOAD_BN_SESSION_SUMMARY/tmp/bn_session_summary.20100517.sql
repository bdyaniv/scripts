...
WHERE 
   ...
   a.visit_date = '20100517'::date
;

TRUNCATE SESSION_SUMMARY_20100517;
INSERT INTO SESSION_SUMMARY_20100517
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100517;
SELECT count(*) from SESSION_SUMMARY_20100517;
END;
