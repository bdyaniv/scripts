...
WHERE 
   ...
   a.visit_date = '20101130'::date
;

TRUNCATE SESSION_SUMMARY_20101130;
INSERT INTO SESSION_SUMMARY_20101130
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101130;
SELECT count(*) from SESSION_SUMMARY_20101130;
END;
