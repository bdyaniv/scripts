...
WHERE 
   ...
   a.visit_date = '20100910'::date
;

TRUNCATE SESSION_SUMMARY_20100910;
INSERT INTO SESSION_SUMMARY_20100910
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100910;
SELECT count(*) from SESSION_SUMMARY_20100910;
END;
