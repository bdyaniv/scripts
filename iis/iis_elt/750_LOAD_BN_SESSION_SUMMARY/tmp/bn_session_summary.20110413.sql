...
WHERE 
   ...
   a.visit_date = '20110413'::date
;

TRUNCATE SESSION_SUMMARY_20110413;
INSERT INTO SESSION_SUMMARY_20110413
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110413;
SELECT count(*) from SESSION_SUMMARY_20110413;
END;
