...
WHERE 
   ...
   a.visit_date = '20101229'::date
;

TRUNCATE SESSION_SUMMARY_20101229;
INSERT INTO SESSION_SUMMARY_20101229
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101229;
SELECT count(*) from SESSION_SUMMARY_20101229;
END;
