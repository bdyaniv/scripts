...
WHERE 
   ...
   a.visit_date = '20100530'::date
;

TRUNCATE SESSION_SUMMARY_20100530;
INSERT INTO SESSION_SUMMARY_20100530
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100530;
SELECT count(*) from SESSION_SUMMARY_20100530;
END;
