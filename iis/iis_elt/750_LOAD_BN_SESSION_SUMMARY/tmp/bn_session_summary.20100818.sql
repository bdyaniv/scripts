...
WHERE 
   ...
   a.visit_date = '20100818'::date
;

TRUNCATE SESSION_SUMMARY_20100818;
INSERT INTO SESSION_SUMMARY_20100818
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100818;
SELECT count(*) from SESSION_SUMMARY_20100818;
END;
