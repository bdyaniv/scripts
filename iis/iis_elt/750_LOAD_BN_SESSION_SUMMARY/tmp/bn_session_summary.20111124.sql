...
WHERE 
   ...
   a.visit_date = '20111124'::date
;

TRUNCATE SESSION_SUMMARY_20111124;
INSERT INTO SESSION_SUMMARY_20111124
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111124;
SELECT count(*) from SESSION_SUMMARY_20111124;
END;
