...
WHERE 
   ...
   a.visit_date = '20100329'::date
;

TRUNCATE SESSION_SUMMARY_20100329;
INSERT INTO SESSION_SUMMARY_20100329
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100329;
SELECT count(*) from SESSION_SUMMARY_20100329;
END;
