...
WHERE 
   ...
   a.visit_date = '20100921'::date
;

TRUNCATE SESSION_SUMMARY_20100921;
INSERT INTO SESSION_SUMMARY_20100921
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100921;
SELECT count(*) from SESSION_SUMMARY_20100921;
END;
