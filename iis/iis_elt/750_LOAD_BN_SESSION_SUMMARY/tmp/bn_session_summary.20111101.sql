...
WHERE 
   ...
   a.visit_date = '20111101'::date
;

TRUNCATE SESSION_SUMMARY_20111101;
INSERT INTO SESSION_SUMMARY_20111101
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111101;
SELECT count(*) from SESSION_SUMMARY_20111101;
END;
