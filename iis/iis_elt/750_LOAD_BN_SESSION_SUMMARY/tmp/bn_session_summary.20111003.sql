...
WHERE 
   ...
   a.visit_date = '20111003'::date
;

TRUNCATE SESSION_SUMMARY_20111003;
INSERT INTO SESSION_SUMMARY_20111003
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111003;
SELECT count(*) from SESSION_SUMMARY_20111003;
END;
