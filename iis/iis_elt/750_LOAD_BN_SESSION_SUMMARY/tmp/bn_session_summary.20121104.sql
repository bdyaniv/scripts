...
WHERE 
   ...
   a.visit_date = '20121104'::date
;

TRUNCATE SESSION_SUMMARY_20121104;
INSERT INTO SESSION_SUMMARY_20121104
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20121104;
SELECT count(*) from SESSION_SUMMARY_20121104;
END;
