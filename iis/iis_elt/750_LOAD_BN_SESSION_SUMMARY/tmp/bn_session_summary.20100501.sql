...
WHERE 
   ...
   a.visit_date = '20100501'::date
;

TRUNCATE SESSION_SUMMARY_20100501;
INSERT INTO SESSION_SUMMARY_20100501
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100501;
SELECT count(*) from SESSION_SUMMARY_20100501;
END;
