...
WHERE 
   ...
   a.visit_date = '20120105'::date
;

TRUNCATE SESSION_SUMMARY_20120105;
INSERT INTO SESSION_SUMMARY_20120105
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20120105;
SELECT count(*) from SESSION_SUMMARY_20120105;
END;
