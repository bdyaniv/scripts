...
WHERE 
   ...
   a.visit_date = '20100610'::date
;

TRUNCATE SESSION_SUMMARY_20100610;
INSERT INTO SESSION_SUMMARY_20100610
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100610;
SELECT count(*) from SESSION_SUMMARY_20100610;
END;
