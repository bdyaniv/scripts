...
WHERE 
   ...
   a.visit_date = '20110403'::date
;

TRUNCATE SESSION_SUMMARY_20110403;
INSERT INTO SESSION_SUMMARY_20110403
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110403;
SELECT count(*) from SESSION_SUMMARY_20110403;
END;
