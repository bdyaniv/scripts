...
WHERE 
   ...
   a.visit_date = '20110811'::date
;

TRUNCATE SESSION_SUMMARY_20110811;
INSERT INTO SESSION_SUMMARY_20110811
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110811;
SELECT count(*) from SESSION_SUMMARY_20110811;
END;
