...
WHERE 
   ...
   a.visit_date = '20101213'::date
;

TRUNCATE SESSION_SUMMARY_20101213;
INSERT INTO SESSION_SUMMARY_20101213
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101213;
SELECT count(*) from SESSION_SUMMARY_20101213;
END;
