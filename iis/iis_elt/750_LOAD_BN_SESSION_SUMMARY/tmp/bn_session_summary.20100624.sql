...
WHERE 
   ...
   a.visit_date = '20100624'::date
;

TRUNCATE SESSION_SUMMARY_20100624;
INSERT INTO SESSION_SUMMARY_20100624
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100624;
SELECT count(*) from SESSION_SUMMARY_20100624;
END;
