...
WHERE 
   ...
   a.visit_date = '20110309'::date
;

TRUNCATE SESSION_SUMMARY_20110309;
INSERT INTO SESSION_SUMMARY_20110309
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110309;
SELECT count(*) from SESSION_SUMMARY_20110309;
END;
