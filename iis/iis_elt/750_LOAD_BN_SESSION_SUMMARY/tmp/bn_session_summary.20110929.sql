...
WHERE 
   ...
   a.visit_date = '20110929'::date
;

TRUNCATE SESSION_SUMMARY_20110929;
INSERT INTO SESSION_SUMMARY_20110929
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110929;
SELECT count(*) from SESSION_SUMMARY_20110929;
END;
