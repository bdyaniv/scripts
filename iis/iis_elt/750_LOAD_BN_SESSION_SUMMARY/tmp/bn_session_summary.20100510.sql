...
WHERE 
   ...
   a.visit_date = '20100510'::date
;

TRUNCATE SESSION_SUMMARY_20100510;
INSERT INTO SESSION_SUMMARY_20100510
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100510;
SELECT count(*) from SESSION_SUMMARY_20100510;
END;
