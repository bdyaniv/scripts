...
WHERE 
   ...
   a.visit_date = '20110628'::date
;

TRUNCATE SESSION_SUMMARY_20110628;
INSERT INTO SESSION_SUMMARY_20110628
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110628;
SELECT count(*) from SESSION_SUMMARY_20110628;
END;
