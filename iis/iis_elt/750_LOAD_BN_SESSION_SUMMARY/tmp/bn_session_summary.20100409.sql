...
WHERE 
   ...
   a.visit_date = '20100409'::date
;

TRUNCATE SESSION_SUMMARY_20100409;
INSERT INTO SESSION_SUMMARY_20100409
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100409;
SELECT count(*) from SESSION_SUMMARY_20100409;
END;
