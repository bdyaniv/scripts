...
WHERE 
   ...
   a.visit_date = '20111122'::date
;

TRUNCATE SESSION_SUMMARY_20111122;
INSERT INTO SESSION_SUMMARY_20111122
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111122;
SELECT count(*) from SESSION_SUMMARY_20111122;
END;
