...
WHERE 
   ...
   a.visit_date = '20100219'::date
;

TRUNCATE SESSION_SUMMARY_20100219;
INSERT INTO SESSION_SUMMARY_20100219
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100219;
SELECT count(*) from SESSION_SUMMARY_20100219;
END;
