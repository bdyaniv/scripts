...
WHERE 
   ...
   a.visit_date = '20110409'::date
;

TRUNCATE SESSION_SUMMARY_20110409;
INSERT INTO SESSION_SUMMARY_20110409
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110409;
SELECT count(*) from SESSION_SUMMARY_20110409;
END;
