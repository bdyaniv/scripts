...
WHERE 
   ...
   a.visit_date = '20111009'::date
;

TRUNCATE SESSION_SUMMARY_20111009;
INSERT INTO SESSION_SUMMARY_20111009
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111009;
SELECT count(*) from SESSION_SUMMARY_20111009;
END;
