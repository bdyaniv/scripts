...
WHERE 
   ...
   a.visit_date = '20110611'::date
;

TRUNCATE SESSION_SUMMARY_20110611;
INSERT INTO SESSION_SUMMARY_20110611
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110611;
SELECT count(*) from SESSION_SUMMARY_20110611;
END;
