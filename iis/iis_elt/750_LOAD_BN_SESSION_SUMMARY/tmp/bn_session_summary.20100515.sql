...
WHERE 
   ...
   a.visit_date = '20100515'::date
;

TRUNCATE SESSION_SUMMARY_20100515;
INSERT INTO SESSION_SUMMARY_20100515
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100515;
SELECT count(*) from SESSION_SUMMARY_20100515;
END;
