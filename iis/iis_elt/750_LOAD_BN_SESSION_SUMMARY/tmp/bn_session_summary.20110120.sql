...
WHERE 
   ...
   a.visit_date = '20110120'::date
;

TRUNCATE SESSION_SUMMARY_20110120;
INSERT INTO SESSION_SUMMARY_20110120
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110120;
SELECT count(*) from SESSION_SUMMARY_20110120;
END;
