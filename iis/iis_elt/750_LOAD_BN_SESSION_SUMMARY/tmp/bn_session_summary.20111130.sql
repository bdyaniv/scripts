...
WHERE 
   ...
   a.visit_date = '20111130'::date
;

TRUNCATE SESSION_SUMMARY_20111130;
INSERT INTO SESSION_SUMMARY_20111130
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111130;
SELECT count(*) from SESSION_SUMMARY_20111130;
END;
