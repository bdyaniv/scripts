...
WHERE 
   ...
   a.visit_date = '20110226'::date
;

TRUNCATE SESSION_SUMMARY_20110226;
INSERT INTO SESSION_SUMMARY_20110226
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110226;
SELECT count(*) from SESSION_SUMMARY_20110226;
END;
