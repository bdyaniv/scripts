...
WHERE 
   ...
   a.visit_date = '20100609'::date
;

TRUNCATE SESSION_SUMMARY_20100609;
INSERT INTO SESSION_SUMMARY_20100609
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100609;
SELECT count(*) from SESSION_SUMMARY_20100609;
END;
