...
WHERE 
   ...
   a.visit_date = '20100407'::date
;

TRUNCATE SESSION_SUMMARY_20100407;
INSERT INTO SESSION_SUMMARY_20100407
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100407;
SELECT count(*) from SESSION_SUMMARY_20100407;
END;
