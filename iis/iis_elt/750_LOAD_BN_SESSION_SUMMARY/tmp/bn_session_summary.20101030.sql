...
WHERE 
   ...
   a.visit_date = '20101030'::date
;

TRUNCATE SESSION_SUMMARY_20101030;
INSERT INTO SESSION_SUMMARY_20101030
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101030;
SELECT count(*) from SESSION_SUMMARY_20101030;
END;
