...
WHERE 
   ...
   a.visit_date = '20100618'::date
;

TRUNCATE SESSION_SUMMARY_20100618;
INSERT INTO SESSION_SUMMARY_20100618
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100618;
SELECT count(*) from SESSION_SUMMARY_20100618;
END;
