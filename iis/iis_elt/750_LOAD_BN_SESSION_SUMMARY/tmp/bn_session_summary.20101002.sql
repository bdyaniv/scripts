...
WHERE 
   ...
   a.visit_date = '20101002'::date
;

TRUNCATE SESSION_SUMMARY_20101002;
INSERT INTO SESSION_SUMMARY_20101002
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101002;
SELECT count(*) from SESSION_SUMMARY_20101002;
END;
