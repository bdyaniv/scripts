...
WHERE 
   ...
   a.visit_date = '20111017'::date
;

TRUNCATE SESSION_SUMMARY_20111017;
INSERT INTO SESSION_SUMMARY_20111017
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111017;
SELECT count(*) from SESSION_SUMMARY_20111017;
END;
