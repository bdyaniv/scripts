...
WHERE 
   ...
   a.visit_date = '20111015'::date
;

TRUNCATE SESSION_SUMMARY_20111015;
INSERT INTO SESSION_SUMMARY_20111015
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111015;
SELECT count(*) from SESSION_SUMMARY_20111015;
END;
