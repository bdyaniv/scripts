...
WHERE 
   ...
   a.visit_date = '20111224'::date
;

TRUNCATE SESSION_SUMMARY_20111224;
INSERT INTO SESSION_SUMMARY_20111224
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111224;
SELECT count(*) from SESSION_SUMMARY_20111224;
END;
