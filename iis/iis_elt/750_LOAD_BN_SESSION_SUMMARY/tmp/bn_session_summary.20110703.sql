...
WHERE 
   ...
   a.visit_date = '20110703'::date
;

TRUNCATE SESSION_SUMMARY_20110703;
INSERT INTO SESSION_SUMMARY_20110703
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110703;
SELECT count(*) from SESSION_SUMMARY_20110703;
END;
