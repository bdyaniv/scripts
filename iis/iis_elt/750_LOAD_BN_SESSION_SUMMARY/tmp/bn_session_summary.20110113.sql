...
WHERE 
   ...
   a.visit_date = '20110113'::date
;

TRUNCATE SESSION_SUMMARY_20110113;
INSERT INTO SESSION_SUMMARY_20110113
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110113;
SELECT count(*) from SESSION_SUMMARY_20110113;
END;
