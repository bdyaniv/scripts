...
WHERE 
   ...
   a.visit_date = '20100830'::date
;

TRUNCATE SESSION_SUMMARY_20100830;
INSERT INTO SESSION_SUMMARY_20100830
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100830;
SELECT count(*) from SESSION_SUMMARY_20100830;
END;
