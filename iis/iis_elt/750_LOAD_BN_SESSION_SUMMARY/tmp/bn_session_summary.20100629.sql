...
WHERE 
   ...
   a.visit_date = '20100629'::date
;

TRUNCATE SESSION_SUMMARY_20100629;
INSERT INTO SESSION_SUMMARY_20100629
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100629;
SELECT count(*) from SESSION_SUMMARY_20100629;
END;
