...
WHERE 
   ...
   a.visit_date = '20100525'::date
;

TRUNCATE SESSION_SUMMARY_20100525;
INSERT INTO SESSION_SUMMARY_20100525
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100525;
SELECT count(*) from SESSION_SUMMARY_20100525;
END;
