...
WHERE 
   ...
   a.visit_date = '20110805'::date
;

TRUNCATE SESSION_SUMMARY_20110805;
INSERT INTO SESSION_SUMMARY_20110805
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110805;
SELECT count(*) from SESSION_SUMMARY_20110805;
END;
