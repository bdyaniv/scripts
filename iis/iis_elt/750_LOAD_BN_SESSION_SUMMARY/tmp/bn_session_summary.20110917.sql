...
WHERE 
   ...
   a.visit_date = '20110917'::date
;

TRUNCATE SESSION_SUMMARY_20110917;
INSERT INTO SESSION_SUMMARY_20110917
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110917;
SELECT count(*) from SESSION_SUMMARY_20110917;
END;
