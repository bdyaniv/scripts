...
WHERE 
   ...
   a.visit_date = '20100310'::date
;

TRUNCATE SESSION_SUMMARY_20100310;
INSERT INTO SESSION_SUMMARY_20100310
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100310;
SELECT count(*) from SESSION_SUMMARY_20100310;
END;
