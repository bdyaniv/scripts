...
WHERE 
   ...
   a.visit_date = '20100311'::date
;

TRUNCATE SESSION_SUMMARY_20100311;
INSERT INTO SESSION_SUMMARY_20100311
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100311;
SELECT count(*) from SESSION_SUMMARY_20100311;
END;
