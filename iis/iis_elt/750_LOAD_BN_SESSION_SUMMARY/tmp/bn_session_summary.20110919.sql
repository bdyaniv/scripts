...
WHERE 
   ...
   a.visit_date = '20110919'::date
;

TRUNCATE SESSION_SUMMARY_20110919;
INSERT INTO SESSION_SUMMARY_20110919
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110919;
SELECT count(*) from SESSION_SUMMARY_20110919;
END;
