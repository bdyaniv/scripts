...
WHERE 
   ...
   a.visit_date = '20110308'::date
;

TRUNCATE SESSION_SUMMARY_20110308;
INSERT INTO SESSION_SUMMARY_20110308
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110308;
SELECT count(*) from SESSION_SUMMARY_20110308;
END;
