...
WHERE 
   ...
   a.visit_date = '20110118'::date
;

TRUNCATE SESSION_SUMMARY_20110118;
INSERT INTO SESSION_SUMMARY_20110118
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110118;
SELECT count(*) from SESSION_SUMMARY_20110118;
END;
