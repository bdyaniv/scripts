...
WHERE 
   ...
   a.visit_date = '20110827'::date
;

TRUNCATE SESSION_SUMMARY_20110827;
INSERT INTO SESSION_SUMMARY_20110827
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110827;
SELECT count(*) from SESSION_SUMMARY_20110827;
END;
