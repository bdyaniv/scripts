...
WHERE 
   ...
   a.visit_date = '20101118'::date
;

TRUNCATE SESSION_SUMMARY_20101118;
INSERT INTO SESSION_SUMMARY_20101118
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101118;
SELECT count(*) from SESSION_SUMMARY_20101118;
END;
