...
WHERE 
   ...
   a.visit_date = '20110502'::date
;

TRUNCATE SESSION_SUMMARY_20110502;
INSERT INTO SESSION_SUMMARY_20110502
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110502;
SELECT count(*) from SESSION_SUMMARY_20110502;
END;
