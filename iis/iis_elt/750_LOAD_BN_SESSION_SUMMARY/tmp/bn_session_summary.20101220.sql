...
WHERE 
   ...
   a.visit_date = '20101220'::date
;

TRUNCATE SESSION_SUMMARY_20101220;
INSERT INTO SESSION_SUMMARY_20101220
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101220;
SELECT count(*) from SESSION_SUMMARY_20101220;
END;
