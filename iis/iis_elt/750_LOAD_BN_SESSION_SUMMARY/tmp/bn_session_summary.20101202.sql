...
WHERE 
   ...
   a.visit_date = '20101202'::date
;

TRUNCATE SESSION_SUMMARY_20101202;
INSERT INTO SESSION_SUMMARY_20101202
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101202;
SELECT count(*) from SESSION_SUMMARY_20101202;
END;
