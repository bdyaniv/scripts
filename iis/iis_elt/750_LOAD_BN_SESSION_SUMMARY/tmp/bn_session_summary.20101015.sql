...
WHERE 
   ...
   a.visit_date = '20101015'::date
;

TRUNCATE SESSION_SUMMARY_20101015;
INSERT INTO SESSION_SUMMARY_20101015
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101015;
SELECT count(*) from SESSION_SUMMARY_20101015;
END;
