...
WHERE 
   ...
   a.visit_date = '20111229'::date
;

TRUNCATE SESSION_SUMMARY_20111229;
INSERT INTO SESSION_SUMMARY_20111229
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111229;
SELECT count(*) from SESSION_SUMMARY_20111229;
END;
