...
WHERE 
   ...
   a.visit_date = '20100606'::date
;

TRUNCATE SESSION_SUMMARY_20100606;
INSERT INTO SESSION_SUMMARY_20100606
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100606;
SELECT count(*) from SESSION_SUMMARY_20100606;
END;
