...
WHERE 
   ...
   a.visit_date = '20110608'::date
;

TRUNCATE SESSION_SUMMARY_20110608;
INSERT INTO SESSION_SUMMARY_20110608
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110608;
SELECT count(*) from SESSION_SUMMARY_20110608;
END;
