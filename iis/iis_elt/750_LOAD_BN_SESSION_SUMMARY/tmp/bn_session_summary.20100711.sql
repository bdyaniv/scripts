...
WHERE 
   ...
   a.visit_date = '20100711'::date
;

TRUNCATE SESSION_SUMMARY_20100711;
INSERT INTO SESSION_SUMMARY_20100711
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100711;
SELECT count(*) from SESSION_SUMMARY_20100711;
END;
