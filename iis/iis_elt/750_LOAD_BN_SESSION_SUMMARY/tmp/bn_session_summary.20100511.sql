...
WHERE 
   ...
   a.visit_date = '20100511'::date
;

TRUNCATE SESSION_SUMMARY_20100511;
INSERT INTO SESSION_SUMMARY_20100511
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100511;
SELECT count(*) from SESSION_SUMMARY_20100511;
END;
