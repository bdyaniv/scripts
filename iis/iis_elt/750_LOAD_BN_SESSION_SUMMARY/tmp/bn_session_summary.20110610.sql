...
WHERE 
   ...
   a.visit_date = '20110610'::date
;

TRUNCATE SESSION_SUMMARY_20110610;
INSERT INTO SESSION_SUMMARY_20110610
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110610;
SELECT count(*) from SESSION_SUMMARY_20110610;
END;
