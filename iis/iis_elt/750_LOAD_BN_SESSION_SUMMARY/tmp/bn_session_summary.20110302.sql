...
WHERE 
   ...
   a.visit_date = '20110302'::date
;

TRUNCATE SESSION_SUMMARY_20110302;
INSERT INTO SESSION_SUMMARY_20110302
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110302;
SELECT count(*) from SESSION_SUMMARY_20110302;
END;
