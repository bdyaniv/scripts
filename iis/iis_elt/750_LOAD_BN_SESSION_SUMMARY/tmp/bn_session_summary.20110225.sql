...
WHERE 
   ...
   a.visit_date = '20110225'::date
;

TRUNCATE SESSION_SUMMARY_20110225;
INSERT INTO SESSION_SUMMARY_20110225
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110225;
SELECT count(*) from SESSION_SUMMARY_20110225;
END;
