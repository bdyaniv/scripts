...
WHERE 
   ...
   a.visit_date = '20110303'::date
;

TRUNCATE SESSION_SUMMARY_20110303;
INSERT INTO SESSION_SUMMARY_20110303
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110303;
SELECT count(*) from SESSION_SUMMARY_20110303;
END;
