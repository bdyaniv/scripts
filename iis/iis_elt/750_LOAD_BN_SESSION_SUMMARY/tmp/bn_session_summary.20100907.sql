...
WHERE 
   ...
   a.visit_date = '20100907'::date
;

TRUNCATE SESSION_SUMMARY_20100907;
INSERT INTO SESSION_SUMMARY_20100907
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100907;
SELECT count(*) from SESSION_SUMMARY_20100907;
END;
