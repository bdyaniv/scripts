...
WHERE 
   ...
   a.visit_date = '20110901'::date
;

TRUNCATE SESSION_SUMMARY_20110901;
INSERT INTO SESSION_SUMMARY_20110901
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110901;
SELECT count(*) from SESSION_SUMMARY_20110901;
END;
