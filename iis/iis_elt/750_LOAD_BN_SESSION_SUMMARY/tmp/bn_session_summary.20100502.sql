...
WHERE 
   ...
   a.visit_date = '20100502'::date
;

TRUNCATE SESSION_SUMMARY_20100502;
INSERT INTO SESSION_SUMMARY_20100502
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100502;
SELECT count(*) from SESSION_SUMMARY_20100502;
END;
