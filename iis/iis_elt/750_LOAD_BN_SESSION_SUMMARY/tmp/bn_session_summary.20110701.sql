...
WHERE 
   ...
   a.visit_date = '20110701'::date
;

TRUNCATE SESSION_SUMMARY_20110701;
INSERT INTO SESSION_SUMMARY_20110701
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110701;
SELECT count(*) from SESSION_SUMMARY_20110701;
END;
