...
WHERE 
   ...
   a.visit_date = '20111209'::date
;

TRUNCATE SESSION_SUMMARY_20111209;
INSERT INTO SESSION_SUMMARY_20111209
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111209;
SELECT count(*) from SESSION_SUMMARY_20111209;
END;
