...
WHERE 
   ...
   a.visit_date = '20110429'::date
;

TRUNCATE SESSION_SUMMARY_20110429;
INSERT INTO SESSION_SUMMARY_20110429
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110429;
SELECT count(*) from SESSION_SUMMARY_20110429;
END;
