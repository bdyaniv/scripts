...
WHERE 
   ...
   a.visit_date = '20110214'::date
;

TRUNCATE SESSION_SUMMARY_20110214;
INSERT INTO SESSION_SUMMARY_20110214
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110214;
SELECT count(*) from SESSION_SUMMARY_20110214;
END;
