...
WHERE 
   ...
   a.visit_date = '20101107'::date
;

TRUNCATE SESSION_SUMMARY_20101107;
INSERT INTO SESSION_SUMMARY_20101107
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101107;
SELECT count(*) from SESSION_SUMMARY_20101107;
END;
