...
WHERE 
   ...
   a.visit_date = '20120107'::date
;

TRUNCATE SESSION_SUMMARY_20120107;
INSERT INTO SESSION_SUMMARY_20120107
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20120107;
SELECT count(*) from SESSION_SUMMARY_20120107;
END;
