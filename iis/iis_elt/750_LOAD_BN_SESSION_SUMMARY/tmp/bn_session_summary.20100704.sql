...
WHERE 
   ...
   a.visit_date = '20100704'::date
;

TRUNCATE SESSION_SUMMARY_20100704;
INSERT INTO SESSION_SUMMARY_20100704
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100704;
SELECT count(*) from SESSION_SUMMARY_20100704;
END;
