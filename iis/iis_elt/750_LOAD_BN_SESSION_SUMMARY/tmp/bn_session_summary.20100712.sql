...
WHERE 
   ...
   a.visit_date = '20100712'::date
;

TRUNCATE SESSION_SUMMARY_20100712;
INSERT INTO SESSION_SUMMARY_20100712
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100712;
SELECT count(*) from SESSION_SUMMARY_20100712;
END;
