...
WHERE 
   ...
   a.visit_date = '20100926'::date
;

TRUNCATE SESSION_SUMMARY_20100926;
INSERT INTO SESSION_SUMMARY_20100926
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100926;
SELECT count(*) from SESSION_SUMMARY_20100926;
END;
