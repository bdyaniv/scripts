...
WHERE 
   ...
   a.visit_date = '20100725'::date
;

TRUNCATE SESSION_SUMMARY_20100725;
INSERT INTO SESSION_SUMMARY_20100725
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100725;
SELECT count(*) from SESSION_SUMMARY_20100725;
END;
