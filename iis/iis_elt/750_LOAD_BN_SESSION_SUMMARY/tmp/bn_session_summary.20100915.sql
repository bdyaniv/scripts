...
WHERE 
   ...
   a.visit_date = '20100915'::date
;

TRUNCATE SESSION_SUMMARY_20100915;
INSERT INTO SESSION_SUMMARY_20100915
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100915;
SELECT count(*) from SESSION_SUMMARY_20100915;
END;
