...
WHERE 
   ...
   a.visit_date = '20100914'::date
;

TRUNCATE SESSION_SUMMARY_20100914;
INSERT INTO SESSION_SUMMARY_20100914
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100914;
SELECT count(*) from SESSION_SUMMARY_20100914;
END;
