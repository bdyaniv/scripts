...
WHERE 
   ...
   a.visit_date = '20110916'::date
;

TRUNCATE SESSION_SUMMARY_20110916;
INSERT INTO SESSION_SUMMARY_20110916
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110916;
SELECT count(*) from SESSION_SUMMARY_20110916;
END;
