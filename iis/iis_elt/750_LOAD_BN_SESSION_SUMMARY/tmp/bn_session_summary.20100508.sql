...
WHERE 
   ...
   a.visit_date = '20100508'::date
;

TRUNCATE SESSION_SUMMARY_20100508;
INSERT INTO SESSION_SUMMARY_20100508
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100508;
SELECT count(*) from SESSION_SUMMARY_20100508;
END;
