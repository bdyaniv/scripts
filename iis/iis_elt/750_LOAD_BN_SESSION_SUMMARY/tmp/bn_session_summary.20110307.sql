...
WHERE 
   ...
   a.visit_date = '20110307'::date
;

TRUNCATE SESSION_SUMMARY_20110307;
INSERT INTO SESSION_SUMMARY_20110307
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110307;
SELECT count(*) from SESSION_SUMMARY_20110307;
END;
