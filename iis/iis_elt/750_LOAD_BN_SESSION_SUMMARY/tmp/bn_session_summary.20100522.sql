...
WHERE 
   ...
   a.visit_date = '20100522'::date
;

TRUNCATE SESSION_SUMMARY_20100522;
INSERT INTO SESSION_SUMMARY_20100522
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100522;
SELECT count(*) from SESSION_SUMMARY_20100522;
END;
