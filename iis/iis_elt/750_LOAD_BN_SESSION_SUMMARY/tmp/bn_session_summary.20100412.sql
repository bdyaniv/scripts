...
WHERE 
   ...
   a.visit_date = '20100412'::date
;

TRUNCATE SESSION_SUMMARY_20100412;
INSERT INTO SESSION_SUMMARY_20100412
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100412;
SELECT count(*) from SESSION_SUMMARY_20100412;
END;
