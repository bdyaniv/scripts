...
WHERE 
   ...
   a.visit_date = '20111202'::date
;

TRUNCATE SESSION_SUMMARY_20111202;
INSERT INTO SESSION_SUMMARY_20111202
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111202;
SELECT count(*) from SESSION_SUMMARY_20111202;
END;
