...
WHERE 
   ...
   a.visit_date = '20101028'::date
;

TRUNCATE SESSION_SUMMARY_20101028;
INSERT INTO SESSION_SUMMARY_20101028
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101028;
SELECT count(*) from SESSION_SUMMARY_20101028;
END;
