...
WHERE 
   ...
   a.visit_date = '20110419'::date
;

TRUNCATE SESSION_SUMMARY_20110419;
INSERT INTO SESSION_SUMMARY_20110419
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110419;
SELECT count(*) from SESSION_SUMMARY_20110419;
END;
