...
WHERE 
   ...
   a.visit_date = '20101106'::date
;

TRUNCATE SESSION_SUMMARY_20101106;
INSERT INTO SESSION_SUMMARY_20101106
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101106;
SELECT count(*) from SESSION_SUMMARY_20101106;
END;
