...
WHERE 
   ...
   a.visit_date = '20100316'::date
;

TRUNCATE SESSION_SUMMARY_20100316;
INSERT INTO SESSION_SUMMARY_20100316
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100316;
SELECT count(*) from SESSION_SUMMARY_20100316;
END;
