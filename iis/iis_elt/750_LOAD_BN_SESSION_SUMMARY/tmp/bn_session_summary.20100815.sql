...
WHERE 
   ...
   a.visit_date = '20100815'::date
;

TRUNCATE SESSION_SUMMARY_20100815;
INSERT INTO SESSION_SUMMARY_20100815
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100815;
SELECT count(*) from SESSION_SUMMARY_20100815;
END;
