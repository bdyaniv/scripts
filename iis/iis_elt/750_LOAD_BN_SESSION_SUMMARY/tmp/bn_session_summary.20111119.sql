...
WHERE 
   ...
   a.visit_date = '20111119'::date
;

TRUNCATE SESSION_SUMMARY_20111119;
INSERT INTO SESSION_SUMMARY_20111119
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111119;
SELECT count(*) from SESSION_SUMMARY_20111119;
END;
