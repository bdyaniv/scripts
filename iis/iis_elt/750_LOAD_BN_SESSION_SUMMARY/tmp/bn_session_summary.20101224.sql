...
WHERE 
   ...
   a.visit_date = '20101224'::date
;

TRUNCATE SESSION_SUMMARY_20101224;
INSERT INTO SESSION_SUMMARY_20101224
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101224;
SELECT count(*) from SESSION_SUMMARY_20101224;
END;
