...
WHERE 
   ...
   a.visit_date = '20100706'::date
;

TRUNCATE SESSION_SUMMARY_20100706;
INSERT INTO SESSION_SUMMARY_20100706
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100706;
SELECT count(*) from SESSION_SUMMARY_20100706;
END;
