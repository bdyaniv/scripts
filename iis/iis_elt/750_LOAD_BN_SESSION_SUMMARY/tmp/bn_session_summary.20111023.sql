...
WHERE 
   ...
   a.visit_date = '20111023'::date
;

TRUNCATE SESSION_SUMMARY_20111023;
INSERT INTO SESSION_SUMMARY_20111023
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111023;
SELECT count(*) from SESSION_SUMMARY_20111023;
END;
