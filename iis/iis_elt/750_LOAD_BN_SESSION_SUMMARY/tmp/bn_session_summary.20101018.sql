...
WHERE 
   ...
   a.visit_date = '20101018'::date
;

TRUNCATE SESSION_SUMMARY_20101018;
INSERT INTO SESSION_SUMMARY_20101018
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101018;
SELECT count(*) from SESSION_SUMMARY_20101018;
END;
