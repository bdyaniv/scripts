...
WHERE 
   ...
   a.visit_date = '20101117'::date
;

TRUNCATE SESSION_SUMMARY_20101117;
INSERT INTO SESSION_SUMMARY_20101117
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101117;
SELECT count(*) from SESSION_SUMMARY_20101117;
END;
