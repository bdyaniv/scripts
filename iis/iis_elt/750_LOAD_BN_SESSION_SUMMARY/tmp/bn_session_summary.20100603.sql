...
WHERE 
   ...
   a.visit_date = '20100603'::date
;

TRUNCATE SESSION_SUMMARY_20100603;
INSERT INTO SESSION_SUMMARY_20100603
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100603;
SELECT count(*) from SESSION_SUMMARY_20100603;
END;
