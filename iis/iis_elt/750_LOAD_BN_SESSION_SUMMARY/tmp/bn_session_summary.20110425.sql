...
WHERE 
   ...
   a.visit_date = '20110425'::date
;

TRUNCATE SESSION_SUMMARY_20110425;
INSERT INTO SESSION_SUMMARY_20110425
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110425;
SELECT count(*) from SESSION_SUMMARY_20110425;
END;
