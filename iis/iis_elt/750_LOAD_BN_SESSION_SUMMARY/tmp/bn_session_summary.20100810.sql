...
WHERE 
   ...
   a.visit_date = '20100810'::date
;

TRUNCATE SESSION_SUMMARY_20100810;
INSERT INTO SESSION_SUMMARY_20100810
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100810;
SELECT count(*) from SESSION_SUMMARY_20100810;
END;
