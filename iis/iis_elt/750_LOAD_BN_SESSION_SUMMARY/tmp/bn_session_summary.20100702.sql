...
WHERE 
   ...
   a.visit_date = '20100702'::date
;

TRUNCATE SESSION_SUMMARY_20100702;
INSERT INTO SESSION_SUMMARY_20100702
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100702;
SELECT count(*) from SESSION_SUMMARY_20100702;
END;
