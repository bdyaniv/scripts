...
WHERE 
   ...
   a.visit_date = '20111012'::date
;

TRUNCATE SESSION_SUMMARY_20111012;
INSERT INTO SESSION_SUMMARY_20111012
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111012;
SELECT count(*) from SESSION_SUMMARY_20111012;
END;
