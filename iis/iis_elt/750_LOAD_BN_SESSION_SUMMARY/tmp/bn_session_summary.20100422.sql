...
WHERE 
   ...
   a.visit_date = '20100422'::date
;

TRUNCATE SESSION_SUMMARY_20100422;
INSERT INTO SESSION_SUMMARY_20100422
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100422;
SELECT count(*) from SESSION_SUMMARY_20100422;
END;
