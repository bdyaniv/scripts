...
WHERE 
   ...
   a.visit_date = '20101207'::date
;

TRUNCATE SESSION_SUMMARY_20101207;
INSERT INTO SESSION_SUMMARY_20101207
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101207;
SELECT count(*) from SESSION_SUMMARY_20101207;
END;
