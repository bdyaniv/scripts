...
WHERE 
   ...
   a.visit_date = '20110613'::date
;

TRUNCATE SESSION_SUMMARY_20110613;
INSERT INTO SESSION_SUMMARY_20110613
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110613;
SELECT count(*) from SESSION_SUMMARY_20110613;
END;
