...
WHERE 
   ...
   a.visit_date = '20100729'::date
;

TRUNCATE SESSION_SUMMARY_20100729;
INSERT INTO SESSION_SUMMARY_20100729
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100729;
SELECT count(*) from SESSION_SUMMARY_20100729;
END;
