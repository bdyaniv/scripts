...
WHERE 
   ...
   a.visit_date = '20100902'::date
;

TRUNCATE SESSION_SUMMARY_20100902;
INSERT INTO SESSION_SUMMARY_20100902
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100902;
SELECT count(*) from SESSION_SUMMARY_20100902;
END;
