...
WHERE 
   ...
   a.visit_date = '20100713'::date
;

TRUNCATE SESSION_SUMMARY_20100713;
INSERT INTO SESSION_SUMMARY_20100713
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100713;
SELECT count(*) from SESSION_SUMMARY_20100713;
END;
