...
WHERE 
   ...
   a.visit_date = '20101024'::date
;

TRUNCATE SESSION_SUMMARY_20101024;
INSERT INTO SESSION_SUMMARY_20101024
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101024;
SELECT count(*) from SESSION_SUMMARY_20101024;
END;
