...
WHERE 
   ...
   a.visit_date = '20110420'::date
;

TRUNCATE SESSION_SUMMARY_20110420;
INSERT INTO SESSION_SUMMARY_20110420
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110420;
SELECT count(*) from SESSION_SUMMARY_20110420;
END;
