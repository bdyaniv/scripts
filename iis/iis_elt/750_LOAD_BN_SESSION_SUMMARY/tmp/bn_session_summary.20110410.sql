...
WHERE 
   ...
   a.visit_date = '20110410'::date
;

TRUNCATE SESSION_SUMMARY_20110410;
INSERT INTO SESSION_SUMMARY_20110410
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110410;
SELECT count(*) from SESSION_SUMMARY_20110410;
END;
