...
WHERE 
   ...
   a.visit_date = '20110618'::date
;

TRUNCATE SESSION_SUMMARY_20110618;
INSERT INTO SESSION_SUMMARY_20110618
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110618;
SELECT count(*) from SESSION_SUMMARY_20110618;
END;
