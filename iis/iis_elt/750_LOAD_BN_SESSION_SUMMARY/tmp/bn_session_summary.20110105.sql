...
WHERE 
   ...
   a.visit_date = '20110105'::date
;

TRUNCATE SESSION_SUMMARY_20110105;
INSERT INTO SESSION_SUMMARY_20110105
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110105;
SELECT count(*) from SESSION_SUMMARY_20110105;
END;
