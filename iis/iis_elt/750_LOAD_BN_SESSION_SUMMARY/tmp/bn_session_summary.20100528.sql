...
WHERE 
   ...
   a.visit_date = '20100528'::date
;

TRUNCATE SESSION_SUMMARY_20100528;
INSERT INTO SESSION_SUMMARY_20100528
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100528;
SELECT count(*) from SESSION_SUMMARY_20100528;
END;
