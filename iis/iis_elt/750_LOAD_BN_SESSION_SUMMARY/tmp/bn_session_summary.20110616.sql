...
WHERE 
   ...
   a.visit_date = '20110616'::date
;

TRUNCATE SESSION_SUMMARY_20110616;
INSERT INTO SESSION_SUMMARY_20110616
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110616;
SELECT count(*) from SESSION_SUMMARY_20110616;
END;
