...
WHERE 
   ...
   a.visit_date = '20110927'::date
;

TRUNCATE SESSION_SUMMARY_20110927;
INSERT INTO SESSION_SUMMARY_20110927
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110927;
SELECT count(*) from SESSION_SUMMARY_20110927;
END;
