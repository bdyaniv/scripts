...
WHERE 
   ...
   a.visit_date = '20110325'::date
;

TRUNCATE SESSION_SUMMARY_20110325;
INSERT INTO SESSION_SUMMARY_20110325
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110325;
SELECT count(*) from SESSION_SUMMARY_20110325;
END;
