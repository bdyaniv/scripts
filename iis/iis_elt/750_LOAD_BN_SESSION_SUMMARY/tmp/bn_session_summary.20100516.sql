...
WHERE 
   ...
   a.visit_date = '20100516'::date
;

TRUNCATE SESSION_SUMMARY_20100516;
INSERT INTO SESSION_SUMMARY_20100516
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100516;
SELECT count(*) from SESSION_SUMMARY_20100516;
END;
