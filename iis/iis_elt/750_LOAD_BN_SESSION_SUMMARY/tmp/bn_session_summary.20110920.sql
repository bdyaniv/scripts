...
WHERE 
   ...
   a.visit_date = '20110920'::date
;

TRUNCATE SESSION_SUMMARY_20110920;
INSERT INTO SESSION_SUMMARY_20110920
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110920;
SELECT count(*) from SESSION_SUMMARY_20110920;
END;
