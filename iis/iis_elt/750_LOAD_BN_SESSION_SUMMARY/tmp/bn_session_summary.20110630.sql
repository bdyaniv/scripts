...
WHERE 
   ...
   a.visit_date = '20110630'::date
;

TRUNCATE SESSION_SUMMARY_20110630;
INSERT INTO SESSION_SUMMARY_20110630
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110630;
SELECT count(*) from SESSION_SUMMARY_20110630;
END;
