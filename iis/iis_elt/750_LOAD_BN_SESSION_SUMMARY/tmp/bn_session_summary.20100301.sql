...
WHERE 
   ...
   a.visit_date = '20100301'::date
;

TRUNCATE SESSION_SUMMARY_20100301;
INSERT INTO SESSION_SUMMARY_20100301
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100301;
SELECT count(*) from SESSION_SUMMARY_20100301;
END;
