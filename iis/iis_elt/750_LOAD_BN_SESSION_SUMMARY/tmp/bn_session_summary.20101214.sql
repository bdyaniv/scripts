...
WHERE 
   ...
   a.visit_date = '20101214'::date
;

TRUNCATE SESSION_SUMMARY_20101214;
INSERT INTO SESSION_SUMMARY_20101214
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101214;
SELECT count(*) from SESSION_SUMMARY_20101214;
END;
