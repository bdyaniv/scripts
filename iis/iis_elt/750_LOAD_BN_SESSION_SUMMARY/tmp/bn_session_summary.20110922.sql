...
WHERE 
   ...
   a.visit_date = '20110922'::date
;

TRUNCATE SESSION_SUMMARY_20110922;
INSERT INTO SESSION_SUMMARY_20110922
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110922;
SELECT count(*) from SESSION_SUMMARY_20110922;
END;
