...
WHERE 
   ...
   a.visit_date = '20100421'::date
;

TRUNCATE SESSION_SUMMARY_20100421;
INSERT INTO SESSION_SUMMARY_20100421
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100421;
SELECT count(*) from SESSION_SUMMARY_20100421;
END;
