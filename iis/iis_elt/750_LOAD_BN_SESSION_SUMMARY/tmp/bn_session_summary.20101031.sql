...
WHERE 
   ...
   a.visit_date = '20101031'::date
;

TRUNCATE SESSION_SUMMARY_20101031;
INSERT INTO SESSION_SUMMARY_20101031
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101031;
SELECT count(*) from SESSION_SUMMARY_20101031;
END;
