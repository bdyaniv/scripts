...
WHERE 
   ...
   a.visit_date = '20100223'::date
;

TRUNCATE SESSION_SUMMARY_20100223;
INSERT INTO SESSION_SUMMARY_20100223
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100223;
SELECT count(*) from SESSION_SUMMARY_20100223;
END;
