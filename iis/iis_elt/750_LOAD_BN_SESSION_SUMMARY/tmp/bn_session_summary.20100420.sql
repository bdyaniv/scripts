...
WHERE 
   ...
   a.visit_date = '20100420'::date
;

TRUNCATE SESSION_SUMMARY_20100420;
INSERT INTO SESSION_SUMMARY_20100420
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100420;
SELECT count(*) from SESSION_SUMMARY_20100420;
END;
