...
WHERE 
   ...
   a.visit_date = '20111219'::date
;

TRUNCATE SESSION_SUMMARY_20111219;
INSERT INTO SESSION_SUMMARY_20111219
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111219;
SELECT count(*) from SESSION_SUMMARY_20111219;
END;
