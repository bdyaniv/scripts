...
WHERE 
   ...
   a.visit_date = '20100415'::date
;

TRUNCATE SESSION_SUMMARY_20100415;
INSERT INTO SESSION_SUMMARY_20100415
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100415;
SELECT count(*) from SESSION_SUMMARY_20100415;
END;
