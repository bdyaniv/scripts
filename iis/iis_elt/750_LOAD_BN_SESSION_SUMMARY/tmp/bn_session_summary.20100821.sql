...
WHERE 
   ...
   a.visit_date = '20100821'::date
;

TRUNCATE SESSION_SUMMARY_20100821;
INSERT INTO SESSION_SUMMARY_20100821
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100821;
SELECT count(*) from SESSION_SUMMARY_20100821;
END;
