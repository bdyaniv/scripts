...
WHERE 
   ...
   a.visit_date = '20101206'::date
;

TRUNCATE SESSION_SUMMARY_20101206;
INSERT INTO SESSION_SUMMARY_20101206
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101206;
SELECT count(*) from SESSION_SUMMARY_20101206;
END;
