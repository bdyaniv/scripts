...
WHERE 
   ...
   a.visit_date = '20100215'::date
;

TRUNCATE SESSION_SUMMARY_20100215;
INSERT INTO SESSION_SUMMARY_20100215
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100215;
SELECT count(*) from SESSION_SUMMARY_20100215;
END;
