...
WHERE 
   ...
   a.visit_date = '20110907'::date
;

TRUNCATE SESSION_SUMMARY_20110907;
INSERT INTO SESSION_SUMMARY_20110907
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110907;
SELECT count(*) from SESSION_SUMMARY_20110907;
END;
