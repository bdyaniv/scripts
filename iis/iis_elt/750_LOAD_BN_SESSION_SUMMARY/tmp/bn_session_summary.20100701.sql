...
WHERE 
   ...
   a.visit_date = '20100701'::date
;

TRUNCATE SESSION_SUMMARY_20100701;
INSERT INTO SESSION_SUMMARY_20100701
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100701;
SELECT count(*) from SESSION_SUMMARY_20100701;
END;
