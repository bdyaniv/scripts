...
WHERE 
   ...
   a.visit_date = '20110709'::date
;

TRUNCATE SESSION_SUMMARY_20110709;
INSERT INTO SESSION_SUMMARY_20110709
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110709;
SELECT count(*) from SESSION_SUMMARY_20110709;
END;
