...
WHERE 
   ...
   a.visit_date = '20110909'::date
;

TRUNCATE SESSION_SUMMARY_20110909;
INSERT INTO SESSION_SUMMARY_20110909
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110909;
SELECT count(*) from SESSION_SUMMARY_20110909;
END;
