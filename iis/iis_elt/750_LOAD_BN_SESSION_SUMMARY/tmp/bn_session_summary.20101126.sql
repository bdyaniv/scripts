...
WHERE 
   ...
   a.visit_date = '20101126'::date
;

TRUNCATE SESSION_SUMMARY_20101126;
INSERT INTO SESSION_SUMMARY_20101126
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101126;
SELECT count(*) from SESSION_SUMMARY_20101126;
END;
