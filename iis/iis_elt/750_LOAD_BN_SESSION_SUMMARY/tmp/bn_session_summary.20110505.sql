...
WHERE 
   ...
   a.visit_date = '20110505'::date
;

TRUNCATE SESSION_SUMMARY_20110505;
INSERT INTO SESSION_SUMMARY_20110505
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110505;
SELECT count(*) from SESSION_SUMMARY_20110505;
END;
