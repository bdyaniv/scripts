...
WHERE 
   ...
   a.visit_date = '20100411'::date
;

TRUNCATE SESSION_SUMMARY_20100411;
INSERT INTO SESSION_SUMMARY_20100411
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100411;
SELECT count(*) from SESSION_SUMMARY_20100411;
END;
