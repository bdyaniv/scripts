...
WHERE 
   ...
   a.visit_date = '20100616'::date
;

TRUNCATE SESSION_SUMMARY_20100616;
INSERT INTO SESSION_SUMMARY_20100616
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100616;
SELECT count(*) from SESSION_SUMMARY_20100616;
END;
