...
WHERE 
   ...
   a.visit_date = '20101029'::date
;

TRUNCATE SESSION_SUMMARY_20101029;
INSERT INTO SESSION_SUMMARY_20101029
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101029;
SELECT count(*) from SESSION_SUMMARY_20101029;
END;
