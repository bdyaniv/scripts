...
WHERE 
   ...
   a.visit_date = '20100705'::date
;

TRUNCATE SESSION_SUMMARY_20100705;
INSERT INTO SESSION_SUMMARY_20100705
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100705;
SELECT count(*) from SESSION_SUMMARY_20100705;
END;
