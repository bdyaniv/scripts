...
WHERE 
   ...
   a.visit_date = '20111125'::date
;

TRUNCATE SESSION_SUMMARY_20111125;
INSERT INTO SESSION_SUMMARY_20111125
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111125;
SELECT count(*) from SESSION_SUMMARY_20111125;
END;
