...
WHERE 
   ...
   a.visit_date = '20110818'::date
;

TRUNCATE SESSION_SUMMARY_20110818;
INSERT INTO SESSION_SUMMARY_20110818
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110818;
SELECT count(*) from SESSION_SUMMARY_20110818;
END;
