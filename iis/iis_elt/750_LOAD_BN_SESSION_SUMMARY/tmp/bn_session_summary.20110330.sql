...
WHERE 
   ...
   a.visit_date = '20110330'::date
;

TRUNCATE SESSION_SUMMARY_20110330;
INSERT INTO SESSION_SUMMARY_20110330
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110330;
SELECT count(*) from SESSION_SUMMARY_20110330;
END;
