...
WHERE 
   ...
   a.visit_date = '20110424'::date
;

TRUNCATE SESSION_SUMMARY_20110424;
INSERT INTO SESSION_SUMMARY_20110424
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110424;
SELECT count(*) from SESSION_SUMMARY_20110424;
END;
