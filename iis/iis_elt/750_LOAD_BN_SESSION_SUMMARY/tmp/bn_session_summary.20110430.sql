...
WHERE 
   ...
   a.visit_date = '20110430'::date
;

TRUNCATE SESSION_SUMMARY_20110430;
INSERT INTO SESSION_SUMMARY_20110430
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110430;
SELECT count(*) from SESSION_SUMMARY_20110430;
END;
