...
WHERE 
   ...
   a.visit_date = '20100612'::date
;

TRUNCATE SESSION_SUMMARY_20100612;
INSERT INTO SESSION_SUMMARY_20100612
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100612;
SELECT count(*) from SESSION_SUMMARY_20100612;
END;
