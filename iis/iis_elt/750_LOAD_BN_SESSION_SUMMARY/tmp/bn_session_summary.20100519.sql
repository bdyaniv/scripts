...
WHERE 
   ...
   a.visit_date = '20100519'::date
;

TRUNCATE SESSION_SUMMARY_20100519;
INSERT INTO SESSION_SUMMARY_20100519
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100519;
SELECT count(*) from SESSION_SUMMARY_20100519;
END;
