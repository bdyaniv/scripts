...
WHERE 
   ...
   a.visit_date = '20100920'::date
;

TRUNCATE SESSION_SUMMARY_20100920;
INSERT INTO SESSION_SUMMARY_20100920
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100920;
SELECT count(*) from SESSION_SUMMARY_20100920;
END;
