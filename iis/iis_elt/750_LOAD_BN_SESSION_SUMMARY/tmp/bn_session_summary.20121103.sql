...
WHERE 
   ...
   a.visit_date = '20121103'::date
;

TRUNCATE SESSION_SUMMARY_20121103;
INSERT INTO SESSION_SUMMARY_20121103
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20121103;
SELECT count(*) from SESSION_SUMMARY_20121103;
END;
