...
WHERE 
   ...
   a.visit_date = '20110823'::date
;

TRUNCATE SESSION_SUMMARY_20110823;
INSERT INTO SESSION_SUMMARY_20110823
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110823;
SELECT count(*) from SESSION_SUMMARY_20110823;
END;
