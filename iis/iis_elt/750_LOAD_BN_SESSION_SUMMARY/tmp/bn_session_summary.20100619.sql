...
WHERE 
   ...
   a.visit_date = '20100619'::date
;

TRUNCATE SESSION_SUMMARY_20100619;
INSERT INTO SESSION_SUMMARY_20100619
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100619;
SELECT count(*) from SESSION_SUMMARY_20100619;
END;
