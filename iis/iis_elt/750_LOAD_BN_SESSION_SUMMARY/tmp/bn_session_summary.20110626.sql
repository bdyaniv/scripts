...
WHERE 
   ...
   a.visit_date = '20110626'::date
;

TRUNCATE SESSION_SUMMARY_20110626;
INSERT INTO SESSION_SUMMARY_20110626
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110626;
SELECT count(*) from SESSION_SUMMARY_20110626;
END;
