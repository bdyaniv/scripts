...
WHERE 
   ...
   a.visit_date = '20100720'::date
;

TRUNCATE SESSION_SUMMARY_20100720;
INSERT INTO SESSION_SUMMARY_20100720
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100720;
SELECT count(*) from SESSION_SUMMARY_20100720;
END;
