...
WHERE 
   ...
   a.visit_date = '20100308'::date
;

TRUNCATE SESSION_SUMMARY_20100308;
INSERT INTO SESSION_SUMMARY_20100308
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100308;
SELECT count(*) from SESSION_SUMMARY_20100308;
END;
