...
WHERE 
   ...
   a.visit_date = '20110130'::date
;

TRUNCATE SESSION_SUMMARY_20110130;
INSERT INTO SESSION_SUMMARY_20110130
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110130;
SELECT count(*) from SESSION_SUMMARY_20110130;
END;
