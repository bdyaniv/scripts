...
WHERE 
   ...
   a.visit_date = '20110906'::date
;

TRUNCATE SESSION_SUMMARY_20110906;
INSERT INTO SESSION_SUMMARY_20110906
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110906;
SELECT count(*) from SESSION_SUMMARY_20110906;
END;
