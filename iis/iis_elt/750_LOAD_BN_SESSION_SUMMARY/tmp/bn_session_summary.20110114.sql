...
WHERE 
   ...
   a.visit_date = '20110114'::date
;

TRUNCATE SESSION_SUMMARY_20110114;
INSERT INTO SESSION_SUMMARY_20110114
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110114;
SELECT count(*) from SESSION_SUMMARY_20110114;
END;
