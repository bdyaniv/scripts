...
WHERE 
   ...
   a.visit_date = '20110416'::date
;

TRUNCATE SESSION_SUMMARY_20110416;
INSERT INTO SESSION_SUMMARY_20110416
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110416;
SELECT count(*) from SESSION_SUMMARY_20110416;
END;
