...
WHERE 
   ...
   a.visit_date = '20100708'::date
;

TRUNCATE SESSION_SUMMARY_20100708;
INSERT INTO SESSION_SUMMARY_20100708
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100708;
SELECT count(*) from SESSION_SUMMARY_20100708;
END;
