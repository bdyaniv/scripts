...
WHERE 
   ...
   a.visit_date = '20110206'::date
;

TRUNCATE SESSION_SUMMARY_20110206;
INSERT INTO SESSION_SUMMARY_20110206
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110206;
SELECT count(*) from SESSION_SUMMARY_20110206;
END;
