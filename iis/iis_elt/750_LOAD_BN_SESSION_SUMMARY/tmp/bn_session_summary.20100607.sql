...
WHERE 
   ...
   a.visit_date = '20100607'::date
;

TRUNCATE SESSION_SUMMARY_20100607;
INSERT INTO SESSION_SUMMARY_20100607
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100607;
SELECT count(*) from SESSION_SUMMARY_20100607;
END;
