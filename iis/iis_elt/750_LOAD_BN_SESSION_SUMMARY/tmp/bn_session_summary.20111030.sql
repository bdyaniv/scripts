...
WHERE 
   ...
   a.visit_date = '20111030'::date
;

TRUNCATE SESSION_SUMMARY_20111030;
INSERT INTO SESSION_SUMMARY_20111030
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111030;
SELECT count(*) from SESSION_SUMMARY_20111030;
END;
