...
WHERE 
   ...
   a.visit_date = '20110710'::date
;

TRUNCATE SESSION_SUMMARY_20110710;
INSERT INTO SESSION_SUMMARY_20110710
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110710;
SELECT count(*) from SESSION_SUMMARY_20110710;
END;
