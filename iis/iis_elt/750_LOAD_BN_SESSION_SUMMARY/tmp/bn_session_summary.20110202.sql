...
WHERE 
   ...
   a.visit_date = '20110202'::date
;

TRUNCATE SESSION_SUMMARY_20110202;
INSERT INTO SESSION_SUMMARY_20110202
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110202;
SELECT count(*) from SESSION_SUMMARY_20110202;
END;
