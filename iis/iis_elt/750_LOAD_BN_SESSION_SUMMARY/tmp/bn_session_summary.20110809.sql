...
WHERE 
   ...
   a.visit_date = '20110809'::date
;

TRUNCATE SESSION_SUMMARY_20110809;
INSERT INTO SESSION_SUMMARY_20110809
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110809;
SELECT count(*) from SESSION_SUMMARY_20110809;
END;
