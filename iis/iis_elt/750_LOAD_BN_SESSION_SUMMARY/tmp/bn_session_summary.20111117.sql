...
WHERE 
   ...
   a.visit_date = '20111117'::date
;

TRUNCATE SESSION_SUMMARY_20111117;
INSERT INTO SESSION_SUMMARY_20111117
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111117;
SELECT count(*) from SESSION_SUMMARY_20111117;
END;
