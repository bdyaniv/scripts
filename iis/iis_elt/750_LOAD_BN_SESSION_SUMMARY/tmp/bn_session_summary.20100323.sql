...
WHERE 
   ...
   a.visit_date = '20100323'::date
;

TRUNCATE SESSION_SUMMARY_20100323;
INSERT INTO SESSION_SUMMARY_20100323
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100323;
SELECT count(*) from SESSION_SUMMARY_20100323;
END;
