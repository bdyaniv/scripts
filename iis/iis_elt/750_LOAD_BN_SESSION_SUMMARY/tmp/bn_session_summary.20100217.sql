...
WHERE 
   ...
   a.visit_date = '20100217'::date
;

TRUNCATE SESSION_SUMMARY_20100217;
INSERT INTO SESSION_SUMMARY_20100217
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100217;
SELECT count(*) from SESSION_SUMMARY_20100217;
END;
