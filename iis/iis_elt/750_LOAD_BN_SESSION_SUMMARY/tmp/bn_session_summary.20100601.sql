...
WHERE 
   ...
   a.visit_date = '20100601'::date
;

TRUNCATE SESSION_SUMMARY_20100601;
INSERT INTO SESSION_SUMMARY_20100601
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100601;
SELECT count(*) from SESSION_SUMMARY_20100601;
END;
