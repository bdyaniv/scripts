...
WHERE 
   ...
   a.visit_date = '20100924'::date
;

TRUNCATE SESSION_SUMMARY_20100924;
INSERT INTO SESSION_SUMMARY_20100924
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100924;
SELECT count(*) from SESSION_SUMMARY_20100924;
END;
