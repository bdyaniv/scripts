...
WHERE 
   ...
   a.visit_date = '20100604'::date
;

TRUNCATE SESSION_SUMMARY_20100604;
INSERT INTO SESSION_SUMMARY_20100604
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100604;
SELECT count(*) from SESSION_SUMMARY_20100604;
END;
