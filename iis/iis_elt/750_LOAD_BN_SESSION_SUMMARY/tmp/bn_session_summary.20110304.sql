...
WHERE 
   ...
   a.visit_date = '20110304'::date
;

TRUNCATE SESSION_SUMMARY_20110304;
INSERT INTO SESSION_SUMMARY_20110304
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110304;
SELECT count(*) from SESSION_SUMMARY_20110304;
END;
