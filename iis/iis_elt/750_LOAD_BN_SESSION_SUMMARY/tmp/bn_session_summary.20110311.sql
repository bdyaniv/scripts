...
WHERE 
   ...
   a.visit_date = '20110311'::date
;

TRUNCATE SESSION_SUMMARY_20110311;
INSERT INTO SESSION_SUMMARY_20110311
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110311;
SELECT count(*) from SESSION_SUMMARY_20110311;
END;
