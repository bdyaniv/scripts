...
WHERE 
   ...
   a.visit_date = '20110426'::date
;

TRUNCATE SESSION_SUMMARY_20110426;
INSERT INTO SESSION_SUMMARY_20110426
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110426;
SELECT count(*) from SESSION_SUMMARY_20110426;
END;
