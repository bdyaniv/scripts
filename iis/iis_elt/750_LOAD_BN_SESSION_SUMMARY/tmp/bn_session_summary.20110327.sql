...
WHERE 
   ...
   a.visit_date = '20110327'::date
;

TRUNCATE SESSION_SUMMARY_20110327;
INSERT INTO SESSION_SUMMARY_20110327
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110327;
SELECT count(*) from SESSION_SUMMARY_20110327;
END;
