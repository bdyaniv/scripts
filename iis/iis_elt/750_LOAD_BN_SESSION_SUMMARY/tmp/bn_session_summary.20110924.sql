...
WHERE 
   ...
   a.visit_date = '20110924'::date
;

TRUNCATE SESSION_SUMMARY_20110924;
INSERT INTO SESSION_SUMMARY_20110924
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110924;
SELECT count(*) from SESSION_SUMMARY_20110924;
END;
