...
WHERE 
   ...
   a.visit_date = '20110401'::date
;

TRUNCATE SESSION_SUMMARY_20110401;
INSERT INTO SESSION_SUMMARY_20110401
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110401;
SELECT count(*) from SESSION_SUMMARY_20110401;
END;
