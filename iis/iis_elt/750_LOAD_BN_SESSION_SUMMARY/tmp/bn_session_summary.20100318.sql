...
WHERE 
   ...
   a.visit_date = '20100318'::date
;

TRUNCATE SESSION_SUMMARY_20100318;
INSERT INTO SESSION_SUMMARY_20100318
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100318;
SELECT count(*) from SESSION_SUMMARY_20100318;
END;
