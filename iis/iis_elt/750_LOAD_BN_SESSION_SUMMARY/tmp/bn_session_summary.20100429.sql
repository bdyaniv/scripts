...
WHERE 
   ...
   a.visit_date = '20100429'::date
;

TRUNCATE SESSION_SUMMARY_20100429;
INSERT INTO SESSION_SUMMARY_20100429
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100429;
SELECT count(*) from SESSION_SUMMARY_20100429;
END;
