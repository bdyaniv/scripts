...
WHERE 
   ...
   a.visit_date = '20101209'::date
;

TRUNCATE SESSION_SUMMARY_20101209;
INSERT INTO SESSION_SUMMARY_20101209
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101209;
SELECT count(*) from SESSION_SUMMARY_20101209;
END;
