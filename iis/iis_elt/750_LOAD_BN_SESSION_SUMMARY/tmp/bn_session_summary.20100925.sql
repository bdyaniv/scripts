...
WHERE 
   ...
   a.visit_date = '20100925'::date
;

TRUNCATE SESSION_SUMMARY_20100925;
INSERT INTO SESSION_SUMMARY_20100925
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100925;
SELECT count(*) from SESSION_SUMMARY_20100925;
END;
