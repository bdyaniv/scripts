...
WHERE 
   ...
   a.visit_date = '20110716'::date
;

TRUNCATE SESSION_SUMMARY_20110716;
INSERT INTO SESSION_SUMMARY_20110716
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110716;
SELECT count(*) from SESSION_SUMMARY_20110716;
END;
