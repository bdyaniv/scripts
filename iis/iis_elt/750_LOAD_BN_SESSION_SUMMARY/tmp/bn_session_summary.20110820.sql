...
WHERE 
   ...
   a.visit_date = '20110820'::date
;

TRUNCATE SESSION_SUMMARY_20110820;
INSERT INTO SESSION_SUMMARY_20110820
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110820;
SELECT count(*) from SESSION_SUMMARY_20110820;
END;
