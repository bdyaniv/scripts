...
WHERE 
   ...
   a.visit_date = '20100717'::date
;

TRUNCATE SESSION_SUMMARY_20100717;
INSERT INTO SESSION_SUMMARY_20100717
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100717;
SELECT count(*) from SESSION_SUMMARY_20100717;
END;
