...
WHERE 
   ...
   a.visit_date = '20101122'::date
;

TRUNCATE SESSION_SUMMARY_20101122;
INSERT INTO SESSION_SUMMARY_20101122
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101122;
SELECT count(*) from SESSION_SUMMARY_20101122;
END;
