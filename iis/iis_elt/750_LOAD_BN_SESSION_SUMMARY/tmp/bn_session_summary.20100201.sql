...
WHERE 
   ...
   a.visit_date = '20100201'::date
;

TRUNCATE SESSION_SUMMARY_20100201;
INSERT INTO SESSION_SUMMARY_20100201
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100201;
SELECT count(*) from SESSION_SUMMARY_20100201;
END;
