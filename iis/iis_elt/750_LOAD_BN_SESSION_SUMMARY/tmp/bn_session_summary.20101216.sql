...
WHERE 
   ...
   a.visit_date = '20101216'::date
;

TRUNCATE SESSION_SUMMARY_20101216;
INSERT INTO SESSION_SUMMARY_20101216
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101216;
SELECT count(*) from SESSION_SUMMARY_20101216;
END;
