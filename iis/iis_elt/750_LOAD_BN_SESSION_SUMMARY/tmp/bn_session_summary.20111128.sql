...
WHERE 
   ...
   a.visit_date = '20111128'::date
;

TRUNCATE SESSION_SUMMARY_20111128;
INSERT INTO SESSION_SUMMARY_20111128
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111128;
SELECT count(*) from SESSION_SUMMARY_20111128;
END;
