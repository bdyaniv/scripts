...
WHERE 
   ...
   a.visit_date = '20110126'::date
;

TRUNCATE SESSION_SUMMARY_20110126;
INSERT INTO SESSION_SUMMARY_20110126
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110126;
SELECT count(*) from SESSION_SUMMARY_20110126;
END;
