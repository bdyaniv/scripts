...
WHERE 
   ...
   a.visit_date = '20100222'::date
;

TRUNCATE SESSION_SUMMARY_20100222;
INSERT INTO SESSION_SUMMARY_20100222
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100222;
SELECT count(*) from SESSION_SUMMARY_20100222;
END;
