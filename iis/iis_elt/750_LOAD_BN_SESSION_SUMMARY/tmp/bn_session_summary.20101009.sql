...
WHERE 
   ...
   a.visit_date = '20101009'::date
;

TRUNCATE SESSION_SUMMARY_20101009;
INSERT INTO SESSION_SUMMARY_20101009
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101009;
SELECT count(*) from SESSION_SUMMARY_20101009;
END;
