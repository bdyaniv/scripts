...
WHERE 
   ...
   a.visit_date = '20110625'::date
;

TRUNCATE SESSION_SUMMARY_20110625;
INSERT INTO SESSION_SUMMARY_20110625
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110625;
SELECT count(*) from SESSION_SUMMARY_20110625;
END;
