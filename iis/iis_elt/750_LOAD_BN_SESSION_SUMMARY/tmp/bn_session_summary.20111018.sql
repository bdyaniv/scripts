...
WHERE 
   ...
   a.visit_date = '20111018'::date
;

TRUNCATE SESSION_SUMMARY_20111018;
INSERT INTO SESSION_SUMMARY_20111018
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111018;
SELECT count(*) from SESSION_SUMMARY_20111018;
END;
