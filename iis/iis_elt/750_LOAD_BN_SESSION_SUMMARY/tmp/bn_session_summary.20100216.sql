...
WHERE 
   ...
   a.visit_date = '20100216'::date
;

TRUNCATE SESSION_SUMMARY_20100216;
INSERT INTO SESSION_SUMMARY_20100216
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100216;
SELECT count(*) from SESSION_SUMMARY_20100216;
END;
