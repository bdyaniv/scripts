...
WHERE 
   ...
   a.visit_date = '20110402'::date
;

TRUNCATE SESSION_SUMMARY_20110402;
INSERT INTO SESSION_SUMMARY_20110402
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110402;
SELECT count(*) from SESSION_SUMMARY_20110402;
END;
