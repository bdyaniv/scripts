...
WHERE 
   ...
   a.visit_date = '20110702'::date
;

TRUNCATE SESSION_SUMMARY_20110702;
INSERT INTO SESSION_SUMMARY_20110702
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110702;
SELECT count(*) from SESSION_SUMMARY_20110702;
END;
