...
WHERE 
   ...
   a.visit_date = '20111011'::date
;

TRUNCATE SESSION_SUMMARY_20111011;
INSERT INTO SESSION_SUMMARY_20111011
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111011;
SELECT count(*) from SESSION_SUMMARY_20111011;
END;
