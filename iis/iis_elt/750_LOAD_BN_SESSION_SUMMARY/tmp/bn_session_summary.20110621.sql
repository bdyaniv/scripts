...
WHERE 
   ...
   a.visit_date = '20110621'::date
;

TRUNCATE SESSION_SUMMARY_20110621;
INSERT INTO SESSION_SUMMARY_20110621
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110621;
SELECT count(*) from SESSION_SUMMARY_20110621;
END;
