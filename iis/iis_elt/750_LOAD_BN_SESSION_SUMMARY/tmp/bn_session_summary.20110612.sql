...
WHERE 
   ...
   a.visit_date = '20110612'::date
;

TRUNCATE SESSION_SUMMARY_20110612;
INSERT INTO SESSION_SUMMARY_20110612
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110612;
SELECT count(*) from SESSION_SUMMARY_20110612;
END;
