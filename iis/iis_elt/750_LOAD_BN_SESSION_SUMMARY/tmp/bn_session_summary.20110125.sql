...
WHERE 
   ...
   a.visit_date = '20110125'::date
;

TRUNCATE SESSION_SUMMARY_20110125;
INSERT INTO SESSION_SUMMARY_20110125
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110125;
SELECT count(*) from SESSION_SUMMARY_20110125;
END;
