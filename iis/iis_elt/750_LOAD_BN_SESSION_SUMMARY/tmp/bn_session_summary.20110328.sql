...
WHERE 
   ...
   a.visit_date = '20110328'::date
;

TRUNCATE SESSION_SUMMARY_20110328;
INSERT INTO SESSION_SUMMARY_20110328
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110328;
SELECT count(*) from SESSION_SUMMARY_20110328;
END;
