...
WHERE 
   ...
   a.visit_date = '20110615'::date
;

TRUNCATE SESSION_SUMMARY_20110615;
INSERT INTO SESSION_SUMMARY_20110615
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110615;
SELECT count(*) from SESSION_SUMMARY_20110615;
END;
