...
WHERE 
   ...
   a.visit_date = '20101005'::date
;

TRUNCATE SESSION_SUMMARY_20101005;
INSERT INTO SESSION_SUMMARY_20101005
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101005;
SELECT count(*) from SESSION_SUMMARY_20101005;
END;
