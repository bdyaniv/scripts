...
WHERE 
   ...
   a.visit_date = '20111114'::date
;

TRUNCATE SESSION_SUMMARY_20111114;
INSERT INTO SESSION_SUMMARY_20111114
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111114;
SELECT count(*) from SESSION_SUMMARY_20111114;
END;
