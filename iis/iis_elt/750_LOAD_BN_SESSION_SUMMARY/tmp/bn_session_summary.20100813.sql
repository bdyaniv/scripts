...
WHERE 
   ...
   a.visit_date = '20100813'::date
;

TRUNCATE SESSION_SUMMARY_20100813;
INSERT INTO SESSION_SUMMARY_20100813
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100813;
SELECT count(*) from SESSION_SUMMARY_20100813;
END;
