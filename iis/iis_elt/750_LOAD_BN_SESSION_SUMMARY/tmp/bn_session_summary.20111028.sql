...
WHERE 
   ...
   a.visit_date = '20111028'::date
;

TRUNCATE SESSION_SUMMARY_20111028;
INSERT INTO SESSION_SUMMARY_20111028
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111028;
SELECT count(*) from SESSION_SUMMARY_20111028;
END;
