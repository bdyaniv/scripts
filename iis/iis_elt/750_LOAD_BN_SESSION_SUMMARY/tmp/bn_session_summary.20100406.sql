...
WHERE 
   ...
   a.visit_date = '20100406'::date
;

TRUNCATE SESSION_SUMMARY_20100406;
INSERT INTO SESSION_SUMMARY_20100406
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100406;
SELECT count(*) from SESSION_SUMMARY_20100406;
END;
