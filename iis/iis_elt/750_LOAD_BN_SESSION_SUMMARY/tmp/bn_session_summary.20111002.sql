...
WHERE 
   ...
   a.visit_date = '20111002'::date
;

TRUNCATE SESSION_SUMMARY_20111002;
INSERT INTO SESSION_SUMMARY_20111002
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111002;
SELECT count(*) from SESSION_SUMMARY_20111002;
END;
