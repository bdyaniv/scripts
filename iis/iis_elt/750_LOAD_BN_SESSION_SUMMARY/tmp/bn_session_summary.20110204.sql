...
WHERE 
   ...
   a.visit_date = '20110204'::date
;

TRUNCATE SESSION_SUMMARY_20110204;
INSERT INTO SESSION_SUMMARY_20110204
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110204;
SELECT count(*) from SESSION_SUMMARY_20110204;
END;
