...
WHERE 
   ...
   a.visit_date = '20110624'::date
;

TRUNCATE SESSION_SUMMARY_20110624;
INSERT INTO SESSION_SUMMARY_20110624
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110624;
SELECT count(*) from SESSION_SUMMARY_20110624;
END;
