...
WHERE 
   ...
   a.visit_date = '20100315'::date
;

TRUNCATE SESSION_SUMMARY_20100315;
INSERT INTO SESSION_SUMMARY_20100315
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100315;
SELECT count(*) from SESSION_SUMMARY_20100315;
END;
