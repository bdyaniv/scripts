...
WHERE 
   ...
   a.visit_date = '20110804'::date
;

TRUNCATE SESSION_SUMMARY_20110804;
INSERT INTO SESSION_SUMMARY_20110804
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110804;
SELECT count(*) from SESSION_SUMMARY_20110804;
END;
