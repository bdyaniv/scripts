...
WHERE 
   ...
   a.visit_date = '20110923'::date
;

TRUNCATE SESSION_SUMMARY_20110923;
INSERT INTO SESSION_SUMMARY_20110923
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110923;
SELECT count(*) from SESSION_SUMMARY_20110923;
END;
