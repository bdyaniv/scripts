...
WHERE 
   ...
   a.visit_date = '20110222'::date
;

TRUNCATE SESSION_SUMMARY_20110222;
INSERT INTO SESSION_SUMMARY_20110222
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110222;
SELECT count(*) from SESSION_SUMMARY_20110222;
END;
