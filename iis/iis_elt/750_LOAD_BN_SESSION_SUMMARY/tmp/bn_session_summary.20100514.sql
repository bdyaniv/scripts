...
WHERE 
   ...
   a.visit_date = '20100514'::date
;

TRUNCATE SESSION_SUMMARY_20100514;
INSERT INTO SESSION_SUMMARY_20100514
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100514;
SELECT count(*) from SESSION_SUMMARY_20100514;
END;
