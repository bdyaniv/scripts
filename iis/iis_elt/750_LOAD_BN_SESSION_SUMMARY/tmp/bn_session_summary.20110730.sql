...
WHERE 
   ...
   a.visit_date = '20110730'::date
;

TRUNCATE SESSION_SUMMARY_20110730;
INSERT INTO SESSION_SUMMARY_20110730
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110730;
SELECT count(*) from SESSION_SUMMARY_20110730;
END;
