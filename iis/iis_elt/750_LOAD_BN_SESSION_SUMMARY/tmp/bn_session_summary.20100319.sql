...
WHERE 
   ...
   a.visit_date = '20100319'::date
;

TRUNCATE SESSION_SUMMARY_20100319;
INSERT INTO SESSION_SUMMARY_20100319
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100319;
SELECT count(*) from SESSION_SUMMARY_20100319;
END;
