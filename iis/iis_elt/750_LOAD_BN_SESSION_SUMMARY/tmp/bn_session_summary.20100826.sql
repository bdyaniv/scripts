...
WHERE 
   ...
   a.visit_date = '20100826'::date
;

TRUNCATE SESSION_SUMMARY_20100826;
INSERT INTO SESSION_SUMMARY_20100826
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100826;
SELECT count(*) from SESSION_SUMMARY_20100826;
END;
