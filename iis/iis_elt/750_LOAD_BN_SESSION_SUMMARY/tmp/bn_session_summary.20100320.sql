...
WHERE 
   ...
   a.visit_date = '20100320'::date
;

TRUNCATE SESSION_SUMMARY_20100320;
INSERT INTO SESSION_SUMMARY_20100320
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100320;
SELECT count(*) from SESSION_SUMMARY_20100320;
END;
