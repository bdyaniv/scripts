...
WHERE 
   ...
   a.visit_date = '20100710'::date
;

TRUNCATE SESSION_SUMMARY_20100710;
INSERT INTO SESSION_SUMMARY_20100710
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100710;
SELECT count(*) from SESSION_SUMMARY_20100710;
END;
