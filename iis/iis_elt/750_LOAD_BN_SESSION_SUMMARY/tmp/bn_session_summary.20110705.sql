...
WHERE 
   ...
   a.visit_date = '20110705'::date
;

TRUNCATE SESSION_SUMMARY_20110705;
INSERT INTO SESSION_SUMMARY_20110705
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110705;
SELECT count(*) from SESSION_SUMMARY_20110705;
END;
