...
WHERE 
   ...
   a.visit_date = '20100209'::date
;

TRUNCATE SESSION_SUMMARY_20100209;
INSERT INTO SESSION_SUMMARY_20100209
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100209;
SELECT count(*) from SESSION_SUMMARY_20100209;
END;
