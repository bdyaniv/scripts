...
WHERE 
   ...
   a.visit_date = '20111218'::date
;

TRUNCATE SESSION_SUMMARY_20111218;
INSERT INTO SESSION_SUMMARY_20111218
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111218;
SELECT count(*) from SESSION_SUMMARY_20111218;
END;
