...
WHERE 
   ...
   a.visit_date = '20101219'::date
;

TRUNCATE SESSION_SUMMARY_20101219;
INSERT INTO SESSION_SUMMARY_20101219
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101219;
SELECT count(*) from SESSION_SUMMARY_20101219;
END;
