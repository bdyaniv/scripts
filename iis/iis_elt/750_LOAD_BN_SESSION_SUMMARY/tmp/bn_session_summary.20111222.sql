...
WHERE 
   ...
   a.visit_date = '20111222'::date
;

TRUNCATE SESSION_SUMMARY_20111222;
INSERT INTO SESSION_SUMMARY_20111222
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111222;
SELECT count(*) from SESSION_SUMMARY_20111222;
END;
