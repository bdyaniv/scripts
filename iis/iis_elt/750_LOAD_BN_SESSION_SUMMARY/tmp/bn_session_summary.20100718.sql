...
WHERE 
   ...
   a.visit_date = '20100718'::date
;

TRUNCATE SESSION_SUMMARY_20100718;
INSERT INTO SESSION_SUMMARY_20100718
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100718;
SELECT count(*) from SESSION_SUMMARY_20100718;
END;
