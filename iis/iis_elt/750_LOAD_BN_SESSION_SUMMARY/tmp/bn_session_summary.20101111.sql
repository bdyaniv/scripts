...
WHERE 
   ...
   a.visit_date = '20101111'::date
;

TRUNCATE SESSION_SUMMARY_20101111;
INSERT INTO SESSION_SUMMARY_20101111
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101111;
SELECT count(*) from SESSION_SUMMARY_20101111;
END;
