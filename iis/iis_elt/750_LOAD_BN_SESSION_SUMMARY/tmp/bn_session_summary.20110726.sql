...
WHERE 
   ...
   a.visit_date = '20110726'::date
;

TRUNCATE SESSION_SUMMARY_20110726;
INSERT INTO SESSION_SUMMARY_20110726
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110726;
SELECT count(*) from SESSION_SUMMARY_20110726;
END;
