...
WHERE 
   ...
   a.visit_date = '20110925'::date
;

TRUNCATE SESSION_SUMMARY_20110925;
INSERT INTO SESSION_SUMMARY_20110925
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110925;
SELECT count(*) from SESSION_SUMMARY_20110925;
END;
