...
WHERE 
   ...
   a.visit_date = '20110603'::date
;

TRUNCATE SESSION_SUMMARY_20110603;
INSERT INTO SESSION_SUMMARY_20110603
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110603;
SELECT count(*) from SESSION_SUMMARY_20110603;
END;
