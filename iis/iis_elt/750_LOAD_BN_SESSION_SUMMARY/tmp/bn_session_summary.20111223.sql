...
WHERE 
   ...
   a.visit_date = '20111223'::date
;

TRUNCATE SESSION_SUMMARY_20111223;
INSERT INTO SESSION_SUMMARY_20111223
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111223;
SELECT count(*) from SESSION_SUMMARY_20111223;
END;
