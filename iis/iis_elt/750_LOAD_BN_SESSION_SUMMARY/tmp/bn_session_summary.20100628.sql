...
WHERE 
   ...
   a.visit_date = '20100628'::date
;

TRUNCATE SESSION_SUMMARY_20100628;
INSERT INTO SESSION_SUMMARY_20100628
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100628;
SELECT count(*) from SESSION_SUMMARY_20100628;
END;
