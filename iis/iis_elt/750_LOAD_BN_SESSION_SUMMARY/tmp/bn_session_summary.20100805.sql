...
WHERE 
   ...
   a.visit_date = '20100805'::date
;

TRUNCATE SESSION_SUMMARY_20100805;
INSERT INTO SESSION_SUMMARY_20100805
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100805;
SELECT count(*) from SESSION_SUMMARY_20100805;
END;
