...
WHERE 
   ...
   a.visit_date = '20110926'::date
;

TRUNCATE SESSION_SUMMARY_20110926;
INSERT INTO SESSION_SUMMARY_20110926
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110926;
SELECT count(*) from SESSION_SUMMARY_20110926;
END;
