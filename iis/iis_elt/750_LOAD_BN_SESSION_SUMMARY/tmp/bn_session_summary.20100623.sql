...
WHERE 
   ...
   a.visit_date = '20100623'::date
;

TRUNCATE SESSION_SUMMARY_20100623;
INSERT INTO SESSION_SUMMARY_20100623
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100623;
SELECT count(*) from SESSION_SUMMARY_20100623;
END;
