...
WHERE 
   ...
   a.visit_date = '20100410'::date
;

TRUNCATE SESSION_SUMMARY_20100410;
INSERT INTO SESSION_SUMMARY_20100410
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100410;
SELECT count(*) from SESSION_SUMMARY_20100410;
END;
