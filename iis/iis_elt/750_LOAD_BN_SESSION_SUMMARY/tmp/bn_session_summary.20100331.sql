...
WHERE 
   ...
   a.visit_date = '20100331'::date
;

TRUNCATE SESSION_SUMMARY_20100331;
INSERT INTO SESSION_SUMMARY_20100331
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100331;
SELECT count(*) from SESSION_SUMMARY_20100331;
END;
