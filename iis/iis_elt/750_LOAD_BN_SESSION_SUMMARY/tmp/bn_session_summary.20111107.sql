...
WHERE 
   ...
   a.visit_date = '20111107'::date
;

TRUNCATE SESSION_SUMMARY_20111107;
INSERT INTO SESSION_SUMMARY_20111107
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111107;
SELECT count(*) from SESSION_SUMMARY_20111107;
END;
