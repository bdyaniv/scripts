...
WHERE 
   ...
   a.visit_date = '20100723'::date
;

TRUNCATE SESSION_SUMMARY_20100723;
INSERT INTO SESSION_SUMMARY_20100723
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100723;
SELECT count(*) from SESSION_SUMMARY_20100723;
END;
