...
WHERE 
   ...
   a.visit_date = '20100513'::date
;

TRUNCATE SESSION_SUMMARY_20100513;
INSERT INTO SESSION_SUMMARY_20100513
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100513;
SELECT count(*) from SESSION_SUMMARY_20100513;
END;
