...
WHERE 
   ...
   a.visit_date = '20100503'::date
;

TRUNCATE SESSION_SUMMARY_20100503;
INSERT INTO SESSION_SUMMARY_20100503
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100503;
SELECT count(*) from SESSION_SUMMARY_20100503;
END;
