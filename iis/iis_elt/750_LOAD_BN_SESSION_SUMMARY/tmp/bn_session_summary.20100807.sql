...
WHERE 
   ...
   a.visit_date = '20100807'::date
;

TRUNCATE SESSION_SUMMARY_20100807;
INSERT INTO SESSION_SUMMARY_20100807
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100807;
SELECT count(*) from SESSION_SUMMARY_20100807;
END;
