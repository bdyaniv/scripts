...
WHERE 
   ...
   a.visit_date = '20110318'::date
;

TRUNCATE SESSION_SUMMARY_20110318;
INSERT INTO SESSION_SUMMARY_20110318
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110318;
SELECT count(*) from SESSION_SUMMARY_20110318;
END;
