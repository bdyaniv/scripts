...
WHERE 
   ...
   a.visit_date = '20110212'::date
;

TRUNCATE SESSION_SUMMARY_20110212;
INSERT INTO SESSION_SUMMARY_20110212
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110212;
SELECT count(*) from SESSION_SUMMARY_20110212;
END;
