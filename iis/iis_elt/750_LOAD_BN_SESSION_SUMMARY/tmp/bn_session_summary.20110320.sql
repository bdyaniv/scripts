...
WHERE 
   ...
   a.visit_date = '20110320'::date
;

TRUNCATE SESSION_SUMMARY_20110320;
INSERT INTO SESSION_SUMMARY_20110320
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110320;
SELECT count(*) from SESSION_SUMMARY_20110320;
END;
