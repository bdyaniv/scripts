...
WHERE 
   ...
   a.visit_date = '20100218'::date
;

TRUNCATE SESSION_SUMMARY_20100218;
INSERT INTO SESSION_SUMMARY_20100218
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100218;
SELECT count(*) from SESSION_SUMMARY_20100218;
END;
