...
WHERE 
   ...
   a.visit_date = '20111129'::date
;

TRUNCATE SESSION_SUMMARY_20111129;
INSERT INTO SESSION_SUMMARY_20111129
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111129;
SELECT count(*) from SESSION_SUMMARY_20111129;
END;
