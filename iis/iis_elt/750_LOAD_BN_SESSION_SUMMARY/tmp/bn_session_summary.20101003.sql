...
WHERE 
   ...
   a.visit_date = '20101003'::date
;

TRUNCATE SESSION_SUMMARY_20101003;
INSERT INTO SESSION_SUMMARY_20101003
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101003;
SELECT count(*) from SESSION_SUMMARY_20101003;
END;
