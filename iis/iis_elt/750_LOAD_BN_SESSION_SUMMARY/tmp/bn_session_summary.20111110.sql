...
WHERE 
   ...
   a.visit_date = '20111110'::date
;

TRUNCATE SESSION_SUMMARY_20111110;
INSERT INTO SESSION_SUMMARY_20111110
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111110;
SELECT count(*) from SESSION_SUMMARY_20111110;
END;
