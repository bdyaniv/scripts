...
WHERE 
   ...
   a.visit_date = '20100404'::date
;

TRUNCATE SESSION_SUMMARY_20100404;
INSERT INTO SESSION_SUMMARY_20100404
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100404;
SELECT count(*) from SESSION_SUMMARY_20100404;
END;
