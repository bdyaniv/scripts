...
WHERE 
   ...
   a.visit_date = '20101008'::date
;

TRUNCATE SESSION_SUMMARY_20101008;
INSERT INTO SESSION_SUMMARY_20101008
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101008;
SELECT count(*) from SESSION_SUMMARY_20101008;
END;
