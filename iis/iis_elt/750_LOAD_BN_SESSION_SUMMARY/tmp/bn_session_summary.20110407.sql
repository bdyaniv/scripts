...
WHERE 
   ...
   a.visit_date = '20110407'::date
;

TRUNCATE SESSION_SUMMARY_20110407;
INSERT INTO SESSION_SUMMARY_20110407
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110407;
SELECT count(*) from SESSION_SUMMARY_20110407;
END;
