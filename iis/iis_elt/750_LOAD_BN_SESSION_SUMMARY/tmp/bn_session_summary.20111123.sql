...
WHERE 
   ...
   a.visit_date = '20111123'::date
;

TRUNCATE SESSION_SUMMARY_20111123;
INSERT INTO SESSION_SUMMARY_20111123
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111123;
SELECT count(*) from SESSION_SUMMARY_20111123;
END;
