...
WHERE 
   ...
   a.visit_date = '20110115'::date
;

TRUNCATE SESSION_SUMMARY_20110115;
INSERT INTO SESSION_SUMMARY_20110115
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110115;
SELECT count(*) from SESSION_SUMMARY_20110115;
END;
