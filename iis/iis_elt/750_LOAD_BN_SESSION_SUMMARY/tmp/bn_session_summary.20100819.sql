...
WHERE 
   ...
   a.visit_date = '20100819'::date
;

TRUNCATE SESSION_SUMMARY_20100819;
INSERT INTO SESSION_SUMMARY_20100819
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100819;
SELECT count(*) from SESSION_SUMMARY_20100819;
END;
