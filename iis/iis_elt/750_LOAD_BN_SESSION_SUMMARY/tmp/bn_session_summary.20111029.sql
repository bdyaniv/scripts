...
WHERE 
   ...
   a.visit_date = '20111029'::date
;

TRUNCATE SESSION_SUMMARY_20111029;
INSERT INTO SESSION_SUMMARY_20111029
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111029;
SELECT count(*) from SESSION_SUMMARY_20111029;
END;
