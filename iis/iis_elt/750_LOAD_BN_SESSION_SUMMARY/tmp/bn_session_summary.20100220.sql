...
WHERE 
   ...
   a.visit_date = '20100220'::date
;

TRUNCATE SESSION_SUMMARY_20100220;
INSERT INTO SESSION_SUMMARY_20100220
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100220;
SELECT count(*) from SESSION_SUMMARY_20100220;
END;
