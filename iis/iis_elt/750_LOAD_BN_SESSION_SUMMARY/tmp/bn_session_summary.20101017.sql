...
WHERE 
   ...
   a.visit_date = '20101017'::date
;

TRUNCATE SESSION_SUMMARY_20101017;
INSERT INTO SESSION_SUMMARY_20101017
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101017;
SELECT count(*) from SESSION_SUMMARY_20101017;
END;
