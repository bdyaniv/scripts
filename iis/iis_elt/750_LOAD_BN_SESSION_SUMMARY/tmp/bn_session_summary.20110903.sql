...
WHERE 
   ...
   a.visit_date = '20110903'::date
;

TRUNCATE SESSION_SUMMARY_20110903;
INSERT INTO SESSION_SUMMARY_20110903
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110903;
SELECT count(*) from SESSION_SUMMARY_20110903;
END;
