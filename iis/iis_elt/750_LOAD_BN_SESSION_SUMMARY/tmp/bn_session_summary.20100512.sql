...
WHERE 
   ...
   a.visit_date = '20100512'::date
;

TRUNCATE SESSION_SUMMARY_20100512;
INSERT INTO SESSION_SUMMARY_20100512
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100512;
SELECT count(*) from SESSION_SUMMARY_20100512;
END;
