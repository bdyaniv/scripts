...
WHERE 
   ...
   a.visit_date = '20110623'::date
;

TRUNCATE SESSION_SUMMARY_20110623;
INSERT INTO SESSION_SUMMARY_20110623
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110623;
SELECT count(*) from SESSION_SUMMARY_20110623;
END;
