...
WHERE 
   ...
   a.visit_date = '20110826'::date
;

TRUNCATE SESSION_SUMMARY_20110826;
INSERT INTO SESSION_SUMMARY_20110826
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110826;
SELECT count(*) from SESSION_SUMMARY_20110826;
END;
