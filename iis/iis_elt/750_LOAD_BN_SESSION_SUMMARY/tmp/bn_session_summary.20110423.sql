...
WHERE 
   ...
   a.visit_date = '20110423'::date
;

TRUNCATE SESSION_SUMMARY_20110423;
INSERT INTO SESSION_SUMMARY_20110423
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110423;
SELECT count(*) from SESSION_SUMMARY_20110423;
END;
