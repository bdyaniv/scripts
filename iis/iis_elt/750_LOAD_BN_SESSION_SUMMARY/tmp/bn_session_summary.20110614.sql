...
WHERE 
   ...
   a.visit_date = '20110614'::date
;

TRUNCATE SESSION_SUMMARY_20110614;
INSERT INTO SESSION_SUMMARY_20110614
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110614;
SELECT count(*) from SESSION_SUMMARY_20110614;
END;
