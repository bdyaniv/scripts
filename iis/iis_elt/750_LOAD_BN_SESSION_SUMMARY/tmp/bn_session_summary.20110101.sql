...
WHERE 
   ...
   a.visit_date = '20110101'::date
;

TRUNCATE SESSION_SUMMARY_20110101;
INSERT INTO SESSION_SUMMARY_20110101
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110101;
SELECT count(*) from SESSION_SUMMARY_20110101;
END;
