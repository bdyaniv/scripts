...
WHERE 
   ...
   a.visit_date = '20111031'::date
;

TRUNCATE SESSION_SUMMARY_20111031;
INSERT INTO SESSION_SUMMARY_20111031
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111031;
SELECT count(*) from SESSION_SUMMARY_20111031;
END;
