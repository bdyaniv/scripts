...
WHERE 
   ...
   a.visit_date = '20100327'::date
;

TRUNCATE SESSION_SUMMARY_20100327;
INSERT INTO SESSION_SUMMARY_20100327
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100327;
SELECT count(*) from SESSION_SUMMARY_20100327;
END;
