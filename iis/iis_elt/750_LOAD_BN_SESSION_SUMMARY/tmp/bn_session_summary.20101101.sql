...
WHERE 
   ...
   a.visit_date = '20101101'::date
;

TRUNCATE SESSION_SUMMARY_20101101;
INSERT INTO SESSION_SUMMARY_20101101
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101101;
SELECT count(*) from SESSION_SUMMARY_20101101;
END;
