...
WHERE 
   ...
   a.visit_date = '20101012'::date
;

TRUNCATE SESSION_SUMMARY_20101012;
INSERT INTO SESSION_SUMMARY_20101012
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101012;
SELECT count(*) from SESSION_SUMMARY_20101012;
END;
