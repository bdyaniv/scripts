...
WHERE 
   ...
   a.visit_date = '20110706'::date
;

TRUNCATE SESSION_SUMMARY_20110706;
INSERT INTO SESSION_SUMMARY_20110706
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110706;
SELECT count(*) from SESSION_SUMMARY_20110706;
END;
