...
WHERE 
   ...
   a.visit_date = '20120109'::date
;

TRUNCATE SESSION_SUMMARY_20120109;
INSERT INTO SESSION_SUMMARY_20120109
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20120109;
SELECT count(*) from SESSION_SUMMARY_20120109;
END;
