...
WHERE 
   ...
   a.visit_date = '20101230'::date
;

TRUNCATE SESSION_SUMMARY_20101230;
INSERT INTO SESSION_SUMMARY_20101230
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101230;
SELECT count(*) from SESSION_SUMMARY_20101230;
END;
