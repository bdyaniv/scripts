...
WHERE 
   ...
   a.visit_date = '20100822'::date
;

TRUNCATE SESSION_SUMMARY_20100822;
INSERT INTO SESSION_SUMMARY_20100822
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100822;
SELECT count(*) from SESSION_SUMMARY_20100822;
END;
