...
WHERE 
   ...
   a.visit_date = '20100204'::date
;

TRUNCATE SESSION_SUMMARY_20100204;
INSERT INTO SESSION_SUMMARY_20100204
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100204;
SELECT count(*) from SESSION_SUMMARY_20100204;
END;
