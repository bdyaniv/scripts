...
WHERE 
   ...
   a.visit_date = '20110810'::date
;

TRUNCATE SESSION_SUMMARY_20110810;
INSERT INTO SESSION_SUMMARY_20110810
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110810;
SELECT count(*) from SESSION_SUMMARY_20110810;
END;
