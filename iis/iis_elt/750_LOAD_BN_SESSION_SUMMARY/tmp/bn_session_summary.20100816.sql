...
WHERE 
   ...
   a.visit_date = '20100816'::date
;

TRUNCATE SESSION_SUMMARY_20100816;
INSERT INTO SESSION_SUMMARY_20100816
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100816;
SELECT count(*) from SESSION_SUMMARY_20100816;
END;
