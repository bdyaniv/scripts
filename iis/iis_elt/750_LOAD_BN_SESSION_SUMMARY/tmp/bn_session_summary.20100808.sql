...
WHERE 
   ...
   a.visit_date = '20100808'::date
;

TRUNCATE SESSION_SUMMARY_20100808;
INSERT INTO SESSION_SUMMARY_20100808
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100808;
SELECT count(*) from SESSION_SUMMARY_20100808;
END;
