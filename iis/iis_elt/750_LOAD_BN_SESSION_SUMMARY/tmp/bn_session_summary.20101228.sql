...
WHERE 
   ...
   a.visit_date = '20101228'::date
;

TRUNCATE SESSION_SUMMARY_20101228;
INSERT INTO SESSION_SUMMARY_20101228
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101228;
SELECT count(*) from SESSION_SUMMARY_20101228;
END;
