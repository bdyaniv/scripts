...
WHERE 
   ...
   a.visit_date = '20100509'::date
;

TRUNCATE SESSION_SUMMARY_20100509;
INSERT INTO SESSION_SUMMARY_20100509
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100509;
SELECT count(*) from SESSION_SUMMARY_20100509;
END;
