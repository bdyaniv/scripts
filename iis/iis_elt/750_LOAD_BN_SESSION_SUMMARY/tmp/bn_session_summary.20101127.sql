...
WHERE 
   ...
   a.visit_date = '20101127'::date
;

TRUNCATE SESSION_SUMMARY_20101127;
INSERT INTO SESSION_SUMMARY_20101127
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101127;
SELECT count(*) from SESSION_SUMMARY_20101127;
END;
