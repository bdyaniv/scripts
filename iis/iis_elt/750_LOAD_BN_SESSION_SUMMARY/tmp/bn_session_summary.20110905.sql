...
WHERE 
   ...
   a.visit_date = '20110905'::date
;

TRUNCATE SESSION_SUMMARY_20110905;
INSERT INTO SESSION_SUMMARY_20110905
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110905;
SELECT count(*) from SESSION_SUMMARY_20110905;
END;
