...
WHERE 
   ...
   a.visit_date = '20101215'::date
;

TRUNCATE SESSION_SUMMARY_20101215;
INSERT INTO SESSION_SUMMARY_20101215
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101215;
SELECT count(*) from SESSION_SUMMARY_20101215;
END;
