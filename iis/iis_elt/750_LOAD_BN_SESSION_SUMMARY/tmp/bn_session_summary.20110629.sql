...
WHERE 
   ...
   a.visit_date = '20110629'::date
;

TRUNCATE SESSION_SUMMARY_20110629;
INSERT INTO SESSION_SUMMARY_20110629
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110629;
SELECT count(*) from SESSION_SUMMARY_20110629;
END;
