...
WHERE 
   ...
   a.visit_date = '20110806'::date
;

TRUNCATE SESSION_SUMMARY_20110806;
INSERT INTO SESSION_SUMMARY_20110806
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110806;
SELECT count(*) from SESSION_SUMMARY_20110806;
END;
