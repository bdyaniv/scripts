...
WHERE 
   ...
   a.visit_date = '20100227'::date
;

TRUNCATE SESSION_SUMMARY_20100227;
INSERT INTO SESSION_SUMMARY_20100227
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100227;
SELECT count(*) from SESSION_SUMMARY_20100227;
END;
