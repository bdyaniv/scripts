...
WHERE 
   ...
   a.visit_date = '20100202'::date
;

TRUNCATE SESSION_SUMMARY_20100202;
INSERT INTO SESSION_SUMMARY_20100202
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100202;
SELECT count(*) from SESSION_SUMMARY_20100202;
END;
