...
WHERE 
   ...
   a.visit_date = '20100529'::date
;

TRUNCATE SESSION_SUMMARY_20100529;
INSERT INTO SESSION_SUMMARY_20100529
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100529;
SELECT count(*) from SESSION_SUMMARY_20100529;
END;
