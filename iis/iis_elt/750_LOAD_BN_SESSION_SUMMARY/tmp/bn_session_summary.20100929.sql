...
WHERE 
   ...
   a.visit_date = '20100929'::date
;

TRUNCATE SESSION_SUMMARY_20100929;
INSERT INTO SESSION_SUMMARY_20100929
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100929;
SELECT count(*) from SESSION_SUMMARY_20100929;
END;
