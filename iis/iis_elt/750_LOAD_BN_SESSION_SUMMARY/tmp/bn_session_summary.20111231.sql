...
WHERE 
   ...
   a.visit_date = '20111231'::date
;

TRUNCATE SESSION_SUMMARY_20111231;
INSERT INTO SESSION_SUMMARY_20111231
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111231;
SELECT count(*) from SESSION_SUMMARY_20111231;
END;
