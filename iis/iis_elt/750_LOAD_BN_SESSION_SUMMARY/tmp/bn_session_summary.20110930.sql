...
WHERE 
   ...
   a.visit_date = '20110930'::date
;

TRUNCATE SESSION_SUMMARY_20110930;
INSERT INTO SESSION_SUMMARY_20110930
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110930;
SELECT count(*) from SESSION_SUMMARY_20110930;
END;
