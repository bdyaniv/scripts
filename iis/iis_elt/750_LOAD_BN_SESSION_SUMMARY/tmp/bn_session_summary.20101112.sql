...
WHERE 
   ...
   a.visit_date = '20101112'::date
;

TRUNCATE SESSION_SUMMARY_20101112;
INSERT INTO SESSION_SUMMARY_20101112
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101112;
SELECT count(*) from SESSION_SUMMARY_20101112;
END;
