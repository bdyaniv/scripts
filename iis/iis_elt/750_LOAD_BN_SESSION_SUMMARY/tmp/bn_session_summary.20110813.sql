...
WHERE 
   ...
   a.visit_date = '20110813'::date
;

TRUNCATE SESSION_SUMMARY_20110813;
INSERT INTO SESSION_SUMMARY_20110813
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110813;
SELECT count(*) from SESSION_SUMMARY_20110813;
END;
