...
WHERE 
   ...
   a.visit_date = '20100626'::date
;

TRUNCATE SESSION_SUMMARY_20100626;
INSERT INTO SESSION_SUMMARY_20100626
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100626;
SELECT count(*) from SESSION_SUMMARY_20100626;
END;
