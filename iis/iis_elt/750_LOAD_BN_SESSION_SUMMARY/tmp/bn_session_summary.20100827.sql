...
WHERE 
   ...
   a.visit_date = '20100827'::date
;

TRUNCATE SESSION_SUMMARY_20100827;
INSERT INTO SESSION_SUMMARY_20100827
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100827;
SELECT count(*) from SESSION_SUMMARY_20100827;
END;
