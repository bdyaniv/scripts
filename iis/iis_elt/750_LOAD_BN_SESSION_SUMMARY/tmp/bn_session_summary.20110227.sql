...
WHERE 
   ...
   a.visit_date = '20110227'::date
;

TRUNCATE SESSION_SUMMARY_20110227;
INSERT INTO SESSION_SUMMARY_20110227
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110227;
SELECT count(*) from SESSION_SUMMARY_20110227;
END;
