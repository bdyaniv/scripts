...
WHERE 
   ...
   a.visit_date = '20111221'::date
;

TRUNCATE SESSION_SUMMARY_20111221;
INSERT INTO SESSION_SUMMARY_20111221
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111221;
SELECT count(*) from SESSION_SUMMARY_20111221;
END;
