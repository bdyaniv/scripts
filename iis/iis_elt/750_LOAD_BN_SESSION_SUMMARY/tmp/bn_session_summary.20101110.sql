...
WHERE 
   ...
   a.visit_date = '20101110'::date
;

TRUNCATE SESSION_SUMMARY_20101110;
INSERT INTO SESSION_SUMMARY_20101110
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101110;
SELECT count(*) from SESSION_SUMMARY_20101110;
END;
