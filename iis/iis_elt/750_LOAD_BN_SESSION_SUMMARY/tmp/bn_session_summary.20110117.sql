...
WHERE 
   ...
   a.visit_date = '20110117'::date
;

TRUNCATE SESSION_SUMMARY_20110117;
INSERT INTO SESSION_SUMMARY_20110117
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110117;
SELECT count(*) from SESSION_SUMMARY_20110117;
END;
