...
WHERE 
   ...
   a.visit_date = '20101022'::date
;

TRUNCATE SESSION_SUMMARY_20101022;
INSERT INTO SESSION_SUMMARY_20101022
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101022;
SELECT count(*) from SESSION_SUMMARY_20101022;
END;
