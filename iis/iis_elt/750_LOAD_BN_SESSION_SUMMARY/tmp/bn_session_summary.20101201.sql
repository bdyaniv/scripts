...
WHERE 
   ...
   a.visit_date = '20101201'::date
;

TRUNCATE SESSION_SUMMARY_20101201;
INSERT INTO SESSION_SUMMARY_20101201
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101201;
SELECT count(*) from SESSION_SUMMARY_20101201;
END;
