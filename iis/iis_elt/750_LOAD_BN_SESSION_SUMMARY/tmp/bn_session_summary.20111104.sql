...
WHERE 
   ...
   a.visit_date = '20111104'::date
;

TRUNCATE SESSION_SUMMARY_20111104;
INSERT INTO SESSION_SUMMARY_20111104
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111104;
SELECT count(*) from SESSION_SUMMARY_20111104;
END;
