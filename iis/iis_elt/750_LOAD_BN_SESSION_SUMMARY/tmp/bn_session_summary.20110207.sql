...
WHERE 
   ...
   a.visit_date = '20110207'::date
;

TRUNCATE SESSION_SUMMARY_20110207;
INSERT INTO SESSION_SUMMARY_20110207
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110207;
SELECT count(*) from SESSION_SUMMARY_20110207;
END;
