...
WHERE 
   ...
   a.visit_date = '20101115'::date
;

TRUNCATE SESSION_SUMMARY_20101115;
INSERT INTO SESSION_SUMMARY_20101115
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101115;
SELECT count(*) from SESSION_SUMMARY_20101115;
END;
