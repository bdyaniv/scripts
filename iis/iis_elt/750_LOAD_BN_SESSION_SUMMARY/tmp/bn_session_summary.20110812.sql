...
WHERE 
   ...
   a.visit_date = '20110812'::date
;

TRUNCATE SESSION_SUMMARY_20110812;
INSERT INTO SESSION_SUMMARY_20110812
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110812;
SELECT count(*) from SESSION_SUMMARY_20110812;
END;
