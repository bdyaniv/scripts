...
WHERE 
   ...
   a.visit_date = '20100322'::date
;

TRUNCATE SESSION_SUMMARY_20100322;
INSERT INTO SESSION_SUMMARY_20100322
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100322;
SELECT count(*) from SESSION_SUMMARY_20100322;
END;
