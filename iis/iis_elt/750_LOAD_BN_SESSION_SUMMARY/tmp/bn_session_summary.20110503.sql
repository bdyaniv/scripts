...
WHERE 
   ...
   a.visit_date = '20110503'::date
;

TRUNCATE SESSION_SUMMARY_20110503;
INSERT INTO SESSION_SUMMARY_20110503
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110503;
SELECT count(*) from SESSION_SUMMARY_20110503;
END;
