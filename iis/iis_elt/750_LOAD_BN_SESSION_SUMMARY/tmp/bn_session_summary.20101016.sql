...
WHERE 
   ...
   a.visit_date = '20101016'::date
;

TRUNCATE SESSION_SUMMARY_20101016;
INSERT INTO SESSION_SUMMARY_20101016
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101016;
SELECT count(*) from SESSION_SUMMARY_20101016;
END;
