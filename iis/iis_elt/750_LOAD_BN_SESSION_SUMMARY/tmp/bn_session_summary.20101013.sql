...
WHERE 
   ...
   a.visit_date = '20101013'::date
;

TRUNCATE SESSION_SUMMARY_20101013;
INSERT INTO SESSION_SUMMARY_20101013
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101013;
SELECT count(*) from SESSION_SUMMARY_20101013;
END;
