...
WHERE 
   ...
   a.visit_date = '20111016'::date
;

TRUNCATE SESSION_SUMMARY_20111016;
INSERT INTO SESSION_SUMMARY_20111016
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111016;
SELECT count(*) from SESSION_SUMMARY_20111016;
END;
