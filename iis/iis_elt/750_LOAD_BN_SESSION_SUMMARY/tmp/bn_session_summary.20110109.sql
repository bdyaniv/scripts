...
WHERE 
   ...
   a.visit_date = '20110109'::date
;

TRUNCATE SESSION_SUMMARY_20110109;
INSERT INTO SESSION_SUMMARY_20110109
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110109;
SELECT count(*) from SESSION_SUMMARY_20110109;
END;
