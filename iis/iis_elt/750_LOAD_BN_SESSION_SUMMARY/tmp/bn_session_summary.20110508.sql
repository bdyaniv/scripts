...
WHERE 
   ...
   a.visit_date = '20110508'::date
;

TRUNCATE SESSION_SUMMARY_20110508;
INSERT INTO SESSION_SUMMARY_20110508
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110508;
SELECT count(*) from SESSION_SUMMARY_20110508;
END;
