...
WHERE 
   ...
   a.visit_date = '20121102'::date
;

TRUNCATE SESSION_SUMMARY_20121102;
INSERT INTO SESSION_SUMMARY_20121102
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20121102;
SELECT count(*) from SESSION_SUMMARY_20121102;
END;
