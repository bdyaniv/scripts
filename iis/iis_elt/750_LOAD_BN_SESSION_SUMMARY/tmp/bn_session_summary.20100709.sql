...
WHERE 
   ...
   a.visit_date = '20100709'::date
;

TRUNCATE SESSION_SUMMARY_20100709;
INSERT INTO SESSION_SUMMARY_20100709
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100709;
SELECT count(*) from SESSION_SUMMARY_20100709;
END;
