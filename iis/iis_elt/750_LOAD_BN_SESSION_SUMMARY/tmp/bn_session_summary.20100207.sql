...
WHERE 
   ...
   a.visit_date = '20100207'::date
;

TRUNCATE SESSION_SUMMARY_20100207;
INSERT INTO SESSION_SUMMARY_20100207
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100207;
SELECT count(*) from SESSION_SUMMARY_20100207;
END;
