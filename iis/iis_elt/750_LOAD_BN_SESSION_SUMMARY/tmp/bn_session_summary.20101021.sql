...
WHERE 
   ...
   a.visit_date = '20101021'::date
;

TRUNCATE SESSION_SUMMARY_20101021;
INSERT INTO SESSION_SUMMARY_20101021
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101021;
SELECT count(*) from SESSION_SUMMARY_20101021;
END;
