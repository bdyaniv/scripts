...
WHERE 
   ...
   a.visit_date = '20100307'::date
;

TRUNCATE SESSION_SUMMARY_20100307;
INSERT INTO SESSION_SUMMARY_20100307
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100307;
SELECT count(*) from SESSION_SUMMARY_20100307;
END;
