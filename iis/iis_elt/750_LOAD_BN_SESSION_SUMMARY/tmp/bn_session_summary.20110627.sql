...
WHERE 
   ...
   a.visit_date = '20110627'::date
;

TRUNCATE SESSION_SUMMARY_20110627;
INSERT INTO SESSION_SUMMARY_20110627
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110627;
SELECT count(*) from SESSION_SUMMARY_20110627;
END;
