...
WHERE 
   ...
   a.visit_date = '20100405'::date
;

TRUNCATE SESSION_SUMMARY_20100405;
INSERT INTO SESSION_SUMMARY_20100405
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100405;
SELECT count(*) from SESSION_SUMMARY_20100405;
END;
