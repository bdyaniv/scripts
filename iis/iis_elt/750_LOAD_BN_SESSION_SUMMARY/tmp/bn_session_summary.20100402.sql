...
WHERE 
   ...
   a.visit_date = '20100402'::date
;

TRUNCATE SESSION_SUMMARY_20100402;
INSERT INTO SESSION_SUMMARY_20100402
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100402;
SELECT count(*) from SESSION_SUMMARY_20100402;
END;
