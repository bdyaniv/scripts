...
WHERE 
   ...
   a.visit_date = '20110918'::date
;

TRUNCATE SESSION_SUMMARY_20110918;
INSERT INTO SESSION_SUMMARY_20110918
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110918;
SELECT count(*) from SESSION_SUMMARY_20110918;
END;
