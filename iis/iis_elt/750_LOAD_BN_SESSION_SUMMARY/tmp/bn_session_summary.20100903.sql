...
WHERE 
   ...
   a.visit_date = '20100903'::date
;

TRUNCATE SESSION_SUMMARY_20100903;
INSERT INTO SESSION_SUMMARY_20100903
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100903;
SELECT count(*) from SESSION_SUMMARY_20100903;
END;
