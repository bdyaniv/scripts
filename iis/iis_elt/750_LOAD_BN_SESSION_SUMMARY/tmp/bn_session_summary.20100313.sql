...
WHERE 
   ...
   a.visit_date = '20100313'::date
;

TRUNCATE SESSION_SUMMARY_20100313;
INSERT INTO SESSION_SUMMARY_20100313
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100313;
SELECT count(*) from SESSION_SUMMARY_20100313;
END;
