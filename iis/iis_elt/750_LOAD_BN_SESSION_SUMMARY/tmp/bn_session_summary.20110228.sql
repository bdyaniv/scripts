...
WHERE 
   ...
   a.visit_date = '20110228'::date
;

TRUNCATE SESSION_SUMMARY_20110228;
INSERT INTO SESSION_SUMMARY_20110228
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110228;
SELECT count(*) from SESSION_SUMMARY_20110228;
END;
