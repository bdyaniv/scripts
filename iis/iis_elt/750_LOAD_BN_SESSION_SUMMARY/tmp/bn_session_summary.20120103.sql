...
WHERE 
   ...
   a.visit_date = '20120103'::date
;

TRUNCATE SESSION_SUMMARY_20120103;
INSERT INTO SESSION_SUMMARY_20120103
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20120103;
SELECT count(*) from SESSION_SUMMARY_20120103;
END;
