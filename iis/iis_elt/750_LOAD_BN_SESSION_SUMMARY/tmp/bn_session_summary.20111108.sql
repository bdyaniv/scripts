...
WHERE 
   ...
   a.visit_date = '20111108'::date
;

TRUNCATE SESSION_SUMMARY_20111108;
INSERT INTO SESSION_SUMMARY_20111108
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111108;
SELECT count(*) from SESSION_SUMMARY_20111108;
END;
