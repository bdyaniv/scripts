...
WHERE 
   ...
   a.visit_date = '20100620'::date
;

TRUNCATE SESSION_SUMMARY_20100620;
INSERT INTO SESSION_SUMMARY_20100620
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100620;
SELECT count(*) from SESSION_SUMMARY_20100620;
END;
