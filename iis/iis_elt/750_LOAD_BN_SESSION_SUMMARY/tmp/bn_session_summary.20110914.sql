...
WHERE 
   ...
   a.visit_date = '20110914'::date
;

TRUNCATE SESSION_SUMMARY_20110914;
INSERT INTO SESSION_SUMMARY_20110914
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110914;
SELECT count(*) from SESSION_SUMMARY_20110914;
END;
