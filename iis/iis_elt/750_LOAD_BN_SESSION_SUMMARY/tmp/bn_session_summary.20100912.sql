...
WHERE 
   ...
   a.visit_date = '20100912'::date
;

TRUNCATE SESSION_SUMMARY_20100912;
INSERT INTO SESSION_SUMMARY_20100912
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100912;
SELECT count(*) from SESSION_SUMMARY_20100912;
END;
