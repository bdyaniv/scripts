...
WHERE 
   ...
   a.visit_date = '20110707'::date
;

TRUNCATE SESSION_SUMMARY_20110707;
INSERT INTO SESSION_SUMMARY_20110707
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20110707;
SELECT count(*) from SESSION_SUMMARY_20110707;
END;
