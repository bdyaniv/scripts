...
WHERE 
   ...
   a.visit_date = '20101108'::date
;

TRUNCATE SESSION_SUMMARY_20101108;
INSERT INTO SESSION_SUMMARY_20101108
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101108;
SELECT count(*) from SESSION_SUMMARY_20101108;
END;
