...
WHERE 
   ...
   a.visit_date = '20101208'::date
;

TRUNCATE SESSION_SUMMARY_20101208;
INSERT INTO SESSION_SUMMARY_20101208
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101208;
SELECT count(*) from SESSION_SUMMARY_20101208;
END;
