...
WHERE 
   ...
   a.visit_date = '20101226'::date
;

TRUNCATE SESSION_SUMMARY_20101226;
INSERT INTO SESSION_SUMMARY_20101226
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101226;
SELECT count(*) from SESSION_SUMMARY_20101226;
END;
