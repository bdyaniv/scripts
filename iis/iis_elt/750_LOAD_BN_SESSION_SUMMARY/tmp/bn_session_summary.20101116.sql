...
WHERE 
   ...
   a.visit_date = '20101116'::date
;

TRUNCATE SESSION_SUMMARY_20101116;
INSERT INTO SESSION_SUMMARY_20101116
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20101116;
SELECT count(*) from SESSION_SUMMARY_20101116;
END;
