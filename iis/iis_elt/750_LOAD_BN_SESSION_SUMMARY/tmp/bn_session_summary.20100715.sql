...
WHERE 
   ...
   a.visit_date = '20100715'::date
;

TRUNCATE SESSION_SUMMARY_20100715;
INSERT INTO SESSION_SUMMARY_20100715
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100715;
SELECT count(*) from SESSION_SUMMARY_20100715;
END;
