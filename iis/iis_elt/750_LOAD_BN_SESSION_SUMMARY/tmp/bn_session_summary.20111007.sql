...
WHERE 
   ...
   a.visit_date = '20111007'::date
;

TRUNCATE SESSION_SUMMARY_20111007;
INSERT INTO SESSION_SUMMARY_20111007
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20111007;
SELECT count(*) from SESSION_SUMMARY_20111007;
END;
