...
WHERE 
   ...
   a.visit_date = '20100314'::date
;

TRUNCATE SESSION_SUMMARY_20100314;
INSERT INTO SESSION_SUMMARY_20100314
(
	session_date,
	last_source_id,
	first_source_id,
...
ANALYZE SESSION_SUMMARY_20100314;
SELECT count(*) from SESSION_SUMMARY_20100314;
END;
