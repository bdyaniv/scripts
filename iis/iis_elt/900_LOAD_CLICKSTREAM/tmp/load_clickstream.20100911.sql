...
TRUNCATE TABLE CLICK_SEARCHES_20100911;
INSERT INTO CLICK_SEARCHES_20100911
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100911'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100911;
ANALYZE CLICK_SEARCHES_20100911;
END;
