...
TRUNCATE TABLE CLICK_SEARCHES_20100614;
INSERT INTO CLICK_SEARCHES_20100614
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100614'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100614;
ANALYZE CLICK_SEARCHES_20100614;
END;
