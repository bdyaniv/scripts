...
TRUNCATE TABLE CLICK_SEARCHES_20100204;
INSERT INTO CLICK_SEARCHES_20100204
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100204'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100204;
ANALYZE CLICK_SEARCHES_20100204;
END;
