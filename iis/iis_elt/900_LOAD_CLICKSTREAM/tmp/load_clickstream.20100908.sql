...
TRUNCATE TABLE CLICK_SEARCHES_20100908;
INSERT INTO CLICK_SEARCHES_20100908
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100908'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100908;
ANALYZE CLICK_SEARCHES_20100908;
END;
