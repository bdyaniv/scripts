...
TRUNCATE TABLE CLICK_SEARCHES_20111003;
INSERT INTO CLICK_SEARCHES_20111003
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111003'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111003;
ANALYZE CLICK_SEARCHES_20111003;
END;
