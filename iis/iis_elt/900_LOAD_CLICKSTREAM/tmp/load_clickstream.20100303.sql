...
TRUNCATE TABLE CLICK_SEARCHES_20100303;
INSERT INTO CLICK_SEARCHES_20100303
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100303'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100303;
ANALYZE CLICK_SEARCHES_20100303;
END;
