...
TRUNCATE TABLE CLICK_SEARCHES_20110726;
INSERT INTO CLICK_SEARCHES_20110726
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110726'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110726;
ANALYZE CLICK_SEARCHES_20110726;
END;
