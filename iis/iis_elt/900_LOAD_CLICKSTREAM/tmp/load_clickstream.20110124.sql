...
TRUNCATE TABLE CLICK_SEARCHES_20110124;
INSERT INTO CLICK_SEARCHES_20110124
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110124'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110124;
ANALYZE CLICK_SEARCHES_20110124;
END;
