...
TRUNCATE TABLE CLICK_SEARCHES_20111102;
INSERT INTO CLICK_SEARCHES_20111102
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111102'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111102;
ANALYZE CLICK_SEARCHES_20111102;
END;
