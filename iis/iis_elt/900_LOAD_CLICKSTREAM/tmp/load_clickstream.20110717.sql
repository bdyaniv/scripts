...
TRUNCATE TABLE CLICK_SEARCHES_20110717;
INSERT INTO CLICK_SEARCHES_20110717
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110717'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110717;
ANALYZE CLICK_SEARCHES_20110717;
END;
