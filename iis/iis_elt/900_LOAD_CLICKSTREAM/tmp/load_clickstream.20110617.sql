...
TRUNCATE TABLE CLICK_SEARCHES_20110617;
INSERT INTO CLICK_SEARCHES_20110617
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110617'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110617;
ANALYZE CLICK_SEARCHES_20110617;
END;
