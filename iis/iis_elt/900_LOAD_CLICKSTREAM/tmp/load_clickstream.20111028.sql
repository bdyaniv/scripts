...
TRUNCATE TABLE CLICK_SEARCHES_20111028;
INSERT INTO CLICK_SEARCHES_20111028
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111028'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111028;
ANALYZE CLICK_SEARCHES_20111028;
END;
