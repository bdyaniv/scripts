...
TRUNCATE TABLE CLICK_SEARCHES_20101111;
INSERT INTO CLICK_SEARCHES_20101111
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101111'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101111;
ANALYZE CLICK_SEARCHES_20101111;
END;
