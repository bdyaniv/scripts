...
TRUNCATE TABLE CLICK_SEARCHES_20110729;
INSERT INTO CLICK_SEARCHES_20110729
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110729'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110729;
ANALYZE CLICK_SEARCHES_20110729;
END;
