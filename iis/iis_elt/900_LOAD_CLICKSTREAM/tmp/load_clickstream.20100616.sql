...
TRUNCATE TABLE CLICK_SEARCHES_20100616;
INSERT INTO CLICK_SEARCHES_20100616
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100616'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100616;
ANALYZE CLICK_SEARCHES_20100616;
END;
