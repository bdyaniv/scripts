...
TRUNCATE TABLE CLICK_SEARCHES_20110130;
INSERT INTO CLICK_SEARCHES_20110130
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110130'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110130;
ANALYZE CLICK_SEARCHES_20110130;
END;
