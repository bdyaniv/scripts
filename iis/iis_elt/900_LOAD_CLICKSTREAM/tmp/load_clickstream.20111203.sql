...
TRUNCATE TABLE CLICK_SEARCHES_20111203;
INSERT INTO CLICK_SEARCHES_20111203
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111203'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111203;
ANALYZE CLICK_SEARCHES_20111203;
END;
