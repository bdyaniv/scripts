...
TRUNCATE TABLE CLICK_SEARCHES_20110630;
INSERT INTO CLICK_SEARCHES_20110630
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110630'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110630;
ANALYZE CLICK_SEARCHES_20110630;
END;
