...
TRUNCATE TABLE CLICK_SEARCHES_20101116;
INSERT INTO CLICK_SEARCHES_20101116
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101116'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101116;
ANALYZE CLICK_SEARCHES_20101116;
END;
