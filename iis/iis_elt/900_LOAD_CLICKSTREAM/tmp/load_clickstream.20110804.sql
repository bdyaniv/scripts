...
TRUNCATE TABLE CLICK_SEARCHES_20110804;
INSERT INTO CLICK_SEARCHES_20110804
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110804'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110804;
ANALYZE CLICK_SEARCHES_20110804;
END;
