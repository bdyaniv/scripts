...
TRUNCATE TABLE CLICK_SEARCHES_20110403;
INSERT INTO CLICK_SEARCHES_20110403
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110403'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110403;
ANALYZE CLICK_SEARCHES_20110403;
END;
