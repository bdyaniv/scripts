...
TRUNCATE TABLE CLICK_SEARCHES_20110115;
INSERT INTO CLICK_SEARCHES_20110115
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110115'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110115;
ANALYZE CLICK_SEARCHES_20110115;
END;
