...
TRUNCATE TABLE CLICK_SEARCHES_20110219;
INSERT INTO CLICK_SEARCHES_20110219
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110219'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110219;
ANALYZE CLICK_SEARCHES_20110219;
END;
