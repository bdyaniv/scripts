...
TRUNCATE TABLE CLICK_SEARCHES_20100404;
INSERT INTO CLICK_SEARCHES_20100404
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100404'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100404;
ANALYZE CLICK_SEARCHES_20100404;
END;
