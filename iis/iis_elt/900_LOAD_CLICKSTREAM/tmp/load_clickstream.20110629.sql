...
TRUNCATE TABLE CLICK_SEARCHES_20110629;
INSERT INTO CLICK_SEARCHES_20110629
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110629'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110629;
ANALYZE CLICK_SEARCHES_20110629;
END;
