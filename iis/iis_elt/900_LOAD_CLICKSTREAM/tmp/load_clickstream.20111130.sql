...
TRUNCATE TABLE CLICK_SEARCHES_20111130;
INSERT INTO CLICK_SEARCHES_20111130
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111130'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111130;
ANALYZE CLICK_SEARCHES_20111130;
END;
