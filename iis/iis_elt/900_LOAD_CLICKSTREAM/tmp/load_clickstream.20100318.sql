...
TRUNCATE TABLE CLICK_SEARCHES_20100318;
INSERT INTO CLICK_SEARCHES_20100318
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100318'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100318;
ANALYZE CLICK_SEARCHES_20100318;
END;
