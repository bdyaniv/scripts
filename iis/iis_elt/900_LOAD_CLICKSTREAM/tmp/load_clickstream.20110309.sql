...
TRUNCATE TABLE CLICK_SEARCHES_20110309;
INSERT INTO CLICK_SEARCHES_20110309
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110309'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110309;
ANALYZE CLICK_SEARCHES_20110309;
END;
