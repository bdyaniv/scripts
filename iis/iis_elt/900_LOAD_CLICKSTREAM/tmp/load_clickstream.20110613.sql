...
TRUNCATE TABLE CLICK_SEARCHES_20110613;
INSERT INTO CLICK_SEARCHES_20110613
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110613'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110613;
ANALYZE CLICK_SEARCHES_20110613;
END;
