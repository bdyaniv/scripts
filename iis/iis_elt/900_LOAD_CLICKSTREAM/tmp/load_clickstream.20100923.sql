...
TRUNCATE TABLE CLICK_SEARCHES_20100923;
INSERT INTO CLICK_SEARCHES_20100923
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100923'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100923;
ANALYZE CLICK_SEARCHES_20100923;
END;
