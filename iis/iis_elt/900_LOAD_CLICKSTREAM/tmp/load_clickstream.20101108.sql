...
TRUNCATE TABLE CLICK_SEARCHES_20101108;
INSERT INTO CLICK_SEARCHES_20101108
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101108'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101108;
ANALYZE CLICK_SEARCHES_20101108;
END;
