...
TRUNCATE TABLE CLICK_SEARCHES_20101028;
INSERT INTO CLICK_SEARCHES_20101028
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101028'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101028;
ANALYZE CLICK_SEARCHES_20101028;
END;
