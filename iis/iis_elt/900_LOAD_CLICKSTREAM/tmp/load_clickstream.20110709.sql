...
TRUNCATE TABLE CLICK_SEARCHES_20110709;
INSERT INTO CLICK_SEARCHES_20110709
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110709'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110709;
ANALYZE CLICK_SEARCHES_20110709;
END;
