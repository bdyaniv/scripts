...
TRUNCATE TABLE CLICK_SEARCHES_20100711;
INSERT INTO CLICK_SEARCHES_20100711
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100711'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100711;
ANALYZE CLICK_SEARCHES_20100711;
END;
