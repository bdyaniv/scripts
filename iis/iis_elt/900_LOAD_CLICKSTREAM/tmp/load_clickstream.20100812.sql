...
TRUNCATE TABLE CLICK_SEARCHES_20100812;
INSERT INTO CLICK_SEARCHES_20100812
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100812'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100812;
ANALYZE CLICK_SEARCHES_20100812;
END;
