...
TRUNCATE TABLE CLICK_SEARCHES_20100223;
INSERT INTO CLICK_SEARCHES_20100223
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100223'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100223;
ANALYZE CLICK_SEARCHES_20100223;
END;
