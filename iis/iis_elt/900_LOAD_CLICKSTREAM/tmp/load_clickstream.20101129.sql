...
TRUNCATE TABLE CLICK_SEARCHES_20101129;
INSERT INTO CLICK_SEARCHES_20101129
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101129'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101129;
ANALYZE CLICK_SEARCHES_20101129;
END;
