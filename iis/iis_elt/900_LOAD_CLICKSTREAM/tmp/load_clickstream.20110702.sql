...
TRUNCATE TABLE CLICK_SEARCHES_20110702;
INSERT INTO CLICK_SEARCHES_20110702
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110702'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110702;
ANALYZE CLICK_SEARCHES_20110702;
END;
