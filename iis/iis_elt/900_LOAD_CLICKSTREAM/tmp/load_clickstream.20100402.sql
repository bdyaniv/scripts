...
TRUNCATE TABLE CLICK_SEARCHES_20100402;
INSERT INTO CLICK_SEARCHES_20100402
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100402'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100402;
ANALYZE CLICK_SEARCHES_20100402;
END;
