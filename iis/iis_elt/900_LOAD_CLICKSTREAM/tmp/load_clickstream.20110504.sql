...
TRUNCATE TABLE CLICK_SEARCHES_20110504;
INSERT INTO CLICK_SEARCHES_20110504
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110504'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110504;
ANALYZE CLICK_SEARCHES_20110504;
END;
