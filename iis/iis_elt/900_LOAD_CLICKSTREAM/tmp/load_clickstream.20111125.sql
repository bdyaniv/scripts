...
TRUNCATE TABLE CLICK_SEARCHES_20111125;
INSERT INTO CLICK_SEARCHES_20111125
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111125'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111125;
ANALYZE CLICK_SEARCHES_20111125;
END;
