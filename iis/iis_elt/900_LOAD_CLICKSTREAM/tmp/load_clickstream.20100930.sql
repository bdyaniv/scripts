...
TRUNCATE TABLE CLICK_SEARCHES_20100930;
INSERT INTO CLICK_SEARCHES_20100930
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100930'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100930;
ANALYZE CLICK_SEARCHES_20100930;
END;
