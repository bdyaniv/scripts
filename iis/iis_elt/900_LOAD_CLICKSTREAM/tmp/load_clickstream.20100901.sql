...
TRUNCATE TABLE CLICK_SEARCHES_20100901;
INSERT INTO CLICK_SEARCHES_20100901
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100901'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100901;
ANALYZE CLICK_SEARCHES_20100901;
END;
