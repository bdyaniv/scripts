...
TRUNCATE TABLE CLICK_SEARCHES_20101214;
INSERT INTO CLICK_SEARCHES_20101214
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101214'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101214;
ANALYZE CLICK_SEARCHES_20101214;
END;
