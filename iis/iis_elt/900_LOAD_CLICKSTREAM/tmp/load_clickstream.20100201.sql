...
TRUNCATE TABLE CLICK_SEARCHES_20100201;
INSERT INTO CLICK_SEARCHES_20100201
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100201'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100201;
ANALYZE CLICK_SEARCHES_20100201;
END;
