...
TRUNCATE TABLE CLICK_SEARCHES_20100615;
INSERT INTO CLICK_SEARCHES_20100615
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100615'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100615;
ANALYZE CLICK_SEARCHES_20100615;
END;
