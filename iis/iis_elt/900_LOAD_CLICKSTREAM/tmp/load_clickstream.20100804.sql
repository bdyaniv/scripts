...
TRUNCATE TABLE CLICK_SEARCHES_20100804;
INSERT INTO CLICK_SEARCHES_20100804
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100804'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100804;
ANALYZE CLICK_SEARCHES_20100804;
END;
