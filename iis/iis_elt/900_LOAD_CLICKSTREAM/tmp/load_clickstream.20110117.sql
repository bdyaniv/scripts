...
TRUNCATE TABLE CLICK_SEARCHES_20110117;
INSERT INTO CLICK_SEARCHES_20110117
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110117'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110117;
ANALYZE CLICK_SEARCHES_20110117;
END;
