...
TRUNCATE TABLE CLICK_SEARCHES_20110826;
INSERT INTO CLICK_SEARCHES_20110826
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110826'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110826;
ANALYZE CLICK_SEARCHES_20110826;
END;
