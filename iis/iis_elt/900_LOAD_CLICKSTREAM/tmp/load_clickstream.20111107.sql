...
TRUNCATE TABLE CLICK_SEARCHES_20111107;
INSERT INTO CLICK_SEARCHES_20111107
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111107'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111107;
ANALYZE CLICK_SEARCHES_20111107;
END;
