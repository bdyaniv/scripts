...
TRUNCATE TABLE CLICK_SEARCHES_20110331;
INSERT INTO CLICK_SEARCHES_20110331
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110331'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110331;
ANALYZE CLICK_SEARCHES_20110331;
END;
