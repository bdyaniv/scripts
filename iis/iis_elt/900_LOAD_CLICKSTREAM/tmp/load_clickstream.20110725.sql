...
TRUNCATE TABLE CLICK_SEARCHES_20110725;
INSERT INTO CLICK_SEARCHES_20110725
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110725'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110725;
ANALYZE CLICK_SEARCHES_20110725;
END;
