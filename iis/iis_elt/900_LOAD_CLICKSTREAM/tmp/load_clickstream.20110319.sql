...
TRUNCATE TABLE CLICK_SEARCHES_20110319;
INSERT INTO CLICK_SEARCHES_20110319
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110319'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110319;
ANALYZE CLICK_SEARCHES_20110319;
END;
