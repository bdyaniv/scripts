...
TRUNCATE TABLE CLICK_SEARCHES_20110701;
INSERT INTO CLICK_SEARCHES_20110701
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110701'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110701;
ANALYZE CLICK_SEARCHES_20110701;
END;
