...
TRUNCATE TABLE CLICK_SEARCHES_20100520;
INSERT INTO CLICK_SEARCHES_20100520
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100520'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100520;
ANALYZE CLICK_SEARCHES_20100520;
END;
