...
TRUNCATE TABLE CLICK_SEARCHES_20101210;
INSERT INTO CLICK_SEARCHES_20101210
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101210'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101210;
ANALYZE CLICK_SEARCHES_20101210;
END;
