...
TRUNCATE TABLE CLICK_SEARCHES_20101231;
INSERT INTO CLICK_SEARCHES_20101231
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101231'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101231;
ANALYZE CLICK_SEARCHES_20101231;
END;
