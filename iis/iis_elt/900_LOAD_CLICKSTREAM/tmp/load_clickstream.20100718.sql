...
TRUNCATE TABLE CLICK_SEARCHES_20100718;
INSERT INTO CLICK_SEARCHES_20100718
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100718'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100718;
ANALYZE CLICK_SEARCHES_20100718;
END;
