...
TRUNCATE TABLE CLICK_SEARCHES_20110503;
INSERT INTO CLICK_SEARCHES_20110503
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110503'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110503;
ANALYZE CLICK_SEARCHES_20110503;
END;
