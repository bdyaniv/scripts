...
TRUNCATE TABLE CLICK_SEARCHES_20110127;
INSERT INTO CLICK_SEARCHES_20110127
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110127'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110127;
ANALYZE CLICK_SEARCHES_20110127;
END;
