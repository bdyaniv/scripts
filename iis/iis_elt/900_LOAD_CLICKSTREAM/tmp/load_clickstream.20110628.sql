...
TRUNCATE TABLE CLICK_SEARCHES_20110628;
INSERT INTO CLICK_SEARCHES_20110628
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110628'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110628;
ANALYZE CLICK_SEARCHES_20110628;
END;
