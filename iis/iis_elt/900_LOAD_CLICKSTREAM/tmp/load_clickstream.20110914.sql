...
TRUNCATE TABLE CLICK_SEARCHES_20110914;
INSERT INTO CLICK_SEARCHES_20110914
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110914'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110914;
ANALYZE CLICK_SEARCHES_20110914;
END;
