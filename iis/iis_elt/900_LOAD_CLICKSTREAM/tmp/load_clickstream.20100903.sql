...
TRUNCATE TABLE CLICK_SEARCHES_20100903;
INSERT INTO CLICK_SEARCHES_20100903
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100903'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100903;
ANALYZE CLICK_SEARCHES_20100903;
END;
