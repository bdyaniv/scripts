...
TRUNCATE TABLE CLICK_SEARCHES_20100407;
INSERT INTO CLICK_SEARCHES_20100407
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100407'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100407;
ANALYZE CLICK_SEARCHES_20100407;
END;
