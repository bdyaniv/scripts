...
TRUNCATE TABLE CLICK_SEARCHES_20110603;
INSERT INTO CLICK_SEARCHES_20110603
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110603'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110603;
ANALYZE CLICK_SEARCHES_20110603;
END;
