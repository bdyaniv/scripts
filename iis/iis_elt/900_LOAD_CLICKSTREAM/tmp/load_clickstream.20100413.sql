...
TRUNCATE TABLE CLICK_SEARCHES_20100413;
INSERT INTO CLICK_SEARCHES_20100413
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100413'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100413;
ANALYZE CLICK_SEARCHES_20100413;
END;
