...
TRUNCATE TABLE CLICK_SEARCHES_20111128;
INSERT INTO CLICK_SEARCHES_20111128
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111128'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111128;
ANALYZE CLICK_SEARCHES_20111128;
END;
