...
TRUNCATE TABLE CLICK_SEARCHES_20110411;
INSERT INTO CLICK_SEARCHES_20110411
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110411'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110411;
ANALYZE CLICK_SEARCHES_20110411;
END;
