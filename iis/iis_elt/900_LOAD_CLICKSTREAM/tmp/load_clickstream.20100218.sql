...
TRUNCATE TABLE CLICK_SEARCHES_20100218;
INSERT INTO CLICK_SEARCHES_20100218
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100218'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100218;
ANALYZE CLICK_SEARCHES_20100218;
END;
