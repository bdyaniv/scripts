...
TRUNCATE TABLE CLICK_SEARCHES_20100227;
INSERT INTO CLICK_SEARCHES_20100227
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100227'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100227;
ANALYZE CLICK_SEARCHES_20100227;
END;
