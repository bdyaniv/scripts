...
TRUNCATE TABLE CLICK_SEARCHES_20101119;
INSERT INTO CLICK_SEARCHES_20101119
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101119'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101119;
ANALYZE CLICK_SEARCHES_20101119;
END;
