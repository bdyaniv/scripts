...
TRUNCATE TABLE CLICK_SEARCHES_20110328;
INSERT INTO CLICK_SEARCHES_20110328
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110328'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110328;
ANALYZE CLICK_SEARCHES_20110328;
END;
