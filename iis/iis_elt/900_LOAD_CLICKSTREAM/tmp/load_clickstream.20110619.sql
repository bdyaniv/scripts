...
TRUNCATE TABLE CLICK_SEARCHES_20110619;
INSERT INTO CLICK_SEARCHES_20110619
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110619'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110619;
ANALYZE CLICK_SEARCHES_20110619;
END;
