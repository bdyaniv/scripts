...
TRUNCATE TABLE CLICK_SEARCHES_20101102;
INSERT INTO CLICK_SEARCHES_20101102
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101102'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101102;
ANALYZE CLICK_SEARCHES_20101102;
END;
