...
TRUNCATE TABLE CLICK_SEARCHES_20101127;
INSERT INTO CLICK_SEARCHES_20101127
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101127'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101127;
ANALYZE CLICK_SEARCHES_20101127;
END;
