...
TRUNCATE TABLE CLICK_SEARCHES_20100317;
INSERT INTO CLICK_SEARCHES_20100317
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100317'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100317;
ANALYZE CLICK_SEARCHES_20100317;
END;
