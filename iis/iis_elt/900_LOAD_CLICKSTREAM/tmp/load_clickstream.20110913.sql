...
TRUNCATE TABLE CLICK_SEARCHES_20110913;
INSERT INTO CLICK_SEARCHES_20110913
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110913'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110913;
ANALYZE CLICK_SEARCHES_20110913;
END;
