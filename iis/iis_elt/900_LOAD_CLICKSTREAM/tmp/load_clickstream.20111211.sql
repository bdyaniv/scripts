...
TRUNCATE TABLE CLICK_SEARCHES_20111211;
INSERT INTO CLICK_SEARCHES_20111211
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111211'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111211;
ANALYZE CLICK_SEARCHES_20111211;
END;
