...
TRUNCATE TABLE CLICK_SEARCHES_20110322;
INSERT INTO CLICK_SEARCHES_20110322
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110322'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110322;
ANALYZE CLICK_SEARCHES_20110322;
END;
