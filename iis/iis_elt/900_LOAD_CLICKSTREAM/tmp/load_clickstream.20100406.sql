...
TRUNCATE TABLE CLICK_SEARCHES_20100406;
INSERT INTO CLICK_SEARCHES_20100406
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100406'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100406;
ANALYZE CLICK_SEARCHES_20100406;
END;
