...
TRUNCATE TABLE CLICK_SEARCHES_20120104;
INSERT INTO CLICK_SEARCHES_20120104
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20120104'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20120104;
ANALYZE CLICK_SEARCHES_20120104;
END;
