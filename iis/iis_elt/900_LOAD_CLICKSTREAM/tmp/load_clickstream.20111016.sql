...
TRUNCATE TABLE CLICK_SEARCHES_20111016;
INSERT INTO CLICK_SEARCHES_20111016
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111016'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111016;
ANALYZE CLICK_SEARCHES_20111016;
END;
