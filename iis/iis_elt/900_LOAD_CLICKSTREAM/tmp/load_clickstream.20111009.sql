...
TRUNCATE TABLE CLICK_SEARCHES_20111009;
INSERT INTO CLICK_SEARCHES_20111009
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111009'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111009;
ANALYZE CLICK_SEARCHES_20111009;
END;
