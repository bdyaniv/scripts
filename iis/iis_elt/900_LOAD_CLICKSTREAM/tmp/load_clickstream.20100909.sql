...
TRUNCATE TABLE CLICK_SEARCHES_20100909;
INSERT INTO CLICK_SEARCHES_20100909
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100909'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100909;
ANALYZE CLICK_SEARCHES_20100909;
END;
