...
TRUNCATE TABLE CLICK_SEARCHES_20110222;
INSERT INTO CLICK_SEARCHES_20110222
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110222'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110222;
ANALYZE CLICK_SEARCHES_20110222;
END;
