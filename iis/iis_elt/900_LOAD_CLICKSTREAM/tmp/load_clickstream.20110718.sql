...
TRUNCATE TABLE CLICK_SEARCHES_20110718;
INSERT INTO CLICK_SEARCHES_20110718
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110718'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110718;
ANALYZE CLICK_SEARCHES_20110718;
END;
