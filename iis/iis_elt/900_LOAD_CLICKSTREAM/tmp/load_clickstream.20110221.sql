...
TRUNCATE TABLE CLICK_SEARCHES_20110221;
INSERT INTO CLICK_SEARCHES_20110221
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110221'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110221;
ANALYZE CLICK_SEARCHES_20110221;
END;
