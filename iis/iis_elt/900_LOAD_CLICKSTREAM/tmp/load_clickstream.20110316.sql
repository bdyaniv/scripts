...
TRUNCATE TABLE CLICK_SEARCHES_20110316;
INSERT INTO CLICK_SEARCHES_20110316
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110316'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110316;
ANALYZE CLICK_SEARCHES_20110316;
END;
