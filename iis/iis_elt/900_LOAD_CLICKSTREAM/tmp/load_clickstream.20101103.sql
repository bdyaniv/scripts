...
TRUNCATE TABLE CLICK_SEARCHES_20101103;
INSERT INTO CLICK_SEARCHES_20101103
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101103'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101103;
ANALYZE CLICK_SEARCHES_20101103;
END;
