...
TRUNCATE TABLE CLICK_SEARCHES_20111213;
INSERT INTO CLICK_SEARCHES_20111213
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111213'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111213;
ANALYZE CLICK_SEARCHES_20111213;
END;
