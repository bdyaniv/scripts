...
TRUNCATE TABLE CLICK_SEARCHES_20110209;
INSERT INTO CLICK_SEARCHES_20110209
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110209'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110209;
ANALYZE CLICK_SEARCHES_20110209;
END;
