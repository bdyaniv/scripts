...
TRUNCATE TABLE CLICK_SEARCHES_20100228;
INSERT INTO CLICK_SEARCHES_20100228
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100228'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100228;
ANALYZE CLICK_SEARCHES_20100228;
END;
