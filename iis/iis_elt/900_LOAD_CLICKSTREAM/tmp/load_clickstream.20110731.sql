...
TRUNCATE TABLE CLICK_SEARCHES_20110731;
INSERT INTO CLICK_SEARCHES_20110731
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110731'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110731;
ANALYZE CLICK_SEARCHES_20110731;
END;
