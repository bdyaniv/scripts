...
TRUNCATE TABLE CLICK_SEARCHES_20100331;
INSERT INTO CLICK_SEARCHES_20100331
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100331'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100331;
ANALYZE CLICK_SEARCHES_20100331;
END;
