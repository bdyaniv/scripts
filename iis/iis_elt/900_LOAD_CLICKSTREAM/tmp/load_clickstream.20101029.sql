...
TRUNCATE TABLE CLICK_SEARCHES_20101029;
INSERT INTO CLICK_SEARCHES_20101029
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101029'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101029;
ANALYZE CLICK_SEARCHES_20101029;
END;
