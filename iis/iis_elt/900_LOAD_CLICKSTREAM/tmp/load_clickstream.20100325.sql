...
TRUNCATE TABLE CLICK_SEARCHES_20100325;
INSERT INTO CLICK_SEARCHES_20100325
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100325'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100325;
ANALYZE CLICK_SEARCHES_20100325;
END;
