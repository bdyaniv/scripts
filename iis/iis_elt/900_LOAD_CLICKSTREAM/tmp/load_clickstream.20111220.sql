...
TRUNCATE TABLE CLICK_SEARCHES_20111220;
INSERT INTO CLICK_SEARCHES_20111220
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111220'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111220;
ANALYZE CLICK_SEARCHES_20111220;
END;
