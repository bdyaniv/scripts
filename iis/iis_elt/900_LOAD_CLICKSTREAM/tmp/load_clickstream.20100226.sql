...
TRUNCATE TABLE CLICK_SEARCHES_20100226;
INSERT INTO CLICK_SEARCHES_20100226
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100226'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100226;
ANALYZE CLICK_SEARCHES_20100226;
END;
