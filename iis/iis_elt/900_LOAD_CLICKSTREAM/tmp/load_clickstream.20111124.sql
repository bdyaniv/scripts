...
TRUNCATE TABLE CLICK_SEARCHES_20111124;
INSERT INTO CLICK_SEARCHES_20111124
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111124'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111124;
ANALYZE CLICK_SEARCHES_20111124;
END;
