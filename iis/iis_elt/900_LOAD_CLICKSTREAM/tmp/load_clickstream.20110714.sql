...
TRUNCATE TABLE CLICK_SEARCHES_20110714;
INSERT INTO CLICK_SEARCHES_20110714
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110714'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110714;
ANALYZE CLICK_SEARCHES_20110714;
END;
