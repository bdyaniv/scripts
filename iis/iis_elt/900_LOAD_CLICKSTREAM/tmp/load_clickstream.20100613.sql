...
TRUNCATE TABLE CLICK_SEARCHES_20100613;
INSERT INTO CLICK_SEARCHES_20100613
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100613'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100613;
ANALYZE CLICK_SEARCHES_20100613;
END;
