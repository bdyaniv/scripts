...
TRUNCATE TABLE CLICK_SEARCHES_20100701;
INSERT INTO CLICK_SEARCHES_20100701
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100701'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100701;
ANALYZE CLICK_SEARCHES_20100701;
END;
