...
TRUNCATE TABLE CLICK_SEARCHES_20110121;
INSERT INTO CLICK_SEARCHES_20110121
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110121'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110121;
ANALYZE CLICK_SEARCHES_20110121;
END;
