...
TRUNCATE TABLE CLICK_SEARCHES_20111223;
INSERT INTO CLICK_SEARCHES_20111223
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111223'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111223;
ANALYZE CLICK_SEARCHES_20111223;
END;
