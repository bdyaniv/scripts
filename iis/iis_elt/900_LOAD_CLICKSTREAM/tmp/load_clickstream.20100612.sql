...
TRUNCATE TABLE CLICK_SEARCHES_20100612;
INSERT INTO CLICK_SEARCHES_20100612
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100612'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100612;
ANALYZE CLICK_SEARCHES_20100612;
END;
