...
TRUNCATE TABLE CLICK_SEARCHES_20111230;
INSERT INTO CLICK_SEARCHES_20111230
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111230'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111230;
ANALYZE CLICK_SEARCHES_20111230;
END;
