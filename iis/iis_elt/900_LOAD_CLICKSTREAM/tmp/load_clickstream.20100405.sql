...
TRUNCATE TABLE CLICK_SEARCHES_20100405;
INSERT INTO CLICK_SEARCHES_20100405
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100405'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100405;
ANALYZE CLICK_SEARCHES_20100405;
END;
