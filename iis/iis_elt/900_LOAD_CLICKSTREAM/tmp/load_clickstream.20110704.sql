...
TRUNCATE TABLE CLICK_SEARCHES_20110704;
INSERT INTO CLICK_SEARCHES_20110704
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110704'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110704;
ANALYZE CLICK_SEARCHES_20110704;
END;
