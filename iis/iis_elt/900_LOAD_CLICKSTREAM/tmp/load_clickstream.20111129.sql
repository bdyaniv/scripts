...
TRUNCATE TABLE CLICK_SEARCHES_20111129;
INSERT INTO CLICK_SEARCHES_20111129
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111129'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111129;
ANALYZE CLICK_SEARCHES_20111129;
END;
