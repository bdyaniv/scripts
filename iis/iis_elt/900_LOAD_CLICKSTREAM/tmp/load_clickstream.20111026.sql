...
TRUNCATE TABLE CLICK_SEARCHES_20111026;
INSERT INTO CLICK_SEARCHES_20111026
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111026'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111026;
ANALYZE CLICK_SEARCHES_20111026;
END;
