...
TRUNCATE TABLE CLICK_SEARCHES_20101008;
INSERT INTO CLICK_SEARCHES_20101008
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101008'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101008;
ANALYZE CLICK_SEARCHES_20101008;
END;
