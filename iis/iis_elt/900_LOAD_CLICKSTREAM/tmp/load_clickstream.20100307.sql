...
TRUNCATE TABLE CLICK_SEARCHES_20100307;
INSERT INTO CLICK_SEARCHES_20100307
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100307'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100307;
ANALYZE CLICK_SEARCHES_20100307;
END;
