...
TRUNCATE TABLE CLICK_SEARCHES_20100209;
INSERT INTO CLICK_SEARCHES_20100209
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100209'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100209;
ANALYZE CLICK_SEARCHES_20100209;
END;
