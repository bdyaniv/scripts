...
TRUNCATE TABLE CLICK_SEARCHES_20100815;
INSERT INTO CLICK_SEARCHES_20100815
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100815'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100815;
ANALYZE CLICK_SEARCHES_20100815;
END;
