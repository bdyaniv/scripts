...
TRUNCATE TABLE CLICK_SEARCHES_20110213;
INSERT INTO CLICK_SEARCHES_20110213
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110213'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110213;
ANALYZE CLICK_SEARCHES_20110213;
END;
