...
TRUNCATE TABLE CLICK_SEARCHES_20110719;
INSERT INTO CLICK_SEARCHES_20110719
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110719'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110719;
ANALYZE CLICK_SEARCHES_20110719;
END;
