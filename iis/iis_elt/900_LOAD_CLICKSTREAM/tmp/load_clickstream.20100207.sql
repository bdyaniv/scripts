...
TRUNCATE TABLE CLICK_SEARCHES_20100207;
INSERT INTO CLICK_SEARCHES_20100207
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100207'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100207;
ANALYZE CLICK_SEARCHES_20100207;
END;
