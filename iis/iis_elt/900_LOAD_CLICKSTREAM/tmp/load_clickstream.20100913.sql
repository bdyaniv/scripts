...
TRUNCATE TABLE CLICK_SEARCHES_20100913;
INSERT INTO CLICK_SEARCHES_20100913
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100913'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100913;
ANALYZE CLICK_SEARCHES_20100913;
END;
