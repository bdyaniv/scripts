...
TRUNCATE TABLE CLICK_SEARCHES_20110428;
INSERT INTO CLICK_SEARCHES_20110428
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110428'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110428;
ANALYZE CLICK_SEARCHES_20110428;
END;
