...
TRUNCATE TABLE CLICK_SEARCHES_20111012;
INSERT INTO CLICK_SEARCHES_20111012
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111012'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111012;
ANALYZE CLICK_SEARCHES_20111012;
END;
