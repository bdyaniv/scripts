...
TRUNCATE TABLE CLICK_SEARCHES_20100619;
INSERT INTO CLICK_SEARCHES_20100619
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100619'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100619;
ANALYZE CLICK_SEARCHES_20100619;
END;
