...
TRUNCATE TABLE CLICK_SEARCHES_20100617;
INSERT INTO CLICK_SEARCHES_20100617
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100617'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100617;
ANALYZE CLICK_SEARCHES_20100617;
END;
