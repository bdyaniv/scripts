...
TRUNCATE TABLE CLICK_SEARCHES_20111122;
INSERT INTO CLICK_SEARCHES_20111122
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111122'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111122;
ANALYZE CLICK_SEARCHES_20111122;
END;
