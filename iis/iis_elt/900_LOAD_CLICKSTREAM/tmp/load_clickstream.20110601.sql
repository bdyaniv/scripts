...
TRUNCATE TABLE CLICK_SEARCHES_20110601;
INSERT INTO CLICK_SEARCHES_20110601
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110601'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110601;
ANALYZE CLICK_SEARCHES_20110601;
END;
