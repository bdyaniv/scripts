...
TRUNCATE TABLE CLICK_SEARCHES_20101027;
INSERT INTO CLICK_SEARCHES_20101027
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101027'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101027;
ANALYZE CLICK_SEARCHES_20101027;
END;
