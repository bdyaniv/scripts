...
TRUNCATE TABLE CLICK_SEARCHES_20110201;
INSERT INTO CLICK_SEARCHES_20110201
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110201'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110201;
ANALYZE CLICK_SEARCHES_20110201;
END;
