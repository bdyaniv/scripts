...
TRUNCATE TABLE CLICK_SEARCHES_20100722;
INSERT INTO CLICK_SEARCHES_20100722
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100722'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100722;
ANALYZE CLICK_SEARCHES_20100722;
END;
