...
TRUNCATE TABLE CLICK_SEARCHES_20100803;
INSERT INTO CLICK_SEARCHES_20100803
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100803'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100803;
ANALYZE CLICK_SEARCHES_20100803;
END;
