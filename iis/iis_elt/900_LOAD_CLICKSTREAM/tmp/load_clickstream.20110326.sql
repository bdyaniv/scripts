...
TRUNCATE TABLE CLICK_SEARCHES_20110326;
INSERT INTO CLICK_SEARCHES_20110326
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110326'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110326;
ANALYZE CLICK_SEARCHES_20110326;
END;
