...
TRUNCATE TABLE CLICK_SEARCHES_20100818;
INSERT INTO CLICK_SEARCHES_20100818
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100818'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100818;
ANALYZE CLICK_SEARCHES_20100818;
END;
