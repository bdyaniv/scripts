...
TRUNCATE TABLE CLICK_SEARCHES_20110903;
INSERT INTO CLICK_SEARCHES_20110903
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110903'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110903;
ANALYZE CLICK_SEARCHES_20110903;
END;
