...
TRUNCATE TABLE CLICK_SEARCHES_20110329;
INSERT INTO CLICK_SEARCHES_20110329
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110329'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110329;
ANALYZE CLICK_SEARCHES_20110329;
END;
