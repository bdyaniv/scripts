...
TRUNCATE TABLE CLICK_SEARCHES_20101101;
INSERT INTO CLICK_SEARCHES_20101101
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101101'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101101;
ANALYZE CLICK_SEARCHES_20101101;
END;
