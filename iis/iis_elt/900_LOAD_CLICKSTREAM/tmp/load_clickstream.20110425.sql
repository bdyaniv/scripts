...
TRUNCATE TABLE CLICK_SEARCHES_20110425;
INSERT INTO CLICK_SEARCHES_20110425
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110425'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110425;
ANALYZE CLICK_SEARCHES_20110425;
END;
