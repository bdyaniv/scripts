...
TRUNCATE TABLE CLICK_SEARCHES_20101003;
INSERT INTO CLICK_SEARCHES_20101003
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101003'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101003;
ANALYZE CLICK_SEARCHES_20101003;
END;
