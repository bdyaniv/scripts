...
TRUNCATE TABLE CLICK_SEARCHES_20110621;
INSERT INTO CLICK_SEARCHES_20110621
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110621'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110621;
ANALYZE CLICK_SEARCHES_20110621;
END;
