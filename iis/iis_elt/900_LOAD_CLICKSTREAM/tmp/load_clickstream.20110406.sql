...
TRUNCATE TABLE CLICK_SEARCHES_20110406;
INSERT INTO CLICK_SEARCHES_20110406
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110406'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110406;
ANALYZE CLICK_SEARCHES_20110406;
END;
