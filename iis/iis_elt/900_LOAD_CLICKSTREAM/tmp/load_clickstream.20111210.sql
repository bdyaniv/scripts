...
TRUNCATE TABLE CLICK_SEARCHES_20111210;
INSERT INTO CLICK_SEARCHES_20111210
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111210'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111210;
ANALYZE CLICK_SEARCHES_20111210;
END;
