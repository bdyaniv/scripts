...
TRUNCATE TABLE CLICK_SEARCHES_20100605;
INSERT INTO CLICK_SEARCHES_20100605
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100605'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100605;
ANALYZE CLICK_SEARCHES_20100605;
END;
