...
TRUNCATE TABLE CLICK_SEARCHES_20111221;
INSERT INTO CLICK_SEARCHES_20111221
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111221'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111221;
ANALYZE CLICK_SEARCHES_20111221;
END;
