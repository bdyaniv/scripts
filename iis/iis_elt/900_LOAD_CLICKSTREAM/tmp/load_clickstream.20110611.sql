...
TRUNCATE TABLE CLICK_SEARCHES_20110611;
INSERT INTO CLICK_SEARCHES_20110611
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110611'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110611;
ANALYZE CLICK_SEARCHES_20110611;
END;
