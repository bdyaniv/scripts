...
TRUNCATE TABLE CLICK_SEARCHES_20100308;
INSERT INTO CLICK_SEARCHES_20100308
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100308'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100308;
ANALYZE CLICK_SEARCHES_20100308;
END;
