...
TRUNCATE TABLE CLICK_SEARCHES_20100428;
INSERT INTO CLICK_SEARCHES_20100428
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100428'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100428;
ANALYZE CLICK_SEARCHES_20100428;
END;
