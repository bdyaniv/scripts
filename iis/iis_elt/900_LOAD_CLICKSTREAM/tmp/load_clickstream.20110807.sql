...
TRUNCATE TABLE CLICK_SEARCHES_20110807;
INSERT INTO CLICK_SEARCHES_20110807
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110807'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110807;
ANALYZE CLICK_SEARCHES_20110807;
END;
