...
TRUNCATE TABLE CLICK_SEARCHES_20110815;
INSERT INTO CLICK_SEARCHES_20110815
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110815'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110815;
ANALYZE CLICK_SEARCHES_20110815;
END;
