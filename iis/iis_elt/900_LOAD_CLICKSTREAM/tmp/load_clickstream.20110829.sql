...
TRUNCATE TABLE CLICK_SEARCHES_20110829;
INSERT INTO CLICK_SEARCHES_20110829
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110829'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110829;
ANALYZE CLICK_SEARCHES_20110829;
END;
