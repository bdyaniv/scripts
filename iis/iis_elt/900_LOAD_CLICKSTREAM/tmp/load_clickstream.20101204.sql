...
TRUNCATE TABLE CLICK_SEARCHES_20101204;
INSERT INTO CLICK_SEARCHES_20101204
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101204'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101204;
ANALYZE CLICK_SEARCHES_20101204;
END;
