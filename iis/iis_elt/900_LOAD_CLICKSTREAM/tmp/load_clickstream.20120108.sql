...
TRUNCATE TABLE CLICK_SEARCHES_20120108;
INSERT INTO CLICK_SEARCHES_20120108
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20120108'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20120108;
ANALYZE CLICK_SEARCHES_20120108;
END;
