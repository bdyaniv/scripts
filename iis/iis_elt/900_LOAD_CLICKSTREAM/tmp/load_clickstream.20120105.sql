...
TRUNCATE TABLE CLICK_SEARCHES_20120105;
INSERT INTO CLICK_SEARCHES_20120105
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20120105'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20120105;
ANALYZE CLICK_SEARCHES_20120105;
END;
