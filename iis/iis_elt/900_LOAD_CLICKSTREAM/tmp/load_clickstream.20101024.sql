...
TRUNCATE TABLE CLICK_SEARCHES_20101024;
INSERT INTO CLICK_SEARCHES_20101024
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101024'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101024;
ANALYZE CLICK_SEARCHES_20101024;
END;
