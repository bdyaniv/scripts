...
TRUNCATE TABLE CLICK_SEARCHES_20111217;
INSERT INTO CLICK_SEARCHES_20111217
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111217'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111217;
ANALYZE CLICK_SEARCHES_20111217;
END;
