...
TRUNCATE TABLE CLICK_SEARCHES_20110818;
INSERT INTO CLICK_SEARCHES_20110818
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110818'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110818;
ANALYZE CLICK_SEARCHES_20110818;
END;
