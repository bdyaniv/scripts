...
TRUNCATE TABLE CLICK_SEARCHES_20101212;
INSERT INTO CLICK_SEARCHES_20101212
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101212'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101212;
ANALYZE CLICK_SEARCHES_20101212;
END;
