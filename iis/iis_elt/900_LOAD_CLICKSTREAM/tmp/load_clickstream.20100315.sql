...
TRUNCATE TABLE CLICK_SEARCHES_20100315;
INSERT INTO CLICK_SEARCHES_20100315
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100315'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100315;
ANALYZE CLICK_SEARCHES_20100315;
END;
