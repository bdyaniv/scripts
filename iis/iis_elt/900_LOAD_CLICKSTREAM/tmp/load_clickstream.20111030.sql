...
TRUNCATE TABLE CLICK_SEARCHES_20111030;
INSERT INTO CLICK_SEARCHES_20111030
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111030'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111030;
ANALYZE CLICK_SEARCHES_20111030;
END;
