...
TRUNCATE TABLE CLICK_SEARCHES_20111114;
INSERT INTO CLICK_SEARCHES_20111114
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111114'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111114;
ANALYZE CLICK_SEARCHES_20111114;
END;
