...
TRUNCATE TABLE CLICK_SEARCHES_20100211;
INSERT INTO CLICK_SEARCHES_20100211
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100211'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100211;
ANALYZE CLICK_SEARCHES_20100211;
END;
