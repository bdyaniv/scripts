...
TRUNCATE TABLE CLICK_SEARCHES_20101030;
INSERT INTO CLICK_SEARCHES_20101030
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101030'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101030;
ANALYZE CLICK_SEARCHES_20101030;
END;
