...
TRUNCATE TABLE CLICK_SEARCHES_20101112;
INSERT INTO CLICK_SEARCHES_20101112
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101112'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101112;
ANALYZE CLICK_SEARCHES_20101112;
END;
