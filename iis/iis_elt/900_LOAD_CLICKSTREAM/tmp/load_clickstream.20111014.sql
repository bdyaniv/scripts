...
TRUNCATE TABLE CLICK_SEARCHES_20111014;
INSERT INTO CLICK_SEARCHES_20111014
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111014'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111014;
ANALYZE CLICK_SEARCHES_20111014;
END;
