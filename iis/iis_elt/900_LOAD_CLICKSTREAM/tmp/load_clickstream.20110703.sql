...
TRUNCATE TABLE CLICK_SEARCHES_20110703;
INSERT INTO CLICK_SEARCHES_20110703
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110703'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110703;
ANALYZE CLICK_SEARCHES_20110703;
END;
