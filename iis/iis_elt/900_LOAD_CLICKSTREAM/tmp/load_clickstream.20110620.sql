...
TRUNCATE TABLE CLICK_SEARCHES_20110620;
INSERT INTO CLICK_SEARCHES_20110620
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110620'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110620;
ANALYZE CLICK_SEARCHES_20110620;
END;
