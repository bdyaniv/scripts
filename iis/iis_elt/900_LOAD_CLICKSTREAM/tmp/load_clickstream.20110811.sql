...
TRUNCATE TABLE CLICK_SEARCHES_20110811;
INSERT INTO CLICK_SEARCHES_20110811
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110811'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110811;
ANALYZE CLICK_SEARCHES_20110811;
END;
