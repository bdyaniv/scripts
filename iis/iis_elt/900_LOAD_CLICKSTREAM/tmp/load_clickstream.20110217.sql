...
TRUNCATE TABLE CLICK_SEARCHES_20110217;
INSERT INTO CLICK_SEARCHES_20110217
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110217'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110217;
ANALYZE CLICK_SEARCHES_20110217;
END;
