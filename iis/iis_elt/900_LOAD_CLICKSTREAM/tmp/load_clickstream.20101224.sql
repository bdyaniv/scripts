...
TRUNCATE TABLE CLICK_SEARCHES_20101224;
INSERT INTO CLICK_SEARCHES_20101224
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101224'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101224;
ANALYZE CLICK_SEARCHES_20101224;
END;
