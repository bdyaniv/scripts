...
TRUNCATE TABLE CLICK_SEARCHES_20100607;
INSERT INTO CLICK_SEARCHES_20100607
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100607'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100607;
ANALYZE CLICK_SEARCHES_20100607;
END;
