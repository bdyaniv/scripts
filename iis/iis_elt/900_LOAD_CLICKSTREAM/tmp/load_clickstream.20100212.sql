...
TRUNCATE TABLE CLICK_SEARCHES_20100212;
INSERT INTO CLICK_SEARCHES_20100212
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100212'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100212;
ANALYZE CLICK_SEARCHES_20100212;
END;
