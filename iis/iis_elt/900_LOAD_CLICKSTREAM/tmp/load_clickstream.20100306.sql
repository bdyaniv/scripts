...
TRUNCATE TABLE CLICK_SEARCHES_20100306;
INSERT INTO CLICK_SEARCHES_20100306
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100306'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100306;
ANALYZE CLICK_SEARCHES_20100306;
END;
