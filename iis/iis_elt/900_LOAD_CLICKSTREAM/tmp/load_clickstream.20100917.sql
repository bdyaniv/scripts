...
TRUNCATE TABLE CLICK_SEARCHES_20100917;
INSERT INTO CLICK_SEARCHES_20100917
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100917'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100917;
ANALYZE CLICK_SEARCHES_20100917;
END;
