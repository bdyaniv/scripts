...
TRUNCATE TABLE CLICK_SEARCHES_20100513;
INSERT INTO CLICK_SEARCHES_20100513
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100513'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100513;
ANALYZE CLICK_SEARCHES_20100513;
END;
