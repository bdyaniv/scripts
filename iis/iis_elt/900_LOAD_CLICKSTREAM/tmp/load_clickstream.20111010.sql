...
TRUNCATE TABLE CLICK_SEARCHES_20111010;
INSERT INTO CLICK_SEARCHES_20111010
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111010'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111010;
ANALYZE CLICK_SEARCHES_20111010;
END;
