...
TRUNCATE TABLE CLICK_SEARCHES_20111218;
INSERT INTO CLICK_SEARCHES_20111218
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111218'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111218;
ANALYZE CLICK_SEARCHES_20111218;
END;
