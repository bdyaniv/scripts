...
TRUNCATE TABLE CLICK_SEARCHES_20111226;
INSERT INTO CLICK_SEARCHES_20111226
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111226'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111226;
ANALYZE CLICK_SEARCHES_20111226;
END;
