...
TRUNCATE TABLE CLICK_SEARCHES_20100316;
INSERT INTO CLICK_SEARCHES_20100316
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100316'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100316;
ANALYZE CLICK_SEARCHES_20100316;
END;
