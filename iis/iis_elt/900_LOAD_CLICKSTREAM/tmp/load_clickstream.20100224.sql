...
TRUNCATE TABLE CLICK_SEARCHES_20100224;
INSERT INTO CLICK_SEARCHES_20100224
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100224'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100224;
ANALYZE CLICK_SEARCHES_20100224;
END;
