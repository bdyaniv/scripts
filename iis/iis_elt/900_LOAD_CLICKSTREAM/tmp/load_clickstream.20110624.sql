...
TRUNCATE TABLE CLICK_SEARCHES_20110624;
INSERT INTO CLICK_SEARCHES_20110624
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110624'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110624;
ANALYZE CLICK_SEARCHES_20110624;
END;
