...
TRUNCATE TABLE CLICK_SEARCHES_20100309;
INSERT INTO CLICK_SEARCHES_20100309
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100309'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100309;
ANALYZE CLICK_SEARCHES_20100309;
END;
