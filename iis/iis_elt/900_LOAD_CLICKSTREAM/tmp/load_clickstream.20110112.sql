...
TRUNCATE TABLE CLICK_SEARCHES_20110112;
INSERT INTO CLICK_SEARCHES_20110112
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110112'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110112;
ANALYZE CLICK_SEARCHES_20110112;
END;
