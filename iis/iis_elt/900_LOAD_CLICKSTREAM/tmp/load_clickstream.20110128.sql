...
TRUNCATE TABLE CLICK_SEARCHES_20110128;
INSERT INTO CLICK_SEARCHES_20110128
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110128'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110128;
ANALYZE CLICK_SEARCHES_20110128;
END;
