...
TRUNCATE TABLE CLICK_SEARCHES_20100304;
INSERT INTO CLICK_SEARCHES_20100304
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100304'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100304;
ANALYZE CLICK_SEARCHES_20100304;
END;
