...
TRUNCATE TABLE CLICK_SEARCHES_20100710;
INSERT INTO CLICK_SEARCHES_20100710
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100710'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100710;
ANALYZE CLICK_SEARCHES_20100710;
END;
