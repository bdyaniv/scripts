...
TRUNCATE TABLE CLICK_SEARCHES_20110205;
INSERT INTO CLICK_SEARCHES_20110205
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110205'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110205;
ANALYZE CLICK_SEARCHES_20110205;
END;
