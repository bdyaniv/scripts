...
TRUNCATE TABLE CLICK_SEARCHES_20101017;
INSERT INTO CLICK_SEARCHES_20101017
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101017'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101017;
ANALYZE CLICK_SEARCHES_20101017;
END;
