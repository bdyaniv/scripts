...
TRUNCATE TABLE CLICK_SEARCHES_20121103;
INSERT INTO CLICK_SEARCHES_20121103
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20121103'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20121103;
ANALYZE CLICK_SEARCHES_20121103;
END;
