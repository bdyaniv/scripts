...
TRUNCATE TABLE CLICK_SEARCHES_20101125;
INSERT INTO CLICK_SEARCHES_20101125
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101125'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101125;
ANALYZE CLICK_SEARCHES_20101125;
END;
