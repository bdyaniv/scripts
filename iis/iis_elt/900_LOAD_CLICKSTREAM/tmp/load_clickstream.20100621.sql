...
TRUNCATE TABLE CLICK_SEARCHES_20100621;
INSERT INTO CLICK_SEARCHES_20100621
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100621'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100621;
ANALYZE CLICK_SEARCHES_20100621;
END;
