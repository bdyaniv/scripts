...
TRUNCATE TABLE CLICK_SEARCHES_20110802;
INSERT INTO CLICK_SEARCHES_20110802
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110802'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110802;
ANALYZE CLICK_SEARCHES_20110802;
END;
