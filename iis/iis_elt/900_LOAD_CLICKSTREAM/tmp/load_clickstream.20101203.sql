...
TRUNCATE TABLE CLICK_SEARCHES_20101203;
INSERT INTO CLICK_SEARCHES_20101203
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101203'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101203;
ANALYZE CLICK_SEARCHES_20101203;
END;
