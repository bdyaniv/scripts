...
TRUNCATE TABLE CLICK_SEARCHES_20110106;
INSERT INTO CLICK_SEARCHES_20110106
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110106'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110106;
ANALYZE CLICK_SEARCHES_20110106;
END;
