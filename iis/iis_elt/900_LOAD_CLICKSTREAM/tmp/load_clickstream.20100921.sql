...
TRUNCATE TABLE CLICK_SEARCHES_20100921;
INSERT INTO CLICK_SEARCHES_20100921
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100921'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100921;
ANALYZE CLICK_SEARCHES_20100921;
END;
