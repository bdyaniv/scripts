...
TRUNCATE TABLE CLICK_SEARCHES_20100916;
INSERT INTO CLICK_SEARCHES_20100916
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100916'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100916;
ANALYZE CLICK_SEARCHES_20100916;
END;
