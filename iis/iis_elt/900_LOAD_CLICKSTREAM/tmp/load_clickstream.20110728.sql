...
TRUNCATE TABLE CLICK_SEARCHES_20110728;
INSERT INTO CLICK_SEARCHES_20110728
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110728'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110728;
ANALYZE CLICK_SEARCHES_20110728;
END;
