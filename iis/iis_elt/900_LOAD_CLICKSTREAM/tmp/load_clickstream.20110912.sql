...
TRUNCATE TABLE CLICK_SEARCHES_20110912;
INSERT INTO CLICK_SEARCHES_20110912
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110912'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110912;
ANALYZE CLICK_SEARCHES_20110912;
END;
