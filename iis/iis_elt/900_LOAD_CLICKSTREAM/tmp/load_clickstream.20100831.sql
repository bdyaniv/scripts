...
TRUNCATE TABLE CLICK_SEARCHES_20100831;
INSERT INTO CLICK_SEARCHES_20100831
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100831'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100831;
ANALYZE CLICK_SEARCHES_20100831;
END;
