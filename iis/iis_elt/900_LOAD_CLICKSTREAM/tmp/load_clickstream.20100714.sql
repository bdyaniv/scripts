...
TRUNCATE TABLE CLICK_SEARCHES_20100714;
INSERT INTO CLICK_SEARCHES_20100714
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100714'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100714;
ANALYZE CLICK_SEARCHES_20100714;
END;
