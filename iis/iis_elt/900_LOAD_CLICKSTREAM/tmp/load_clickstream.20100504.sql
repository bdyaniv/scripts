...
TRUNCATE TABLE CLICK_SEARCHES_20100504;
INSERT INTO CLICK_SEARCHES_20100504
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100504'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100504;
ANALYZE CLICK_SEARCHES_20100504;
END;
