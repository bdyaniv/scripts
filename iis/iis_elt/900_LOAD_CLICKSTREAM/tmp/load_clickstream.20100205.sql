...
TRUNCATE TABLE CLICK_SEARCHES_20100205;
INSERT INTO CLICK_SEARCHES_20100205
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100205'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100205;
ANALYZE CLICK_SEARCHES_20100205;
END;
