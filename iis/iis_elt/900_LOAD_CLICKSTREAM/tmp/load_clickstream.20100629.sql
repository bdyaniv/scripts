...
TRUNCATE TABLE CLICK_SEARCHES_20100629;
INSERT INTO CLICK_SEARCHES_20100629
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100629'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100629;
ANALYZE CLICK_SEARCHES_20100629;
END;
