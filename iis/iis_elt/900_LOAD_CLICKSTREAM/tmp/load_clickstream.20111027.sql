...
TRUNCATE TABLE CLICK_SEARCHES_20111027;
INSERT INTO CLICK_SEARCHES_20111027
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111027'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111027;
ANALYZE CLICK_SEARCHES_20111027;
END;
