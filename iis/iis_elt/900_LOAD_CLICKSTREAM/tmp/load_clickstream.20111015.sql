...
TRUNCATE TABLE CLICK_SEARCHES_20111015;
INSERT INTO CLICK_SEARCHES_20111015
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111015'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111015;
ANALYZE CLICK_SEARCHES_20111015;
END;
