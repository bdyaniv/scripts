...
TRUNCATE TABLE CLICK_SEARCHES_20110626;
INSERT INTO CLICK_SEARCHES_20110626
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110626'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110626;
ANALYZE CLICK_SEARCHES_20110626;
END;
