...
TRUNCATE TABLE CLICK_SEARCHES_20110820;
INSERT INTO CLICK_SEARCHES_20110820
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110820'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110820;
ANALYZE CLICK_SEARCHES_20110820;
END;
