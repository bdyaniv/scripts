...
TRUNCATE TABLE CLICK_SEARCHES_20111005;
INSERT INTO CLICK_SEARCHES_20111005
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111005'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111005;
ANALYZE CLICK_SEARCHES_20111005;
END;
