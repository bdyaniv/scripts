...
TRUNCATE TABLE CLICK_SEARCHES_20111101;
INSERT INTO CLICK_SEARCHES_20111101
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111101'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111101;
ANALYZE CLICK_SEARCHES_20111101;
END;
