...
TRUNCATE TABLE CLICK_SEARCHES_20111001;
INSERT INTO CLICK_SEARCHES_20111001
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111001'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111001;
ANALYZE CLICK_SEARCHES_20111001;
END;
