...
TRUNCATE TABLE CLICK_SEARCHES_20100511;
INSERT INTO CLICK_SEARCHES_20100511
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100511'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100511;
ANALYZE CLICK_SEARCHES_20100511;
END;
