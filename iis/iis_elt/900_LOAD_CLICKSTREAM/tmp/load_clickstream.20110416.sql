...
TRUNCATE TABLE CLICK_SEARCHES_20110416;
INSERT INTO CLICK_SEARCHES_20110416
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110416'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110416;
ANALYZE CLICK_SEARCHES_20110416;
END;
