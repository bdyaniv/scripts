...
TRUNCATE TABLE CLICK_SEARCHES_20111225;
INSERT INTO CLICK_SEARCHES_20111225
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111225'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111225;
ANALYZE CLICK_SEARCHES_20111225;
END;
