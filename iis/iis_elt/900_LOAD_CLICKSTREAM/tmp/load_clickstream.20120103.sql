...
TRUNCATE TABLE CLICK_SEARCHES_20120103;
INSERT INTO CLICK_SEARCHES_20120103
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20120103'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20120103;
ANALYZE CLICK_SEARCHES_20120103;
END;
