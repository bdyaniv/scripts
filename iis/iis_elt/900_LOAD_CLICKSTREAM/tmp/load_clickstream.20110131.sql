...
TRUNCATE TABLE CLICK_SEARCHES_20110131;
INSERT INTO CLICK_SEARCHES_20110131
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110131'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110131;
ANALYZE CLICK_SEARCHES_20110131;
END;
