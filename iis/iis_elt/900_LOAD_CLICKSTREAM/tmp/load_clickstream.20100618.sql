...
TRUNCATE TABLE CLICK_SEARCHES_20100618;
INSERT INTO CLICK_SEARCHES_20100618
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100618'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100618;
ANALYZE CLICK_SEARCHES_20100618;
END;
