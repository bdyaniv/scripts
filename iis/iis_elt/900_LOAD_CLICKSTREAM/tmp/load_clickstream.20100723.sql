...
TRUNCATE TABLE CLICK_SEARCHES_20100723;
INSERT INTO CLICK_SEARCHES_20100723
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100723'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100723;
ANALYZE CLICK_SEARCHES_20100723;
END;
