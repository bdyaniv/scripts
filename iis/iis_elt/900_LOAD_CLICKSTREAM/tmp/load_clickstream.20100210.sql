...
TRUNCATE TABLE CLICK_SEARCHES_20100210;
INSERT INTO CLICK_SEARCHES_20100210
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100210'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100210;
ANALYZE CLICK_SEARCHES_20100210;
END;
