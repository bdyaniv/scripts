...
TRUNCATE TABLE CLICK_SEARCHES_20100719;
INSERT INTO CLICK_SEARCHES_20100719
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100719'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100719;
ANALYZE CLICK_SEARCHES_20100719;
END;
