...
TRUNCATE TABLE CLICK_SEARCHES_20110822;
INSERT INTO CLICK_SEARCHES_20110822
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110822'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110822;
ANALYZE CLICK_SEARCHES_20110822;
END;
