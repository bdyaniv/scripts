...
TRUNCATE TABLE CLICK_SEARCHES_20100720;
INSERT INTO CLICK_SEARCHES_20100720
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100720'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100720;
ANALYZE CLICK_SEARCHES_20100720;
END;
