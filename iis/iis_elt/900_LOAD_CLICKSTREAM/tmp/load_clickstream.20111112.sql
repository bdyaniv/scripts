...
TRUNCATE TABLE CLICK_SEARCHES_20111112;
INSERT INTO CLICK_SEARCHES_20111112
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111112'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111112;
ANALYZE CLICK_SEARCHES_20111112;
END;
