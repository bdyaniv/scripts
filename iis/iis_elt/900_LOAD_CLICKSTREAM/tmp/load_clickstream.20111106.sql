...
TRUNCATE TABLE CLICK_SEARCHES_20111106;
INSERT INTO CLICK_SEARCHES_20111106
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111106'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111106;
ANALYZE CLICK_SEARCHES_20111106;
END;
