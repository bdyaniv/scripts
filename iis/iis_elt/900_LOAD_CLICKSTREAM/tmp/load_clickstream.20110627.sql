...
TRUNCATE TABLE CLICK_SEARCHES_20110627;
INSERT INTO CLICK_SEARCHES_20110627
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110627'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110627;
ANALYZE CLICK_SEARCHES_20110627;
END;
