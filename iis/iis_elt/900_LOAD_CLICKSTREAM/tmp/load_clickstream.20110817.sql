...
TRUNCATE TABLE CLICK_SEARCHES_20110817;
INSERT INTO CLICK_SEARCHES_20110817
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110817'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110817;
ANALYZE CLICK_SEARCHES_20110817;
END;
