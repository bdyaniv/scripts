...
TRUNCATE TABLE CLICK_SEARCHES_20101215;
INSERT INTO CLICK_SEARCHES_20101215
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101215'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101215;
ANALYZE CLICK_SEARCHES_20101215;
END;
