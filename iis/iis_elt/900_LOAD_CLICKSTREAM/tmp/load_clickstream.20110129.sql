...
TRUNCATE TABLE CLICK_SEARCHES_20110129;
INSERT INTO CLICK_SEARCHES_20110129
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110129'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110129;
ANALYZE CLICK_SEARCHES_20110129;
END;
