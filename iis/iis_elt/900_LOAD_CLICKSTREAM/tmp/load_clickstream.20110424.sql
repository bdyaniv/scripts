...
TRUNCATE TABLE CLICK_SEARCHES_20110424;
INSERT INTO CLICK_SEARCHES_20110424
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110424'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110424;
ANALYZE CLICK_SEARCHES_20110424;
END;
