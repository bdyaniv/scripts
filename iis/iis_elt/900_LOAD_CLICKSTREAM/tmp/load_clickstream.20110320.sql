...
TRUNCATE TABLE CLICK_SEARCHES_20110320;
INSERT INTO CLICK_SEARCHES_20110320
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110320'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110320;
ANALYZE CLICK_SEARCHES_20110320;
END;
