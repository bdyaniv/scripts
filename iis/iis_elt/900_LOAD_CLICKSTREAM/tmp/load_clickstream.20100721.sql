...
TRUNCATE TABLE CLICK_SEARCHES_20100721;
INSERT INTO CLICK_SEARCHES_20100721
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100721'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100721;
ANALYZE CLICK_SEARCHES_20100721;
END;
