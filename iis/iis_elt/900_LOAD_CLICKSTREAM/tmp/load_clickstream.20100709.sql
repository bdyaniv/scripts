...
TRUNCATE TABLE CLICK_SEARCHES_20100709;
INSERT INTO CLICK_SEARCHES_20100709
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100709'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100709;
ANALYZE CLICK_SEARCHES_20100709;
END;
