...
TRUNCATE TABLE CLICK_SEARCHES_20100608;
INSERT INTO CLICK_SEARCHES_20100608
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100608'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100608;
ANALYZE CLICK_SEARCHES_20100608;
END;
