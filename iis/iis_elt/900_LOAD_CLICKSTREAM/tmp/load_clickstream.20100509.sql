...
TRUNCATE TABLE CLICK_SEARCHES_20100509;
INSERT INTO CLICK_SEARCHES_20100509
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100509'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100509;
ANALYZE CLICK_SEARCHES_20100509;
END;
