...
TRUNCATE TABLE CLICK_SEARCHES_20100623;
INSERT INTO CLICK_SEARCHES_20100623
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100623'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100623;
ANALYZE CLICK_SEARCHES_20100623;
END;
