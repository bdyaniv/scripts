...
TRUNCATE TABLE CLICK_SEARCHES_20101226;
INSERT INTO CLICK_SEARCHES_20101226
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101226'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101226;
ANALYZE CLICK_SEARCHES_20101226;
END;
