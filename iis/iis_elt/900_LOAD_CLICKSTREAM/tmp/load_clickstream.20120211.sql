...
TRUNCATE TABLE CLICK_SEARCHES_20120211;
INSERT INTO CLICK_SEARCHES_20120211
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20120211'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20120211;
ANALYZE CLICK_SEARCHES_20120211;
END;
