...
TRUNCATE TABLE CLICK_SEARCHES_20110508;
INSERT INTO CLICK_SEARCHES_20110508
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110508'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110508;
ANALYZE CLICK_SEARCHES_20110508;
END;
