...
TRUNCATE TABLE CLICK_SEARCHES_20110906;
INSERT INTO CLICK_SEARCHES_20110906
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110906'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110906;
ANALYZE CLICK_SEARCHES_20110906;
END;
