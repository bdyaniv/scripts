...
TRUNCATE TABLE CLICK_SEARCHES_20100727;
INSERT INTO CLICK_SEARCHES_20100727
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100727'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100727;
ANALYZE CLICK_SEARCHES_20100727;
END;
