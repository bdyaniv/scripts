...
TRUNCATE TABLE CLICK_SEARCHES_20110505;
INSERT INTO CLICK_SEARCHES_20110505
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110505'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110505;
ANALYZE CLICK_SEARCHES_20110505;
END;
