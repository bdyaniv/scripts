...
TRUNCATE TABLE CLICK_SEARCHES_20100809;
INSERT INTO CLICK_SEARCHES_20100809
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100809'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100809;
ANALYZE CLICK_SEARCHES_20100809;
END;
