...
TRUNCATE TABLE CLICK_SEARCHES_20110720;
INSERT INTO CLICK_SEARCHES_20110720
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110720'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110720;
ANALYZE CLICK_SEARCHES_20110720;
END;
