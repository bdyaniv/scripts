...
TRUNCATE TABLE CLICK_SEARCHES_20100919;
INSERT INTO CLICK_SEARCHES_20100919
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100919'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100919;
ANALYZE CLICK_SEARCHES_20100919;
END;
