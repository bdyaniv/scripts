...
TRUNCATE TABLE CLICK_SEARCHES_20100412;
INSERT INTO CLICK_SEARCHES_20100412
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100412'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100412;
ANALYZE CLICK_SEARCHES_20100412;
END;
