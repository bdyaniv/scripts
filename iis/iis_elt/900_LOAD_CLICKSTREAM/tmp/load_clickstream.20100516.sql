...
TRUNCATE TABLE CLICK_SEARCHES_20100516;
INSERT INTO CLICK_SEARCHES_20100516
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100516'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100516;
ANALYZE CLICK_SEARCHES_20100516;
END;
