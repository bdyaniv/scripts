...
TRUNCATE TABLE CLICK_SEARCHES_20101201;
INSERT INTO CLICK_SEARCHES_20101201
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101201'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101201;
ANALYZE CLICK_SEARCHES_20101201;
END;
