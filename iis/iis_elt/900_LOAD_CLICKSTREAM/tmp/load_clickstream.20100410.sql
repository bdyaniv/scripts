...
TRUNCATE TABLE CLICK_SEARCHES_20100410;
INSERT INTO CLICK_SEARCHES_20100410
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100410'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100410;
ANALYZE CLICK_SEARCHES_20100410;
END;
