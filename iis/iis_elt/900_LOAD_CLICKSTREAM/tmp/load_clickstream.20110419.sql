...
TRUNCATE TABLE CLICK_SEARCHES_20110419;
INSERT INTO CLICK_SEARCHES_20110419
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110419'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110419;
ANALYZE CLICK_SEARCHES_20110419;
END;
