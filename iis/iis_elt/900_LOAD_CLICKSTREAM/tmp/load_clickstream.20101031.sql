...
TRUNCATE TABLE CLICK_SEARCHES_20101031;
INSERT INTO CLICK_SEARCHES_20101031
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101031'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101031;
ANALYZE CLICK_SEARCHES_20101031;
END;
