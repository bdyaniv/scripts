...
TRUNCATE TABLE CLICK_SEARCHES_20110907;
INSERT INTO CLICK_SEARCHES_20110907
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110907'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110907;
ANALYZE CLICK_SEARCHES_20110907;
END;
