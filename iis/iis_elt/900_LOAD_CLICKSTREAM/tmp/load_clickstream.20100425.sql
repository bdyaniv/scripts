...
TRUNCATE TABLE CLICK_SEARCHES_20100425;
INSERT INTO CLICK_SEARCHES_20100425
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100425'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100425;
ANALYZE CLICK_SEARCHES_20100425;
END;
