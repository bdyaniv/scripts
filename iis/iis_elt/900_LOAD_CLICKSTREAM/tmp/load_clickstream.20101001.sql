...
TRUNCATE TABLE CLICK_SEARCHES_20101001;
INSERT INTO CLICK_SEARCHES_20101001
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101001'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101001;
ANALYZE CLICK_SEARCHES_20101001;
END;
