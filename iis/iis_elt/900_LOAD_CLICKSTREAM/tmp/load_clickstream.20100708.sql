...
TRUNCATE TABLE CLICK_SEARCHES_20100708;
INSERT INTO CLICK_SEARCHES_20100708
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100708'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100708;
ANALYZE CLICK_SEARCHES_20100708;
END;
