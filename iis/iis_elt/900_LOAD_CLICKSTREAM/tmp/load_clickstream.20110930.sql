...
TRUNCATE TABLE CLICK_SEARCHES_20110930;
INSERT INTO CLICK_SEARCHES_20110930
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110930'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110930;
ANALYZE CLICK_SEARCHES_20110930;
END;
