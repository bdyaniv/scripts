...
TRUNCATE TABLE CLICK_SEARCHES_20110426;
INSERT INTO CLICK_SEARCHES_20110426
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110426'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110426;
ANALYZE CLICK_SEARCHES_20110426;
END;
