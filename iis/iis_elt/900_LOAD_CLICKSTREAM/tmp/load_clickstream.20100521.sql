...
TRUNCATE TABLE CLICK_SEARCHES_20100521;
INSERT INTO CLICK_SEARCHES_20100521
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100521'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100521;
ANALYZE CLICK_SEARCHES_20100521;
END;
