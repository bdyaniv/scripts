...
TRUNCATE TABLE CLICK_SEARCHES_20110727;
INSERT INTO CLICK_SEARCHES_20110727
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110727'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110727;
ANALYZE CLICK_SEARCHES_20110727;
END;
