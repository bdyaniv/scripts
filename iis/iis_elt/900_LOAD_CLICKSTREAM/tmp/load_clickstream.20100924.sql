...
TRUNCATE TABLE CLICK_SEARCHES_20100924;
INSERT INTO CLICK_SEARCHES_20100924
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100924'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100924;
ANALYZE CLICK_SEARCHES_20100924;
END;
