...
TRUNCATE TABLE CLICK_SEARCHES_20100726;
INSERT INTO CLICK_SEARCHES_20100726
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100726'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100726;
ANALYZE CLICK_SEARCHES_20100726;
END;
