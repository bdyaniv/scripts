...
TRUNCATE TABLE CLICK_SEARCHES_20100829;
INSERT INTO CLICK_SEARCHES_20100829
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100829'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100829;
ANALYZE CLICK_SEARCHES_20100829;
END;
