...
TRUNCATE TABLE CLICK_SEARCHES_20101006;
INSERT INTO CLICK_SEARCHES_20101006
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101006'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101006;
ANALYZE CLICK_SEARCHES_20101006;
END;
