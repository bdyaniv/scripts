...
TRUNCATE TABLE CLICK_SEARCHES_20110404;
INSERT INTO CLICK_SEARCHES_20110404
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110404'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110404;
ANALYZE CLICK_SEARCHES_20110404;
END;
