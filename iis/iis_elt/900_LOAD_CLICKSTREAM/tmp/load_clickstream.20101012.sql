...
TRUNCATE TABLE CLICK_SEARCHES_20101012;
INSERT INTO CLICK_SEARCHES_20101012
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101012'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101012;
ANALYZE CLICK_SEARCHES_20101012;
END;
