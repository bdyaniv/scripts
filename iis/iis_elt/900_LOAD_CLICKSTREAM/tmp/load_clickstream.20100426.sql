...
TRUNCATE TABLE CLICK_SEARCHES_20100426;
INSERT INTO CLICK_SEARCHES_20100426
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100426'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100426;
ANALYZE CLICK_SEARCHES_20100426;
END;
