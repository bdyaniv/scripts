...
TRUNCATE TABLE CLICK_SEARCHES_20110228;
INSERT INTO CLICK_SEARCHES_20110228
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110228'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110228;
ANALYZE CLICK_SEARCHES_20110228;
END;
