...
TRUNCATE TABLE CLICK_SEARCHES_20110109;
INSERT INTO CLICK_SEARCHES_20110109
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110109'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110109;
ANALYZE CLICK_SEARCHES_20110109;
END;
