...
TRUNCATE TABLE CLICK_SEARCHES_20110303;
INSERT INTO CLICK_SEARCHES_20110303
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110303'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110303;
ANALYZE CLICK_SEARCHES_20110303;
END;
