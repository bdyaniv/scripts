...
TRUNCATE TABLE CLICK_SEARCHES_20100609;
INSERT INTO CLICK_SEARCHES_20100609
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100609'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100609;
ANALYZE CLICK_SEARCHES_20100609;
END;
