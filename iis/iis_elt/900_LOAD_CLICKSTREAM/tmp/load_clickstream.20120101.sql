...
TRUNCATE TABLE CLICK_SEARCHES_20120101;
INSERT INTO CLICK_SEARCHES_20120101
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20120101'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20120101;
ANALYZE CLICK_SEARCHES_20120101;
END;
