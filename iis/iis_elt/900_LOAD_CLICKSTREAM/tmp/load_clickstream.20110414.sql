...
TRUNCATE TABLE CLICK_SEARCHES_20110414;
INSERT INTO CLICK_SEARCHES_20110414
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110414'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110414;
ANALYZE CLICK_SEARCHES_20110414;
END;
