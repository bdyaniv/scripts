...
TRUNCATE TABLE CLICK_SEARCHES_20111205;
INSERT INTO CLICK_SEARCHES_20111205
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111205'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111205;
ANALYZE CLICK_SEARCHES_20111205;
END;
