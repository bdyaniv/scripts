...
TRUNCATE TABLE CLICK_SEARCHES_20110805;
INSERT INTO CLICK_SEARCHES_20110805
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110805'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110805;
ANALYZE CLICK_SEARCHES_20110805;
END;
