...
TRUNCATE TABLE CLICK_SEARCHES_20100206;
INSERT INTO CLICK_SEARCHES_20100206
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100206'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100206;
ANALYZE CLICK_SEARCHES_20100206;
END;
