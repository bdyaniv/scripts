...
TRUNCATE TABLE CLICK_SEARCHES_20100305;
INSERT INTO CLICK_SEARCHES_20100305
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100305'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100305;
ANALYZE CLICK_SEARCHES_20100305;
END;
