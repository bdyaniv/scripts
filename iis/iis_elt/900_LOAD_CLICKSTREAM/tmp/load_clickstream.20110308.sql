...
TRUNCATE TABLE CLICK_SEARCHES_20110308;
INSERT INTO CLICK_SEARCHES_20110308
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110308'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110308;
ANALYZE CLICK_SEARCHES_20110308;
END;
