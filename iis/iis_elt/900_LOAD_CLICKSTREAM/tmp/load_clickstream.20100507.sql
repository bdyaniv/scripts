...
TRUNCATE TABLE CLICK_SEARCHES_20100507;
INSERT INTO CLICK_SEARCHES_20100507
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100507'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100507;
ANALYZE CLICK_SEARCHES_20100507;
END;
