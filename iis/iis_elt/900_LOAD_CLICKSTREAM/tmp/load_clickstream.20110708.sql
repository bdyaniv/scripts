...
TRUNCATE TABLE CLICK_SEARCHES_20110708;
INSERT INTO CLICK_SEARCHES_20110708
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110708'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110708;
ANALYZE CLICK_SEARCHES_20110708;
END;
