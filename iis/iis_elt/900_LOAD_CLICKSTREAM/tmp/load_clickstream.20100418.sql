...
TRUNCATE TABLE CLICK_SEARCHES_20100418;
INSERT INTO CLICK_SEARCHES_20100418
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100418'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100418;
ANALYZE CLICK_SEARCHES_20100418;
END;
