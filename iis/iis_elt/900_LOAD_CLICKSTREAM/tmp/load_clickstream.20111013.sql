...
TRUNCATE TABLE CLICK_SEARCHES_20111013;
INSERT INTO CLICK_SEARCHES_20111013
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111013'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111013;
ANALYZE CLICK_SEARCHES_20111013;
END;
