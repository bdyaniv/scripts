...
TRUNCATE TABLE CLICK_SEARCHES_20101124;
INSERT INTO CLICK_SEARCHES_20101124
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101124'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101124;
ANALYZE CLICK_SEARCHES_20101124;
END;
