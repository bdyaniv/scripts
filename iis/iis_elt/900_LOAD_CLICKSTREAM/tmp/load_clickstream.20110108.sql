...
TRUNCATE TABLE CLICK_SEARCHES_20110108;
INSERT INTO CLICK_SEARCHES_20110108
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110108'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110108;
ANALYZE CLICK_SEARCHES_20110108;
END;
