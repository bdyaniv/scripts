...
TRUNCATE TABLE CLICK_SEARCHES_20110110;
INSERT INTO CLICK_SEARCHES_20110110
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110110'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110110;
ANALYZE CLICK_SEARCHES_20110110;
END;
