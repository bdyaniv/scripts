...
TRUNCATE TABLE CLICK_SEARCHES_20110420;
INSERT INTO CLICK_SEARCHES_20110420
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110420'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110420;
ANALYZE CLICK_SEARCHES_20110420;
END;
