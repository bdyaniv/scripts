...
TRUNCATE TABLE CLICK_SEARCHES_20111031;
INSERT INTO CLICK_SEARCHES_20111031
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111031'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111031;
ANALYZE CLICK_SEARCHES_20111031;
END;
