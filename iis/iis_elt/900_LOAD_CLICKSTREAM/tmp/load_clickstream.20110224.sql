...
TRUNCATE TABLE CLICK_SEARCHES_20110224;
INSERT INTO CLICK_SEARCHES_20110224
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110224'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110224;
ANALYZE CLICK_SEARCHES_20110224;
END;
