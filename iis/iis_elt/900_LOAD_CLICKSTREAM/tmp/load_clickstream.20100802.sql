...
TRUNCATE TABLE CLICK_SEARCHES_20100802;
INSERT INTO CLICK_SEARCHES_20100802
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100802'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100802;
ANALYZE CLICK_SEARCHES_20100802;
END;
