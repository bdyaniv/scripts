...
TRUNCATE TABLE CLICK_SEARCHES_20110916;
INSERT INTO CLICK_SEARCHES_20110916
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110916'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110916;
ANALYZE CLICK_SEARCHES_20110916;
END;
