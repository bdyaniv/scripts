...
TRUNCATE TABLE CLICK_SEARCHES_20101018;
INSERT INTO CLICK_SEARCHES_20101018
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101018'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101018;
ANALYZE CLICK_SEARCHES_20101018;
END;
