...
TRUNCATE TABLE CLICK_SEARCHES_20101011;
INSERT INTO CLICK_SEARCHES_20101011
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101011'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101011;
ANALYZE CLICK_SEARCHES_20101011;
END;
