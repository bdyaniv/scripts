...
TRUNCATE TABLE CLICK_SEARCHES_20100828;
INSERT INTO CLICK_SEARCHES_20100828
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100828'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100828;
ANALYZE CLICK_SEARCHES_20100828;
END;
