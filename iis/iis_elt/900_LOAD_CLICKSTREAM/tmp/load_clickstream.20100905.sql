...
TRUNCATE TABLE CLICK_SEARCHES_20100905;
INSERT INTO CLICK_SEARCHES_20100905
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100905'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100905;
ANALYZE CLICK_SEARCHES_20100905;
END;
