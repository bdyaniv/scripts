...
TRUNCATE TABLE CLICK_SEARCHES_20101021;
INSERT INTO CLICK_SEARCHES_20101021
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101021'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101021;
ANALYZE CLICK_SEARCHES_20101021;
END;
