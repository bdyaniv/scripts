...
TRUNCATE TABLE CLICK_SEARCHES_20100501;
INSERT INTO CLICK_SEARCHES_20100501
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100501'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100501;
ANALYZE CLICK_SEARCHES_20100501;
END;
