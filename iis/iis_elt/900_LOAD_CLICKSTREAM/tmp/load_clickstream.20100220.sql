...
TRUNCATE TABLE CLICK_SEARCHES_20100220;
INSERT INTO CLICK_SEARCHES_20100220
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100220'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100220;
ANALYZE CLICK_SEARCHES_20100220;
END;
