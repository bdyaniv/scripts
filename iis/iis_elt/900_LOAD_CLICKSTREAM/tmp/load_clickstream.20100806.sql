...
TRUNCATE TABLE CLICK_SEARCHES_20100806;
INSERT INTO CLICK_SEARCHES_20100806
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100806'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100806;
ANALYZE CLICK_SEARCHES_20100806;
END;
