...
TRUNCATE TABLE CLICK_SEARCHES_20110423;
INSERT INTO CLICK_SEARCHES_20110423
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110423'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110423;
ANALYZE CLICK_SEARCHES_20110423;
END;
