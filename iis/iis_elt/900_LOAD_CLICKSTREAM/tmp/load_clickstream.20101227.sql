...
TRUNCATE TABLE CLICK_SEARCHES_20101227;
INSERT INTO CLICK_SEARCHES_20101227
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101227'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101227;
ANALYZE CLICK_SEARCHES_20101227;
END;
