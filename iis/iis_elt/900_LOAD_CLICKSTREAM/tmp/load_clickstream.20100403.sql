...
TRUNCATE TABLE CLICK_SEARCHES_20100403;
INSERT INTO CLICK_SEARCHES_20100403
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100403'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100403;
ANALYZE CLICK_SEARCHES_20100403;
END;
