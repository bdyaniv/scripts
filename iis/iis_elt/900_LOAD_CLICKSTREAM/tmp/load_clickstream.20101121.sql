...
TRUNCATE TABLE CLICK_SEARCHES_20101121;
INSERT INTO CLICK_SEARCHES_20101121
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101121'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101121;
ANALYZE CLICK_SEARCHES_20101121;
END;
