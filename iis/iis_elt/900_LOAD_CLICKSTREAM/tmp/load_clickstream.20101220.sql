...
TRUNCATE TABLE CLICK_SEARCHES_20101220;
INSERT INTO CLICK_SEARCHES_20101220
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101220'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101220;
ANALYZE CLICK_SEARCHES_20101220;
END;
