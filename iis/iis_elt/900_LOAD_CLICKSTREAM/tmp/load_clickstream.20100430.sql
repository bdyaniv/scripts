...
TRUNCATE TABLE CLICK_SEARCHES_20100430;
INSERT INTO CLICK_SEARCHES_20100430
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100430'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100430;
ANALYZE CLICK_SEARCHES_20100430;
END;
