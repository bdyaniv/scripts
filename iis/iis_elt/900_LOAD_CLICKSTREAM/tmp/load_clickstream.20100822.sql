...
TRUNCATE TABLE CLICK_SEARCHES_20100822;
INSERT INTO CLICK_SEARCHES_20100822
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100822'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100822;
ANALYZE CLICK_SEARCHES_20100822;
END;
