...
TRUNCATE TABLE CLICK_SEARCHES_20111108;
INSERT INTO CLICK_SEARCHES_20111108
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111108'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111108;
ANALYZE CLICK_SEARCHES_20111108;
END;
