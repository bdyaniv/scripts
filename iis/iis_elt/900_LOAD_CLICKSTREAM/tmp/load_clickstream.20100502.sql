...
TRUNCATE TABLE CLICK_SEARCHES_20100502;
INSERT INTO CLICK_SEARCHES_20100502
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100502'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100502;
ANALYZE CLICK_SEARCHES_20100502;
END;
