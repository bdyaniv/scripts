...
TRUNCATE TABLE CLICK_SEARCHES_20100202;
INSERT INTO CLICK_SEARCHES_20100202
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100202'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100202;
ANALYZE CLICK_SEARCHES_20100202;
END;
