...
TRUNCATE TABLE CLICK_SEARCHES_20100523;
INSERT INTO CLICK_SEARCHES_20100523
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100523'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100523;
ANALYZE CLICK_SEARCHES_20100523;
END;
