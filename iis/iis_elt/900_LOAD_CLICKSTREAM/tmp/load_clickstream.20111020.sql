...
TRUNCATE TABLE CLICK_SEARCHES_20111020;
INSERT INTO CLICK_SEARCHES_20111020
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111020'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111020;
ANALYZE CLICK_SEARCHES_20111020;
END;
