...
TRUNCATE TABLE CLICK_SEARCHES_20100706;
INSERT INTO CLICK_SEARCHES_20100706
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100706'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100706;
ANALYZE CLICK_SEARCHES_20100706;
END;
