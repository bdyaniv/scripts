...
TRUNCATE TABLE CLICK_SEARCHES_20100811;
INSERT INTO CLICK_SEARCHES_20100811
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100811'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100811;
ANALYZE CLICK_SEARCHES_20100811;
END;
