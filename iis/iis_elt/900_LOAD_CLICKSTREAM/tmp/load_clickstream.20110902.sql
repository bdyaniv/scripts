...
TRUNCATE TABLE CLICK_SEARCHES_20110902;
INSERT INTO CLICK_SEARCHES_20110902
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110902'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110902;
ANALYZE CLICK_SEARCHES_20110902;
END;
