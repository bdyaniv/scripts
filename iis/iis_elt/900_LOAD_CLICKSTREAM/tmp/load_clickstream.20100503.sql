...
TRUNCATE TABLE CLICK_SEARCHES_20100503;
INSERT INTO CLICK_SEARCHES_20100503
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100503'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100503;
ANALYZE CLICK_SEARCHES_20100503;
END;
