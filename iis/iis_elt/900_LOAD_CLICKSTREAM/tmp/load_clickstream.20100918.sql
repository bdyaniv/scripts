...
TRUNCATE TABLE CLICK_SEARCHES_20100918;
INSERT INTO CLICK_SEARCHES_20100918
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100918'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100918;
ANALYZE CLICK_SEARCHES_20100918;
END;
