...
TRUNCATE TABLE CLICK_SEARCHES_20100927;
INSERT INTO CLICK_SEARCHES_20100927
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100927'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100927;
ANALYZE CLICK_SEARCHES_20100927;
END;
