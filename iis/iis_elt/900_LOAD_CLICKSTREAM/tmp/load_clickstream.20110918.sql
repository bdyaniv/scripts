...
TRUNCATE TABLE CLICK_SEARCHES_20110918;
INSERT INTO CLICK_SEARCHES_20110918
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110918'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110918;
ANALYZE CLICK_SEARCHES_20110918;
END;
