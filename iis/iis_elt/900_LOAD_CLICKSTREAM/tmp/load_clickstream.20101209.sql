...
TRUNCATE TABLE CLICK_SEARCHES_20101209;
INSERT INTO CLICK_SEARCHES_20101209
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101209'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101209;
ANALYZE CLICK_SEARCHES_20101209;
END;
