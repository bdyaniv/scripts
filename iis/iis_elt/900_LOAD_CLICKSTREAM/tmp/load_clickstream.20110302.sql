...
TRUNCATE TABLE CLICK_SEARCHES_20110302;
INSERT INTO CLICK_SEARCHES_20110302
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110302'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110302;
ANALYZE CLICK_SEARCHES_20110302;
END;
