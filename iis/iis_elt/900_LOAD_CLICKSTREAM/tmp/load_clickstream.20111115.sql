...
TRUNCATE TABLE CLICK_SEARCHES_20111115;
INSERT INTO CLICK_SEARCHES_20111115
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111115'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111115;
ANALYZE CLICK_SEARCHES_20111115;
END;
