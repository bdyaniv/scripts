...
TRUNCATE TABLE CLICK_SEARCHES_20111110;
INSERT INTO CLICK_SEARCHES_20111110
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111110'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111110;
ANALYZE CLICK_SEARCHES_20111110;
END;
