...
TRUNCATE TABLE CLICK_SEARCHES_20110909;
INSERT INTO CLICK_SEARCHES_20110909
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110909'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110909;
ANALYZE CLICK_SEARCHES_20110909;
END;
