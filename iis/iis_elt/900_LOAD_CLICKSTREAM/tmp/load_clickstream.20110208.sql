...
TRUNCATE TABLE CLICK_SEARCHES_20110208;
INSERT INTO CLICK_SEARCHES_20110208
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110208'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110208;
ANALYZE CLICK_SEARCHES_20110208;
END;
