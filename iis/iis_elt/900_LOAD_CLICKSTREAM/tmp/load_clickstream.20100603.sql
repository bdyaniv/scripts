...
TRUNCATE TABLE CLICK_SEARCHES_20100603;
INSERT INTO CLICK_SEARCHES_20100603
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100603'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100603;
ANALYZE CLICK_SEARCHES_20100603;
END;
