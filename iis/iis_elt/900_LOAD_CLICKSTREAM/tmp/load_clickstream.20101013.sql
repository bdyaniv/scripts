...
TRUNCATE TABLE CLICK_SEARCHES_20101013;
INSERT INTO CLICK_SEARCHES_20101013
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101013'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101013;
ANALYZE CLICK_SEARCHES_20101013;
END;
