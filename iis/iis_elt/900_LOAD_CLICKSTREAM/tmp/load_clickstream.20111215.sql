...
TRUNCATE TABLE CLICK_SEARCHES_20111215;
INSERT INTO CLICK_SEARCHES_20111215
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111215'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111215;
ANALYZE CLICK_SEARCHES_20111215;
END;
