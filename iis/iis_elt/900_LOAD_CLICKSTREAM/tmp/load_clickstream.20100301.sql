...
TRUNCATE TABLE CLICK_SEARCHES_20100301;
INSERT INTO CLICK_SEARCHES_20100301
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100301'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100301;
ANALYZE CLICK_SEARCHES_20100301;
END;
