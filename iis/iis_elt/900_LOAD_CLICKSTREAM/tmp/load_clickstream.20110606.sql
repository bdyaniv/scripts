...
TRUNCATE TABLE CLICK_SEARCHES_20110606;
INSERT INTO CLICK_SEARCHES_20110606
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110606'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110606;
ANALYZE CLICK_SEARCHES_20110606;
END;
