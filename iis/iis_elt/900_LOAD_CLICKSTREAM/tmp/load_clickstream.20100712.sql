...
TRUNCATE TABLE CLICK_SEARCHES_20100712;
INSERT INTO CLICK_SEARCHES_20100712
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100712'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100712;
ANALYZE CLICK_SEARCHES_20100712;
END;
