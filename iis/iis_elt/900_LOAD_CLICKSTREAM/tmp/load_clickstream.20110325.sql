...
TRUNCATE TABLE CLICK_SEARCHES_20110325;
INSERT INTO CLICK_SEARCHES_20110325
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110325'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110325;
ANALYZE CLICK_SEARCHES_20110325;
END;
