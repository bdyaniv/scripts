...
TRUNCATE TABLE CLICK_SEARCHES_20110225;
INSERT INTO CLICK_SEARCHES_20110225
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110225'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110225;
ANALYZE CLICK_SEARCHES_20110225;
END;
