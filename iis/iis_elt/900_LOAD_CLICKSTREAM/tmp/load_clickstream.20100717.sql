...
TRUNCATE TABLE CLICK_SEARCHES_20100717;
INSERT INTO CLICK_SEARCHES_20100717
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100717'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100717;
ANALYZE CLICK_SEARCHES_20100717;
END;
