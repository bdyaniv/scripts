...
TRUNCATE TABLE CLICK_SEARCHES_20110927;
INSERT INTO CLICK_SEARCHES_20110927
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110927'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110927;
ANALYZE CLICK_SEARCHES_20110927;
END;
