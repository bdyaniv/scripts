...
TRUNCATE TABLE CLICK_SEARCHES_20100527;
INSERT INTO CLICK_SEARCHES_20100527
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100527'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100527;
ANALYZE CLICK_SEARCHES_20100527;
END;
