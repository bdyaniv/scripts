...
TRUNCATE TABLE CLICK_SEARCHES_20101004;
INSERT INTO CLICK_SEARCHES_20101004
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101004'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101004;
ANALYZE CLICK_SEARCHES_20101004;
END;
