...
TRUNCATE TABLE CLICK_SEARCHES_20111209;
INSERT INTO CLICK_SEARCHES_20111209
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111209'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111209;
ANALYZE CLICK_SEARCHES_20111209;
END;
