...
TRUNCATE TABLE CLICK_SEARCHES_20100320;
INSERT INTO CLICK_SEARCHES_20100320
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100320'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100320;
ANALYZE CLICK_SEARCHES_20100320;
END;
