...
TRUNCATE TABLE CLICK_SEARCHES_20111017;
INSERT INTO CLICK_SEARCHES_20111017
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111017'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111017;
ANALYZE CLICK_SEARCHES_20111017;
END;
