...
TRUNCATE TABLE CLICK_SEARCHES_20100703;
INSERT INTO CLICK_SEARCHES_20100703
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100703'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100703;
ANALYZE CLICK_SEARCHES_20100703;
END;
