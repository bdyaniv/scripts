...
TRUNCATE TABLE CLICK_SEARCHES_20110625;
INSERT INTO CLICK_SEARCHES_20110625
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110625'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110625;
ANALYZE CLICK_SEARCHES_20110625;
END;
