...
TRUNCATE TABLE CLICK_SEARCHES_20110204;
INSERT INTO CLICK_SEARCHES_20110204
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110204'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110204;
ANALYZE CLICK_SEARCHES_20110204;
END;
