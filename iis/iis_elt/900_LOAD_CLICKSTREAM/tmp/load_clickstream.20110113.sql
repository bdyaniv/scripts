...
TRUNCATE TABLE CLICK_SEARCHES_20110113;
INSERT INTO CLICK_SEARCHES_20110113
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110113'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110113;
ANALYZE CLICK_SEARCHES_20110113;
END;
