...
TRUNCATE TABLE CLICK_SEARCHES_20110206;
INSERT INTO CLICK_SEARCHES_20110206
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110206'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110206;
ANALYZE CLICK_SEARCHES_20110206;
END;
