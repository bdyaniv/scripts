...
TRUNCATE TABLE CLICK_SEARCHES_20110125;
INSERT INTO CLICK_SEARCHES_20110125
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110125'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110125;
ANALYZE CLICK_SEARCHES_20110125;
END;
