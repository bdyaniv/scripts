...
TRUNCATE TABLE CLICK_SEARCHES_20110215;
INSERT INTO CLICK_SEARCHES_20110215
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110215'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110215;
ANALYZE CLICK_SEARCHES_20110215;
END;
