...
TRUNCATE TABLE CLICK_SEARCHES_20100420;
INSERT INTO CLICK_SEARCHES_20100420
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100420'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100420;
ANALYZE CLICK_SEARCHES_20100420;
END;
