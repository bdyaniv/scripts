...
TRUNCATE TABLE CLICK_SEARCHES_20100423;
INSERT INTO CLICK_SEARCHES_20100423
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100423'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100423;
ANALYZE CLICK_SEARCHES_20100423;
END;
