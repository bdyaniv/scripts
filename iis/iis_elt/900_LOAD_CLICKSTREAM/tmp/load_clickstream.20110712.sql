...
TRUNCATE TABLE CLICK_SEARCHES_20110712;
INSERT INTO CLICK_SEARCHES_20110712
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110712'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110712;
ANALYZE CLICK_SEARCHES_20110712;
END;
