...
TRUNCATE TABLE CLICK_SEARCHES_20101002;
INSERT INTO CLICK_SEARCHES_20101002
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101002'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101002;
ANALYZE CLICK_SEARCHES_20101002;
END;
