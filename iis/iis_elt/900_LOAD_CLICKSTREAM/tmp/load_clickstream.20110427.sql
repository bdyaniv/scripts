...
TRUNCATE TABLE CLICK_SEARCHES_20110427;
INSERT INTO CLICK_SEARCHES_20110427
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110427'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110427;
ANALYZE CLICK_SEARCHES_20110427;
END;
