...
TRUNCATE TABLE CLICK_SEARCHES_20110609;
INSERT INTO CLICK_SEARCHES_20110609
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110609'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110609;
ANALYZE CLICK_SEARCHES_20110609;
END;
