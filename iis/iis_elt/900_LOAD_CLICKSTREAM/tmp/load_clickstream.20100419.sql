...
TRUNCATE TABLE CLICK_SEARCHES_20100419;
INSERT INTO CLICK_SEARCHES_20100419
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100419'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100419;
ANALYZE CLICK_SEARCHES_20100419;
END;
