...
TRUNCATE TABLE CLICK_SEARCHES_20101023;
INSERT INTO CLICK_SEARCHES_20101023
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101023'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101023;
ANALYZE CLICK_SEARCHES_20101023;
END;
