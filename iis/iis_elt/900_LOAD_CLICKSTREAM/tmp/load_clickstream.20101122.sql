...
TRUNCATE TABLE CLICK_SEARCHES_20101122;
INSERT INTO CLICK_SEARCHES_20101122
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101122'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101122;
ANALYZE CLICK_SEARCHES_20101122;
END;
