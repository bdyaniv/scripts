...
TRUNCATE TABLE CLICK_SEARCHES_20100827;
INSERT INTO CLICK_SEARCHES_20100827
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100827'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100827;
ANALYZE CLICK_SEARCHES_20100827;
END;
