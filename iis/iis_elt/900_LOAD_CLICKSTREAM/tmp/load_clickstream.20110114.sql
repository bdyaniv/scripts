...
TRUNCATE TABLE CLICK_SEARCHES_20110114;
INSERT INTO CLICK_SEARCHES_20110114
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110114'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110114;
ANALYZE CLICK_SEARCHES_20110114;
END;
