...
TRUNCATE TABLE CLICK_SEARCHES_20110808;
INSERT INTO CLICK_SEARCHES_20110808
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110808'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110808;
ANALYZE CLICK_SEARCHES_20110808;
END;
