...
TRUNCATE TABLE CLICK_SEARCHES_20111103;
INSERT INTO CLICK_SEARCHES_20111103
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111103'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111103;
ANALYZE CLICK_SEARCHES_20111103;
END;
