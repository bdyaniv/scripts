...
TRUNCATE TABLE CLICK_SEARCHES_20100912;
INSERT INTO CLICK_SEARCHES_20100912
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100912'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100912;
ANALYZE CLICK_SEARCHES_20100912;
END;
