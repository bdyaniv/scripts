...
TRUNCATE TABLE CLICK_SEARCHES_20110716;
INSERT INTO CLICK_SEARCHES_20110716
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110716'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110716;
ANALYZE CLICK_SEARCHES_20110716;
END;
