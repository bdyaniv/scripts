...
TRUNCATE TABLE CLICK_SEARCHES_20110722;
INSERT INTO CLICK_SEARCHES_20110722
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110722'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110722;
ANALYZE CLICK_SEARCHES_20110722;
END;
