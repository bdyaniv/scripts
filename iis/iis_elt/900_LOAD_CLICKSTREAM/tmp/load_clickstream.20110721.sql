...
TRUNCATE TABLE CLICK_SEARCHES_20110721;
INSERT INTO CLICK_SEARCHES_20110721
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110721'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110721;
ANALYZE CLICK_SEARCHES_20110721;
END;
