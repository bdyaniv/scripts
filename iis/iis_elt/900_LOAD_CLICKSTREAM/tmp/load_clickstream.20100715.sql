...
TRUNCATE TABLE CLICK_SEARCHES_20100715;
INSERT INTO CLICK_SEARCHES_20100715
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100715'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100715;
ANALYZE CLICK_SEARCHES_20100715;
END;
