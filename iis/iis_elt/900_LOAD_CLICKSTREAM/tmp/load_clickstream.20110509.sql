...
TRUNCATE TABLE CLICK_SEARCHES_20110509;
INSERT INTO CLICK_SEARCHES_20110509
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110509'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110509;
ANALYZE CLICK_SEARCHES_20110509;
END;
