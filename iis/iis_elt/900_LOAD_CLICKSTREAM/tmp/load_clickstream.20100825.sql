...
TRUNCATE TABLE CLICK_SEARCHES_20100825;
INSERT INTO CLICK_SEARCHES_20100825
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100825'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100825;
ANALYZE CLICK_SEARCHES_20100825;
END;
