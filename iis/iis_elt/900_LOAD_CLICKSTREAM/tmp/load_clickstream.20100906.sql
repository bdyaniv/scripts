...
TRUNCATE TABLE CLICK_SEARCHES_20100906;
INSERT INTO CLICK_SEARCHES_20100906
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100906'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100906;
ANALYZE CLICK_SEARCHES_20100906;
END;
