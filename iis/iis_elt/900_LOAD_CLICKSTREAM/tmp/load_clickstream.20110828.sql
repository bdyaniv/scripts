...
TRUNCATE TABLE CLICK_SEARCHES_20110828;
INSERT INTO CLICK_SEARCHES_20110828
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110828'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110828;
ANALYZE CLICK_SEARCHES_20110828;
END;
