...
TRUNCATE TABLE CLICK_SEARCHES_20110315;
INSERT INTO CLICK_SEARCHES_20110315
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110315'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110315;
ANALYZE CLICK_SEARCHES_20110315;
END;
