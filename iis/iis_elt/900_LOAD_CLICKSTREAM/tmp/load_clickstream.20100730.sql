...
TRUNCATE TABLE CLICK_SEARCHES_20100730;
INSERT INTO CLICK_SEARCHES_20100730
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100730'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100730;
ANALYZE CLICK_SEARCHES_20100730;
END;
