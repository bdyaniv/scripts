...
TRUNCATE TABLE CLICK_SEARCHES_20110111;
INSERT INTO CLICK_SEARCHES_20110111
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110111'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110111;
ANALYZE CLICK_SEARCHES_20110111;
END;
