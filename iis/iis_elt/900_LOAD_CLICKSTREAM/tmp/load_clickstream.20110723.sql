...
TRUNCATE TABLE CLICK_SEARCHES_20110723;
INSERT INTO CLICK_SEARCHES_20110723
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110723'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110723;
ANALYZE CLICK_SEARCHES_20110723;
END;
