...
TRUNCATE TABLE CLICK_SEARCHES_20110924;
INSERT INTO CLICK_SEARCHES_20110924
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110924'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110924;
ANALYZE CLICK_SEARCHES_20110924;
END;
