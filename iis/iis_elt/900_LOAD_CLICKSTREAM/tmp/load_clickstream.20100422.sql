...
TRUNCATE TABLE CLICK_SEARCHES_20100422;
INSERT INTO CLICK_SEARCHES_20100422
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100422'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100422;
ANALYZE CLICK_SEARCHES_20100422;
END;
