...
TRUNCATE TABLE CLICK_SEARCHES_20111018;
INSERT INTO CLICK_SEARCHES_20111018
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111018'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111018;
ANALYZE CLICK_SEARCHES_20111018;
END;
