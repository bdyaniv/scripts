...
TRUNCATE TABLE CLICK_SEARCHES_20101205;
INSERT INTO CLICK_SEARCHES_20101205
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101205'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101205;
ANALYZE CLICK_SEARCHES_20101205;
END;
