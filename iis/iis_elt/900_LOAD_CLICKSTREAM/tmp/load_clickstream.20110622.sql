...
TRUNCATE TABLE CLICK_SEARCHES_20110622;
INSERT INTO CLICK_SEARCHES_20110622
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110622'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110622;
ANALYZE CLICK_SEARCHES_20110622;
END;
