...
TRUNCATE TABLE CLICK_SEARCHES_20101114;
INSERT INTO CLICK_SEARCHES_20101114
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101114'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101114;
ANALYZE CLICK_SEARCHES_20101114;
END;
