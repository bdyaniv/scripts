...
TRUNCATE TABLE CLICK_SEARCHES_20101009;
INSERT INTO CLICK_SEARCHES_20101009
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101009'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101009;
ANALYZE CLICK_SEARCHES_20101009;
END;
