...
TRUNCATE TABLE CLICK_SEARCHES_20110810;
INSERT INTO CLICK_SEARCHES_20110810
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110810'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110810;
ANALYZE CLICK_SEARCHES_20110810;
END;
