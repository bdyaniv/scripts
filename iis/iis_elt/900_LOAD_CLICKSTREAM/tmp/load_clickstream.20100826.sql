...
TRUNCATE TABLE CLICK_SEARCHES_20100826;
INSERT INTO CLICK_SEARCHES_20100826
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100826'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100826;
ANALYZE CLICK_SEARCHES_20100826;
END;
