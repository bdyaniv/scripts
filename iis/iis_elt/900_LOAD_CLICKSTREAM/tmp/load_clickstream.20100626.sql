...
TRUNCATE TABLE CLICK_SEARCHES_20100626;
INSERT INTO CLICK_SEARCHES_20100626
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100626'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100626;
ANALYZE CLICK_SEARCHES_20100626;
END;
