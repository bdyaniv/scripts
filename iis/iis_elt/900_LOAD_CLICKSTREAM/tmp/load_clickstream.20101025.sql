...
TRUNCATE TABLE CLICK_SEARCHES_20101025;
INSERT INTO CLICK_SEARCHES_20101025
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101025'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101025;
ANALYZE CLICK_SEARCHES_20101025;
END;
