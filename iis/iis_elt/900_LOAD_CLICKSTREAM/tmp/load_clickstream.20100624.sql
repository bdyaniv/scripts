...
TRUNCATE TABLE CLICK_SEARCHES_20100624;
INSERT INTO CLICK_SEARCHES_20100624
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100624'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100624;
ANALYZE CLICK_SEARCHES_20100624;
END;
