...
TRUNCATE TABLE CLICK_SEARCHES_20100508;
INSERT INTO CLICK_SEARCHES_20100508
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100508'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100508;
ANALYZE CLICK_SEARCHES_20100508;
END;
