...
TRUNCATE TABLE CLICK_SEARCHES_20100216;
INSERT INTO CLICK_SEARCHES_20100216
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100216'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100216;
ANALYZE CLICK_SEARCHES_20100216;
END;
