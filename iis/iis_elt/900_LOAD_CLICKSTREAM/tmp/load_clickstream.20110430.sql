...
TRUNCATE TABLE CLICK_SEARCHES_20110430;
INSERT INTO CLICK_SEARCHES_20110430
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110430'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110430;
ANALYZE CLICK_SEARCHES_20110430;
END;
