...
TRUNCATE TABLE CLICK_SEARCHES_20110310;
INSERT INTO CLICK_SEARCHES_20110310
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110310'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110310;
ANALYZE CLICK_SEARCHES_20110310;
END;
