...
TRUNCATE TABLE CLICK_SEARCHES_20100725;
INSERT INTO CLICK_SEARCHES_20100725
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100725'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100725;
ANALYZE CLICK_SEARCHES_20100725;
END;
