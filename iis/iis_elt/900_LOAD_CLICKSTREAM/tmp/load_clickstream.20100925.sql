...
TRUNCATE TABLE CLICK_SEARCHES_20100925;
INSERT INTO CLICK_SEARCHES_20100925
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100925'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100925;
ANALYZE CLICK_SEARCHES_20100925;
END;
