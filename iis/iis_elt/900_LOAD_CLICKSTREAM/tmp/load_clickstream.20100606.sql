...
TRUNCATE TABLE CLICK_SEARCHES_20100606;
INSERT INTO CLICK_SEARCHES_20100606
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100606'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100606;
ANALYZE CLICK_SEARCHES_20100606;
END;
