...
TRUNCATE TABLE CLICK_SEARCHES_20110212;
INSERT INTO CLICK_SEARCHES_20110212
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110212'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110212;
ANALYZE CLICK_SEARCHES_20110212;
END;
