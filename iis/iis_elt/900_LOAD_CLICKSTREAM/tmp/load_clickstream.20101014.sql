...
TRUNCATE TABLE CLICK_SEARCHES_20101014;
INSERT INTO CLICK_SEARCHES_20101014
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101014'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101014;
ANALYZE CLICK_SEARCHES_20101014;
END;
