...
TRUNCATE TABLE CLICK_SEARCHES_20110104;
INSERT INTO CLICK_SEARCHES_20110104
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110104'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110104;
ANALYZE CLICK_SEARCHES_20110104;
END;
