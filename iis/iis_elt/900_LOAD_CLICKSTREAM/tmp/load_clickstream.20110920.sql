...
TRUNCATE TABLE CLICK_SEARCHES_20110920;
INSERT INTO CLICK_SEARCHES_20110920
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110920'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110920;
ANALYZE CLICK_SEARCHES_20110920;
END;
