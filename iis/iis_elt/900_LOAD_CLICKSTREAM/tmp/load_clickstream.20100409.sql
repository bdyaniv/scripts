...
TRUNCATE TABLE CLICK_SEARCHES_20100409;
INSERT INTO CLICK_SEARCHES_20100409
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100409'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100409;
ANALYZE CLICK_SEARCHES_20100409;
END;
