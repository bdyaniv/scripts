...
TRUNCATE TABLE CLICK_SEARCHES_20110816;
INSERT INTO CLICK_SEARCHES_20110816
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110816'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110816;
ANALYZE CLICK_SEARCHES_20110816;
END;
