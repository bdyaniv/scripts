...
TRUNCATE TABLE CLICK_SEARCHES_20111109;
INSERT INTO CLICK_SEARCHES_20111109
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111109'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111109;
ANALYZE CLICK_SEARCHES_20111109;
END;
