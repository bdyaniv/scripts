...
TRUNCATE TABLE CLICK_SEARCHES_20110707;
INSERT INTO CLICK_SEARCHES_20110707
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110707'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110707;
ANALYZE CLICK_SEARCHES_20110707;
END;
