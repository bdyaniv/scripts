...
TRUNCATE TABLE CLICK_SEARCHES_20110421;
INSERT INTO CLICK_SEARCHES_20110421
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110421'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110421;
ANALYZE CLICK_SEARCHES_20110421;
END;
