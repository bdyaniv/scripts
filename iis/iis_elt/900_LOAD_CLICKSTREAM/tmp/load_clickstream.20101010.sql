...
TRUNCATE TABLE CLICK_SEARCHES_20101010;
INSERT INTO CLICK_SEARCHES_20101010
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101010'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101010;
ANALYZE CLICK_SEARCHES_20101010;
END;
