...
TRUNCATE TABLE CLICK_SEARCHES_20110413;
INSERT INTO CLICK_SEARCHES_20110413
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110413'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110413;
ANALYZE CLICK_SEARCHES_20110413;
END;
