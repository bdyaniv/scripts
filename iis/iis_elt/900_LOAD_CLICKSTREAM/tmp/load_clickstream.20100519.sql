...
TRUNCATE TABLE CLICK_SEARCHES_20100519;
INSERT INTO CLICK_SEARCHES_20100519
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100519'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100519;
ANALYZE CLICK_SEARCHES_20100519;
END;
