...
TRUNCATE TABLE CLICK_SEARCHES_20101022;
INSERT INTO CLICK_SEARCHES_20101022
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101022'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101022;
ANALYZE CLICK_SEARCHES_20101022;
END;
