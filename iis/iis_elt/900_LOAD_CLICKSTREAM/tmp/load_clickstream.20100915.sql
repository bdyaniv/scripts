...
TRUNCATE TABLE CLICK_SEARCHES_20100915;
INSERT INTO CLICK_SEARCHES_20100915
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100915'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100915;
ANALYZE CLICK_SEARCHES_20100915;
END;
