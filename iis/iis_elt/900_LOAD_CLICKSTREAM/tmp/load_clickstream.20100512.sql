...
TRUNCATE TABLE CLICK_SEARCHES_20100512;
INSERT INTO CLICK_SEARCHES_20100512
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100512'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100512;
ANALYZE CLICK_SEARCHES_20100512;
END;
