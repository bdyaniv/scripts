...
TRUNCATE TABLE CLICK_SEARCHES_20101115;
INSERT INTO CLICK_SEARCHES_20101115
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101115'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101115;
ANALYZE CLICK_SEARCHES_20101115;
END;
