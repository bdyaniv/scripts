...
TRUNCATE TABLE CLICK_SEARCHES_20100330;
INSERT INTO CLICK_SEARCHES_20100330
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100330'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100330;
ANALYZE CLICK_SEARCHES_20100330;
END;
