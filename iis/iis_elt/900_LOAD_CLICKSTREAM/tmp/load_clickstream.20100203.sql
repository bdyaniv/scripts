...
TRUNCATE TABLE CLICK_SEARCHES_20100203;
INSERT INTO CLICK_SEARCHES_20100203
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100203'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100203;
ANALYZE CLICK_SEARCHES_20100203;
END;
