...
TRUNCATE TABLE CLICK_SEARCHES_20101005;
INSERT INTO CLICK_SEARCHES_20101005
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101005'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101005;
ANALYZE CLICK_SEARCHES_20101005;
END;
