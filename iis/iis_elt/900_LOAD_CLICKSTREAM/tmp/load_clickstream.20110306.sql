...
TRUNCATE TABLE CLICK_SEARCHES_20110306;
INSERT INTO CLICK_SEARCHES_20110306
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110306'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110306;
ANALYZE CLICK_SEARCHES_20110306;
END;
