...
TRUNCATE TABLE CLICK_SEARCHES_20110814;
INSERT INTO CLICK_SEARCHES_20110814
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110814'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110814;
ANALYZE CLICK_SEARCHES_20110814;
END;
