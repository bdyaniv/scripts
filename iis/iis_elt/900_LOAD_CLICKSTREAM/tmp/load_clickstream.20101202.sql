...
TRUNCATE TABLE CLICK_SEARCHES_20101202;
INSERT INTO CLICK_SEARCHES_20101202
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101202'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101202;
ANALYZE CLICK_SEARCHES_20101202;
END;
