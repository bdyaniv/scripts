...
TRUNCATE TABLE CLICK_SEARCHES_20101130;
INSERT INTO CLICK_SEARCHES_20101130
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101130'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101130;
ANALYZE CLICK_SEARCHES_20101130;
END;
