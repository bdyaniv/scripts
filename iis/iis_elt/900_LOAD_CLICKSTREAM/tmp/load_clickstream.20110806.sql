...
TRUNCATE TABLE CLICK_SEARCHES_20110806;
INSERT INTO CLICK_SEARCHES_20110806
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110806'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110806;
ANALYZE CLICK_SEARCHES_20110806;
END;
