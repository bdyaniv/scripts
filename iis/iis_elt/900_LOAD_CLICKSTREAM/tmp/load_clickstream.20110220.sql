...
TRUNCATE TABLE CLICK_SEARCHES_20110220;
INSERT INTO CLICK_SEARCHES_20110220
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110220'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110220;
ANALYZE CLICK_SEARCHES_20110220;
END;
