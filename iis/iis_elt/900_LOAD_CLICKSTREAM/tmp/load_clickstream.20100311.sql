...
TRUNCATE TABLE CLICK_SEARCHES_20100311;
INSERT INTO CLICK_SEARCHES_20100311
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100311'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100311;
ANALYZE CLICK_SEARCHES_20100311;
END;
