...
TRUNCATE TABLE CLICK_SEARCHES_20120107;
INSERT INTO CLICK_SEARCHES_20120107
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20120107'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20120107;
ANALYZE CLICK_SEARCHES_20120107;
END;
