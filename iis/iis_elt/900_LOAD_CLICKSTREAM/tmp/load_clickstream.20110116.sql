...
TRUNCATE TABLE CLICK_SEARCHES_20110116;
INSERT INTO CLICK_SEARCHES_20110116
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110116'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110116;
ANALYZE CLICK_SEARCHES_20110116;
END;
