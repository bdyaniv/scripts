...
TRUNCATE TABLE CLICK_SEARCHES_20110908;
INSERT INTO CLICK_SEARCHES_20110908
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110908'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110908;
ANALYZE CLICK_SEARCHES_20110908;
END;
