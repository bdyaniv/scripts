...
TRUNCATE TABLE CLICK_SEARCHES_20110803;
INSERT INTO CLICK_SEARCHES_20110803
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110803'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110803;
ANALYZE CLICK_SEARCHES_20110803;
END;
