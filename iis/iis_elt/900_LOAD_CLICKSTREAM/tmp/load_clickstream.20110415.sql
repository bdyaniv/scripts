...
TRUNCATE TABLE CLICK_SEARCHES_20110415;
INSERT INTO CLICK_SEARCHES_20110415
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110415'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110415;
ANALYZE CLICK_SEARCHES_20110415;
END;
