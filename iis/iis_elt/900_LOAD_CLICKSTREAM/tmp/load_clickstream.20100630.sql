...
TRUNCATE TABLE CLICK_SEARCHES_20100630;
INSERT INTO CLICK_SEARCHES_20100630
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100630'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100630;
ANALYZE CLICK_SEARCHES_20100630;
END;
