...
TRUNCATE TABLE CLICK_SEARCHES_20111202;
INSERT INTO CLICK_SEARCHES_20111202
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111202'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111202;
ANALYZE CLICK_SEARCHES_20111202;
END;
