...
TRUNCATE TABLE CLICK_SEARCHES_20100713;
INSERT INTO CLICK_SEARCHES_20100713
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100713'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100713;
ANALYZE CLICK_SEARCHES_20100713;
END;
