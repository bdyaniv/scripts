...
TRUNCATE TABLE CLICK_SEARCHES_20100530;
INSERT INTO CLICK_SEARCHES_20100530
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100530'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100530;
ANALYZE CLICK_SEARCHES_20100530;
END;
