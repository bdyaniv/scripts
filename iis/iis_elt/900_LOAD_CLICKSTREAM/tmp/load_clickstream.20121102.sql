...
TRUNCATE TABLE CLICK_SEARCHES_20121102;
INSERT INTO CLICK_SEARCHES_20121102
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20121102'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20121102;
ANALYZE CLICK_SEARCHES_20121102;
END;
