...
TRUNCATE TABLE CLICK_SEARCHES_20110928;
INSERT INTO CLICK_SEARCHES_20110928
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110928'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110928;
ANALYZE CLICK_SEARCHES_20110928;
END;
