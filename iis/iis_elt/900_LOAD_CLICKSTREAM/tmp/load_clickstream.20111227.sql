...
TRUNCATE TABLE CLICK_SEARCHES_20111227;
INSERT INTO CLICK_SEARCHES_20111227
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111227'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111227;
ANALYZE CLICK_SEARCHES_20111227;
END;
