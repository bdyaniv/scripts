...
TRUNCATE TABLE CLICK_SEARCHES_20100620;
INSERT INTO CLICK_SEARCHES_20100620
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100620'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100620;
ANALYZE CLICK_SEARCHES_20100620;
END;
