...
TRUNCATE TABLE CLICK_SEARCHES_20110103;
INSERT INTO CLICK_SEARCHES_20110103
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110103'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110103;
ANALYZE CLICK_SEARCHES_20110103;
END;
