...
TRUNCATE TABLE CLICK_SEARCHES_20111004;
INSERT INTO CLICK_SEARCHES_20111004
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111004'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111004;
ANALYZE CLICK_SEARCHES_20111004;
END;
