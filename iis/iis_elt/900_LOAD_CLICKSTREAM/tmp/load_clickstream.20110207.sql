...
TRUNCATE TABLE CLICK_SEARCHES_20110207;
INSERT INTO CLICK_SEARCHES_20110207
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110207'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110207;
ANALYZE CLICK_SEARCHES_20110207;
END;
