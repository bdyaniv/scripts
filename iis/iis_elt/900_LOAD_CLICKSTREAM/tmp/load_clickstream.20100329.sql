...
TRUNCATE TABLE CLICK_SEARCHES_20100329;
INSERT INTO CLICK_SEARCHES_20100329
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100329'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100329;
ANALYZE CLICK_SEARCHES_20100329;
END;
