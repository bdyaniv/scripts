...
TRUNCATE TABLE CLICK_SEARCHES_20111120;
INSERT INTO CLICK_SEARCHES_20111120
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111120'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111120;
ANALYZE CLICK_SEARCHES_20111120;
END;
