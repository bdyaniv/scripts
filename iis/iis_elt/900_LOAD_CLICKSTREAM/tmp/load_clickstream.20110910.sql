...
TRUNCATE TABLE CLICK_SEARCHES_20110910;
INSERT INTO CLICK_SEARCHES_20110910
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110910'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110910;
ANALYZE CLICK_SEARCHES_20110910;
END;
