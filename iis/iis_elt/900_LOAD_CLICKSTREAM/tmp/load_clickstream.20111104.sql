...
TRUNCATE TABLE CLICK_SEARCHES_20111104;
INSERT INTO CLICK_SEARCHES_20111104
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111104'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111104;
ANALYZE CLICK_SEARCHES_20111104;
END;
