...
TRUNCATE TABLE CLICK_SEARCHES_20101104;
INSERT INTO CLICK_SEARCHES_20101104
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101104'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101104;
ANALYZE CLICK_SEARCHES_20101104;
END;
