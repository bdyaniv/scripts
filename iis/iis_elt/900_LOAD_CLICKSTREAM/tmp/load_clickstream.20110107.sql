...
TRUNCATE TABLE CLICK_SEARCHES_20110107;
INSERT INTO CLICK_SEARCHES_20110107
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110107'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110107;
ANALYZE CLICK_SEARCHES_20110107;
END;
