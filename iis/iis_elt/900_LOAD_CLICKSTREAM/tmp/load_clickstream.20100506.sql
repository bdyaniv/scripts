...
TRUNCATE TABLE CLICK_SEARCHES_20100506;
INSERT INTO CLICK_SEARCHES_20100506
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100506'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100506;
ANALYZE CLICK_SEARCHES_20100506;
END;
