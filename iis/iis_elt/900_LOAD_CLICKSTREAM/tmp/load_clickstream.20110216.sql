...
TRUNCATE TABLE CLICK_SEARCHES_20110216;
INSERT INTO CLICK_SEARCHES_20110216
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110216'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110216;
ANALYZE CLICK_SEARCHES_20110216;
END;
