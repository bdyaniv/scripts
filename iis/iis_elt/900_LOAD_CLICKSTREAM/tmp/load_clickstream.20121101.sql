...
TRUNCATE TABLE CLICK_SEARCHES_20121101;
INSERT INTO CLICK_SEARCHES_20121101
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20121101'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20121101;
ANALYZE CLICK_SEARCHES_20121101;
END;
