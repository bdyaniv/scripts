...
TRUNCATE TABLE CLICK_SEARCHES_20111011;
INSERT INTO CLICK_SEARCHES_20111011
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111011'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111011;
ANALYZE CLICK_SEARCHES_20111011;
END;
