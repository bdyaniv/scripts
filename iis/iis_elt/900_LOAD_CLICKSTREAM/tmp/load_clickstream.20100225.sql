...
TRUNCATE TABLE CLICK_SEARCHES_20100225;
INSERT INTO CLICK_SEARCHES_20100225
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100225'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100225;
ANALYZE CLICK_SEARCHES_20100225;
END;
