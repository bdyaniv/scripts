...
TRUNCATE TABLE CLICK_SEARCHES_20110921;
INSERT INTO CLICK_SEARCHES_20110921
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110921'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110921;
ANALYZE CLICK_SEARCHES_20110921;
END;
