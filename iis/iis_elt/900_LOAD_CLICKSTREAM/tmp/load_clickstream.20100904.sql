...
TRUNCATE TABLE CLICK_SEARCHES_20100904;
INSERT INTO CLICK_SEARCHES_20100904
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100904'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100904;
ANALYZE CLICK_SEARCHES_20100904;
END;
