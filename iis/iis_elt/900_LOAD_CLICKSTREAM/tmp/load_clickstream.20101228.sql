...
TRUNCATE TABLE CLICK_SEARCHES_20101228;
INSERT INTO CLICK_SEARCHES_20101228
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101228'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101228;
ANALYZE CLICK_SEARCHES_20101228;
END;
