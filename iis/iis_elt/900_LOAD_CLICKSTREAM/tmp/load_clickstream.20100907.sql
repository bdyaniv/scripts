...
TRUNCATE TABLE CLICK_SEARCHES_20100907;
INSERT INTO CLICK_SEARCHES_20100907
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100907'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100907;
ANALYZE CLICK_SEARCHES_20100907;
END;
