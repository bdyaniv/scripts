...
TRUNCATE TABLE CLICK_SEARCHES_20110605;
INSERT INTO CLICK_SEARCHES_20110605
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110605'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110605;
ANALYZE CLICK_SEARCHES_20110605;
END;
