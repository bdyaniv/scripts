...
TRUNCATE TABLE CLICK_SEARCHES_20101120;
INSERT INTO CLICK_SEARCHES_20101120
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101120'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101120;
ANALYZE CLICK_SEARCHES_20101120;
END;
