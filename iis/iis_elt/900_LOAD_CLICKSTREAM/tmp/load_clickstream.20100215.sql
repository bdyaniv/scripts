...
TRUNCATE TABLE CLICK_SEARCHES_20100215;
INSERT INTO CLICK_SEARCHES_20100215
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100215'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100215;
ANALYZE CLICK_SEARCHES_20100215;
END;
