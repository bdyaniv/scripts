...
TRUNCATE TABLE CLICK_SEARCHES_20110317;
INSERT INTO CLICK_SEARCHES_20110317
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110317'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110317;
ANALYZE CLICK_SEARCHES_20110317;
END;
