...
TRUNCATE TABLE CLICK_SEARCHES_20101117;
INSERT INTO CLICK_SEARCHES_20101117
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101117'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101117;
ANALYZE CLICK_SEARCHES_20101117;
END;
