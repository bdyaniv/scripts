...
TRUNCATE TABLE CLICK_SEARCHES_20100327;
INSERT INTO CLICK_SEARCHES_20100327
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100327'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100327;
ANALYZE CLICK_SEARCHES_20100327;
END;
