...
TRUNCATE TABLE CLICK_SEARCHES_20100416;
INSERT INTO CLICK_SEARCHES_20100416
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100416'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100416;
ANALYZE CLICK_SEARCHES_20100416;
END;
