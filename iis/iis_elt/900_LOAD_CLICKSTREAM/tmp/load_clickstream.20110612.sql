...
TRUNCATE TABLE CLICK_SEARCHES_20110612;
INSERT INTO CLICK_SEARCHES_20110612
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110612'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110612;
ANALYZE CLICK_SEARCHES_20110612;
END;
