...
TRUNCATE TABLE CLICK_SEARCHES_20100625;
INSERT INTO CLICK_SEARCHES_20100625
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100625'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100625;
ANALYZE CLICK_SEARCHES_20100625;
END;
