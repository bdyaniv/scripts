...
TRUNCATE TABLE CLICK_SEARCHES_20111024;
INSERT INTO CLICK_SEARCHES_20111024
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111024'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111024;
ANALYZE CLICK_SEARCHES_20111024;
END;
