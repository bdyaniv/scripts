...
TRUNCATE TABLE CLICK_SEARCHES_20110227;
INSERT INTO CLICK_SEARCHES_20110227
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110227'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110227;
ANALYZE CLICK_SEARCHES_20110227;
END;
