...
TRUNCATE TABLE CLICK_SEARCHES_20100323;
INSERT INTO CLICK_SEARCHES_20100323
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100323'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100323;
ANALYZE CLICK_SEARCHES_20100323;
END;
