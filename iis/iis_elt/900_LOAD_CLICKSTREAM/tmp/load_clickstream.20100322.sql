...
TRUNCATE TABLE CLICK_SEARCHES_20100322;
INSERT INTO CLICK_SEARCHES_20100322
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100322'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100322;
ANALYZE CLICK_SEARCHES_20100322;
END;
