...
TRUNCATE TABLE CLICK_SEARCHES_20100813;
INSERT INTO CLICK_SEARCHES_20100813
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100813'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100813;
ANALYZE CLICK_SEARCHES_20100813;
END;
