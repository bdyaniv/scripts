...
TRUNCATE TABLE CLICK_SEARCHES_20100324;
INSERT INTO CLICK_SEARCHES_20100324
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100324'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100324;
ANALYZE CLICK_SEARCHES_20100324;
END;
