...
TRUNCATE TABLE CLICK_SEARCHES_20100807;
INSERT INTO CLICK_SEARCHES_20100807
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100807'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100807;
ANALYZE CLICK_SEARCHES_20100807;
END;
