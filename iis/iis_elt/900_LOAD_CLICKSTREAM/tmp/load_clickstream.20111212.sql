...
TRUNCATE TABLE CLICK_SEARCHES_20111212;
INSERT INTO CLICK_SEARCHES_20111212
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111212'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111212;
ANALYZE CLICK_SEARCHES_20111212;
END;
