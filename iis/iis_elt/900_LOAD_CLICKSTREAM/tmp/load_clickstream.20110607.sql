...
TRUNCATE TABLE CLICK_SEARCHES_20110607;
INSERT INTO CLICK_SEARCHES_20110607
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110607'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110607;
ANALYZE CLICK_SEARCHES_20110607;
END;
