...
TRUNCATE TABLE CLICK_SEARCHES_20111118;
INSERT INTO CLICK_SEARCHES_20111118
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111118'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111118;
ANALYZE CLICK_SEARCHES_20111118;
END;
