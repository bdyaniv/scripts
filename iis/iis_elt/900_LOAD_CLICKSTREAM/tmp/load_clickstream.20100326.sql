...
TRUNCATE TABLE CLICK_SEARCHES_20100326;
INSERT INTO CLICK_SEARCHES_20100326
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100326'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100326;
ANALYZE CLICK_SEARCHES_20100326;
END;
