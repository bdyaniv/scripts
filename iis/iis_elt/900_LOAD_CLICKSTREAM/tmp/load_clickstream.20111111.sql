...
TRUNCATE TABLE CLICK_SEARCHES_20111111;
INSERT INTO CLICK_SEARCHES_20111111
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111111'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111111;
ANALYZE CLICK_SEARCHES_20111111;
END;
