...
TRUNCATE TABLE CLICK_SEARCHES_20100524;
INSERT INTO CLICK_SEARCHES_20100524
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100524'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100524;
ANALYZE CLICK_SEARCHES_20100524;
END;
