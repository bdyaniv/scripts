...
TRUNCATE TABLE CLICK_SEARCHES_20100505;
INSERT INTO CLICK_SEARCHES_20100505
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100505'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100505;
ANALYZE CLICK_SEARCHES_20100505;
END;
