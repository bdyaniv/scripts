...
TRUNCATE TABLE CLICK_SEARCHES_20110824;
INSERT INTO CLICK_SEARCHES_20110824
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110824'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110824;
ANALYZE CLICK_SEARCHES_20110824;
END;
