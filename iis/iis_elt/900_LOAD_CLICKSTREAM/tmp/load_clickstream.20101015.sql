...
TRUNCATE TABLE CLICK_SEARCHES_20101015;
INSERT INTO CLICK_SEARCHES_20101015
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101015'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101015;
ANALYZE CLICK_SEARCHES_20101015;
END;
