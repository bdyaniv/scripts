...
TRUNCATE TABLE CLICK_SEARCHES_20110819;
INSERT INTO CLICK_SEARCHES_20110819
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110819'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110819;
ANALYZE CLICK_SEARCHES_20110819;
END;
