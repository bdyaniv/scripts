...
TRUNCATE TABLE CLICK_SEARCHES_20101211;
INSERT INTO CLICK_SEARCHES_20101211
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101211'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101211;
ANALYZE CLICK_SEARCHES_20101211;
END;
