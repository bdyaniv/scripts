...
TRUNCATE TABLE CLICK_SEARCHES_20110608;
INSERT INTO CLICK_SEARCHES_20110608
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110608'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110608;
ANALYZE CLICK_SEARCHES_20110608;
END;
