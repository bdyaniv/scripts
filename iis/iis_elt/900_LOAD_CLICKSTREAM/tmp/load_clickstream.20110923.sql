...
TRUNCATE TABLE CLICK_SEARCHES_20110923;
INSERT INTO CLICK_SEARCHES_20110923
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110923'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110923;
ANALYZE CLICK_SEARCHES_20110923;
END;
