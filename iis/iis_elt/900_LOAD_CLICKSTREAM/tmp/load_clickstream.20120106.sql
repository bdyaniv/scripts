...
TRUNCATE TABLE CLICK_SEARCHES_20120106;
INSERT INTO CLICK_SEARCHES_20120106
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20120106'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20120106;
ANALYZE CLICK_SEARCHES_20120106;
END;
