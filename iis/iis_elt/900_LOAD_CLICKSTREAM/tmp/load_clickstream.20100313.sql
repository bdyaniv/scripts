...
TRUNCATE TABLE CLICK_SEARCHES_20100313;
INSERT INTO CLICK_SEARCHES_20100313
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100313'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100313;
ANALYZE CLICK_SEARCHES_20100313;
END;
