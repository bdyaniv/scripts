...
TRUNCATE TABLE CLICK_SEARCHES_20100817;
INSERT INTO CLICK_SEARCHES_20100817
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100817'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100817;
ANALYZE CLICK_SEARCHES_20100817;
END;
