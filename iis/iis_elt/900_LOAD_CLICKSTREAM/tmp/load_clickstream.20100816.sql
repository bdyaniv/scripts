...
TRUNCATE TABLE CLICK_SEARCHES_20100816;
INSERT INTO CLICK_SEARCHES_20100816
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100816'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100816;
ANALYZE CLICK_SEARCHES_20100816;
END;
