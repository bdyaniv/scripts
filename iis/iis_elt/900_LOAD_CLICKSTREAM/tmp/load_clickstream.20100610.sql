...
TRUNCATE TABLE CLICK_SEARCHES_20100610;
INSERT INTO CLICK_SEARCHES_20100610
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100610'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100610;
ANALYZE CLICK_SEARCHES_20100610;
END;
