...
TRUNCATE TABLE CLICK_SEARCHES_20111231;
INSERT INTO CLICK_SEARCHES_20111231
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111231'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111231;
ANALYZE CLICK_SEARCHES_20111231;
END;
