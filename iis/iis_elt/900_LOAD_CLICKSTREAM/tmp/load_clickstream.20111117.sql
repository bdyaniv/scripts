...
TRUNCATE TABLE CLICK_SEARCHES_20111117;
INSERT INTO CLICK_SEARCHES_20111117
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111117'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111117;
ANALYZE CLICK_SEARCHES_20111117;
END;
