...
TRUNCATE TABLE CLICK_SEARCHES_20101126;
INSERT INTO CLICK_SEARCHES_20101126
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101126'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101126;
ANALYZE CLICK_SEARCHES_20101126;
END;
