...
TRUNCATE TABLE CLICK_SEARCHES_20100429;
INSERT INTO CLICK_SEARCHES_20100429
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100429'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100429;
ANALYZE CLICK_SEARCHES_20100429;
END;
