...
TRUNCATE TABLE CLICK_SEARCHES_20101123;
INSERT INTO CLICK_SEARCHES_20101123
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101123'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101123;
ANALYZE CLICK_SEARCHES_20101123;
END;
