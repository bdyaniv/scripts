...
TRUNCATE TABLE CLICK_SEARCHES_20111207;
INSERT INTO CLICK_SEARCHES_20111207
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111207'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111207;
ANALYZE CLICK_SEARCHES_20111207;
END;
