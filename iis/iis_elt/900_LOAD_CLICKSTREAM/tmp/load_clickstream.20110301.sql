...
TRUNCATE TABLE CLICK_SEARCHES_20110301;
INSERT INTO CLICK_SEARCHES_20110301
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110301'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110301;
ANALYZE CLICK_SEARCHES_20110301;
END;
