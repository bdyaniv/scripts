...
TRUNCATE TABLE CLICK_SEARCHES_20100716;
INSERT INTO CLICK_SEARCHES_20100716
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100716'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100716;
ANALYZE CLICK_SEARCHES_20100716;
END;
