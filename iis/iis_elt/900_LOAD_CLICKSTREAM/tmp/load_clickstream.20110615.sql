...
TRUNCATE TABLE CLICK_SEARCHES_20110615;
INSERT INTO CLICK_SEARCHES_20110615
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110615'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110615;
ANALYZE CLICK_SEARCHES_20110615;
END;
