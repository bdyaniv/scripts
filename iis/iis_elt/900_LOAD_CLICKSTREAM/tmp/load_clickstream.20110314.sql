...
TRUNCATE TABLE CLICK_SEARCHES_20110314;
INSERT INTO CLICK_SEARCHES_20110314
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110314'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110314;
ANALYZE CLICK_SEARCHES_20110314;
END;
