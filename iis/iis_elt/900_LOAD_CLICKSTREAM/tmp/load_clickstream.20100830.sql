...
TRUNCATE TABLE CLICK_SEARCHES_20100830;
INSERT INTO CLICK_SEARCHES_20100830
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100830'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100830;
ANALYZE CLICK_SEARCHES_20100830;
END;
