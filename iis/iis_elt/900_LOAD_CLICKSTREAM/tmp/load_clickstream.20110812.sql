...
TRUNCATE TABLE CLICK_SEARCHES_20110812;
INSERT INTO CLICK_SEARCHES_20110812
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110812'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110812;
ANALYZE CLICK_SEARCHES_20110812;
END;
