...
TRUNCATE TABLE CLICK_SEARCHES_20111219;
INSERT INTO CLICK_SEARCHES_20111219
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111219'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111219;
ANALYZE CLICK_SEARCHES_20111219;
END;
