...
TRUNCATE TABLE CLICK_SEARCHES_20110327;
INSERT INTO CLICK_SEARCHES_20110327
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110327'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110327;
ANALYZE CLICK_SEARCHES_20110327;
END;
