...
TRUNCATE TABLE CLICK_SEARCHES_20111123;
INSERT INTO CLICK_SEARCHES_20111123
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111123'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111123;
ANALYZE CLICK_SEARCHES_20111123;
END;
