...
TRUNCATE TABLE CLICK_SEARCHES_20110831;
INSERT INTO CLICK_SEARCHES_20110831
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110831'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110831;
ANALYZE CLICK_SEARCHES_20110831;
END;
