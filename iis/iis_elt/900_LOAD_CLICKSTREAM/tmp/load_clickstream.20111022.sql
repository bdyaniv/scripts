...
TRUNCATE TABLE CLICK_SEARCHES_20111022;
INSERT INTO CLICK_SEARCHES_20111022
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111022'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111022;
ANALYZE CLICK_SEARCHES_20111022;
END;
