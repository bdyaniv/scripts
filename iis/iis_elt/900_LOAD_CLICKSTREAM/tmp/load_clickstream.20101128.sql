...
TRUNCATE TABLE CLICK_SEARCHES_20101128;
INSERT INTO CLICK_SEARCHES_20101128
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101128'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101128;
ANALYZE CLICK_SEARCHES_20101128;
END;
