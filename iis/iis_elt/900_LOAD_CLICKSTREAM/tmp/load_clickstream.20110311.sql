...
TRUNCATE TABLE CLICK_SEARCHES_20110311;
INSERT INTO CLICK_SEARCHES_20110311
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110311'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110311;
ANALYZE CLICK_SEARCHES_20110311;
END;
