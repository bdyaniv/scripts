...
TRUNCATE TABLE CLICK_SEARCHES_20101016;
INSERT INTO CLICK_SEARCHES_20101016
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101016'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101016;
ANALYZE CLICK_SEARCHES_20101016;
END;
