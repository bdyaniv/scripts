...
TRUNCATE TABLE CLICK_SEARCHES_20100221;
INSERT INTO CLICK_SEARCHES_20100221
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100221'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100221;
ANALYZE CLICK_SEARCHES_20100221;
END;
