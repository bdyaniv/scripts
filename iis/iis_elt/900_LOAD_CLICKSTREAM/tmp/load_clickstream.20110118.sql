...
TRUNCATE TABLE CLICK_SEARCHES_20110118;
INSERT INTO CLICK_SEARCHES_20110118
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110118'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110118;
ANALYZE CLICK_SEARCHES_20110118;
END;
