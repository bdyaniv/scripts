...
TRUNCATE TABLE CLICK_SEARCHES_20110401;
INSERT INTO CLICK_SEARCHES_20110401
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110401'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110401;
ANALYZE CLICK_SEARCHES_20110401;
END;
