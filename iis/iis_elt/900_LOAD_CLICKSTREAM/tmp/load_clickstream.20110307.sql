...
TRUNCATE TABLE CLICK_SEARCHES_20110307;
INSERT INTO CLICK_SEARCHES_20110307
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110307'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110307;
ANALYZE CLICK_SEARCHES_20110307;
END;
