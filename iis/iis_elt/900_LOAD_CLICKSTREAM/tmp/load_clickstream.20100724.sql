...
TRUNCATE TABLE CLICK_SEARCHES_20100724;
INSERT INTO CLICK_SEARCHES_20100724
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100724'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100724;
ANALYZE CLICK_SEARCHES_20100724;
END;
