...
TRUNCATE TABLE CLICK_SEARCHES_20100222;
INSERT INTO CLICK_SEARCHES_20100222
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100222'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100222;
ANALYZE CLICK_SEARCHES_20100222;
END;
