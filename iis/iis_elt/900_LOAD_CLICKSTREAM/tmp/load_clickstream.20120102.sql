...
TRUNCATE TABLE CLICK_SEARCHES_20120102;
INSERT INTO CLICK_SEARCHES_20120102
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20120102'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20120102;
ANALYZE CLICK_SEARCHES_20120102;
END;
