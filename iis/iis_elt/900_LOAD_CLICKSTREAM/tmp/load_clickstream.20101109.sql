...
TRUNCATE TABLE CLICK_SEARCHES_20101109;
INSERT INTO CLICK_SEARCHES_20101109
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101109'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101109;
ANALYZE CLICK_SEARCHES_20101109;
END;
