...
TRUNCATE TABLE CLICK_SEARCHES_20110724;
INSERT INTO CLICK_SEARCHES_20110724
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110724'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110724;
ANALYZE CLICK_SEARCHES_20110724;
END;
