...
TRUNCATE TABLE CLICK_SEARCHES_20100208;
INSERT INTO CLICK_SEARCHES_20100208
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100208'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100208;
ANALYZE CLICK_SEARCHES_20100208;
END;
