...
TRUNCATE TABLE CLICK_SEARCHES_20111206;
INSERT INTO CLICK_SEARCHES_20111206
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111206'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111206;
ANALYZE CLICK_SEARCHES_20111206;
END;
