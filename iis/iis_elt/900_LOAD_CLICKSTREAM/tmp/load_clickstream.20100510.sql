...
TRUNCATE TABLE CLICK_SEARCHES_20100510;
INSERT INTO CLICK_SEARCHES_20100510
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100510'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100510;
ANALYZE CLICK_SEARCHES_20100510;
END;
