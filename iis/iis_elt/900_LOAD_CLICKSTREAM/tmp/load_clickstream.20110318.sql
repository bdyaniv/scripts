...
TRUNCATE TABLE CLICK_SEARCHES_20110318;
INSERT INTO CLICK_SEARCHES_20110318
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110318'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110318;
ANALYZE CLICK_SEARCHES_20110318;
END;
