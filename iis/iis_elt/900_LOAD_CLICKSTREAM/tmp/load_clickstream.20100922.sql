...
TRUNCATE TABLE CLICK_SEARCHES_20100922;
INSERT INTO CLICK_SEARCHES_20100922
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100922'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100922;
ANALYZE CLICK_SEARCHES_20100922;
END;
