...
TRUNCATE TABLE CLICK_SEARCHES_20110405;
INSERT INTO CLICK_SEARCHES_20110405
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110405'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110405;
ANALYZE CLICK_SEARCHES_20110405;
END;
