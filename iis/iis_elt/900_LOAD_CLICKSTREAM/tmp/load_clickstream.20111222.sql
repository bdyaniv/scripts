...
TRUNCATE TABLE CLICK_SEARCHES_20111222;
INSERT INTO CLICK_SEARCHES_20111222
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111222'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111222;
ANALYZE CLICK_SEARCHES_20111222;
END;
