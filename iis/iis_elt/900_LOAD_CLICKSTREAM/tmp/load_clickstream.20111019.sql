...
TRUNCATE TABLE CLICK_SEARCHES_20111019;
INSERT INTO CLICK_SEARCHES_20111019
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111019'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111019;
ANALYZE CLICK_SEARCHES_20111019;
END;
