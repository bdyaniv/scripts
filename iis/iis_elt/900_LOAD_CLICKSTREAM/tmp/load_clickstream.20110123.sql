...
TRUNCATE TABLE CLICK_SEARCHES_20110123;
INSERT INTO CLICK_SEARCHES_20110123
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110123'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110123;
ANALYZE CLICK_SEARCHES_20110123;
END;
