...
TRUNCATE TABLE CLICK_SEARCHES_20110506;
INSERT INTO CLICK_SEARCHES_20110506
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110506'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110506;
ANALYZE CLICK_SEARCHES_20110506;
END;
