...
TRUNCATE TABLE CLICK_SEARCHES_20110821;
INSERT INTO CLICK_SEARCHES_20110821
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110821'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110821;
ANALYZE CLICK_SEARCHES_20110821;
END;
