...
TRUNCATE TABLE CLICK_SEARCHES_20100820;
INSERT INTO CLICK_SEARCHES_20100820
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100820'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100820;
ANALYZE CLICK_SEARCHES_20100820;
END;
