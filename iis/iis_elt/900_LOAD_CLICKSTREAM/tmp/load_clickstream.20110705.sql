...
TRUNCATE TABLE CLICK_SEARCHES_20110705;
INSERT INTO CLICK_SEARCHES_20110705
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110705'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110705;
ANALYZE CLICK_SEARCHES_20110705;
END;
