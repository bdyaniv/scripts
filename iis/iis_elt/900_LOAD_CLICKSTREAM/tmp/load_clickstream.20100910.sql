...
TRUNCATE TABLE CLICK_SEARCHES_20100910;
INSERT INTO CLICK_SEARCHES_20100910
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100910'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100910;
ANALYZE CLICK_SEARCHES_20100910;
END;
