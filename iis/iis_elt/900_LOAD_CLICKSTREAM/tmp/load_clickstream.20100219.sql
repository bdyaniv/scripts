...
TRUNCATE TABLE CLICK_SEARCHES_20100219;
INSERT INTO CLICK_SEARCHES_20100219
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100219'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100219;
ANALYZE CLICK_SEARCHES_20100219;
END;
