...
TRUNCATE TABLE CLICK_SEARCHES_20110929;
INSERT INTO CLICK_SEARCHES_20110929
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110929'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110929;
ANALYZE CLICK_SEARCHES_20110929;
END;
