...
TRUNCATE TABLE CLICK_SEARCHES_20100611;
INSERT INTO CLICK_SEARCHES_20100611
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100611'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100611;
ANALYZE CLICK_SEARCHES_20100611;
END;
