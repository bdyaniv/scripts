...
TRUNCATE TABLE CLICK_SEARCHES_20101230;
INSERT INTO CLICK_SEARCHES_20101230
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101230'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101230;
ANALYZE CLICK_SEARCHES_20101230;
END;
