...
TRUNCATE TABLE CLICK_SEARCHES_20110919;
INSERT INTO CLICK_SEARCHES_20110919
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110919'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110919;
ANALYZE CLICK_SEARCHES_20110919;
END;
