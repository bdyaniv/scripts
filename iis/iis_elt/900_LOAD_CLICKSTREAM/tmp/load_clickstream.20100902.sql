...
TRUNCATE TABLE CLICK_SEARCHES_20100902;
INSERT INTO CLICK_SEARCHES_20100902
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100902'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100902;
ANALYZE CLICK_SEARCHES_20100902;
END;
