...
TRUNCATE TABLE CLICK_SEARCHES_20100704;
INSERT INTO CLICK_SEARCHES_20100704
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100704'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100704;
ANALYZE CLICK_SEARCHES_20100704;
END;
