...
TRUNCATE TABLE CLICK_SEARCHES_20110211;
INSERT INTO CLICK_SEARCHES_20110211
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110211'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110211;
ANALYZE CLICK_SEARCHES_20110211;
END;
