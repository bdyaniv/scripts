...
TRUNCATE TABLE CLICK_SEARCHES_20100517;
INSERT INTO CLICK_SEARCHES_20100517
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100517'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100517;
ANALYZE CLICK_SEARCHES_20100517;
END;
