...
TRUNCATE TABLE CLICK_SEARCHES_20100214;
INSERT INTO CLICK_SEARCHES_20100214
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100214'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100214;
ANALYZE CLICK_SEARCHES_20100214;
END;
