...
TRUNCATE TABLE CLICK_SEARCHES_20100914;
INSERT INTO CLICK_SEARCHES_20100914
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100914'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100914;
ANALYZE CLICK_SEARCHES_20100914;
END;
