...
TRUNCATE TABLE CLICK_SEARCHES_20101110;
INSERT INTO CLICK_SEARCHES_20101110
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101110'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101110;
ANALYZE CLICK_SEARCHES_20101110;
END;
