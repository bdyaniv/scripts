...
TRUNCATE TABLE CLICK_SEARCHES_20100525;
INSERT INTO CLICK_SEARCHES_20100525
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100525'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100525;
ANALYZE CLICK_SEARCHES_20100525;
END;
