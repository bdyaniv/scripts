...
TRUNCATE TABLE CLICK_SEARCHES_20110323;
INSERT INTO CLICK_SEARCHES_20110323
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110323'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110323;
ANALYZE CLICK_SEARCHES_20110323;
END;
