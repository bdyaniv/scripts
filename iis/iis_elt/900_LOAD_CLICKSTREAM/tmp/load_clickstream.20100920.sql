...
TRUNCATE TABLE CLICK_SEARCHES_20100920;
INSERT INTO CLICK_SEARCHES_20100920
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100920'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100920;
ANALYZE CLICK_SEARCHES_20100920;
END;
