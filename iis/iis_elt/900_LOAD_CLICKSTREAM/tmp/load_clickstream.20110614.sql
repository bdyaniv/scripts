...
TRUNCATE TABLE CLICK_SEARCHES_20110614;
INSERT INTO CLICK_SEARCHES_20110614
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110614'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110614;
ANALYZE CLICK_SEARCHES_20110614;
END;
