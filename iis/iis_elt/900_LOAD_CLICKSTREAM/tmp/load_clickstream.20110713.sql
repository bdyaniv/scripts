...
TRUNCATE TABLE CLICK_SEARCHES_20110713;
INSERT INTO CLICK_SEARCHES_20110713
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110713'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110713;
ANALYZE CLICK_SEARCHES_20110713;
END;
