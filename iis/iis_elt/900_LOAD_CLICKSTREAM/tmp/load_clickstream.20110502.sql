...
TRUNCATE TABLE CLICK_SEARCHES_20110502;
INSERT INTO CLICK_SEARCHES_20110502
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110502'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110502;
ANALYZE CLICK_SEARCHES_20110502;
END;
