...
TRUNCATE TABLE CLICK_SEARCHES_20110417;
INSERT INTO CLICK_SEARCHES_20110417
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110417'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110417;
ANALYZE CLICK_SEARCHES_20110417;
END;
