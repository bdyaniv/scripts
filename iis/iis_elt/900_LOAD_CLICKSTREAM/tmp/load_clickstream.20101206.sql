...
TRUNCATE TABLE CLICK_SEARCHES_20101206;
INSERT INTO CLICK_SEARCHES_20101206
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101206'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101206;
ANALYZE CLICK_SEARCHES_20101206;
END;
