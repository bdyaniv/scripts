...
TRUNCATE TABLE CLICK_SEARCHES_20100401;
INSERT INTO CLICK_SEARCHES_20100401
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100401'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100401;
ANALYZE CLICK_SEARCHES_20100401;
END;
