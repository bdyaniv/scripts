...
TRUNCATE TABLE CLICK_SEARCHES_20101218;
INSERT INTO CLICK_SEARCHES_20101218
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101218'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101218;
ANALYZE CLICK_SEARCHES_20101218;
END;
