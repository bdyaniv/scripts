...
TRUNCATE TABLE CLICK_SEARCHES_20100628;
INSERT INTO CLICK_SEARCHES_20100628
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100628'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100628;
ANALYZE CLICK_SEARCHES_20100628;
END;
