...
TRUNCATE TABLE CLICK_SEARCHES_20101118;
INSERT INTO CLICK_SEARCHES_20101118
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101118'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101118;
ANALYZE CLICK_SEARCHES_20101118;
END;
