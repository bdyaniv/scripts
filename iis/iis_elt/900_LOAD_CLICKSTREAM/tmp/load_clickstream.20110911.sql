...
TRUNCATE TABLE CLICK_SEARCHES_20110911;
INSERT INTO CLICK_SEARCHES_20110911
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110911'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110911;
ANALYZE CLICK_SEARCHES_20110911;
END;
