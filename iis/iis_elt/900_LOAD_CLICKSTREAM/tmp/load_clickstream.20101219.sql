...
TRUNCATE TABLE CLICK_SEARCHES_20101219;
INSERT INTO CLICK_SEARCHES_20101219
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101219'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101219;
ANALYZE CLICK_SEARCHES_20101219;
END;
