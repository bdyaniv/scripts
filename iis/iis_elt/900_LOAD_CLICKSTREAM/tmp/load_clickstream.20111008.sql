...
TRUNCATE TABLE CLICK_SEARCHES_20111008;
INSERT INTO CLICK_SEARCHES_20111008
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111008'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111008;
ANALYZE CLICK_SEARCHES_20111008;
END;
