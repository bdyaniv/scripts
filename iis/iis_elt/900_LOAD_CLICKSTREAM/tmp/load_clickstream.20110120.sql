...
TRUNCATE TABLE CLICK_SEARCHES_20110120;
INSERT INTO CLICK_SEARCHES_20110120
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110120'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110120;
ANALYZE CLICK_SEARCHES_20110120;
END;
