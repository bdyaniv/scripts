...
TRUNCATE TABLE CLICK_SEARCHES_20110409;
INSERT INTO CLICK_SEARCHES_20110409
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110409'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110409;
ANALYZE CLICK_SEARCHES_20110409;
END;
