...
TRUNCATE TABLE CLICK_SEARCHES_20111023;
INSERT INTO CLICK_SEARCHES_20111023
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111023'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111023;
ANALYZE CLICK_SEARCHES_20111023;
END;
