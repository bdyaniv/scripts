...
TRUNCATE TABLE CLICK_SEARCHES_20110711;
INSERT INTO CLICK_SEARCHES_20110711
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110711'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110711;
ANALYZE CLICK_SEARCHES_20110711;
END;
