...
TRUNCATE TABLE CLICK_SEARCHES_20110507;
INSERT INTO CLICK_SEARCHES_20110507
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110507'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110507;
ANALYZE CLICK_SEARCHES_20110507;
END;
