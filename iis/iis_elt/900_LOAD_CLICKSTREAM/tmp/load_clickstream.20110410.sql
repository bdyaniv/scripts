...
TRUNCATE TABLE CLICK_SEARCHES_20110410;
INSERT INTO CLICK_SEARCHES_20110410
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110410'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110410;
ANALYZE CLICK_SEARCHES_20110410;
END;
