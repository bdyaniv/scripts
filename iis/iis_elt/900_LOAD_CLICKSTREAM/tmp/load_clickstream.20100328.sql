...
TRUNCATE TABLE CLICK_SEARCHES_20100328;
INSERT INTO CLICK_SEARCHES_20100328
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100328'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100328;
ANALYZE CLICK_SEARCHES_20100328;
END;
