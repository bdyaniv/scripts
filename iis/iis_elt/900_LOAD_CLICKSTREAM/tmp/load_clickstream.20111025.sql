...
TRUNCATE TABLE CLICK_SEARCHES_20111025;
INSERT INTO CLICK_SEARCHES_20111025
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111025'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111025;
ANALYZE CLICK_SEARCHES_20111025;
END;
