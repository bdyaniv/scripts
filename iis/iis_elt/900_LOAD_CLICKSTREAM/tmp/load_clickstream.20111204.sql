...
TRUNCATE TABLE CLICK_SEARCHES_20111204;
INSERT INTO CLICK_SEARCHES_20111204
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111204'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111204;
ANALYZE CLICK_SEARCHES_20111204;
END;
