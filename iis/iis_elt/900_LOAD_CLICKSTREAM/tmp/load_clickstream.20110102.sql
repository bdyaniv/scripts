...
TRUNCATE TABLE CLICK_SEARCHES_20110102;
INSERT INTO CLICK_SEARCHES_20110102
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110102'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110102;
ANALYZE CLICK_SEARCHES_20110102;
END;
