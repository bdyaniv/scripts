...
TRUNCATE TABLE CLICK_SEARCHES_20110203;
INSERT INTO CLICK_SEARCHES_20110203
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110203'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110203;
ANALYZE CLICK_SEARCHES_20110203;
END;
