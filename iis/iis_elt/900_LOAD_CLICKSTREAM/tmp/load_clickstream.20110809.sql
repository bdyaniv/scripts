...
TRUNCATE TABLE CLICK_SEARCHES_20110809;
INSERT INTO CLICK_SEARCHES_20110809
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110809'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110809;
ANALYZE CLICK_SEARCHES_20110809;
END;
