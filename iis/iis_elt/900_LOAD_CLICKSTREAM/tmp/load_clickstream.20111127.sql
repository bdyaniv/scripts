...
TRUNCATE TABLE CLICK_SEARCHES_20111127;
INSERT INTO CLICK_SEARCHES_20111127
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111127'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111127;
ANALYZE CLICK_SEARCHES_20111127;
END;
