...
TRUNCATE TABLE CLICK_SEARCHES_20100627;
INSERT INTO CLICK_SEARCHES_20100627
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100627'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100627;
ANALYZE CLICK_SEARCHES_20100627;
END;
