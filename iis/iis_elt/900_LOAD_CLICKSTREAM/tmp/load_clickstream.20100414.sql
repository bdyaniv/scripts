...
TRUNCATE TABLE CLICK_SEARCHES_20100414;
INSERT INTO CLICK_SEARCHES_20100414
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100414'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100414;
ANALYZE CLICK_SEARCHES_20100414;
END;
