...
TRUNCATE TABLE CLICK_SEARCHES_20100514;
INSERT INTO CLICK_SEARCHES_20100514
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100514'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100514;
ANALYZE CLICK_SEARCHES_20100514;
END;
