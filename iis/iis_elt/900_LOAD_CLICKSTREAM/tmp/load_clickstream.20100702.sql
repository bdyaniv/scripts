...
TRUNCATE TABLE CLICK_SEARCHES_20100702;
INSERT INTO CLICK_SEARCHES_20100702
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100702'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100702;
ANALYZE CLICK_SEARCHES_20100702;
END;
