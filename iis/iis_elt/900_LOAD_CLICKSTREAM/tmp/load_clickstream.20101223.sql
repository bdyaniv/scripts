...
TRUNCATE TABLE CLICK_SEARCHES_20101223;
INSERT INTO CLICK_SEARCHES_20101223
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101223'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101223;
ANALYZE CLICK_SEARCHES_20101223;
END;
