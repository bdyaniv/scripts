...
TRUNCATE TABLE CLICK_SEARCHES_20100808;
INSERT INTO CLICK_SEARCHES_20100808
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100808'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100808;
ANALYZE CLICK_SEARCHES_20100808;
END;
