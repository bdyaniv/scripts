...
TRUNCATE TABLE CLICK_SEARCHES_20100926;
INSERT INTO CLICK_SEARCHES_20100926
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100926'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100926;
ANALYZE CLICK_SEARCHES_20100926;
END;
