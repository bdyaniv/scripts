...
TRUNCATE TABLE CLICK_SEARCHES_20110915;
INSERT INTO CLICK_SEARCHES_20110915
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110915'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110915;
ANALYZE CLICK_SEARCHES_20110915;
END;
