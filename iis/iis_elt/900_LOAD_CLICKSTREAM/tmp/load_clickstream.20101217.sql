...
TRUNCATE TABLE CLICK_SEARCHES_20101217;
INSERT INTO CLICK_SEARCHES_20101217
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101217'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101217;
ANALYZE CLICK_SEARCHES_20101217;
END;
