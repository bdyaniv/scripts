...
TRUNCATE TABLE CLICK_SEARCHES_20110830;
INSERT INTO CLICK_SEARCHES_20110830
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110830'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110830;
ANALYZE CLICK_SEARCHES_20110830;
END;
