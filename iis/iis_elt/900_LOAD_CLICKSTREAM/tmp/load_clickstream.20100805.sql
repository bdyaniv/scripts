...
TRUNCATE TABLE CLICK_SEARCHES_20100805;
INSERT INTO CLICK_SEARCHES_20100805
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100805'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100805;
ANALYZE CLICK_SEARCHES_20100805;
END;
