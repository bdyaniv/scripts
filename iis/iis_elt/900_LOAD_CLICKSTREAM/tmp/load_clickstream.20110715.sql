...
TRUNCATE TABLE CLICK_SEARCHES_20110715;
INSERT INTO CLICK_SEARCHES_20110715
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110715'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110715;
ANALYZE CLICK_SEARCHES_20110715;
END;
