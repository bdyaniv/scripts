...
TRUNCATE TABLE CLICK_SEARCHES_20110604;
INSERT INTO CLICK_SEARCHES_20110604
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110604'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110604;
ANALYZE CLICK_SEARCHES_20110604;
END;
