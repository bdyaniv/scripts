...
TRUNCATE TABLE CLICK_SEARCHES_20101020;
INSERT INTO CLICK_SEARCHES_20101020
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101020'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101020;
ANALYZE CLICK_SEARCHES_20101020;
END;
