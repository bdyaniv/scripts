...
TRUNCATE TABLE CLICK_SEARCHES_20110101;
INSERT INTO CLICK_SEARCHES_20110101
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110101'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110101;
ANALYZE CLICK_SEARCHES_20110101;
END;
