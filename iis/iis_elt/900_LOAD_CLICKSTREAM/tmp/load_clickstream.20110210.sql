...
TRUNCATE TABLE CLICK_SEARCHES_20110210;
INSERT INTO CLICK_SEARCHES_20110210
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110210'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110210;
ANALYZE CLICK_SEARCHES_20110210;
END;
