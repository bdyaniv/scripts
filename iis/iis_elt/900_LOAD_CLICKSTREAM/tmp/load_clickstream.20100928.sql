...
TRUNCATE TABLE CLICK_SEARCHES_20100928;
INSERT INTO CLICK_SEARCHES_20100928
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100928'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100928;
ANALYZE CLICK_SEARCHES_20100928;
END;
