...
TRUNCATE TABLE CLICK_SEARCHES_20110418;
INSERT INTO CLICK_SEARCHES_20110418
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110418'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110418;
ANALYZE CLICK_SEARCHES_20110418;
END;
