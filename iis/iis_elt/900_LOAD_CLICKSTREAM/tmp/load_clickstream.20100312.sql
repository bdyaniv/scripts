...
TRUNCATE TABLE CLICK_SEARCHES_20100312;
INSERT INTO CLICK_SEARCHES_20100312
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100312'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100312;
ANALYZE CLICK_SEARCHES_20100312;
END;
