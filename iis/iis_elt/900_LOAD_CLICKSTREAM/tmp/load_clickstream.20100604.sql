...
TRUNCATE TABLE CLICK_SEARCHES_20100604;
INSERT INTO CLICK_SEARCHES_20100604
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100604'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100604;
ANALYZE CLICK_SEARCHES_20100604;
END;
