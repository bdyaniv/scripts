...
TRUNCATE TABLE CLICK_SEARCHES_20100319;
INSERT INTO CLICK_SEARCHES_20100319
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100319'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100319;
ANALYZE CLICK_SEARCHES_20100319;
END;
