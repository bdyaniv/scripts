...
TRUNCATE TABLE CLICK_SEARCHES_20110623;
INSERT INTO CLICK_SEARCHES_20110623
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110623'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110623;
ANALYZE CLICK_SEARCHES_20110623;
END;
