...
TRUNCATE TABLE CLICK_SEARCHES_20110706;
INSERT INTO CLICK_SEARCHES_20110706
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110706'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110706;
ANALYZE CLICK_SEARCHES_20110706;
END;
