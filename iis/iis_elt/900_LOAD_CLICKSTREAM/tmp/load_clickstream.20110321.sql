...
TRUNCATE TABLE CLICK_SEARCHES_20110321;
INSERT INTO CLICK_SEARCHES_20110321
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110321'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110321;
ANALYZE CLICK_SEARCHES_20110321;
END;
