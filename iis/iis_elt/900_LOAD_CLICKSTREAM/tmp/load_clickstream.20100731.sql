...
TRUNCATE TABLE CLICK_SEARCHES_20100731;
INSERT INTO CLICK_SEARCHES_20100731
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100731'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100731;
ANALYZE CLICK_SEARCHES_20100731;
END;
