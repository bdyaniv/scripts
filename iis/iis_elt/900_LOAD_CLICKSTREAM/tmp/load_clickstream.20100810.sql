...
TRUNCATE TABLE CLICK_SEARCHES_20100810;
INSERT INTO CLICK_SEARCHES_20100810
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100810'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100810;
ANALYZE CLICK_SEARCHES_20100810;
END;
