...
TRUNCATE TABLE CLICK_SEARCHES_20111021;
INSERT INTO CLICK_SEARCHES_20111021
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111021'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111021;
ANALYZE CLICK_SEARCHES_20111021;
END;
