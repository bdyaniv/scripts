...
TRUNCATE TABLE CLICK_SEARCHES_20111029;
INSERT INTO CLICK_SEARCHES_20111029
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111029'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111029;
ANALYZE CLICK_SEARCHES_20111029;
END;
