...
TRUNCATE TABLE CLICK_SEARCHES_20101106;
INSERT INTO CLICK_SEARCHES_20101106
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101106'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101106;
ANALYZE CLICK_SEARCHES_20101106;
END;
