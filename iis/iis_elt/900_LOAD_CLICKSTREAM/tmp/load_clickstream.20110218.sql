...
TRUNCATE TABLE CLICK_SEARCHES_20110218;
INSERT INTO CLICK_SEARCHES_20110218
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110218'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110218;
ANALYZE CLICK_SEARCHES_20110218;
END;
