...
TRUNCATE TABLE CLICK_SEARCHES_20100314;
INSERT INTO CLICK_SEARCHES_20100314
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100314'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100314;
ANALYZE CLICK_SEARCHES_20100314;
END;
