...
TRUNCATE TABLE CLICK_SEARCHES_20100217;
INSERT INTO CLICK_SEARCHES_20100217
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100217'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100217;
ANALYZE CLICK_SEARCHES_20100217;
END;
