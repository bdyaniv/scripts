...
TRUNCATE TABLE CLICK_SEARCHES_20110616;
INSERT INTO CLICK_SEARCHES_20110616
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110616'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110616;
ANALYZE CLICK_SEARCHES_20110616;
END;
