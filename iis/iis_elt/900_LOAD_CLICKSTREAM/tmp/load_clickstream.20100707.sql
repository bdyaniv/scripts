...
TRUNCATE TABLE CLICK_SEARCHES_20100707;
INSERT INTO CLICK_SEARCHES_20100707
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100707'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100707;
ANALYZE CLICK_SEARCHES_20100707;
END;
