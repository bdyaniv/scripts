...
TRUNCATE TABLE CLICK_SEARCHES_20110827;
INSERT INTO CLICK_SEARCHES_20110827
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110827'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110827;
ANALYZE CLICK_SEARCHES_20110827;
END;
