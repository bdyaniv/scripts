...
TRUNCATE TABLE CLICK_SEARCHES_20101113;
INSERT INTO CLICK_SEARCHES_20101113
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101113'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101113;
ANALYZE CLICK_SEARCHES_20101113;
END;
