...
TRUNCATE TABLE CLICK_SEARCHES_20101213;
INSERT INTO CLICK_SEARCHES_20101213
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101213'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101213;
ANALYZE CLICK_SEARCHES_20101213;
END;
