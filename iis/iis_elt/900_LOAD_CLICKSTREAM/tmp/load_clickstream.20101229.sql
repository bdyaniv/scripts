...
TRUNCATE TABLE CLICK_SEARCHES_20101229;
INSERT INTO CLICK_SEARCHES_20101229
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101229'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101229;
ANALYZE CLICK_SEARCHES_20101229;
END;
