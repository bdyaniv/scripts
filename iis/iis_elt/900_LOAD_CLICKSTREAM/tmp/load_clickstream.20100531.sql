...
TRUNCATE TABLE CLICK_SEARCHES_20100531;
INSERT INTO CLICK_SEARCHES_20100531
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100531'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100531;
ANALYZE CLICK_SEARCHES_20100531;
END;
