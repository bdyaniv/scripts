...
TRUNCATE TABLE CLICK_SEARCHES_20110126;
INSERT INTO CLICK_SEARCHES_20110126
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110126'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110126;
ANALYZE CLICK_SEARCHES_20110126;
END;
