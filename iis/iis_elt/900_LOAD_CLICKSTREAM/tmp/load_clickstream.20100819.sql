...
TRUNCATE TABLE CLICK_SEARCHES_20100819;
INSERT INTO CLICK_SEARCHES_20100819
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100819'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100819;
ANALYZE CLICK_SEARCHES_20100819;
END;
