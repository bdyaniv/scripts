...
TRUNCATE TABLE CLICK_SEARCHES_20100705;
INSERT INTO CLICK_SEARCHES_20100705
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100705'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100705;
ANALYZE CLICK_SEARCHES_20100705;
END;
