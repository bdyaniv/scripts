...
TRUNCATE TABLE CLICK_SEARCHES_20110926;
INSERT INTO CLICK_SEARCHES_20110926
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110926'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110926;
ANALYZE CLICK_SEARCHES_20110926;
END;
