...
TRUNCATE TABLE CLICK_SEARCHES_20100528;
INSERT INTO CLICK_SEARCHES_20100528
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100528'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100528;
ANALYZE CLICK_SEARCHES_20100528;
END;
