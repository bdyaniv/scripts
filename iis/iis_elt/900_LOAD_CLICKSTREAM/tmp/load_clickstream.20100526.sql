...
TRUNCATE TABLE CLICK_SEARCHES_20100526;
INSERT INTO CLICK_SEARCHES_20100526
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100526'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100526;
ANALYZE CLICK_SEARCHES_20100526;
END;
