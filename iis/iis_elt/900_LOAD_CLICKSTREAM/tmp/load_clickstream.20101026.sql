...
TRUNCATE TABLE CLICK_SEARCHES_20101026;
INSERT INTO CLICK_SEARCHES_20101026
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101026'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101026;
ANALYZE CLICK_SEARCHES_20101026;
END;
