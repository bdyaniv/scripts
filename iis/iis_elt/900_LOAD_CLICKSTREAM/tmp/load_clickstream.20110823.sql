...
TRUNCATE TABLE CLICK_SEARCHES_20110823;
INSERT INTO CLICK_SEARCHES_20110823
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110823'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110823;
ANALYZE CLICK_SEARCHES_20110823;
END;
