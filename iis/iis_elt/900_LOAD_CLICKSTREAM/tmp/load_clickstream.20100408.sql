...
TRUNCATE TABLE CLICK_SEARCHES_20100408;
INSERT INTO CLICK_SEARCHES_20100408
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100408'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100408;
ANALYZE CLICK_SEARCHES_20100408;
END;
