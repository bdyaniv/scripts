...
TRUNCATE TABLE CLICK_SEARCHES_20110214;
INSERT INTO CLICK_SEARCHES_20110214
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110214'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110214;
ANALYZE CLICK_SEARCHES_20110214;
END;
