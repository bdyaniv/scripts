...
TRUNCATE TABLE CLICK_SEARCHES_20110330;
INSERT INTO CLICK_SEARCHES_20110330
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110330'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110330;
ANALYZE CLICK_SEARCHES_20110330;
END;
