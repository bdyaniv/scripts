...
TRUNCATE TABLE CLICK_SEARCHES_20110710;
INSERT INTO CLICK_SEARCHES_20110710
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110710'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110710;
ANALYZE CLICK_SEARCHES_20110710;
END;
