...
TRUNCATE TABLE CLICK_SEARCHES_20111006;
INSERT INTO CLICK_SEARCHES_20111006
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111006'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111006;
ANALYZE CLICK_SEARCHES_20111006;
END;
