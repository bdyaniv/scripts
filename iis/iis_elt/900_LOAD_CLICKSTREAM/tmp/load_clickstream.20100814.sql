...
TRUNCATE TABLE CLICK_SEARCHES_20100814;
INSERT INTO CLICK_SEARCHES_20100814
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100814'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100814;
ANALYZE CLICK_SEARCHES_20100814;
END;
