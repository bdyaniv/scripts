...
TRUNCATE TABLE CLICK_SEARCHES_20110226;
INSERT INTO CLICK_SEARCHES_20110226
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110226'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110226;
ANALYZE CLICK_SEARCHES_20110226;
END;
