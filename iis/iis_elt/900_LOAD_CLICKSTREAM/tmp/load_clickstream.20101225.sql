...
TRUNCATE TABLE CLICK_SEARCHES_20101225;
INSERT INTO CLICK_SEARCHES_20101225
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101225'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101225;
ANALYZE CLICK_SEARCHES_20101225;
END;
