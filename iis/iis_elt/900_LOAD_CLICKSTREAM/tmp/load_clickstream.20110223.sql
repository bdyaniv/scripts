...
TRUNCATE TABLE CLICK_SEARCHES_20110223;
INSERT INTO CLICK_SEARCHES_20110223
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110223'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110223;
ANALYZE CLICK_SEARCHES_20110223;
END;
