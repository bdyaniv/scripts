...
TRUNCATE TABLE CLICK_SEARCHES_20100427;
INSERT INTO CLICK_SEARCHES_20100427
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100427'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100427;
ANALYZE CLICK_SEARCHES_20100427;
END;
