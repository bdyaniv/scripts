...
TRUNCATE TABLE CLICK_SEARCHES_20101221;
INSERT INTO CLICK_SEARCHES_20101221
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101221'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101221;
ANALYZE CLICK_SEARCHES_20101221;
END;
