...
TRUNCATE TABLE CLICK_SEARCHES_20111007;
INSERT INTO CLICK_SEARCHES_20111007
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111007'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111007;
ANALYZE CLICK_SEARCHES_20111007;
END;
