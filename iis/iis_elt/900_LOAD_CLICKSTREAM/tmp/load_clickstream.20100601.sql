...
TRUNCATE TABLE CLICK_SEARCHES_20100601;
INSERT INTO CLICK_SEARCHES_20100601
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100601'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100601;
ANALYZE CLICK_SEARCHES_20100601;
END;
