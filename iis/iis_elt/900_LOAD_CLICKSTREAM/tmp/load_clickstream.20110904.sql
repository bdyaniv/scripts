...
TRUNCATE TABLE CLICK_SEARCHES_20110904;
INSERT INTO CLICK_SEARCHES_20110904
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110904'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110904;
ANALYZE CLICK_SEARCHES_20110904;
END;
