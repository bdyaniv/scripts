...
TRUNCATE TABLE CLICK_SEARCHES_20111121;
INSERT INTO CLICK_SEARCHES_20111121
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111121'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111121;
ANALYZE CLICK_SEARCHES_20111121;
END;
