...
TRUNCATE TABLE CLICK_SEARCHES_20100602;
INSERT INTO CLICK_SEARCHES_20100602
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100602'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100602;
ANALYZE CLICK_SEARCHES_20100602;
END;
