...
TRUNCATE TABLE CLICK_SEARCHES_20111116;
INSERT INTO CLICK_SEARCHES_20111116
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111116'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111116;
ANALYZE CLICK_SEARCHES_20111116;
END;
