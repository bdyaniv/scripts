...
TRUNCATE TABLE CLICK_SEARCHES_20100417;
INSERT INTO CLICK_SEARCHES_20100417
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100417'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100417;
ANALYZE CLICK_SEARCHES_20100417;
END;
