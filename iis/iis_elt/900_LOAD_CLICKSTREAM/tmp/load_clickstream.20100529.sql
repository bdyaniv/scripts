...
TRUNCATE TABLE CLICK_SEARCHES_20100529;
INSERT INTO CLICK_SEARCHES_20100529
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100529'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100529;
ANALYZE CLICK_SEARCHES_20100529;
END;
