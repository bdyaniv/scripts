...
TRUNCATE TABLE CLICK_SEARCHES_20110305;
INSERT INTO CLICK_SEARCHES_20110305
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110305'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110305;
ANALYZE CLICK_SEARCHES_20110305;
END;
