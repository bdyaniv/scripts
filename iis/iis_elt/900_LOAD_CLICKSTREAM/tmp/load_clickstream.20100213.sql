...
TRUNCATE TABLE CLICK_SEARCHES_20100213;
INSERT INTO CLICK_SEARCHES_20100213
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100213'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100213;
ANALYZE CLICK_SEARCHES_20100213;
END;
