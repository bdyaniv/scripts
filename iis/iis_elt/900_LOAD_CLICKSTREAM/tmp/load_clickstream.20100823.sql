...
TRUNCATE TABLE CLICK_SEARCHES_20100823;
INSERT INTO CLICK_SEARCHES_20100823
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100823'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100823;
ANALYZE CLICK_SEARCHES_20100823;
END;
