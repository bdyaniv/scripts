...
TRUNCATE TABLE CLICK_SEARCHES_20110917;
INSERT INTO CLICK_SEARCHES_20110917
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110917'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110917;
ANALYZE CLICK_SEARCHES_20110917;
END;
