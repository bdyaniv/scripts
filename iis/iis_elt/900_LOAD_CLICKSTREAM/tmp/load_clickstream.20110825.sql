...
TRUNCATE TABLE CLICK_SEARCHES_20110825;
INSERT INTO CLICK_SEARCHES_20110825
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110825'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110825;
ANALYZE CLICK_SEARCHES_20110825;
END;
