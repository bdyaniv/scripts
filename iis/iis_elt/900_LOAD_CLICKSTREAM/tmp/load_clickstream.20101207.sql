...
TRUNCATE TABLE CLICK_SEARCHES_20101207;
INSERT INTO CLICK_SEARCHES_20101207
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101207'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101207;
ANALYZE CLICK_SEARCHES_20101207;
END;
