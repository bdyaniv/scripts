...
TRUNCATE TABLE CLICK_SEARCHES_20120109;
INSERT INTO CLICK_SEARCHES_20120109
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20120109'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20120109;
ANALYZE CLICK_SEARCHES_20120109;
END;
