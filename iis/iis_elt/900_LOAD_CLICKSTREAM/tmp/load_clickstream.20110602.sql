...
TRUNCATE TABLE CLICK_SEARCHES_20110602;
INSERT INTO CLICK_SEARCHES_20110602
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110602'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110602;
ANALYZE CLICK_SEARCHES_20110602;
END;
