...
TRUNCATE TABLE CLICK_SEARCHES_20100728;
INSERT INTO CLICK_SEARCHES_20100728
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100728'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100728;
ANALYZE CLICK_SEARCHES_20100728;
END;
