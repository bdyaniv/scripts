...
TRUNCATE TABLE CLICK_SEARCHES_20110422;
INSERT INTO CLICK_SEARCHES_20110422
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110422'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110422;
ANALYZE CLICK_SEARCHES_20110422;
END;
