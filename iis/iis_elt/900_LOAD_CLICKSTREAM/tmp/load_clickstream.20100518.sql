...
TRUNCATE TABLE CLICK_SEARCHES_20100518;
INSERT INTO CLICK_SEARCHES_20100518
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100518'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100518;
ANALYZE CLICK_SEARCHES_20100518;
END;
