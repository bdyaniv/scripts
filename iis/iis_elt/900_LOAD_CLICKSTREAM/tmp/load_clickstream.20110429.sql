...
TRUNCATE TABLE CLICK_SEARCHES_20110429;
INSERT INTO CLICK_SEARCHES_20110429
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110429'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110429;
ANALYZE CLICK_SEARCHES_20110429;
END;
