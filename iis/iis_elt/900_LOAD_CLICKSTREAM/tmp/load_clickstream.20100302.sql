...
TRUNCATE TABLE CLICK_SEARCHES_20100302;
INSERT INTO CLICK_SEARCHES_20100302
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100302'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100302;
ANALYZE CLICK_SEARCHES_20100302;
END;
