...
TRUNCATE TABLE CLICK_SEARCHES_20111208;
INSERT INTO CLICK_SEARCHES_20111208
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111208'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111208;
ANALYZE CLICK_SEARCHES_20111208;
END;
