...
TRUNCATE TABLE CLICK_SEARCHES_20100929;
INSERT INTO CLICK_SEARCHES_20100929
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100929'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100929;
ANALYZE CLICK_SEARCHES_20100929;
END;
