...
TRUNCATE TABLE CLICK_SEARCHES_20110510;
INSERT INTO CLICK_SEARCHES_20110510
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110510'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110510;
ANALYZE CLICK_SEARCHES_20110510;
END;
