...
TRUNCATE TABLE CLICK_SEARCHES_20110501;
INSERT INTO CLICK_SEARCHES_20110501
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110501'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110501;
ANALYZE CLICK_SEARCHES_20110501;
END;
