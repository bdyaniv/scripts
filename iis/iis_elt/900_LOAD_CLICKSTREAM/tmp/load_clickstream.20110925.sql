...
TRUNCATE TABLE CLICK_SEARCHES_20110925;
INSERT INTO CLICK_SEARCHES_20110925
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110925'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110925;
ANALYZE CLICK_SEARCHES_20110925;
END;
