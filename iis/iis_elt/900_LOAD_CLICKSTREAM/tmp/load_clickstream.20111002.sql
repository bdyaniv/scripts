...
TRUNCATE TABLE CLICK_SEARCHES_20111002;
INSERT INTO CLICK_SEARCHES_20111002
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111002'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111002;
ANALYZE CLICK_SEARCHES_20111002;
END;
