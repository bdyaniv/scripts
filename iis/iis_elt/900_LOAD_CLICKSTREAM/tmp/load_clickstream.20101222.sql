...
TRUNCATE TABLE CLICK_SEARCHES_20101222;
INSERT INTO CLICK_SEARCHES_20101222
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101222'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101222;
ANALYZE CLICK_SEARCHES_20101222;
END;
