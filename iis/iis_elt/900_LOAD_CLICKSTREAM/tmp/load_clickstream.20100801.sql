...
TRUNCATE TABLE CLICK_SEARCHES_20100801;
INSERT INTO CLICK_SEARCHES_20100801
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100801'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100801;
ANALYZE CLICK_SEARCHES_20100801;
END;
