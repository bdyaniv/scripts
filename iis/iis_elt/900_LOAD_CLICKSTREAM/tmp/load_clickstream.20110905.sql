...
TRUNCATE TABLE CLICK_SEARCHES_20110905;
INSERT INTO CLICK_SEARCHES_20110905
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110905'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110905;
ANALYZE CLICK_SEARCHES_20110905;
END;
