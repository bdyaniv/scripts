...
TRUNCATE TABLE CLICK_SEARCHES_20110312;
INSERT INTO CLICK_SEARCHES_20110312
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110312'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110312;
ANALYZE CLICK_SEARCHES_20110312;
END;
