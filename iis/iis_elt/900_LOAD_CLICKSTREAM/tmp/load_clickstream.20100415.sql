...
TRUNCATE TABLE CLICK_SEARCHES_20100415;
INSERT INTO CLICK_SEARCHES_20100415
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100415'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100415;
ANALYZE CLICK_SEARCHES_20100415;
END;
