...
TRUNCATE TABLE CLICK_SEARCHES_20101007;
INSERT INTO CLICK_SEARCHES_20101007
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101007'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101007;
ANALYZE CLICK_SEARCHES_20101007;
END;
