...
TRUNCATE TABLE CLICK_SEARCHES_20110610;
INSERT INTO CLICK_SEARCHES_20110610
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110610'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110610;
ANALYZE CLICK_SEARCHES_20110610;
END;
