...
TRUNCATE TABLE CLICK_SEARCHES_20101019;
INSERT INTO CLICK_SEARCHES_20101019
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101019'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101019;
ANALYZE CLICK_SEARCHES_20101019;
END;
