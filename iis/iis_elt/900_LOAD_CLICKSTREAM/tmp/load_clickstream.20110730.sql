...
TRUNCATE TABLE CLICK_SEARCHES_20110730;
INSERT INTO CLICK_SEARCHES_20110730
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110730'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110730;
ANALYZE CLICK_SEARCHES_20110730;
END;
