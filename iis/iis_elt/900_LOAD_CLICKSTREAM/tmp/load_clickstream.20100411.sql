...
TRUNCATE TABLE CLICK_SEARCHES_20100411;
INSERT INTO CLICK_SEARCHES_20100411
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100411'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100411;
ANALYZE CLICK_SEARCHES_20100411;
END;
