...
TRUNCATE TABLE CLICK_SEARCHES_20101105;
INSERT INTO CLICK_SEARCHES_20101105
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101105'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101105;
ANALYZE CLICK_SEARCHES_20101105;
END;
