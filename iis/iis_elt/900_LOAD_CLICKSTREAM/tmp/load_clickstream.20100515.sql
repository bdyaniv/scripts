...
TRUNCATE TABLE CLICK_SEARCHES_20100515;
INSERT INTO CLICK_SEARCHES_20100515
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100515'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100515;
ANALYZE CLICK_SEARCHES_20100515;
END;
