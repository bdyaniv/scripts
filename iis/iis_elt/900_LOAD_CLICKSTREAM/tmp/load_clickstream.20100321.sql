...
TRUNCATE TABLE CLICK_SEARCHES_20100321;
INSERT INTO CLICK_SEARCHES_20100321
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100321'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100321;
ANALYZE CLICK_SEARCHES_20100321;
END;
