...
TRUNCATE TABLE CLICK_SEARCHES_20111214;
INSERT INTO CLICK_SEARCHES_20111214
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20111214'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20111214;
ANALYZE CLICK_SEARCHES_20111214;
END;
