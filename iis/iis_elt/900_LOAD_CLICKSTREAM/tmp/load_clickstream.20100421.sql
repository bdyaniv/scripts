...
TRUNCATE TABLE CLICK_SEARCHES_20100421;
INSERT INTO CLICK_SEARCHES_20100421
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100421'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100421;
ANALYZE CLICK_SEARCHES_20100421;
END;
