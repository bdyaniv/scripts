...
TRUNCATE TABLE CLICK_SEARCHES_20110901;
INSERT INTO CLICK_SEARCHES_20110901
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110901'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110901;
ANALYZE CLICK_SEARCHES_20110901;
END;
