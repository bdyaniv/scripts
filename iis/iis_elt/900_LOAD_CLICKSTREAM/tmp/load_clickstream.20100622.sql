...
TRUNCATE TABLE CLICK_SEARCHES_20100622;
INSERT INTO CLICK_SEARCHES_20100622
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100622'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100622;
ANALYZE CLICK_SEARCHES_20100622;
END;
