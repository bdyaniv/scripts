...
TRUNCATE TABLE CLICK_SEARCHES_20110407;
INSERT INTO CLICK_SEARCHES_20110407
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110407'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110407;
ANALYZE CLICK_SEARCHES_20110407;
END;
