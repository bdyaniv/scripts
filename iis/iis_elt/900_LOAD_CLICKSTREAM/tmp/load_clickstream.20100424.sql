...
TRUNCATE TABLE CLICK_SEARCHES_20100424;
INSERT INTO CLICK_SEARCHES_20100424
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100424'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100424;
ANALYZE CLICK_SEARCHES_20100424;
END;
