...
TRUNCATE TABLE CLICK_SEARCHES_20101107;
INSERT INTO CLICK_SEARCHES_20101107
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101107'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101107;
ANALYZE CLICK_SEARCHES_20101107;
END;
