...
TRUNCATE TABLE CLICK_SEARCHES_20100522;
INSERT INTO CLICK_SEARCHES_20100522
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100522'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100522;
ANALYZE CLICK_SEARCHES_20100522;
END;
