...
TRUNCATE TABLE CLICK_SEARCHES_20100824;
INSERT INTO CLICK_SEARCHES_20100824
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100824'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100824;
ANALYZE CLICK_SEARCHES_20100824;
END;
