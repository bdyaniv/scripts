...
TRUNCATE TABLE CLICK_SEARCHES_20100821;
INSERT INTO CLICK_SEARCHES_20100821
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100821'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100821;
ANALYZE CLICK_SEARCHES_20100821;
END;
