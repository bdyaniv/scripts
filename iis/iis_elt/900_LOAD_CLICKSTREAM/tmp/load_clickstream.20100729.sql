...
TRUNCATE TABLE CLICK_SEARCHES_20100729;
INSERT INTO CLICK_SEARCHES_20100729
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20100729'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20100729;
ANALYZE CLICK_SEARCHES_20100729;
END;
