...
TRUNCATE TABLE CLICK_SEARCHES_20110304;
INSERT INTO CLICK_SEARCHES_20110304
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20110304'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20110304;
ANALYZE CLICK_SEARCHES_20110304;
END;
