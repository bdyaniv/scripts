...
TRUNCATE TABLE CLICK_SEARCHES_20101208;
INSERT INTO CLICK_SEARCHES_20101208
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '20101208'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_20101208;
ANALYZE CLICK_SEARCHES_20101208;
END;
