...
TRUNCATE TABLE CLICK_SEARCHES_%CUR_YYYYMMDD%;
INSERT INTO CLICK_SEARCHES_%CUR_YYYYMMDD%
(
	hit_id,
	resource_id,
	hit_date,
...
WHERE 
  ...
  b.visit_date = '%CUR_YYYYMMDD%'::date
;

SELECT COUNT(*) FROM CLICK_SEARCHES_%CUR_YYYYMMDD%;
ANALYZE CLICK_SEARCHES_%CUR_YYYYMMDD%;
END;
