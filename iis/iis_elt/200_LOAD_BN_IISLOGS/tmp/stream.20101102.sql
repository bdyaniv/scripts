...
FROM STREAM(
     ON (SELECT 'temp.gz:' || line 
         ...
         WHERE 
           hit_timestamp >= ('20101102 0:0:0'::timestamp + interval '5 hours')
         UNION
         SELECT 'temp.gz:' || line
         FROM
           iis_logs_raw_child_20101103
         WHERE
           hit_timestamp < ('20101103 00:00:00'::timestamp + interval '5 hours')
        )
...
ALTER TABLE iis_child.iis_logs_raw_child_20101031 COMPRESS HIGH;
