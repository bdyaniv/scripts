...
FROM STREAM(
     ON (SELECT 'temp.gz:' || line 
         FROM 
           iis_logs_raw_child_20101105
         WHERE 
           hit_timestamp >= ('20101105 0:0:0'::timestamp + interval '5 hours')
         UNION
         SELECT 'temp.gz:' || line
         FROM
           iis_logs_raw_child_20101106
         WHERE
           hit_timestamp < ('20101106 00:00:00'::timestamp + interval '5 hours')
        )
...
ALTER TABLE iis_child.iis_logs_raw_child_20101103 COMPRESS HIGH;
