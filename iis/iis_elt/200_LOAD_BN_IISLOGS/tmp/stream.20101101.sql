...
FROM STREAM(
     ON (SELECT 'temp.gz:' || line 
         FROM 
           iis_logs_raw_child_20101101
         WHERE 
           hit_timestamp >= ('20101101 0:0:0'::timestamp + interval '5 hours')
         UNION
         SELECT 'temp.gz:' || line
         FROM
           iis_logs_raw_child_20101102
         WHERE
           hit_timestamp < ('20101102 00:00:00'::timestamp + interval '5 hours')
        )
...
ALTER TABLE iis_child.iis_logs_raw_child_20101030 COMPRESS HIGH;
