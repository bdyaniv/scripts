...
TRUNCATE TABLE page_view_summary_%CUR_YYYYMMDD%;
INSERT INTO page_view_summary_%CUR_YYYYMMDD%
(
	hit_date,
	resource_name,
	host_name,
...
SELECT 
  ...
  a.visible_page_ind  
FROM 
  click_searches_%CUR_YYYYMMDD% a,
  events b  
WHERE 
...
SELECT count(*) from PAGE_VIEW_SUMMARY_%CUR_YYYYMMDD%;
ANALYZE PAGE_VIEW_SUMMARY_%CUR_YYYYMMDD%;
