...
#    loader_command.write("ncluster_loader --loader 10.225.75.243 -a -f -D \"^O\" --columns uuid,hit_timestamp,line --el-discard-errors -U beehive -w beehive --skip-rows 1 iis.iis_logs_raw_parent tmp.new.txt")
    loader_command.write("ncluster_loader --loader 10.225.78.242 -a -f -D \"\"")
...
=======
    loader_command.write(" --columns srcfile,uuid,hit_timestamp,line --el-discard-errors -U etl -w etl --skip-rows 1 iis.iis_logs_raw_parent tmp.new.txt")
>>>>>>> .r1090
